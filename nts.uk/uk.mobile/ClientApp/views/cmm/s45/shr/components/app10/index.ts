...
export class CmmS45ShrComponentsApp10Component extends Vue {
    ...
    private init() {
        ...
        vm.$http.post('at', API.getDetail, command).then((data: any) => {
            ...
            vm.params.appDispInfoStartupOutput = data.data.appDispInfoStartup;
    ...
    public cdtHdMngLeaveDailyType() {
        ...
        if ((workType.morningCls == 6 && vm.params.appDetail.holidayManage == 1) ||
            (workType.afternoonCls == 6 && vm.params.appDetail.holidayManage == 1)) {
            return true;
        }
