<template>
  <div class="cmms45componentsapp9">
    ...
    <div class="row pl-4 pb-2">
        ...
        <span class="col-8" v-else-if="cond1 == false">{{time.attendanceTime | timewd}} から出勤{{'KAFS04_14' | i18n}}</span>
    ...
    <div class="row pl-4 pb-2">
        ...
        <span class="col-8" v-else-if="cond2 == false">{{time.leaveTime | timewd}} に退勤{{'KAFS04_14' | i18n}}</span>
        <span v-else class="col-8">{{'KAFS04_18' | i18n}}</span>
    </div>
    <!-- B2 -->
    <div v-if="showData">
