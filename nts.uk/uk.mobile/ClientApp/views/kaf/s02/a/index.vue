      ...
      <div class="card card-label">
        ...
        <div>
          <div v-for="itemWH in workHourLst" :key="itemWH.frame">
            ...
            <!-- A3_3 -->
            <div style="color: red" v-if="condition2 && itemWH.errorMsg !== null && condition1(itemWH)">{{ itemWH.errorMsg }}</div>
            <!-- A3_1 -->
        ...
        <div v-if="condition4">
          <div v-for="itemTH in tempWorkHourLst" :key="itemTH.frame">
            ...
            <!-- A3_3 -->
            <div style="color: red" v-if="condition2 && condition12">{{ itemTH.errorMsg }}</div>
            <!-- A3_1 -->
            <div class="card-body">
    ...
    <div v-if="condition6">
      <div class="card card-label">
        ...
        <div v-for="itemGH in goOutLst" :key="itemGH.frame">
          ...
          <!-- A4_3 -->
          <div style="color: red" v-if="condition2 && condition12">{{ itemGH.errorMsg }}</div>
          <!-- A4_1 -->
          <div class="card-body">
    ...
    <div v-if="condition7">
      <div class="card card-label">
        ...
        <div v-for="itemBH in breakLst" :key="itemBH.frame">
          ...
          <!-- A5_3 -->
          <div style="color: red" v-if="condition2 && condition12">{{ itemBH.errorMsg }}</div>
          <!-- A5_1 -->
          <div class="card-body">
    ...
    <div v-if="condition8">
      <div class="card card-label">
        ...
        <div v-for="itemCH in childCareLst" :key="itemCH.frame">
          ...
          <!-- A6_3 -->
          <div style="color: red" v-if="condition2 && condition12">{{ itemCH.errorMsg }}</div>
          <!-- A6_1 -->
          <div class="card-body">
    ...
    <div v-if="condition9">
      <div class="card card-label">
        ...
        <div v-for="itemLH in longTermLst" :key="itemLH.frame">
          ...
          <!-- A7_3 -->
          <div style="color: red" v-if="condition2">{{ itemLH.errorMsg }}</div>
          <!-- A7_1 -->
          <div class="card-body">
