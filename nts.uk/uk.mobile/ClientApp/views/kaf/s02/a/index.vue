  ...
  <div class="kafs02a">
    ...
    <div v-if="(mode && (condition5 || condition4)) || (!mode && (workHourLst.length > 0 || tempWorkHourLst.length > 0))">
      <div class="card card-label">
        ...
        <!-- Temprory WorkHour -->
        <div v-if="(mode && condition4) || (!mode && tempWorkHourLst.length > 0)">
          <div v-for="itemTH in tempWorkHourLst" :key="itemTH.frame">
            ...
            <!-- A3_3 -->
            <div style="color: red; font-size: 90%" v-if="condition2 && itemTH.errorMsg !== null && condition1(itemTH)">{{ itemTH.errorMsg }}</div>
            <!-- A3_1 -->
            <div class="card-body">
    ...
    <!-- A4 -->
    <div v-if="(mode && condition6) || (!mode && goOutLst.length > 0)">
      <div class="card card-label">
        <div class="card-header uk-bg-accordion mt-2 mb-n2">
        ...
        <div v-for="itemGH in goOutLst" :key="itemGH.frame">
          ...
          <!-- A4_3 -->
          <div style="color: red; font-size: 90%" v-if="condition2 && itemGH.errorMsg !== null && condition1(itemGH)">{{ itemGH.errorMsg }}</div>
          <!-- A4_1 -->
          <div class="card-body">
    ...
    <!-- A5 -->
    <div v-if="(mode && condition7) || (!mode && breakLst.length > 0)">
      <div class="card card-label">
        <div class="card-header uk-bg-accordion mt-2 mb-n2">
        ...
        <div v-for="itemBH in breakLst" :key="itemBH.frame">
          ...
          <!-- A5_3 -->
          <div style="color: red; font-size: 90%" v-if="condition2 && itemBH.errorMsg !== null && condition1(itemBH)">{{ itemBH.errorMsg }}</div>
          <!-- A5_1 -->
          <div class="card-body">
    ...
    <!-- A6 -->
    <div v-if="(mode && condition8) || (!mode && childCareLst.length > 0)">
      <div class="card card-label">
        <div class="card-header uk-bg-accordion mt-2 mb-n2">
        ...
        <div v-for="itemCH in childCareLst" :key="itemCH.frame">
          ...
          <!-- A6_3 -->
          <div style="color: red; font-size: 90%" v-if="condition2 && itemCH.errorMsg !== null && condition1(itemCH)">{{ itemCH.errorMsg }}</div>
          <!-- A6_1 -->
          <div class="card-body">
    ...
    <!-- A7 -->
    <div v-if="(mode && condition9) || (!mode && longTermLst.length > 0)">
      <div class="card card-label">
        <div class="card-header uk-bg-accordion mt-2 mb-n2">
