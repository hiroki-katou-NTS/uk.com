<template>
  <div class="kafs09a">
    ...
    <div v-if="C1" class="card card-label">
      ...
      <div class="card-body">
        <nts-switchbox v-model="model.changeWork" v-bind:value="1">{{'KAFS07_13' | i18n}}</nts-switchbox>
        <nts-switchbox v-model="model.changeWork" v-bind:value="2">{{'KAFS07_14' | i18n}}</nts-switchbox>
      </div>
    </div>
