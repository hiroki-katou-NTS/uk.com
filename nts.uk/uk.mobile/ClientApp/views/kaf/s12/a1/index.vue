<template>
  <div class="kafs12a1">
    ...
    >
      <!-- A_A5_1 -->
      <div v-if="dispInfoTimeLeaveRequest.frame == 0 && condition2">
        ...
        <!-- <span v-if="condition2 == false">hien chu nay </span> -->
        <!-- A_A5_2 -->
      ...
      <div v-if="dispInfoTimeLeaveRequest.frame == 1 && condition3">
        <div class="card card-label">
          <div class="card-header uk-bg-accordion">
            <span>{{ dispInfoTimeLeaveRequest.header | i18n }}</span>
            <span class="badge badge-info">任意</span>
      ...
      <div v-if="dispInfoTimeLeaveRequest.frame == 2 && condition9">
        <div class="card card-label">
          <div class="card-header uk-bg-accordion">
            <span>{{ dispInfoTimeLeaveRequest.header | i18n }}</span>
            <span class="badge badge-info">任意</span>
      ...
      <div v-if="dispInfoTimeLeaveRequest.frame == 3 && condition12">
        <div class="card card-label">
          <div class="card-header uk-bg-accordion">
            <span>{{ dispInfoTimeLeaveRequest.header | i18n }}</span>
            <span class="badge badge-info">任意</span>
    ...
    <div class="card card-label">
      <div v-if="condition15">
          ...
          >
            <div class="card-body mb-n3">
              <nts-time-range-input
                ...
                v-bind:name="
                  goBackTimeItem.name | i18n(goBackTimeItem.frame + 1)
                "
              >
              </nts-time-range-input>
              <div v-if="condition16" class="card-body w-100 mt-n3">
                <nts-switchbox
        ...
        <div v-if="showAddButton" class="mb-2">
        ...
        <button
          type="button"
          class="btn btn-success btn-block text-center mt-2"
