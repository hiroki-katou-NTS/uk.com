...
@Stateless
public class UpdateDepartmentCommandHandler extends CommandHandler<UpdateDepartmentCommand> {

	@Inject
	private DepartmentDomainService departmentDomainService;

	@Override
	protected void handle(CommandHandlerContext<UpdateDepartmentCommand> context) {
		...
		departmentDomainService.update(department);
	}
