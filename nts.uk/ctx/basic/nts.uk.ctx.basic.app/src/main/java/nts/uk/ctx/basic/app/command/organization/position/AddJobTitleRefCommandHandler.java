...
//		JobTitleRef jTitleRef = JobTitleRef.createFromJavaType(companyCode, context.getCommand().getHistoryId(),
//				context.getCommand().getJobCode(), context.getCommand().getAuthorizationCode(),
