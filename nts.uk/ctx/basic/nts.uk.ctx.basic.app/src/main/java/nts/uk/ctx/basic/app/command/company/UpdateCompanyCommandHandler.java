...
public class UpdateCompanyCommandHandler extends CommandHandler<UpdateCompanyCommand>{
	...
	protected void handle(CommandHandlerContext<UpdateCompanyCommand> context) {
		...
		company =Company.createFromJavaType(update.getCompanyCode(), update.getCompanyName(), update.getCompanyNameGlobal(),
				...
				update.getAddressKana2(), update.getTermBeginMon(), update.getUse_Gr_Set(),update.getUse_Kt_Set(), update.getUse_Qy_Set(),
				update.getUse_Jj_Set(), update.getUse_Ac_Set(), update.getUse_Gw_Set(), update.getUse_Hc_Set(), 
				update.getUse_Lc_Set(), update.getUse_Bi_Set(), update.getUse_Rs01_Set(), update.getUse_Rs02_Set(), 
				update.getUse_Rs03_Set(), update.getUse_Rs04_Set(), update.getUse_Rs05_Set(), update.getUse_Rs06_Set(),
				update.getUse_Rs07_Set(), update.getUse_Rs08_Set(), update.getUse_Rs09_Set(), update.getUse_Rs10_Set());
