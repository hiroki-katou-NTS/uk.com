...
@Stateless
public class AddWorkPlaceCommandHandler extends CommandHandler<AddWorkPlaceCommand> {

	@Inject
	private WorkPlaceRepository workPlaceRepository;

	@Override
	protected void handle(CommandHandlerContext<AddWorkPlaceCommand> context) {
...
//				new WorkPlaceGenericName(context.getCommand().getGenericName()),
