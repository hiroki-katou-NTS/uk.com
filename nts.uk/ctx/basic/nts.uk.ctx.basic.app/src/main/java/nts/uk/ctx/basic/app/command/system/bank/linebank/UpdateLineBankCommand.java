...
@Data
@NoArgsConstructor
public class UpdateLineBankCommand {
	...
	public LineBank toDomain(String companyCode){
		LineBank domain = LineBank.createFromJavaType(companyCode,
				this.accountAtr, 
				this.accountNo, 
				this.bankCode, 
				this.branchCode, 
		...
		domain.createConsignorFromJavaType(
				consignor.get(0).getCode(),consignor.get(0).getMemo(),
				consignor.get(1).getCode(),consignor.get(1).getMemo(),
				consignor.get(2).getCode(),consignor.get(2).getMemo(),
				consignor.get(3).getCode(),consignor.get(3).getMemo(),
