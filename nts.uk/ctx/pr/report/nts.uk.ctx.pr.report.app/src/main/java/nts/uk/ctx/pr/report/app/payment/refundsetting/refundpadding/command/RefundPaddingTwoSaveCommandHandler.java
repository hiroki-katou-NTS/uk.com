...
@Stateless
public class RefundPaddingTwoSaveCommandHandler
	extends CommandHandler<RefundPaddingTwoSaveCommand> {
	...
	@Override
	@Transactional
	protected void handle(CommandHandlerContext<RefundPaddingTwoSaveCommand> context) {
		...
		// get command
		RefundPaddingTwoSaveCommand command = context.getCommand();
