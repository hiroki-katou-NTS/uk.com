...
@Stateless
public class RefundPaddingOnceSaveCommandHandler
		extends CommandHandler<RefundPaddingOnceSaveCommand> {
	...
	@Override
	@Transactional
	protected void handle(CommandHandlerContext<RefundPaddingOnceSaveCommand> context) {
		...
		// get command
		RefundPaddingOnceSaveCommand command = context.getCommand();
