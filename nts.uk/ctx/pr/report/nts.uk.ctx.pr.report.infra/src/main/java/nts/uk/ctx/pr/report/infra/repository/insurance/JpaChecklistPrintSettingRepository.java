...
public class JpaChecklistPrintSettingRepository implements ChecklistPrintSettingRepository {
	...
	private ChecklistPrintSetting toDomain() {
	    ChecklistPrintSetting entity = new ChecklistPrintSetting(new JpaChecklistPrintSettingGetMemento(null));
	    return entity;
	}
	...
	class JpaChecklistPrintSettingGetMemento implements ChecklistPrintSettingGetMemento {
        ...
        /* (non-Javadoc)
         * @see nts.uk.ctx.pr.report.dom.insurance.ChecklistPrintSettingGetMemento#getCompanyCode()
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see nts.uk.ctx.pr.report.dom.insurance.ChecklistPrintSettingGetMemento#getShowCategoryInsuranceItem()
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see nts.uk.ctx.pr.report.dom.insurance.ChecklistPrintSettingGetMemento#getShowDeliveryNoticeAmount()
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see nts.uk.ctx.pr.report.dom.insurance.ChecklistPrintSettingGetMemento#getShowDetail()
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see nts.uk.ctx.pr.report.dom.insurance.ChecklistPrintSettingGetMemento#getShowOffice()
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see nts.uk.ctx.pr.report.dom.insurance.ChecklistPrintSettingGetMemento#getShowTotal()
         */
        @Override
