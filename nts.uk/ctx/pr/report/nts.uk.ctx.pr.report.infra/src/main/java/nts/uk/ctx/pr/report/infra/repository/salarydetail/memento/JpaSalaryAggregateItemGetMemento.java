 ...
 */
public class JpaSalaryAggregateItemGetMemento implements SalaryCategorySettingGetMemento {
	 ...
	 */
	public JpaSalaryAggregateItemGetMemento(List<QlsptPaylstFormDetail> details, SalaryCategory category) {
		super();
