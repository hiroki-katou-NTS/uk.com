...
@Setter
@Embeddable
public class QlsptLedgerAggreHeadPK implements Serializable {
	 ...
	 *            the ctg atr
	 */
	public QlsptLedgerAggreHeadPK(String ccd, int payBonusAtr, String aggregateCd, int ctgAtr) {
		this.ccd = ccd;
	...
	public boolean equals(Object object) {
		if (!(object instanceof QlsptLedgerAggreHeadPK)) {
			return false;
		}
		QlsptLedgerAggreHeadPK other = (QlsptLedgerAggreHeadPK) object;
