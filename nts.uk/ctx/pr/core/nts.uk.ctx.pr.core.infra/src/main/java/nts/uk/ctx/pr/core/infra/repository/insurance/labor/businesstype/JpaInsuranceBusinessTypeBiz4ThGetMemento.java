 ...
 */
public class JpaInsuranceBusinessTypeBiz4ThGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz4ThGetMemento(QismtBusinessType typeValue) {
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz4Th;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName04());
	}
