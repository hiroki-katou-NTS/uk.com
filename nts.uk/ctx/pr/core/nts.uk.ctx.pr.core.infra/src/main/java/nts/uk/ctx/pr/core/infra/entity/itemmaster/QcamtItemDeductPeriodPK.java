...
@NoArgsConstructor
@Embeddable
public class QcamtItemDeductPeriodPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemDeductPeriodPK)) {
            return false;
        }
        QcamtItemDeductPeriodPK other = (QcamtItemDeductPeriodPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemDeductPeriodPK[ ccd=" + ccd + ", itemCd=" + itemCd + " ]";
    }
