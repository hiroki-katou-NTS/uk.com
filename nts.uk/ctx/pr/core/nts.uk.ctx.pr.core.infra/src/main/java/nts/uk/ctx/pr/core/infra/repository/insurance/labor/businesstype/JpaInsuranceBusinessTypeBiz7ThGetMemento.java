 ...
 */
public class JpaInsuranceBusinessTypeBiz7ThGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz7ThGetMemento(QismtBusinessType typeValue) {
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz7Th;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName07());
	}
