...
@NoArgsConstructor
@Embeddable
public class QcamtItemSalaryPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemSalaryPK)) {
            return false;
        }
        QcamtItemSalaryPK other = (QcamtItemSalaryPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemSalaryPK[ ccd=" + ccd + ", itemCd=" + itemCd + " ]";
    }
