 ...
 */
public class JpaInsuranceBusinessTypeBiz10ThGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz10ThGetMemento(QismtBusinessType typeValue) {
	...
	public CompanyCode getCompanyCode() {
		return new CompanyCode(this.typeValue.getBizName10());
	}
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz10Th;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName10());
	}
