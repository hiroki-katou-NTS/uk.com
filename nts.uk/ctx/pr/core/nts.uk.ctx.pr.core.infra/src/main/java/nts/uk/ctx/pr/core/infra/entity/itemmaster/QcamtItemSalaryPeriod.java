...
@Entity
public class QcamtItemSalaryPeriod extends UkJpaEntity implements Serializable {
    ...
    @Override
    protected QcamtItemSalaryPeriodPK getKey() {
    	return this.qcamtItemSalaryPeriodPK;
    }
}
