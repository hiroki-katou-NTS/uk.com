...
/**
 * The Class QismtPensionRatePK.
 */
@Data
@Embeddable
public class QismtPensionRatePK implements Serializable {
	...
	/**
	 * Instantiates a new qismt pension rate PK.
	 */
	public QismtPensionRatePK() {
		super();
	}
	 ...
	 *            the hist id
	 */
	public QismtPensionRatePK(String ccd, String siOfficeCd, String histId) {
		this.ccd = ccd;
	...
	public boolean equals(Object object) {
		if (!(object instanceof QismtPensionRatePK)) {
			return false;
		}
		QismtPensionRatePK other = (QismtPensionRatePK) object;
