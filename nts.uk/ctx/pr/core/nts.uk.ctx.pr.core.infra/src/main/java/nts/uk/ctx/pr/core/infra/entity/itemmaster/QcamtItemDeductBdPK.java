...
@NoArgsConstructor
@Embeddable
public class QcamtItemDeductBdPK{
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemDeductBdPK)) {
            return false;
        }
        QcamtItemDeductBdPK other = (QcamtItemDeductBdPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemDeductBdPK[ ccd=" + ccd + ", itemCd=" + itemCd + ", itemBreakdownCd=" + itemBreakdownCd + " ]";
    }
