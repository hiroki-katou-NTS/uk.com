...
import nts.uk.ctx.pr.core.dom.wagetable.reference.WageTableCodeRefGetMemento;
import nts.uk.ctx.pr.core.infra.entity.wagetable.reference.QwtmtWagetableRefCd;

/**
 * The Class JpaWageTableCodeRefGetMemento.
 */
public class JpaWageTableCodeRefGetMemento implements WageTableCodeRefGetMemento {
	 ...
	 *            the type value
	 */
	public JpaWageTableCodeRefGetMemento(QwtmtWagetableRefCd typeValue) {
	...
	public CompanyCode getCompanyCode() {
		return new CompanyCode(this.typeValue.getQwtmtWagetableRefCdPK().getCcd());
	}
