 ...
 */
public class JpaInsuranceBusinessTypeBiz2NdGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz2NdGetMemento(QismtBusinessType typeValue) {
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz2Nd;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName02());
	}
