...
public class QwtmtWagetableRefCd implements Serializable {
	 ...
	 *            the wage person field
	 */
	public QwtmtWagetableRefCd(QwtmtWagetableRefCdPK qwtmtWagetableRefCdPK, int exclusVer, String refCdName,
			String wageRefValue, String wagePersonTable, String wagePersonField) {
		this.qwtmtWagetableRefCdPK = qwtmtWagetableRefCdPK;
		this.exclusVer = exclusVer;
		this.refCdName = refCdName;
