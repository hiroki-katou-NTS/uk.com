...
@AllArgsConstructor
@NoArgsConstructor
public class QcamtItemSalaryPeriodPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemSalaryPeriodPK)) {
            return false;
        }
        QcamtItemSalaryPeriodPK other = (QcamtItemSalaryPeriodPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemSalaryPeriodPK[ ccd=" + ccd + ", itemCd=" + itemCd + " ]";
    }
