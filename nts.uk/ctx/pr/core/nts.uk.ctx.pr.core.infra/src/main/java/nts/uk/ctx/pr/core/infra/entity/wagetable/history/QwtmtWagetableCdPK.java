...
public class QwtmtWagetableCdPK implements Serializable {
     ...
     *
     * @param ccd the ccd
     * @param wageTableCd the wage table cd
     * @param histId the hist id
     * @param demensionNo the demension no
     * @param elementCd the element cd
     */
    public QwtmtWagetableCdPK(String ccd, String wageTableCd, String histId, short demensionNo, String elementCd) {
        this.ccd = ccd;
    ...
    public boolean equals(Object object) {
        ...
        if ((this.wageTableCd == null && other.wageTableCd != null) || (this.wageTableCd != null && !this.wageTableCd.equals(other.wageTableCd))) {
            return false;
        }
        ...
        if ((this.elementCd == null && other.elementCd != null) || (this.elementCd != null && !this.elementCd.equals(other.elementCd))) {
            return false;
        }
        return true;
    }
