...
@Data
@Embeddable
public class QismtHealthInsuRatePK implements Serializable {
	 ...
	 *            the hist id
	 */
	public QismtHealthInsuRatePK(String ccd, String siOfficeCd, String histId) {
		this.ccd = ccd;
	...
	public boolean equals(Object object) {
		if (!(object instanceof QismtHealthInsuRatePK)) {
			return false;
		}
		QismtHealthInsuRatePK other = (QismtHealthInsuRatePK) object;
