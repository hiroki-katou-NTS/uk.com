...
public class JpaAcquisitionRuleSetMemento implements AcquisitionRuleSetMemento {
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.pr.core.dom.vacation.setting.acquisitionrule.VaAcRuleSetMemento#setCompanyId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.pr.core.dom.vacation.setting.acquisitionrule.VaAcRuleSetMemento#setSettingclassification(nts.uk.ctx.pr.core.dom.vacation.setting.acquisitionrule.Settingclassification)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.pr.core.dom.vacation.setting.acquisitionrule.VaAcRuleSetMemento#setAcquisitionOrder(java.util.List)
	 */
	@Override
