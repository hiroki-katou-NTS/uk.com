...
public class QbkdtBankTransfer extends TableEntity {
    ...
    public QbkdtBankTransfer(QbkdtBankTransferPK qbkdtBankTransferPK, String cnameKana, String fromBankKnName, String fromBranchKnName, String toBankKnName, String toBranchKnName, String toAccountKnName, String depcd, BigDecimal paymentMny, int processingNo, int processingYm) {
        this.qbkdtBankTransferPK = qbkdtBankTransferPK;
    ...
    public QbkdtBankTransfer(String ccd, String pid, String fromBankCd, String fromBranchCd, int fromAccountAtr, String fromAccountNo, String toBankCd, String toBranchCd, int toAccountAtr, String toAccountNo, int payBonusAtr, GeneralDate payDate, int sparePayAtr) {
        this.qbkdtBankTransferPK = new QbkdtBankTransferPK(ccd, pid, fromBankCd, fromBranchCd, fromAccountAtr, fromAccountNo, toBankCd, toBranchCd, toAccountAtr, toAccountNo, payBonusAtr, payDate, sparePayAtr);
    }
}
