 ...
 */
public class JpaInsuranceBusinessTypeBiz6ThGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz6ThGetMemento(QismtBusinessType typeValue) {
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz6Th;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName06());
	}
