...
public class JpaItemPeriodRepository extends JpaRepository implements ItemPeriodRepository {
	...
	public Optional<ItemPeriod> find(String companyCode ,int ctgAtr , String itemCd) {
		return this.queryProxy().query(DEL_1, QcamtItemPeriod.class)
				.setParameter("companyCode", companyCode)
				.setParameter("ctgAtr", ctgAtr)
	...
	private ItemPeriod toDomain(QcamtItemPeriod entity) {
		val domain = ItemPeriod.createFromJavaType(
				entity.qcamtItemPeriodPK.ccd,
				entity.qcamtItemPeriodPK.ctgAtr, 
				entity.qcamtItemPeriodPK.itemCd, 
				entity.periodAtr, 
				entity.strY,
				entity.endY, 
				entity.cycleAtr, 
