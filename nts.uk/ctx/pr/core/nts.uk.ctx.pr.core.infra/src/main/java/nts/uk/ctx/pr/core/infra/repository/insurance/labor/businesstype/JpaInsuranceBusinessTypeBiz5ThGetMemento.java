 ...
 */
public class JpaInsuranceBusinessTypeBiz5ThGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz5ThGetMemento(QismtBusinessType typeValue) {
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz5Th;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName05());
	}
