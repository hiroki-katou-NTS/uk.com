...
@XmlRootElement
public class QcamtItemAttend extends TableEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.qcamtItemAttendPK == null && other.qcamtItemAttendPK != null) || (this.qcamtItemAttendPK != null && !this.qcamtItemAttendPK.equals(other.qcamtItemAttendPK))) {
            return false;
        }
        return true;
    }
