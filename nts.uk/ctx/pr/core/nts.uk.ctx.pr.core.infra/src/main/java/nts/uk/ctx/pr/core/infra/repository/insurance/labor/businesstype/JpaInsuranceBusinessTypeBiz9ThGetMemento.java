 ...
 */
public class JpaInsuranceBusinessTypeBiz9ThGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz9ThGetMemento(QismtBusinessType typeValue) {
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz9Th;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName09());
	}
