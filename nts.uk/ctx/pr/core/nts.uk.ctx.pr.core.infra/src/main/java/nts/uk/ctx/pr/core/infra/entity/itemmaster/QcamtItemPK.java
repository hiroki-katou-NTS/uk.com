...
public class QcamtItemPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemPK)) {
            return false;
        }
        QcamtItemPK other = (QcamtItemPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemPK[ ccd=" + ccd + ", ctgAtr=" + ctgAtr + ", itemCd=" + itemCd + " ]";
    }
