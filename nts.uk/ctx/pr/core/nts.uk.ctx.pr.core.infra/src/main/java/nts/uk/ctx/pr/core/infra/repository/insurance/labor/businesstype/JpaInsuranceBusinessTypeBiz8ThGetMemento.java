 ...
 */
public class JpaInsuranceBusinessTypeBiz8ThGetMemento implements InsuranceBusinessTypeGetMemento {
	 ...
	 *            the type value
	 */
	public JpaInsuranceBusinessTypeBiz8ThGetMemento(QismtBusinessType typeValue) {
	...
	public BusinessTypeEnum getBizOrder() {
		return BusinessTypeEnum.Biz8Th;
	}
	...
	public BusinessName getBizName() {
		return new BusinessName(this.typeValue.getBizName08());
	}
