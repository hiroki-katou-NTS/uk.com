 ...
 */
@RequestScoped
public class RegisterRetirementPayItemCommandHandler extends CommandHandler<RegisterRetirementPayItemCommand>{
	@Inject
	private RetirementPayItemRepository retirementPayItemRepository;
	
	@Override
	protected void handle(CommandHandlerContext<RegisterRetirementPayItemCommand> context) {
		// TODO Auto-generated method stub
		RegisterRetirementPayItemCommand command = context.getCommand();
		...
		this.retirementPayItemRepository.add(retirementPayItem);
	}
}
