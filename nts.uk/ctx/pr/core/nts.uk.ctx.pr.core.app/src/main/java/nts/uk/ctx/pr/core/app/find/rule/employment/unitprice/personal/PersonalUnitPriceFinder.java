...
PersonalUnitPriceFinder {
	...
	public List<PersonalUnitPriceDto> findAll() {
		...
		return personalUnitPriceRepository.findAll(companyCode)
	...
	public PersonalUnitPriceDto find(String personalUnitPriceCode) {
		...
		return new PersonalUnitPriceDto(
				unitPrice.getPersonalUnitPriceCode().v(),
				unitPrice.getPersonalUnitPriceName().v(),
				unitPrice.getPersonalUnitPriceAbName().v(),
				unitPrice.getDisplaySet().value,
				unitPrice.getUniteCode().v(),
				unitPrice.getPaymentSettingType().value,
				unitPrice.getFixPaymentAtr().value,
				unitPrice.getFixPaymentMonthly().value,
				unitPrice.getFixPaymentDayMonth().value,
				unitPrice.getFixPaymentDaily().value,
