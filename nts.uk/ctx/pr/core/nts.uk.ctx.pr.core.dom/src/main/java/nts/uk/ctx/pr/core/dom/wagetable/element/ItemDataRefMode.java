 ...
 */
@Getter
public class ItemDataRefMode implements ElementMode {

	/** The Constant mode. */
	public static final ElementType mode = ElementType.ItemDataRef;
	 ...
	 *            the items
	 */
	public ItemDataRefMode(Integer lowerLimit, Integer upperLimit, Integer interval) {
		super();
