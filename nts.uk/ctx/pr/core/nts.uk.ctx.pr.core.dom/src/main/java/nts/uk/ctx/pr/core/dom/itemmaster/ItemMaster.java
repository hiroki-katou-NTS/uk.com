...
public class ItemMaster extends AggregateRoot {
	...
	public ItemMaster(CompanyCode companyCode, ItemCode itemCode, ItemName itemName, ItemName itemAbName,
			...
			String uniteCode, DisplayAtr zeroDisplaySet, ItemDisplayAtr itemDisplayAtr) {
		super();
	...
	public static ItemMaster createFromJavaType(String companyCode, String itemCode, String itemName, String itemAbName,
			String itemAbNameE, String itemAbNameO, int categoryAtr, int fixAtr, int displaySet,
			String uniteCode, int zeroDisplaySet, int itemDisplayAtr) {
		return new ItemMaster(
				new CompanyCode(companyCode), 
				new ItemCode(itemCode), 
				new ItemName(itemName), 
				new ItemName(itemAbName), 
				new ItemName(itemAbNameE), 
				new ItemName(itemAbNameO),
				EnumAdaptor.valueOf(categoryAtr, CategoryAtr.class), 
				fixAtr, 
				EnumAdaptor.valueOf(displaySet, DisplayAtr.class), 
				uniteCode, 
