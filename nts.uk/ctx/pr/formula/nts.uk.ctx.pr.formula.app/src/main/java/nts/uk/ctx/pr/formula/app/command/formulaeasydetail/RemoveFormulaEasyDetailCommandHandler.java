...
@Stateless
public class RemoveFormulaEasyDetailCommandHandler extends CommandHandler<RemoveFormulaEasyDetailCommand>{
	
	@Inject
	private FormulaEasyDetailRepository repository;

	@Override
	protected void handle(CommandHandlerContext<RemoveFormulaEasyDetailCommand> context) {
		
		RemoveFormulaEasyDetailCommand command = context.getCommand();
