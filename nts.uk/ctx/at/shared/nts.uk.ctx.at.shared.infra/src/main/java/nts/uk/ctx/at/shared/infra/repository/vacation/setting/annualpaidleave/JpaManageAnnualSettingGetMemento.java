...
public class JpaManageAnnualSettingGetMemento implements ManageAnnualSettingGetMemento {
	...
	public String getCompanyId() {
		return this.manageAnnual.getKmfmtMngAnnualSetPK().getCid();
	}
	...
	public RemainingNumberSetting getRemainingNumberSetting() {
		...
		HalfDayManage halfDayManage = HalfDayManage.builder()
				...
				.maxNumberUniformCompany(
						new AnnualNumberDay(this.manageAnnual.getCUniformMaxNumber()))
				.build();
	...
	public AcquisitionVacationSetting getAcquisitionSetting() {
		return AcquisitionVacationSetting.builder()
				.yearVacationPriority(
						ApplyPermission.valueOf(this.manageAnnual.getYearVacaPriority()))
	...
	public DisplaySetting getDisplaySetting() {
		return DisplaySetting.builder()
				.remainingNumberDisplay(
						DisplayDivision.valueOf(this.manageAnnual.getRemainNumDisplay()))
				.nextGrantDayDisplay(
						DisplayDivision.valueOf(this.manageAnnual.getNextGrantDayDisplay()))
				.build();
	}
