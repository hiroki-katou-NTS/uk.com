module nts.custombinding {
    ...
    export class LayoutControl implements KnockoutBindingHandler {
        ...
        private services = {
            ...
            getItemByGroups: (gids: Array<any>) => ajax(`com`, `ctx/pereg/person/groupitem/findby/listgroupId`, gids),
            getItemsById: (id: string) => ajax(`com`, `ctx/pereg/person/info/ctgItem/layout/findby/itemId/${id}`),
            getItemsByIds: (ids: Array<any>) => ajax(`com`, `ctx/pereg/person/info/ctgItem/layout/findby/listItemIdv2`, ids)
        };
