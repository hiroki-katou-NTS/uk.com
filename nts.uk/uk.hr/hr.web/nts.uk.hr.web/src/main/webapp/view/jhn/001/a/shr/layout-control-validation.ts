                    ...
                    if (button) {
                        $(button.id)
                            ...
                            .on('click', () => {
                                ...
                                modal('com', `/view/jhn/001/${btn.dialogId}/index.xhtml`).onClosed(() => {
                                    // load lai du lieu
        ...
        dateTime = () => {
            let self = this,
                ...
                initCDL008Data = (data: IItemData) => {
                    ...
                    } else if (location.href.indexOf('/view/jhn/001') > -1) {
                        if (!!CS00017_IS00082) {
            ...
            let getComboData = () => {
                ...
                let startDate = CS00020_IS00119 ? CS00020_IS00119.data.value() : undefined,
                    ...
                    if (location.href.indexOf('/view/jhn/001') > -1 && __viewContext.viewModel.layout.mode() == 'layout') {
