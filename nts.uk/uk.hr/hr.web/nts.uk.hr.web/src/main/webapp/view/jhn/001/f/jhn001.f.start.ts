            ...
            ko.computed(() => {
                ...
                $grid.ntsGrid({
                    ...
                    columns: [
                        ...
                        { headerText: nts.uk.resource.getText('JHN001_F2_3_2'), key: 'fileName', dataType: 'string', width: '330px', template: '<a href="${urlFile}" target="_blank" data-download="true" data-id="${id}">${fileName}</a>'},
                        { headerText: nts.uk.resource.getText('JHN001_F2_3_3'), key: 'urlFile', dataType: 'string', width: '100px', template: '<div data-upload="true" data-id="${id}" ></div>' },
