/*!@license
 * Infragistics.Web.ClientUI Tile Manager 16.1.20161.2145
 *
...
(function ($) {
	...
	*/
    $.widget("ui.igTileManager", {
        ...
        _setRightPanelSize: function () {
            var self = this,
                ...
                splitterWidth =
                    this.element.children(this._selectors.splitbarSelector).outerWidth(true),
            ...
            maxCols =
                Math.max(Math.floor((this.element.width() - minMaximizedTileWidth - splitterWidth -
            ...
            leftPanelWidth =
                this.element.width() - rightPanelWidth - 2 * gl.marginLeft - splitterWidth;
    ...
    $.extend($.ui.igTileManager, { version: "16.1.20161.2145" });
}(jQuery));
