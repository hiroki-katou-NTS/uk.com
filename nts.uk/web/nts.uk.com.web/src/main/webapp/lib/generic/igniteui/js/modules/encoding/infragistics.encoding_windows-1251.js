/*!@license
* Infragistics.Web.ClientUI infragistics.encoding_windows-1251.js 16.1.20161.2145
*
...
$.ig.util.defType('Windows1251Encoding', 'SingleByteEncoding', {
	...
	init: function () {
		...
		$.ig.SingleByteEncoding.prototype.init1.call(this, 1, 1251, "windows-1251");
	},
	$type: new $.ig.Type('Windows1251Encoding', $.ig.SingleByteEncoding.prototype.$type)
}, true);
