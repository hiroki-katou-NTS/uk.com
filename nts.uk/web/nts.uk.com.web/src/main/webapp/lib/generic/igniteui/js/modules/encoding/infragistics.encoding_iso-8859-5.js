/*!@license
* Infragistics.Web.ClientUI infragistics.encoding_iso-8859-5.js 16.1.20161.2145
*
...
$.ig.util.defType('Iso8859Dash5', 'SingleByteEncoding', {
	...
	init: function () {
		...
		$.ig.SingleByteEncoding.prototype.init1.call(this, 1, 28595, "iso-8859-5");
	},
	$type: new $.ig.Type('Iso8859Dash5', $.ig.SingleByteEncoding.prototype.$type)
}, true);
