        ...
        (function (service) {
            ...
            (function (model) {
                var CompanyDto = (function () {
                    function CompanyDto(companyCode, companyName, address1, address2, addressKana1, addressKana2, companyNameAbb, companyNameKana, corporateMyNumber, depWorkPlaceSet, displayAttribute, faxNo, postal, presidentName, presidentJobTitle, telephoneNo, termBeginMon, useGrSet, useKtSet, useQySet, useJjSet) {
                        this.termBeginMon = 0;
                        this.use_Gr_Set = 0;
                        this.use_Kt_Set = 0;
                        this.use_Qy_Set = 0;
