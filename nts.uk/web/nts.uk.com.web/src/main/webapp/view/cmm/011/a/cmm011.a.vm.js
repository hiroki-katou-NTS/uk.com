    ...
    (function (a) {
        ...
        (function (viewmodel) {
            ...
            (function (model) {
                ...
                //    Department     
                class DtoWKP {
                    constructor(companyCode, departmentCode, historyId, endDate, externalCode, fullName, hierarchyCode, name, parentChildAttribute1, parentChildAttribute2, parentWorkCode1, parentWorkCode2, shortName, startDate, children) {
                        var self = this;
                ...
                class AddWorkplaceDto {
                    constructor(workPlaceCode, historyId, endDate, externalCode, fullName, hierarchyCode, name, startDate, memo, shortName, parentChildAttribute1, parentChildAttribute2, parentWorkCode1, parentWorkCode2, children) {
                        var self = this;
                        self.memo = memo;
