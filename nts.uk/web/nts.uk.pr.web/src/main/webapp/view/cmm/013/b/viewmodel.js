            ...
            var ScreenModel = (function () {
                ...
                function ScreenModel() {
                    ...
                    self.itemsRadio = ko.observableArray([
                        { value: 1, text: ko.observable('譛譁ｰ縺ｮ螻･豁ｴ・・+self.selectStartYm()+', 峨, 繧牙ｼ輔, 邯吶, ')},, { value: 2, text: ko.observable('蛻昴ａ縺九ｉ菴懈・縺吶ｋ') }) }
                    ]);
                ...
                ScreenModel.prototype.buildItemList = function () {
                    ...
                    self.itemList.push(new ItemModel('0', '繝ｬ繝ｼ繧ｶ繝ｼ繝励Μ繝ｳ繧ｿ', '・｡・・, ', 邵ｦ蜷代, ',', 1, 莠ｺ, ',', 譛, 螟ｧ縲, 30, 陦鯉ｽ, 蛻, 縺ｾ縺ｧ險ｭ螳壼庄閭ｽ, ',', '));, self.itemList.push(new ItemModel('1', '繝ｬ繝ｼ繧ｶ繝ｼ繝励Μ繝ｳ繧ｿ', '・｡・・, ', 邵ｦ蜷代, ',', 譛, 螟ｧ2莠ｺ, ',', 譛, 螟ｧ縲, 17, 陦鯉ｽ, 蛻, 縺ｾ縺ｧ險ｭ螳壼庄閭ｽ, ',', '));, self.itemList.push(new ItemModel('2', '繝ｬ繝ｼ繧ｶ繝ｼ繝励Μ繝ｳ繧ｿ', '・｡・・, ', 邵ｦ蜷代, ',', 譛, 螟ｧ3莠ｺ, ',', 譛, 螟ｧ縲, 10, 陦鯉ｽ, 蛻, 縺ｾ縺ｧ險ｭ螳壼庄閭ｽ, ',', '));, self.itemList.push(new ItemModel('3', '繝ｬ繝ｼ繧ｶ繝ｼ繝励Μ繝ｳ繧ｿ', '・｡・・, ', 讓ｪ蜷代, ',', 譛, 螟ｧ2莠ｺ, ',', 譛, 螟ｧ縲, 10, 陦鯉ｽ, 蛻, 縺ｾ縺ｧ險ｭ螳壼庄閭ｽ, ',', '));, self.itemList.push(new ItemModel('4', '繝ｬ繝ｼ繧ｶ繝ｼ・亥悸逹蠑擾ｼ・, ', , '邵ｦ蜷代″', '1莠ｺ', '譛螟ｧ縲17陦鯉ｽ・蛻･縺ｾ縺ｧ險ｭ螳壼庄閭ｽ', '蝨ｧ逹蠑擾ｼ壹・ｺ謚倥ｊ'))))))))));
