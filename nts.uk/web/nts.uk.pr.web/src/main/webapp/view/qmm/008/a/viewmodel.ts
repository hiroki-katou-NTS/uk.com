module nts.uk.pr.view.qmm008.a {
    export module viewmodel {
        ...
        export class ScreenModel {
            ...
            pension_inp_002: any;
            //health inputs
            health_inp_003: any;health_inp_004: any;health_inp_005: any;health_inp_006: any;
            health_inp_007: any;health_inp_008: any;health_inp_009: any;health_inp_010: any;
            health_inp_011: any;health_inp_012: any;health_inp_013: any;health_inp_014: any;
            health_inp_015: any;health_inp_016: any;health_inp_017: any;health_inp_018: any;
            //pension inputs
            pension_inp_003: any;
            pension_inp_004: any;
            pension_inp_005: any;
            ...
            OpenModalSubWindow() {
                ...
                nts.uk.ui.windows.sub.modal("/view/qmm/008/b/index.xhtml").onClosed(() => {
                    // Get child value
            ...
            OpenModalOfficeRegister() {
                ...
                nts.uk.ui.windows.setShared("isTransistReturnData", this.isTransistReturnData());
                nts.uk.ui.windows.sub.modal("/view/qmm/008/c/index.xhtml").onClosed(() => {
                    // Get child value
            ...
            OpenModalStandardMonthlyPriceHealth() {
                ...
                nts.uk.ui.windows.setShared("isTransistReturnData", this.isTransistReturnData());
                nts.uk.ui.windows.sub.modal("/view/qmm/008/d/index.xhtml").onClosed(() => {
                    // Get child value
                    var returnValue = nts.uk.ui.windows.getShared("listOfficeOfChildValue");
                });
            }
            OpenModalStandardMonthlyPricePension() {
                ...
                nts.uk.ui.windows.setShared("dataParentValue", this.value());
                nts.uk.ui.windows.setShared("isTransistReturnData", this.isTransistReturnData());
                nts.uk.ui.windows.sub.modal("/view/qmm/008/e/index.xhtml").onClosed(() => {
                    // Get child value
                    var returnValue = nts.uk.ui.windows.getShared("listOfficeOfChildValue");
                });
            }
            OpenModalConfigHistory() {
                ...
                nts.uk.ui.windows.setShared("addHistoryParentValue", this.value());
                nts.uk.ui.windows.setShared("isTransistReturnData", this.isTransistReturnData());
                nts.uk.ui.windows.sub.modal("/view/qmm/008/f/index.xhtml").onClosed(() => {
                    // Get child value
                    var returnValue = nts.uk.ui.windows.getShared("addHistoryChildValue");
                });
            }
