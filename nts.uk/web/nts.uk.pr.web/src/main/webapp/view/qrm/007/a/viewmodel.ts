module qrm007.a.viewmodel {
        ...
        updateRetirementPayItemList(){
            ...
            */
            qrm007.a.service.updateRetirementPayItem(command).done(function(data) {
                let currentCode = command.itemCode;
    ...
    class RetirementPayItemModel {
        ...
        constructor(code: string, name: string, printName: string, memo: string, companyCode: string, category: number, englishName: string, fullName: string) {
            this.itemCode = code;
            this.itemName = name;
