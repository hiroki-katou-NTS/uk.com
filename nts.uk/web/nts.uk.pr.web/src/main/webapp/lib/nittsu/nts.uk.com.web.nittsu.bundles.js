...
(function (nts) {
    ...
    (function (uk) {
        ...
        (function (ui_7) {
            ...
            })(windows = ui_7.windows || (ui_7.windows = {}));
            function localize(textId) {
                return textId;
            }
            ui_7.localize = localize;
            var dialog;
            (function (dialog) {
                ...
                ;
            })(dialog = ui_7.dialog || (ui_7.dialog = {}));
            var contextmenu;
            ...
            })(contextmenu = ui_7.contextmenu || (ui_7.contextmenu = {}));
            ui_7.confirmSave = function (dirtyChecker) {
            ...
            ui_7.confirmSaveEnableDialog = confirmSaveEnableDialog;
            ;
            function confirmSaveDisableDialog(dialog) {
                dialog.on("dialogbeforeclose", function () { });
            }
            ui_7.confirmSaveDisableDialog = confirmSaveDisableDialog;
            ;
            function confirmSaveEnable(beforeunloadHandler) {
                $(window).bind('beforeunload', beforeunloadHandler);
            }
            ui_7.confirmSaveEnable = confirmSaveEnable;
            ;
            function confirmSaveDisable() {
                $(window).unbind('beforeunload');
            }
            ui_7.confirmSaveDisable = confirmSaveDisable;
            ;
            ...
            ui_7.DirtyChecker = DirtyChecker;
            /**
