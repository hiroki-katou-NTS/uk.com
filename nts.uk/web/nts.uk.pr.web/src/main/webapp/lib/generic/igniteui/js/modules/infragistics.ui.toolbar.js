...
/*!@license
 * Infragistics.Web.ClientUI Toolbar 16.1.20161.2145
 *
 * Copyright (c) 2011-2016 Infragistics Inc.
 * <Licensing info>
 *
	...
	*/
    $.widget("ui.igToolbar", {
        ...
        _init: function () {
            ...
            if (!this.options.isExpanded) {
                ...
                this.collapseBtn
                    ...
                    .children(":first")
                        .switchClass(
                            this.options.collapseButtonIcon, this.options.expandButtonIcon);
            }
        ...
        _render: function () {
            ...
            this.collapseBtn =
                $('<div tabIndex="0" id="' + this._id("_collapseButton") + '"></div>')
            ...
            this.buttonsList =
                $('<div id="' + this._id("_toolbar_buttons") + '" class="' +
                this.css.igToolbarButtonsHolder + '"></div>')
                    .appendTo(this.element);
        },
                ...
                if (noCancel) {
                    ...
                    this.collapseBtn
                        .attr("title", $.ig.Toolbar.locale.collapseButtonTitle + " " +
                            ...
                            .children(":first")
                                .switchClass(
                                    this.options.expandButtonIcon, this.options.collapseButtonIcon);
                }
            }
        ...
        */
            ...
            if (self.options.isExpanded) {
                ...
                self.collapseBtn
                    .attr("title", $.ig.Toolbar.locale.collapseButtonTitle + " " +
                        ...
                        .children(":first")
                            .switchClass(
                                self.options.expandButtonIcon, self.options.collapseButtonIcon);
                ...
                self.collapseBtn
                    .attr("title", $.ig.Toolbar.locale.expandButtonTitle + " " +
                        ...
                        .children(":first")
                            .switchClass(
                                self.options.collapseButtonIcon, self.options.expandButtonIcon);
            }
        ...
        _attachEvents: function () {
            ...
            this.element
                .delegate(
                    ":ui-igCombo", "igcomboselectionchanged",
                    $.proxy(this._onComboListItemClick, this))
                .delegate(
                    ":ui-igCombo", "igcombodropdownclosed",
    ...
    $.extend($.ui.igToolbar, { version: "16.1.20161.2145" });
}(jQuery));
