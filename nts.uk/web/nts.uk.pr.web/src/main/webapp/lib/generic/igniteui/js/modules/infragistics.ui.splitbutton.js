/*!@license
 * Infragistics.Web.ClientUI SplitButton 16.1.20161.2145
 *
	...
	*/
    $.widget("ui.igSplitButton", {
        ...
        _renderDefaultBtn: function () {
            ...
            this._options.defaultButton = $('<div id="' +
                this._id("_" + options.defaultItemName) + '"></div>')
        ...
        _renderExpandBtn: function () {
            this._options.expandButton = $("<div id='" +
                this._id("_arrow") + "' class='" + this.css.arrow + "'></div>")
                .igToolbarButton({
                    onlyIcons: true,
                    labelText: "&nbsp;",
                    icons: {
        ...
        _createItemsList: function () {
            var list = $("<ul class='ui-splitbutton-list ui-menu " +
                "ui-widget ui-widget-content ui-corner-all'></ul>"),
    ...
    $.extend($.ui.igSplitButton, { version: "16.1.20161.2145" });
}(jQuery));
