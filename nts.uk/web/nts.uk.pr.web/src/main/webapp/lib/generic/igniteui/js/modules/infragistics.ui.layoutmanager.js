/*!@license
* Infragistics.Web.ClientUI Layout Manager 16.1.20161.2145
*
...
(function ($) {
	...
	*/
        ...
        reflow: function (forceReflow, animationDuration, event) {
			...
			*/
            ...
            if (this.options.layoutMode === "grid") {
                ...
                animationDuration = parsedDur >= 0 ? parsedDur :
    ...
    $.extend($.ui.igLayoutManager, { version: "16.1.20161.2145" });
}(jQuery));
