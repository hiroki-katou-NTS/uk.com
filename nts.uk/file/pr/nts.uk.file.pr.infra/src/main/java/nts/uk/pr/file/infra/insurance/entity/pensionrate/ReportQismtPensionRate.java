 ...
 * All right reserved.                                            *
 *****************************************************************/
package nts.uk.pr.file.infra.insurance.entity.pensionrate;
...
import nts.uk.pr.file.infra.insurance.entity.pensionavgearn.ReportQismtPensionAvgearn;
...
public class ReportQismtPensionRate extends UkJpaEntity implements Serializable {
	...
	@EmbeddedId
	protected ReportQismtPensionRatePK qismtPensionRatePK;
	...
	private List<ReportQismtPensionAvgearn> qismtPensionAvgearnList;
	 ...
	 *            the qismt pension rate PK
	 */
	public ReportQismtPensionRate(ReportQismtPensionRatePK qismtPensionRatePK) {
	 ...
	 *            the hist id
	 */
	public ReportQismtPensionRate(String ccd, String siOfficeCd, String histId) {
		this.qismtPensionRatePK = new ReportQismtPensionRatePK(ccd, siOfficeCd, histId);
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof ReportQismtPensionRate)) {
			return false;
		}
		ReportQismtPensionRate other = (ReportQismtPensionRate) object;
