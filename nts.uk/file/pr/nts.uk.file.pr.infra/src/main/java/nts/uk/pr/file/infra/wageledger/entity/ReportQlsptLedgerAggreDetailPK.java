...
@Setter
@Embeddable
public class ReportQlsptLedgerAggreDetailPK implements Serializable {
	 ...
	 */
	public ReportQlsptLedgerAggreDetailPK() {
	}
	 ...
	 *            the item cd
	 */
	public ReportQlsptLedgerAggreDetailPK(String ccd, int payBonusAtr, String aggregateCd, int ctgAtr, String itemCd) {
		this.ccd = ccd;
	...
	public boolean equals(Object object) {
		if (!(object instanceof ReportQlsptLedgerAggreDetailPK)) {
			return false;
		}
		ReportQlsptLedgerAggreDetailPK other = (ReportQlsptLedgerAggreDetailPK) object;
