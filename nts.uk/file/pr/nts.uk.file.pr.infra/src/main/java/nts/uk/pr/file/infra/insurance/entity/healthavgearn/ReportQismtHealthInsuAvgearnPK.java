...
@Data
@Embeddable
public class ReportQismtHealthInsuAvgearnPK implements Serializable {
	 ...
	 */
	public ReportQismtHealthInsuAvgearnPK() {
		super();
	}
	 ...
	 *            the health insu grade
	 */
	public ReportQismtHealthInsuAvgearnPK(String ccd, String siOfficeCd, String histId, BigDecimal healthInsuGrade) {
		this.ccd = ccd;
	...
	public boolean equals(Object object) {
		if (!(object instanceof ReportQismtHealthInsuAvgearnPK)) {
			return false;
		}
		ReportQismtHealthInsuAvgearnPK other = (ReportQismtHealthInsuAvgearnPK) object;
