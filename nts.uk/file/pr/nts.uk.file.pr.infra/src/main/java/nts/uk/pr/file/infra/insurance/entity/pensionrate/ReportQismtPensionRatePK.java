...
@Data
@Embeddable
public class ReportQismtPensionRatePK implements Serializable {
	 ...
	 */
	public ReportQismtPensionRatePK() {
		super();
	}
	 ...
	 *            the hist id
	 */
	public ReportQismtPensionRatePK(String ccd, String siOfficeCd, String histId) {
		this.ccd = ccd;
	...
	public boolean equals(Object object) {
		if (!(object instanceof ReportQismtPensionRatePK)) {
			return false;
		}
		ReportQismtPensionRatePK other = (ReportQismtPensionRatePK) object;
