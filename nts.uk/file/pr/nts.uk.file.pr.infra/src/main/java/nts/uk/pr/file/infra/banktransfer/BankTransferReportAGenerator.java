...
import nts.uk.file.pr.app.export.banktransfer.BankTransferReportGenerator;
...
@Stateless
public class BankTransferReportAGenerator extends AsposeCellsReportGenerator implements BankTransferReportGenerator {
