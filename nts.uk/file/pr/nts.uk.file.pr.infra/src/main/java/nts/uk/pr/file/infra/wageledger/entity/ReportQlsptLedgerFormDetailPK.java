...
@Setter
@Embeddable
public class ReportQlsptLedgerFormDetailPK implements Serializable {
	 ...
	 */
	public ReportQlsptLedgerFormDetailPK() {
	}
	 ...
	 *            the item agre cd
	 */
	public ReportQlsptLedgerFormDetailPK(String ccd, String formCd, int payBonusAtr, int ctgAtr, int aggregateAtr,
			String itemAgreCd) {
		this.ccd = ccd;
		this.formCd = formCd;
	...
	public boolean equals(Object object) {
		if (!(object instanceof ReportQlsptLedgerFormDetailPK)) {
			return false;
		}
		ReportQlsptLedgerFormDetailPK other = (ReportQlsptLedgerFormDetailPK) object;
