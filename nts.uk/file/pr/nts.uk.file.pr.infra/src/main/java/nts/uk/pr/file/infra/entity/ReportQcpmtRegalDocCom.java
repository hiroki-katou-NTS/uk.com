...
public class ReportQcpmtRegalDocCom extends TableEntity implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    public ReportQcpmtRegalDocComPK qcpmtRegalDocComPK;
    ...
    public ReportQcpmtRegalDocCom() {
    }

    public ReportQcpmtRegalDocCom(ReportQcpmtRegalDocComPK qcpmtRegalDocComPK) {
        this.qcpmtRegalDocComPK = qcpmtRegalDocComPK;
    }

    public ReportQcpmtRegalDocCom(ReportQcpmtRegalDocComPK qcpmtRegalDocComPK, String regalDocCname, String linkDepcd, String payerAddress1) {
        this.qcpmtRegalDocComPK = qcpmtRegalDocComPK;
    ...
    public ReportQcpmtRegalDocCom(String ccd, String regalDocCcd) {
        this.qcpmtRegalDocComPK = new ReportQcpmtRegalDocComPK(ccd, regalDocCcd);
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReportQcpmtRegalDocCom)) {
            return false;
        }
        ReportQcpmtRegalDocCom other = (ReportQcpmtRegalDocCom) object;
