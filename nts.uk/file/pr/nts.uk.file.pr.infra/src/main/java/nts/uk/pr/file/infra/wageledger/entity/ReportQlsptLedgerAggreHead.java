...
public class ReportQlsptLedgerAggreHead implements Serializable {
	...
	@EmbeddedId
	protected ReportQlsptLedgerAggreHeadPK qlsptLedgerAggreHeadPK;
	...
	private List<ReportQlsptLedgerAggreDetail> qlsptLedgerAggreDetailList;

	/**
	 * Instantiates a new qlspt ledger aggre head.
	 */
	public ReportQlsptLedgerAggreHead() {
	}
	 ...
	 *            the qlspt ledger aggre head PK
	 */
	public ReportQlsptLedgerAggreHead(ReportQlsptLedgerAggreHeadPK qlsptLedgerAggreHeadPK) {
	 ...
	 *            the disp zero atr
	 */
	public ReportQlsptLedgerAggreHead(ReportQlsptLedgerAggreHeadPK qlsptLedgerAggreHeadPK, int exclusVer, int dispNameZeroAtr,
			int dispZeroAtr) {
		this.qlsptLedgerAggreHeadPK = qlsptLedgerAggreHeadPK;
	 ...
	 *            the ctg atr
	 */
	public ReportQlsptLedgerAggreHead(String ccd, int payBonusAtr, String aggregateCd, int ctgAtr) {
		this.qlsptLedgerAggreHeadPK = new ReportQlsptLedgerAggreHeadPK(ccd, payBonusAtr, aggregateCd, ctgAtr);
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof ReportQlsptLedgerAggreHead)) {
			return false;
		}
		ReportQlsptLedgerAggreHead other = (ReportQlsptLedgerAggreHead) object;
