package nts.uk.ctx.cloud.operate.infra.web.component.filetag;
...
@FacesComponent(tagName = "scriptfile_cloud", createTag = true)
public class ScriptFile extends UIComponentBase {
    ...
    public static Set<String> FILES_BASIC = new LinkedHashSet<String>(Arrays.asList(new String[] {
            ...
            "/lib/nittsu/iefix.js",
            "/nts.uk.cloud.web/lib/nittsu/nts.uk.com.web.nittsu.bundles.js"
    }));
