/*!@license
* Infragistics.Web.ClientUI infragistics.encoding_iso646-us.js 16.1.20161.2145
*
...
$.ig.util.defType('UsAsciiEncoding', 'SingleByteEncoding', {
	...
	init: function () {
		...
		$.ig.SingleByteEncoding.prototype.init1.call(this, 1, 20127, "ISO646-US");
	},
	$type: new $.ig.Type('UsAsciiEncoding', $.ig.SingleByteEncoding.prototype.$type)
}, true);
