    ...
    (function (a) {
        var ScreenModel = (function () {
            ...
            ScreenModel.prototype.openADialog = function () {
                ...
                nts.uk.ui.windows.sub.modal('/view/qmm/019/d/index.xhtml', { title: '明細レイアウトの作成＞履歴追加', width: 960, height: 660 }).onClosed(function () {
            ...
            ScreenModel.prototype.openEDialog = function () {
                ...
                nts.uk.ui.windows.sub.modal('/view/qmm/019/e/index.xhtml', { title: '明細レイアウトの作成＞履歴の編集', width: 570, height: 400 }).onClosed(function () {
                    self.start(self.singleSelectedCode());
                });
            };
            ScreenModel.prototype.openGDialog = function () {
                var self = this;
                nts.uk.ui.windows.sub.modal('/view/qmm/019/g/index.xhtml', { title: '明細レイアウトの作成＞新規登録', width: 960, height: 710 }).onClosed(function () {
