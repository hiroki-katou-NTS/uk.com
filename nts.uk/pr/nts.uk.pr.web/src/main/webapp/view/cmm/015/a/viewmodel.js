            ...
            var ListBox = (function () {
                function ListBox(listItemDto, currentItemCode, isUpdate, stmtCode, startYm, categoryAtr) {
                    ...
                    if (isUpdate == false) {
                        ...
                        a.service.getLayoutMasterDetail(stmtCode, startYm, categoryAtr, currentItemCode).done(function (data) {
                            var item;
                            if (data != null) {
                                item = {
                    ...
                    $.when(qmm019.f.service.getItemsByCategory(self.paramCategoryAtr())).done(function (data) {
                        if (data !== null) {
                            ...
                            if (self.paramIsUpdate == false) {
                                ...
                                a.service.getLayoutMasterDetail(self.paramStmtCode, self.paramStartYm, self.paramCategoryAtr(), self.paramItemCode).done(function (data) {
                                    if (data != null) {
                                        item = {
                                            companyCode: ko.observable(null),
                                            itemCode: ko.observable(data.itemCode),
