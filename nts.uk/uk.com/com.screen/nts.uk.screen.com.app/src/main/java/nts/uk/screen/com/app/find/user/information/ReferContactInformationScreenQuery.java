...
public class ReferContactInformationScreenQuery {
	...
	public ReferContactInformationDto getContactInfomation(String employeeId, StartMode startMode) {
		...
		// step 2 : [起動モード＝0]:get(会社ID): Optional<ユーザー情報の使用方法>
		...
		// step 5 : <call> 社員ID（List）と期間から個人情報を取得する
		...
		// step 6 : get*(ログイン会社ID、雇用コード) - get domain 雇用
		...
		// step 7 : get*(ログイン会社ID、分類コード) - get domain 分類
		...
		// step 8 : get*(ログイン会社ID、職位ID) - get domain 職位情報
		...
		// step 9 : get*(ログイン会社ID、職場ID) - get domain 職場情報
