...
public enum PublicHolidayCarryOverDeadline {
	...
	/** The  2 month. */
	//2ヶ月
	_2_MONTH(1, "Enum_2Month"),
	
	/** The  3 month. */
	//3ヶ月
	_3_MONTH(2, "Enum_3Month"),
	
	/** The  4 month. */
	//4ヶ月
	_4_MONTH(3, "Enum_4Month"),
	
	/** The  5 month. */
	//5ヶ月
	_5_MONTH(4, "Enum_5Month"),
	
	/** The  6 month. */
	//6ヶ月
	_6_MONTH(5, "Enum_6Month"),
	
	/** The  7 month. */
	//7ヶ月
	_7_MONTH(6, "Enum_7Month"),
	
	/** The  8 month. */
	//8ヶ月
	_8_MONTH(7, "Enum_8Month"),
	
	/** The  9 month. */
	//9ヶ月
	_9_MONTH(8, "Enum_9Month"),
	
	/** The  10 month. */
	//10ヶ月
	_10_MONTH(9, "Enum_10Month"),
	
	/** The  11 month. */
	//11ヶ月
	_11_MONTH(10, "Enum_11Month"),
	
	/** The  12 month. */
	//12ヶ月
	_12_MONTH(11, "Enum_12Month"),
	
	/** The year end. */
	// 年度末
	YEAR_END(12, "Enum_YearEnd"),
	
	/** The indefinite. */
	// 無期限
	INDEFINITE(13, "Enum_Indefinite"),
	
	/** The current month. */
	// 当月
	CURRENT_MONTH(14, "Enum_CurrentMonth");
