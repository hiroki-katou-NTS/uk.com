...
public class BsymtWkpInfor extends ContractUkJpaEntity {

	@EmbeddedId
	public BsymtWkpInforPk pk;
	...
	public static BsymtWkpInfor fromDomain(WorkplaceInformation domain) {
		return new BsymtWkpInfor(
				new BsymtWkpInforPk(domain.getCompanyId(), domain.getWorkplaceHistoryId(),
