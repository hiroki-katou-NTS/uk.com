...
/**
 * The Class KshmtEmpMonthDaySetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtEmpMonthDaySetPK implements Serializable {
     ...
     */
    public KshmtEmpMonthDaySetPK(String cid, String empCd, int manageYear, int month) {
        this.cid = cid;
        this.empCd = empCd;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof KshmtEmpMonthDaySetPK)) {
            return false;
        }
        KshmtEmpMonthDaySetPK other = (KshmtEmpMonthDaySetPK) object;
