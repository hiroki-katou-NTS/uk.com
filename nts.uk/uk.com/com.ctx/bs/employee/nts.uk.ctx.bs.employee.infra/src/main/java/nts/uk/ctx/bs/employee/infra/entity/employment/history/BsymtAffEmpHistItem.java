...
/**
 * The Class BsymtAffEmpHistItem.
 */
@Entity
@Table(name = "BSYMT_AFF_EMP_HIST_ITEM")
public class BsymtAffEmpHistItem extends ContractUkJpaEntity implements Serializable {
	...
	public BsymtAffEmpHist bsymtAffEmpHist;
	 ...
	 */
	public BsymtAffEmpHistItem(String hisId, String sid, String empCode, Integer salarySegment) {
		super();
		this.hisId = hisId;
		this.sid = sid;
