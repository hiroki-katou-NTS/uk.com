...
public class ItemDefinitionFactory {
	...
	public static void matchInformation(String categoryCode, LayoutPersonInfoClsDto authClassItem,
			TempLeaveAbsenceHistory leaveHoliday, ActionRole actionRole) {
	}
	...
	public static Map<String, List<LayoutPersonInfoValueDto>> matchTemporaryAbsence(
			LayoutPersonInfoClsDto personInfoClsDto, List<TempLeaveAbsenceHistory> temporaryAbsence) {
		return null;
	}

	public static Map<String, List<LayoutPersonInfoValueDto>> matchTemporaryAbsence(
			LayoutPersonInfoClsDto personInfoClsDto, ActionRole actionRole, List<TempLeaveAbsenceHistory> temporaryAbsence) {
		return null;
	}
