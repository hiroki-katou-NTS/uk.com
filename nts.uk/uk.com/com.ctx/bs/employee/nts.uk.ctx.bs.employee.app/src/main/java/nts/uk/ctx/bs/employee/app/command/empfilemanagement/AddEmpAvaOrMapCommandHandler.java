...
@Stateless
public class AddEmpAvaOrMapCommandHandler extends CommandHandler<AddEmpAvaOrMapCommand>{

	@Inject
	private EmpFileManagementRepository empFileManagementRepository;
	
	@Override
	protected void handle(CommandHandlerContext<AddEmpAvaOrMapCommand> context) {
		AddEmpAvaOrMapCommand command = context.getCommand();
