package nts.uk.ctx.bs.person.infra.repository.person.itemcls.definition;
...
import nts.uk.ctx.bs.person.infra.entity.layout.cls.definition.PpemtLayoutItemClsDfPk;
