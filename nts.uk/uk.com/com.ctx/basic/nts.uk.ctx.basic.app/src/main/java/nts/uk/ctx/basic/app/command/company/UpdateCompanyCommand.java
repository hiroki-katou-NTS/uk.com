...
public class UpdateCompanyCommand {
	...
	public Company toDomain() {
		return Company.createFromJavaType(companyCode, companyName, companyNameGlobal, companyNameAbb, companyNameKana,
				corporateMyNumber, faxNo, postal, presidentName, presidentJobTitle, telephoneNo, depWorkPlaceSet,
				displayAttribute, address1, address2, addressKana1, addressKana2, termBeginMon, use_Gr_Set, use_Kt_Set,
				use_Qy_Set, use_Jj_Set, use_Ac_Set, use_Gw_Set, use_Hc_Set, use_Lc_Set, use_Bi_Set, use_Rs01_Set,
				use_Rs02_Set, use_Rs03_Set, use_Rs04_Set, use_Rs05_Set, use_Rs06_Set, use_Rs07_Set, use_Rs08_Set,
				use_Rs09_Set, use_Rs10_Set);
	}
}
