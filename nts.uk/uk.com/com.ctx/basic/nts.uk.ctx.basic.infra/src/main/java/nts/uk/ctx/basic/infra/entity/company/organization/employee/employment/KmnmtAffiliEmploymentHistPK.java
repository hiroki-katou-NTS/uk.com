...
public class KmnmtAffiliEmploymentHistPK implements Serializable {
    ...
    public KmnmtAffiliEmploymentHistPK(String histId, String sid, String emptcd) {
        this.histId = histId;
        this.sid = sid;
        this.emptcd = emptcd;
    }
	...
	public boolean equals(Object object) {
		...
		// not set
		if (!(object instanceof KmnmtAffiliEmploymentHistPK)) {
			return false;
		}
		KmnmtAffiliEmploymentHistPK other = (KmnmtAffiliEmploymentHistPK) object;
