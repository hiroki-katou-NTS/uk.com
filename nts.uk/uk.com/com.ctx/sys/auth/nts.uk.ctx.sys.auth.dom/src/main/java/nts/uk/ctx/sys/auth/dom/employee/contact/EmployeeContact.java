...
public class EmployeeContact extends AggregateRoot {
    ...
    public void getMemento(MementoGetter memento) {
        ...
        this.seatDialIn = Optional.of(new SeatDialIn(memento.getSeatDialIn()));
        this.isSeatDialInDisplay = Optional.of(memento.getIsSeatDialInDisplay());
        this.seatExtensionNumber = Optional.of(new SeatExtensionNumber(memento.getSeatExtensionNumber()));
        this.isSeatExtensionNumberDisplay = Optional.of(memento.getIsSeatExtensionNumberDisplay());
        this.mobileMailAddress = Optional.of(new MailAddress(memento.getMobileMailAddress()));
        this.isMobileMailAddressDisplay = Optional.of(memento.getIsMobileMailAddressDisplay());
        this.cellPhoneNumber = Optional.of(new PhoneNumber(memento.getCellPhoneNumber()));
        this.isCellPhoneNumberDisplay = Optional.of(memento.getIsCellPhoneNumberDisplay());
    }
