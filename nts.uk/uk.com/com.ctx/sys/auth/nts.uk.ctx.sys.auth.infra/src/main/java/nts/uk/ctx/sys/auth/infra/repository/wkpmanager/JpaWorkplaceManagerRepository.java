...
public class JpaWorkplaceManagerRepository extends JpaRepository implements WorkplaceManagerRepository {
	...
	@Override
	public List<WorkPlaceSelectionExportData> findAllWorkPlaceSelection(String companyId, String workplaceId,
			String languageId) {
		return this.queryProxy().query(WORKPLACE_SELECT_ALL, Object[].class).setParameter("companyId", companyId)
				.setParameter("companyId", companyId).getList(x -> toReportData(x, languageId));
	}

	private WorkPlaceSelectionExportData toReportData(Object[] entity, String langId) {
		// TODO Auto-generated method stub
		return new WorkPlaceSelectionExportData(entity[0] == null ? null : entity[0].toString(),
				...
				// entity[6] == null ? null : (Integer)entity[6],
