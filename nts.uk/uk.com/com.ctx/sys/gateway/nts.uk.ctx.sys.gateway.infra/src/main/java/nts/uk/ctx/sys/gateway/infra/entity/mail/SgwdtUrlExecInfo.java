...
public class SgwdtUrlExecInfo extends UkJpaEntity implements Serializable
{
    ...
    */
    ...
    public static SgwdtUrlExecInfo toEntity(UrlExecInfo domain) {
        ...
        return new SgwdtUrlExecInfo(new SgwmtUrlExecInfoPk(domain.getEmbeddedId(), domain.getCid()), domain.getProgramId(), domain.getLoginId(), domain.getContractCd(), domain.getExpiredDate(), domain.getIssueDate(), domain.getScreenId(), domain.getSid(), domain.getScd(), domain.getTaskIncre().stream().map(x -> {
