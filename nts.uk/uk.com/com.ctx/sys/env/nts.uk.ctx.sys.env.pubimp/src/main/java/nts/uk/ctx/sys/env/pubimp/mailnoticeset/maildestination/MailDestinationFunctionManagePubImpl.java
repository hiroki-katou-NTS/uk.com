package nts.uk.ctx.sys.env.pubimp.mailnoticeset.maildestination;
...
import nts.uk.ctx.sys.env.pub.mailnoticeset.maildestination.SentMailListExport;

@Stateless
public class MailDestinationFunctionManagePubImpl implements MailDestinationFunctionManagePub {
