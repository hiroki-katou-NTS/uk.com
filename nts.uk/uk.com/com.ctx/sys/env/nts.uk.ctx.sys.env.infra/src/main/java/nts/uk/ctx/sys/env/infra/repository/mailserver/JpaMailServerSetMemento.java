...
public class JpaMailServerSetMemento implements MailServerSetMemento {
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setCompanyId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setUseAuthentication(nts.uk.ctx.sys.env.dom.mailserver.UseAuthentication)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setEncryptionMethod(nts.uk.ctx.sys.env.dom.mailserver.EncryptionMethod)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setAuthenticationMethod(nts.uk.ctx.sys.env.dom.mailserver.AuthenticationMethod)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setEmailAuthentication(nts.uk.ctx.sys.env.dom.mailserver.EmailAuthentication)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setPassword(nts.uk.ctx.sys.env.dom.mailserver.Password)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setSmtpInfo(nts.uk.ctx.sys.env.dom.mailserver.SmtpInfo)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setImapInfo(nts.uk.ctx.sys.env.dom.mailserver.ImapInfo)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.sys.env.dom.mailserver.MailServerSetMemento#setPopInfo(nts.uk.ctx.sys.env.dom.mailserver.PopInfo)
	 */
	@Override
