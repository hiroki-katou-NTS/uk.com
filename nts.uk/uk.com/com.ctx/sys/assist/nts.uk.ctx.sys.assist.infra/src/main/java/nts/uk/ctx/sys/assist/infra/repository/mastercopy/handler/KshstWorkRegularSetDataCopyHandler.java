...
public class KshstWorkRegularSetDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO KSHST_WORK_REGULAR_SET(CID, PRE_CALC_ACTUAL_OPERATION, PRE_EXEMPT_TAX_TIME, PRE_INC_CHILD_NURSE_CARE, PRE_ADDITION_TIME, "
	...
	private final String DELETE_BY_CID_QUERY = "DELETE FROM KSHST_WORK_REGULAR_SET WHERE CID = ?";

	/** The paramater quantity. */
	private final int PARAMATER_QUANTITY = 14;
