...
public class CcgmtMyPageSetDataCopyHandler extends DataCopyHandler {
	...
	private String SELECT_BY_CID_QUERY = "SELECT CID ,USE_MY_PAGE_ATR ,USE_STANDAR_WIDGET_ATR ,USE_OPTIONAL_WIDGET_ATR ,USE_DASH_BOARD_ATR,USE_FLOW_MENU_ATR,EXTERNAL_URL_PERMISSION_ATR FROM CCGMT_MY_PAGE_SET WHERE CID = ?";

	/** The delete by cid query. */
	private String DELETE_BY_CID_QUERY = "DELETE FROM CCGMT_MY_PAGE_SET WHERE CID = ?";
