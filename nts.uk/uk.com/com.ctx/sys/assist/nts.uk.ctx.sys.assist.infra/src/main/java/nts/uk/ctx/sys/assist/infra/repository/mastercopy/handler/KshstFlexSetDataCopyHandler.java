...
/**
 * The Class KshstFlexSetDataCopyHandler.
 */
@Getter
@Setter
...
@NoArgsConstructor
@AllArgsConstructor
public class KshstFlexSetDataCopyHandler implements DataCopyHandler {
	 ...
	 * The insert query.
	 */
	private String INSERT_QUERY = "INSERT INTO KSHST_FLEX_SET(CID ,MISS_CALC_HD,PREMIUM_CALC_HD,MISS_CALC_SUBHD,PREMIUM_CALC_SUBHD,FLEX_DEDUCT_CALC,FLEX_NONWKING_CALC) VALUES (?,?,?,?,?,?,?);";

	/**
	 * The select by cid query.
	 */
	private String SELECT_BY_CID_QUERY = "SELECT CID ,MISS_CALC_HD,PREMIUM_CALC_HD,MISS_CALC_SUBHD,PREMIUM_CALC_SUBHD,FLEX_DEDUCT_CALC,FLEX_NONWKING_CALC FROM KSHST_FLEX_SET WHERE CID = ?";

	/**
	 * The delete by cid query.
	 */
	private String DELETE_BY_CID_QUERY = "DELETE FROM KSHST_FLEX_SET WHERE CID = ?";
