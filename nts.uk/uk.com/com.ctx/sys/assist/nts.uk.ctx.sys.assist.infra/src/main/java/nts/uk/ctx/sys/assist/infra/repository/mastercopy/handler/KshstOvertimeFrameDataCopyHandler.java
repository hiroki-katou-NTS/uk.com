...
public class KshstOvertimeFrameDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private static final String INSERT_QUERY = "INSERT INTO KSHST_OVERTIME_FRAME(CID ,OT_FR_NO ,USE_ATR ,OT_FR_NAME ,TRANS_FR_NAME) VALUES (?, ?, ?, ?, ?);";
	
	/** The select by cid query. */
	private static final String SELECT_BY_CID_QUERY = "SELECT CID, OT_FR_NO, USE_ATR, OT_FR_NAME, TRANS_FR_NAME FROM KSHST_OVERTIME_FRAME WHERE CID = ?";
	
	/** The delete by cid query. */
	private static final String DELETE_BY_CID_QUERY = "DELETE FROM KSHST_OVERTIME_FRAME WHERE CID = ?";
