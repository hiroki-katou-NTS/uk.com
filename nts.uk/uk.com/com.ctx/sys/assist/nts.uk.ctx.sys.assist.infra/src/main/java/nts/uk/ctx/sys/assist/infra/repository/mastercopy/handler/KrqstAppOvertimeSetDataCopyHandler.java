...
public class KrqstAppOvertimeSetDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO KRQST_APP_OVERTIME_SET(CID, FLEX_EXCESS_USE_SET_ATR, PRE_TYPE_SIFT_REFLECT_FLG, PRE_OVERTIME_REFLECT_FLG, POST_TYPESIFT_REFLECT_FLG"
	...
	private final String SELECT_BY_CID_QUERY = "SELECT CID, FLEX_EXCESS_USE_SET_ATR, PRE_TYPE_SIFT_REFLECT_FLG, PRE_OVERTIME_REFLECT_FLG, POST_TYPESIFT_REFLECT_FLG"
			+ ", POST_BREAK_REFLECT_FLG, POST_WORKTIME_REFLECT_FLG, CALENDAR_DISP_ATR, EARLY_OVER_TIME_USE_ATR, "
	...
	private final String DELETE_BY_CID_QUERY = "DELETE FROM KRQST_APP_OVERTIME_SET WHERE CID = ?";
