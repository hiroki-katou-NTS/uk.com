...
public class SspmtCategoryForDelete extends ContractUkJpaEntity implements Serializable {
	...
	public static SspmtCategoryForDelete toEntity(CategoryForDelete domain) {
		return new SspmtCategoryForDelete(domain.getCategoryId().v(), domain.getSchelperSystem().value,
