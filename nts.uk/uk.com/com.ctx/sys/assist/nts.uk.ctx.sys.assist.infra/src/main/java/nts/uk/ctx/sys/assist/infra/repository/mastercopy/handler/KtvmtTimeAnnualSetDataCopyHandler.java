...
public class KtvmtTimeAnnualSetDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private static final String INSERT_QUERY = "INSERT INTO KTVMT_TIME_ANNUAL_SET(CID, TIME_MANAGE_ATR, TIME_UNIT, TIME_MAX_DAY_MANAGE_ATR, TIME_MAX_DAY_REFERENCE, TIME_MAX_DAY_UNIF_COMP, "
			+ "IS_ENOUGH_TIME_ONE_DAY, ROUND_PRO_CLA) VALUES (?,?,?,?,?,?,?,?)";

	/** The select by cid query. */
	private static final String SELECT_BY_CID_QUERY = "SELECT CID, TIME_MANAGE_ATR, TIME_UNIT, TIME_MAX_DAY_MANAGE_ATR, TIME_MAX_DAY_REFERENCE, TIME_MAX_DAY_UNIF_COMP, "
			+ "IS_ENOUGH_TIME_ONE_DAY, ROUND_PRO_CLA FROM KTVMT_TIME_ANNUAL_SET WHERE CID = ?";

	/** The delete by cid query. */
	private static final String DELETE_BY_CID_QUERY = "DELETE FROM KTVMT_TIME_ANNUAL_SET WHERE CID = ?";
