...
public class KshstWorkDepLaborSetDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private static final String INSERT_QUERY = "INSERT INTO KSHST_WORK_DEF_LABOR_SET(CID, PRE_CALC_ACTUAL_OPERATION, PRE_EXEMPT_TAX_TIME, PRE_INC_CHILD_NURSE_CARE, PRE_ADDITION_TIME, "
	...
	private static final String DELETE_BY_CID_QUERY = "DELETE FROM KSHST_WORK_DEF_LABOR_SET WHERE CID = ?";

	/** The paramater quantity. */
	private static final int PARAMATER_QUANTITY = 15;
