...
/**
 * The Class KscstWorkTypeDispSetDataCopyHandler.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class KscstWorkTypeDispSetDataCopyHandler implements DataCopyHandler {
	 ...
	 *            the company id
	 */
	public KscstWorkTypeDispSetDataCopyHandler(EntityManager entityManager, CopyMethod copyMethod, String companyId) {
