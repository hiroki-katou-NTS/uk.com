...
@NoArgsConstructor
@AllArgsConstructor
public class KclmtCompensLeaveComDataCopyHandler implements DataCopyHandler {
	 ...
	 *            the company cd
	 */
	public KclmtCompensLeaveComDataCopyHandler(EntityManager entityManager, CopyMethod copyMethod, String companyId) {
