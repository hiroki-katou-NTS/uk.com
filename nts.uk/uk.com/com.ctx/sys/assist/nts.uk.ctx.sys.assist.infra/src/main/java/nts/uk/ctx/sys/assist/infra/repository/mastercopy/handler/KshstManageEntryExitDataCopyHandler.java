...
public class KshstManageEntryExitDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO KSHST_MANAGE_ENTRY_EXIT(CID ,USE_CLS) VALUES (?, ?);";

	/** The select by cid query. */
	private final String SELECT_BY_CID_QUERY = "SELECT CID ,USE_CLS FROM KSHST_MANAGE_ENTRY_EXIT WHERE CID = ?";

	/** The delete by cid query. */
	private final String DELETE_BY_CID_QUERY = "DELETE FROM KSHST_MANAGE_ENTRY_EXIT WHERE CID = ?";
