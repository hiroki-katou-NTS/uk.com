...
public class SspmtCategoryFieldMtForDelete extends UkJpaEntity implements Serializable {
	...
	public CategoryFieldMtForDelete toDomain() {
		return new CategoryFieldMtForDelete(this.categoryFieldMtPk.categoryId, this.categoryFieldMtPk.tableNo,
	...
	public static SspmtCategoryFieldMtForDelete toEntity(CategoryFieldMt domain) {
		return new SspmtCategoryFieldMtForDelete(new SspmtCategoryFieldMtForDeletePk(domain.getCategoryId(), domain.getTableNo()),
