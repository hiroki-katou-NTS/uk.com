...
public class KshstTotalConditionDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO KSHST_TOTAL_CONDITION(CID ,TOTAL_TIMES_NO,UPPER_LIMIT_SET_ATR,LOWER_LIMIT_SET_ATR,THRESOLD_UPPER_LIMIT,THRESOLD_LOWER_LIMIT,ATD_ITEM_ID) VALUES (?, ?, ?, ?, ?,?,?);";

	/** The select by cid query. */
	private final String SELECT_BY_CID_QUERY = "SELECT CID ,TOTAL_TIMES_NO,UPPER_LIMIT_SET_ATR,LOWER_LIMIT_SET_ATR,THRESOLD_UPPER_LIMIT,THRESOLD_LOWER_LIMIT,ATD_ITEM_ID FROM KSHST_TOTAL_CONDITION WHERE CID = ?";

	/** The delete by cid query. */
	private final String DELETE_BY_CID_QUERY = "DELETE FROM KSHST_TOTAL_CONDITION WHERE CID = ?";
