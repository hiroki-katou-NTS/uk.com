...
/**
 * The Class KshstAddSetManWKHourDataCopyHandler.
 */
@Setter
@NoArgsConstructor
public class KshstAddSetManWKHourDataCopyHandler extends DataCopyHandler {
	 ...
	 *            the company id
	 */
	public KshstAddSetManWKHourDataCopyHandler(EntityManager entityManager, CopyMethod copyMethod, String companyId) {
