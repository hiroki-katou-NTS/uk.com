...
public class PpemtPerInfoCtgDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO PPEMT_PER_INFO_CTG(CID, PER_INFO_CTG_ID, CATEGORY_CD, CATEGORY_NAME, ABOLITION_ATR) VALUES (?, ?, ?, ?, ?);";

	/** The select by cid query. */
	private final String SELECT_BY_CID_QUERY = "SELECT CID, PER_INFO_CTG_ID, CATEGORY_CD, CATEGORY_NAME, ABOLITION_ATR FROM PPEMT_PER_INFO_CTG WHERE CID = ?";

	/** The delete by cid query. */
	private final String DELETE_BY_CID_QUERY = "DELETE FROM PPEMT_PER_INFO_CTG WHERE CID = ?";
