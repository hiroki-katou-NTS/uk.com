package nts.uk.ctx.sys.assist.infra.repository.status;
...
import nts.uk.ctx.sys.assist.dom.status.ActivityStatusRepository;
import nts.uk.ctx.sys.assist.infra.entity.status.ActivityStatusEntity;
