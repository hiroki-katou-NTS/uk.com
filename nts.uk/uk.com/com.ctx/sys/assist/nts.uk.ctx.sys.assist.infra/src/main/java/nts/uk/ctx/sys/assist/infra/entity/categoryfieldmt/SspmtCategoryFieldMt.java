...
public class SspmtCategoryFieldMt extends UkJpaEntity implements Serializable {
	...
	public CategoryFieldMt toDomain() {
		boolean hasParentTblFlg = this.hasParentTblFlg == 1;
		return new CategoryFieldMt(this.categoryFieldMtPk.categoryId, this.categoryFieldMtPk.tableNo,
				...
				EnumAdaptor.valueOf(this.historyCls, HistoryDiviSion.class), hasParentTblFlg, this.parentTblName,
				this.parentTblJapanName, this.fieldAcqDateTime, this.fieldAcqEndDate, this.fieldAcqEmployeeId,
				this.fieldAcqStartDate, this.fieldAcqCid, this.fieldParent1, this.fieldParent2, this.fieldParent3,
				...
				this.fieldChild9, this.fieldChild10);
	}

	public static SspmtCategoryFieldMt toEntity(CategoryFieldMt domain) {
		int hasParentTblFlg = domain.isHasParentTblFlg() == true ? 1 : 0;
		return new SspmtCategoryFieldMt(new SspmtCategoryFieldMtPk(domain.getCategoryId(), domain.getTableNo()),
				...
				domain.getHistoryCls().value, hasParentTblFlg, domain.getParentTblName(),
				domain.getParentTblJapanName(), domain.getFieldAcqDateTime(), domain.getFieldAcqEndDate(), domain.getFieldAcqEmployeeId(),
				domain.getFieldAcqStartDate(), domain.getFieldAcqCid(), domain.getFieldParent1(), domain.getFieldParent2(), domain.getFieldParent3(),
				domain.getFieldParent4(), domain.getFieldParent5(), domain.getFieldParent6(), domain.getFieldParent7(), domain.getFieldParent8(),
				domain.getFieldParent9(), domain.getFieldParent10(), domain.getFieldChild1(), domain.getFieldChild2(), domain.getFieldChild3(),
				domain.getFieldChild4(), domain.getFieldChild5(), domain.getFieldChild6(), domain.getFieldChild7(), domain.getFieldChild8(),
				domain.getFieldChild9(), domain.getFieldChild10());
	}
