...
import nts.uk.ctx.sys.assist.dom.result.Result;
...
public class SspdtResultDeletion extends UkJpaEntity implements Serializable {
	...
	public Result toDomain() {
		...
		return Result.createFromJavatype(this.sspdtResultDeletionPK.delID, this.companyID, this.delName, 
	...
	public static SspdtResultDeletion toEntity(Result result) {
