...
public class KrqstStampRequestSettingDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO KRQST_STAMP_REQUEST_SET(CID, TOP_COMMENT_TEXT, TOP_COMMENT_FONT_COLOR, TOP_COMMENT_FONT_WEIGHT, BOTTOM_COMMENT_TEXT, BOTTOM_COMMENT_FONT_COLOR, "
	...
	private final String SELECT_BY_CID_QUERY = "SELECT CID, TOP_COMMENT_TEXT, TOP_COMMENT_FONT_COLOR, TOP_COMMENT_FONT_WEIGHT, BOTTOM_COMMENT_TEXT, BOTTOM_COMMENT_FONT_COLOR, "
			+ "BOTTOM_COMMENT_FONT_WEIGHT, RESULT_DISP_FLG, SUP_FRAME_DISP_NO, STAMP_PLACE_DISP_FLG, STAMP_ATR_WORK_DISP_FLG, STAMP_ATR_GO_OUT_DISP_FLG, "
	...
	private final String DELETE_BY_CID_QUERY = "DELETE FROM KRQST_STAMP_REQUEST_SET WHERE CID = ?";
