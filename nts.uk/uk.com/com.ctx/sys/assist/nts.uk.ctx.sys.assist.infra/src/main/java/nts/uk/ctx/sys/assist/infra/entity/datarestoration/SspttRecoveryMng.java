...
@NoArgsConstructor
@Entity
@Table(name = "SSPTT_RECOVERY_MNG")
public class SspttRecoveryMng extends ContractUkJpaEntity implements Serializable {
	...
	public static SspttRecoveryMng toEntity(DataRecoveryMng domain) {
		return new SspttRecoveryMng(domain.getDataRecoveryProcessId(), domain.getErrorCount(),
