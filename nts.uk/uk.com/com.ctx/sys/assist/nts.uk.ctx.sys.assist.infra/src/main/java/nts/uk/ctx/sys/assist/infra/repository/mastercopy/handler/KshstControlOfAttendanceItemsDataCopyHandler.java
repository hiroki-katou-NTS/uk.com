...
/**
 * The Class KshstControlOfAttendanceItemsDataCopyHandler.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class KshstControlOfAttendanceItemsDataCopyHandler implements DataCopyHandler {
	 ...
	 *            the company id
	 */
	public KshstControlOfAttendanceItemsDataCopyHandler(EntityManager entityManager, CopyMethod copyMethod,
			String companyId) {
