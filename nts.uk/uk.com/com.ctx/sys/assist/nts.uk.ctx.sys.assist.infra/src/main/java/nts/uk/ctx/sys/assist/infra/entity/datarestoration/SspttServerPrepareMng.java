...
@NoArgsConstructor
@Entity
@Table(name = "SSPTT_SERVER_PREPARE_MNG")
public class SspttServerPrepareMng extends ContractUkJpaEntity implements Serializable {
	...
	public static SspttServerPrepareMng toEntity(ServerPrepareMng domain) {
		return new SspttServerPrepareMng(domain.getDataRecoveryProcessId(),
