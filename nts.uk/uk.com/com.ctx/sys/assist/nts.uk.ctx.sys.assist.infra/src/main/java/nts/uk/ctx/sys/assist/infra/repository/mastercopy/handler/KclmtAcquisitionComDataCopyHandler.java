...
public class KclmtAcquisitionComDataCopyHandler implements DataCopyHandler {
	...
	private String SELECT_BY_CID_QUERY = "SELECT CID ,EXP_TIME,PREEMP_PERMIT_ATR,DEADL_CHECK_MONTH FROM KCLMT_ACQUISITION_COM WHERE CID = ?";

	/** The delete by cid query. */
	private String DELETE_BY_CID_QUERY = "DELETE FROM KCLMT_ACQUISITION_COM WHERE CID = ?";
