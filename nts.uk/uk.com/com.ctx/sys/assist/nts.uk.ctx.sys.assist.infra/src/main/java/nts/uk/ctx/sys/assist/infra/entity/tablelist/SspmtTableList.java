...
//	public String dataStorageProcessId;
	...
	public TableList toDomain() {
		return new TableList(tableListPk.categoryId, categoryName, tableListPk.dataStorageProcessingId,
				...
				Integer.parseInt(saveForm), saveDateFrom, saveDateTo, storageRangeSaved, retentionPeriodCls, internalFileName,
	...
	public static SspmtTableList toEntity(TableList domain) {
		return new SspmtTableList(
				...
				domain.getPatternCode(), domain.getSaveSetName(), String.valueOf(domain.getSaveForm().value),
