...
public class SspdtManualSetDeletion extends UkJpaEntity implements Serializable {
	...
	public ManualSetting toDomain() {
		...
		return ManualSetting.createFromJavatype(this.sspdtManualSetDeletionPK.delID, this.companyID, this.systemType, 
	...
	public static SspdtManualSetDeletion toEntity(ManualSetting manualSetting) {
