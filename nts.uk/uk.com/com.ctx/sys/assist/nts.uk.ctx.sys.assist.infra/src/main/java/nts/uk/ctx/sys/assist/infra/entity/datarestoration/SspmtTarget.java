...
public class SspmtTarget extends ContractUkJpaEntity implements Serializable {
	...
	public static SspmtTarget toEntity(Target domain) {
		return new SspmtTarget(new SspmtTargetPk(domain.getDataRecoveryProcessId(), domain.getSid()),
