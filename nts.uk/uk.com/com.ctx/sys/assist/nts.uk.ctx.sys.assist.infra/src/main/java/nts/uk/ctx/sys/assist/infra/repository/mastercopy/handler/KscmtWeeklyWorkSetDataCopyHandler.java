...
/**
 * The Class KscmtWeeklyWorkSetDataCopyHandler.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class KscmtWeeklyWorkSetDataCopyHandler implements DataCopyHandler {
	...
	/**
	 * Instantiates a new kscmt weekly work set data copy handler.
	 *
	 * @param entityManager
	 *            the entity manager
	 * @param copyMethod
	 ...
	 *            the company id
	 */
	public KscmtWeeklyWorkSetDataCopyHandler(EntityManager entityManager, CopyMethod copyMethod, String companyId) {
