...
@AllArgsConstructor
@Embeddable
public class SspctMastercopyDataPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SspctMastercopyDataPK)) {
			return false;
		}
		SspctMastercopyDataPK castOther = (SspctMastercopyDataPK)other;
		return 
