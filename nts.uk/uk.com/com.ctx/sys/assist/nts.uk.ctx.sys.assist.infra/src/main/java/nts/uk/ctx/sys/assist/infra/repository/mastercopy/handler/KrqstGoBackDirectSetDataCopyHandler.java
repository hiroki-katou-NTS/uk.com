...
public class KrqstGoBackDirectSetDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO KRQST_GO_BACK_DIRECT_SET(CID, WORK_CHANGE_FLG, WORK_CHANGE_TIME_ATR, PERFORMANCE_DISPLAY_ATR, CONTRADITION_CHECK_ATR, WORK_TYPE, LATE_LEAVE_EARLY_SETTING_ATR, "
	...
	private final String SELECT_BY_CID_QUERY = "SELECT CID, WORK_CHANGE_FLG, WORK_CHANGE_TIME_ATR, PERFORMANCE_DISPLAY_ATR, CONTRADITION_CHECK_ATR, WORK_TYPE, LATE_LEAVE_EARLY_SETTING_ATR, "
	...
	private final String DELETE_BY_CID_QUERY = "DELETE FROM KRQST_GO_BACK_DIRECT_SET WHERE CID = ?";
