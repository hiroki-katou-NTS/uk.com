package nts.uk.ctx.sys.assist.infra.entity.resultlog;
...
public class SspdtResultLogDeletion extends UkJpaEntity implements Serializable {
	...
	public ResultLog toDomain() {
		return ResultLog.createFromJavatype(this.sspdtResultLogDeletionPK.seqId, this.delId, this.companyID, this.logTime,
				this.processingContent, this.errorContent, this.errorEmployeeId, this.errorDate);
	}

	public static SspdtResultLogDeletion toEntity(ResultLog resultLog) {
