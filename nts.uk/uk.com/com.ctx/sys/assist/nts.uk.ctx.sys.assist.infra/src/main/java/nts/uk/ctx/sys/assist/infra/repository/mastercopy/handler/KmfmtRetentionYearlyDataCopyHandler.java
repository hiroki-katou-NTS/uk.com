...
public class KmfmtRetentionYearlyDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private final String INSERT_QUERY = "INSERT INTO KMFMT_RETENTION_YEARLY(CID, NUMBER_OF_YEAR, MAX_NUMBER_OF_DAYS, LEAVE_AS_WORK_DAYS, MANAGEMENT_YEARLY_ATR) VALUES (?,?,?,?,?)";

	/** The select by cid query. */
	private final String SELECT_BY_CID_QUERY = "SELECT CID, NUMBER_OF_YEAR, MAX_NUMBER_OF_DAYS, LEAVE_AS_WORK_DAYS, MANAGEMENT_YEARLY_ATR FROM KMFMT_RETENTION_YEARLY WHERE CID = ?";

	/** The delete by cid query. */
	private final String DELETE_BY_CID_QUERY = "DELETE FROM KMFMT_RETENTION_YEARLY WHERE CID = ?";
