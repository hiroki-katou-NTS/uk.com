...
@Setter
@NoArgsConstructor
public class KrcstConstraintTimeCalDataCopyHandler extends DataCopyHandler {
	 ...
	 *            the company id
	 */
	public KrcstConstraintTimeCalDataCopyHandler(EntityManager entityManager, CopyMethod copyMethod, String companyId) {
