...
public class SspmtSaveCategoryFieldForDelete extends ContractUkJpaEntity implements Serializable {
	 ...
	 */
	@EmbeddedId
	public SspmtSaveCategoryFieldForDeletePk categoryFieldMtPk;
	...
	public static SspmtSaveCategoryFieldForDelete toEntity(CategoryFieldMt domain) {
		return new SspmtSaveCategoryFieldForDelete(
				new SspmtSaveCategoryFieldForDeletePk(domain.getCategoryId(), domain.getTableNo(), domain.getSystemType().value),
