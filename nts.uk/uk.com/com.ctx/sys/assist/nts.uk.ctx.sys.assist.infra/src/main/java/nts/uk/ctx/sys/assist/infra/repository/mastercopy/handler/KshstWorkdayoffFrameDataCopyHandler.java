...
public class KshstWorkdayoffFrameDataCopyHandler extends DataCopyHandler {
	...
	/** The insert query. */
	private static final String INSERT_QUERY = "INSERT INTO KSHST_WORKDAYOFF_FRAME(CID, WDO_FR_NO, EXCLUS_VER, USE_ATR, WDO_FR_NAME, TRANS_FR_NAME) VALUES (?, ?, ?, ?, ?, ?);";

	/** The select by cid query. */
	private static final String SELECT_BY_CID_QUERY = "SELECT CID, WDO_FR_NO, EXCLUS_VER, USE_ATR, WDO_FR_NAME, TRANS_FR_NAME FROM KSHST_WORKDAYOFF_FRAME WHERE CID = ?";

	/** The delete by cid query. */
	private static final String DELETE_BY_CID_QUERY = "DELETE FROM KSHST_WORKDAYOFF_FRAME WHERE CID = ?";
