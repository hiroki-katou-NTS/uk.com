...
public class SspmtCategory extends ContractUkJpaEntity implements Serializable {
	...
	public Category toDomain() {
		return new Category(EnumAdaptor.valueOf(this.schelperSystem, SystemUsability.class),
	...
	public static SspmtCategory toEntity(Category domain) {
		return new SspmtCategory(domain.getCategoryId().v(), domain.getSchelperSystem().value,
