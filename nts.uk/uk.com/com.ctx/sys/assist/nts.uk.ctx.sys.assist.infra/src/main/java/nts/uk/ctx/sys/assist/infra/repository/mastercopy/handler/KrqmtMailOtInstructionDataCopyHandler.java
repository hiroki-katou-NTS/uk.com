...
public class KrqmtMailOtInstructionDataCopyHandler implements DataCopyHandler {
	 ...
	 * The insert query.
	 */
	private String INSERT_QUERY = "INSERT INTO KRQMT_MAIL_OT_INSTRUCTION(CID,SUBJECT,CONTENT) VALUES (?,?,?);";

	/**
	 * The select by cid query.
	 */
	private String SELECT_BY_CID_QUERY = "SELECT CID,SUBJECT,CONTENT FROM KRQMT_MAIL_OT_INSTRUCTION WHERE CID = ?";

	/**
	 * The delete by cid query.
	 */
	private String DELETE_BY_CID_QUERY = "DELETE FROM KRQMT_MAIL_OT_INSTRUCTION WHERE CID = ?";
