...
public class KrqmtMailOtInstructionDataCopyHandler extends DataCopyHandler {
     ...
     * The insert query.
     */
    private final String INSERT_QUERY = "INSERT INTO KRQMT_MAIL_OT_INSTRUCTION(CID,SUBJECT,CONTENT) VALUES (?,?,?);";

    /**
     * The select by cid query.
     */
    private final String SELECT_BY_CID_QUERY = "SELECT CID,SUBJECT,CONTENT FROM KRQMT_MAIL_OT_INSTRUCTION WHERE CID = ?";

    /**
     * The delete by cid query.
     */
    private final String DELETE_BY_CID_QUERY = "DELETE FROM KRQMT_MAIL_OT_INSTRUCTION WHERE CID = ?";
     ...
     */
    public KrqmtMailOtInstructionDataCopyHandler(EntityManager entityManager, CopyMethod copyMethod, String companyId) {
