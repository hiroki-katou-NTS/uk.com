...
public class SaveTargetCsv {
	...
	public SaveTargetCsv(String storeProcessingId, int saveForm, String saveSetCode, String saveName,
			String suppleExplanation, String categoryId, String categoryName, int timeStore, int recoveryStorageRange,
