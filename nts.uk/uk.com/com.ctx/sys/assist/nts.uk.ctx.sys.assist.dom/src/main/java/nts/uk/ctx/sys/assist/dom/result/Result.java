package nts.uk.ctx.sys.assist.dom.result;
...
import nts.uk.ctx.sys.assist.dom.manual.DelName;
 ...
 * データ削除の保存結果
 */
public class Result extends AggregateRoot {
	...
	public static Result createFromJavatype(String delId, String companyId, String delName, 
			...
			int fileSize) {
		return new Result(delId, companyId, new DelName(delName),
