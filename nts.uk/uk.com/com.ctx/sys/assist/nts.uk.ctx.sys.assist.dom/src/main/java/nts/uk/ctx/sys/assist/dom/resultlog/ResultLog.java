package nts.uk.ctx.sys.assist.dom.resultlog;
 ...
 * データ削除の結果ログ
 */
public class ResultLog extends AggregateRoot {
	...
	public static ResultLog createFromJavatype(int seqId, String delId, String companyId, GeneralDateTime logTime,
			String processingContent, String errorContent, String errorEmployeeId,
			GeneralDate errorDate) {
		return new ResultLog(seqId, delId, companyId, logTime,
