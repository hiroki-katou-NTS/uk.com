 ...
 * データ削除の手動設定
 */
public class ManualSetting extends AggregateRoot {
	...
	public static ManualSetting createFromJavatype(String delId, String companyId, int systemType, String delName,
		...
		return new ManualSetting(delId, companyId, systemType, new DelName(delName), isSaveBeforeDeleteFlg,
