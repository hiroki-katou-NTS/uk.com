...
public class TableList extends DomainObject {
	...
	public static TableList createFromCsvData(List<String> tableListSetting) {
		...
		TableList tableListData = new TableList(tableListSetting.get(0), tableListSetting.get(1),
				tableListSetting.get(2), tableListSetting.get(3), tableListSetting.get(4), tableListSetting.get(5),
				tableListSetting.get(6), retentionPeriodCls, storageRangeSaved, tableListSetting.get(9),
				tableListSetting.get(10), tableListSetting.get(11), surveyPreservation, anotherComCls,
				Integer.parseInt(tableListSetting.get(14)), tableListSetting.get(15), tableListSetting.get(16),
				historyCls, hasParentTblFlg, tableListSetting.get(19), tableListSetting.get(20),
				tableListSetting.get(21), tableListSetting.get(22), tableListSetting.get(23), tableListSetting.get(24),
		...
		tableListData.setSelectionTargetForRes(Optional.of(0));
