...
/*
 * UKDesign.ドメインモデル.NittsuSystem.UniversalK.オフィス支援.在席照会.外出.App.外出を変更登録する.外出を変更登録する
 */
@Stateless
@TransactionAttribute(TransactionAttributeType.SUPPORTS)
public class GoOutEmployeeInformationUpdateCommandHandler extends CommandHandler<GoOutEmployeeInformationCommand> {
