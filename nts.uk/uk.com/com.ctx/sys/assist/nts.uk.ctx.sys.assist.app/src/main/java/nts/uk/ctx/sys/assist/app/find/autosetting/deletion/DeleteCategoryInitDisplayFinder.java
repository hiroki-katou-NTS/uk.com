...
public class DeleteCategoryInitDisplayFinder {
	...
	public StartupParameterDto<DeleteCategoryDto, DataDeletionPatternSettingDto> initDisplay() {
		...
		List<DataDeletionPatternSetting> patterns = dataDeletionPatternSettingRepository.findByContractCd(user.contractCode());
		...
		} else throw new BusinessException("Msg_1740");
		return dto;
	}
