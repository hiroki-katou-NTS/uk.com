...
public class WorkPlaceSelectionImpl implements WorkPlaceSelectionRepository {
	...
	private static final String GET_EXPORT_EXCEL = "SELECT "
			...
			+"						INNER JOIN BSYMT_WKP_CONFIG bwc ON wm.CID = bwc.CID AND bwc.END_DATE = '9999-12-31 00:00:00'"
			+"						INNER JOIN BSYMT_WKP_CONFIG_INFO wci ON wci.WKPID = wi.WKP_ID AND bwc.HIST_ID = wci.HIST_ID"
			+" 						WHERE "
