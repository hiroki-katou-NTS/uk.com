...
public class JpaPerInfoInitValueSetCtgRepository extends JpaRepository implements PerInfoInitValueSetCtgRepository {
	private static final String GET_EXPORT_DATA;
	  static {
	     ...
	     exportSQL.append("						AND TABLE_RESULT.SELECTION_ITEM_REF_CODE <> 'M00017',");
	     ...
	     exportSQL.append("  INNER JOIN PPEMT_PER_INFO_CTG_CM ctgcm ON ctg.CATEGORY_CD = ctgcm.CATEGORY_CD AND ctgcm.CONTRACT_CD = ?CONTRACT_CD");
	     ...
	     exportSQL.append("   INNER JOIN PPEMT_PER_INFO_CTG_ORDER ctgorder ON  ctg.PER_INFO_CTG_ID = ctgorder.PER_INFO_CTG_ID");
	     ...
	     exportSQL.append("  LEFT JOIN KBPMT_BONUS_PAY_SET bonuspay ON initsetitem.STRING_VAL = bonuspay.BONUS_PAY_SET_CD ");
	     exportSQL.append("       AND initset.CID= bonuspay.CID AND itemcm.SELECTION_ITEM_REF_CODE = 'M00015'");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_HD_TBL_SET hdtblset ON initsetitem.STRING_VAL = hdtblset.YEAR_HD_CD ");
	     exportSQL.append("       AND initset.CID= hdtblset.CID AND itemcm.SELECTION_ITEM_REF_CODE = 'M00016'");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset ON initsetitem.STRING_VAL = dateset.GD_TBL_CD AND initset.CID= dateset.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00025' AND dateset.SPHD_CD = 1");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset1 ON initsetitem.STRING_VAL = dateset1.GD_TBL_CD AND initset.CID= dateset1.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00026' AND dateset1.SPHD_CD = 2");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset2 ON initsetitem.STRING_VAL = dateset2.GD_TBL_CD AND initset.CID= dateset2.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00027' AND dateset2.SPHD_CD = 3");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset3 ON initsetitem.STRING_VAL = dateset3.GD_TBL_CD AND initset.CID= dateset3.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00028' AND dateset3.SPHD_CD = 4");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset4 ON initsetitem.STRING_VAL = dateset4.GD_TBL_CD AND initset.CID= dateset4.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00029' AND dateset4.SPHD_CD = 5");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset5 ON initsetitem.STRING_VAL = dateset5.GD_TBL_CD AND initset.CID= dateset5.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00030' AND dateset5.SPHD_CD = 6");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset6 ON initsetitem.STRING_VAL = dateset6.GD_TBL_CD AND initset.CID= dateset6.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00031' AND dateset6.SPHD_CD = 7");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset7 ON initsetitem.STRING_VAL = dateset7.GD_TBL_CD AND initset.CID= dateset7.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00032' AND dateset7.SPHD_CD = 8");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset8 ON initsetitem.STRING_VAL = dateset8.GD_TBL_CD AND initset.CID= dateset8.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00033' AND dateset8.SPHD_CD = 9");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset9 ON initsetitem.STRING_VAL = dateset9.GD_TBL_CD AND initset.CID= dateset9.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00034' AND dateset9.SPHD_CD = 10");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset10 ON initsetitem.STRING_VAL = dateset10.GD_TBL_CD AND initset.CID= dateset10.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00049' AND dateset10.SPHD_CD = 11");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset11 ON initsetitem.STRING_VAL = dateset11.GD_TBL_CD AND initset.CID= dateset11.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00050' AND dateset11.SPHD_CD = 12");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset12 ON initsetitem.STRING_VAL = dateset12.GD_TBL_CD AND initset.CID= dateset12.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00051' AND dateset12.SPHD_CD = 13");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset13 ON initsetitem.STRING_VAL = dateset13.GD_TBL_CD AND initset.CID= dateset13.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00052' AND dateset13.SPHD_CD = 14");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset14 ON initsetitem.STRING_VAL = dateset14.GD_TBL_CD AND initset.CID= dateset14.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00053' AND dateset14.SPHD_CD = 15");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset15 ON initsetitem.STRING_VAL = dateset15.GD_TBL_CD AND initset.CID= dateset15.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00054' AND dateset15.SPHD_CD = 16");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset16 ON initsetitem.STRING_VAL = dateset16.GD_TBL_CD AND initset.CID= dateset16.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00055' AND dateset16.SPHD_CD = 17");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset17 ON initsetitem.STRING_VAL = dateset17.GD_TBL_CD AND initset.CID= dateset17.CID ");
	     exportSQL.append("       AND itemcm.SELECTION_ITEM_REF_CODE = 'M00017' AND ctg.CATEGORY_CD = 'CS00056' AND dateset17.SPHD_CD = 18");
	     exportSQL.append("  LEFT JOIN KSHST_GRANT_DATE_TBL dateset18 ON initsetitem.STRING_VAL = dateset18.GD_TBL_CD AND initset.CID= dateset18.CID ");
