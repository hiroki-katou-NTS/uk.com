...
public class JpaChangePerInforDefinitionRepository extends JpaRepository implements ChangePerInforDefinitionExRepository {
	...
	private static final String GET_PER_INFOR_DEFINITION;
	  static {
	     ...
	     exportSQL.append("              FROM PPEMT_PER_INFO_CTG cc");
	     exportSQL.append("          INNER JOIN PPEMT_PER_INFO_CTG_CM ccm");
	     ...
	     exportSQL.append("                       FROM PPEMT_PER_INFO_CTG_CM ");
	     exportSQL.append("                       WHERE CONTRACT_CD = ?contracCd");
	     exportSQL.append("                   ) c ");
	     exportSQL.append("                     ON i.CATEGORY_CD = c.CATEGORY_CD ");
	     exportSQL.append("            INNER JOIN PPEMT_PER_INFO_CTG_ORDER o ON i.CID = o.CID AND o.PER_INFO_CTG_ID = i.PER_INFO_CTG_ID ");
	     ...
	     exportSQL.append("                 FROM PPEMT_PER_INFO_CTG ");
	     ...
	     exportSQL.append("                   INNER JOIN PPEMT_PER_INFO_ITEM_ORDER io ON p.PER_INFO_ITEM_DEFINITION_ID = io.PER_INFO_ITEM_DEFINITION_ID");
