...
public class PersonRoleImpl implements PersonRoleRepository {
	...
	private static final String GET_EXPORT_EXCEL = "SELECT "
			...
			+ " TBL.SELF_AUTH_TYPE,"
			+ " ("
			+ "  select count(*) from PPEMT_PER_INFO_ITEM ii where ii.PER_INFO_CTG_ID = TBL.PER_INFO_CTG_ID and  ii.ABOLITION_ATR =0"
			+ " ) as count_i,"
			+ " ("
			+ "  select count(*) from PPEMT_PERSON_ITEM_AUTH ia where ia.PER_INFO_CTG_ID=TBL.PER_INFO_CTG_ID and ia.ROLE_ID=TBL.ROLE_ID"
			+ " ) as count_ia,"
			+ " TBL.IsItemConfig "
			+ " FROM"
			+ " ("
			...
			+ " CASE"
			+ " WHEN xx.PER_INFO_CTG_ID IS NOT NULL  THEN "
			+ "	'True' "
			+ "	 ELSE 'False' "
			+ "	END AS IsConfig,"
			...
			+ " CASE "
			+ "	WHEN ctgau.PER_INFO_ITEM_DEF_ID IS NOT NULL  THEN "
			+ "	'True' "
			+ "	ELSE "
			+ "	'False' "
			+ "	END AS IsItemConfig,"
			...
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			...
			+ " xx.SELF_ALLOW_ADD_HIS_ATR,xx.SELF_ALLOW_DEL_HIS_ATR,xx.SELF_FUTURE_HIS_AUTH_TYPE,xx.SELF_PAST_HIS_AUTH_TYPE,co.DISPORDER"
			+ "	) "
			+ "	AS ROW_NUMBER18,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			...
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,"
			+ " xx.OTHER_ALLOW_ADD_HIS_ATR,xx.OTHER_ALLOW_DEL_HIS_ATR,xx.OTHER_FUTURE_HIS_AUTH_TYPE,xx.OTHER_PAST_HIS_AUTH_TYPE,"
			+ " xx.SELF_ALLOW_ADD_HIS_ATR,xx.SELF_ALLOW_DEL_HIS_ATR,xx.SELF_FUTURE_HIS_AUTH_TYPE,co.DISPORDER"
			+ "	) "
			+ "	AS ROW_NUMBER17,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			...
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,"
			+ " xx.OTHER_ALLOW_ADD_HIS_ATR,xx.OTHER_ALLOW_DEL_HIS_ATR,xx.OTHER_FUTURE_HIS_AUTH_TYPE,xx.OTHER_PAST_HIS_AUTH_TYPE,"
			+ " xx.SELF_ALLOW_ADD_HIS_ATR,xx.SELF_ALLOW_DEL_HIS_ATR,co.DISPORDER"
			+ "	) "
			+ "	AS ROW_NUMBER16,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			...
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,"
			+ " xx.OTHER_ALLOW_ADD_HIS_ATR,xx.OTHER_ALLOW_DEL_HIS_ATR,xx.OTHER_FUTURE_HIS_AUTH_TYPE,xx.OTHER_PAST_HIS_AUTH_TYPE,xx.SELF_ALLOW_ADD_HIS_ATR,co.DISPORDER"
			+ "	) AS ROW_NUMBER15,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,"
			+ " xx.OTHER_ALLOW_ADD_HIS_ATR,xx.OTHER_ALLOW_DEL_HIS_ATR,xx.OTHER_FUTURE_HIS_AUTH_TYPE,xx.OTHER_PAST_HIS_AUTH_TYPE,co.DISPORDER"
			+ "	) AS ROW_NUMBER14,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR,"
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,"
			+ " xx.OTHER_ALLOW_ADD_HIS_ATR,xx.OTHER_ALLOW_DEL_HIS_ATR,xx.OTHER_FUTURE_HIS_AUTH_TYPE,co.DISPORDER"
			+ "	) AS ROW_NUMBER13,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,"
			+ " xx.OTHER_ALLOW_ADD_HIS_ATR,xx.OTHER_ALLOW_DEL_HIS_ATR,co.DISPORDER"
			+ "	) AS ROW_NUMBER12,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,"
			+ " xx.OTHER_ALLOW_ADD_HIS_ATR,co.DISPORDER"
			+ "	) AS ROW_NUMBER11,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,xx.SELF_ALLOW_DEL_MULTI_ATR,co.DISPORDER"
			+ "	) AS ROW_NUMBER10,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR,"
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,xx.SELF_ALLOW_ADD_MULTI_ATR,co.DISPORDER"
			+ "	) AS ROW_NUMBER9,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,xx.OTHER_ALLOW_DEL_MULTI_ATR,co.DISPORDER"
			+ "	) AS ROW_NUMBER8,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			+ " xx.ALLOW_OTHER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE,xx.ALLOW_OTHER_REF_ATR, xx.ALLOW_PER_REF_ATR,"
			+ " xx.OTHER_ALLOW_ADD_MULTI_ATR,co.DISPORDER"
			+ "	) AS ROW_NUMBER7,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR, "
			...
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE, xx.ALLOW_PER_REF_ATR ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE, xx.ALLOW_OTHER_REF_ATR, co.DISPORDER"
			+ "	) AS ROW_NUMBER5,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,ctgau.OTHER_PERSON_AUTH_TYPE ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME,cm.CATEGORY_TYPE, co.DISPORDER"
			+ "	) AS ROW_NUMBER4,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME ORDER BY x.ROLE_CD, x.ROLE_NAME,c.CATEGORY_NAME, co.DISPORDER"
			+ "	) AS ROW_NUMBER3,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD, x.ROLE_NAME ORDER BY x.ROLE_CD, x.ROLE_NAME, co.DISPORDER"
			+ "	) AS ROW_NUMBER2,"
			+ " ROW_NUMBER() OVER "
			+ "	("
			+ "	PARTITION BY x.ROLE_CD ORDER BY x.ROLE_CD, co.DISPORDER"
			+ "	) AS ROW_NUMBER1"
			...
			+ "	("
			+ "	SELECT DISTINCT"
			+ "	 pp.ROLE_ID,r.ROLE_CD, r.ROLE_NAME "
			+ "	FROM "
			+ "	PPEMT_PERSON_CTG_AUTH pp"
			+ " JOIN PPEMT_PER_INFO_CTG c on pp.PER_INFO_CTG_ID = c.PER_INFO_CTG_ID "
			...
			+ " WHERE ((cm.SALARY_USE_ATR = 1 AND ?6 = 1) OR (cm.PERSONNEL_USE_ATR = 1 AND ?7 = 1) OR (cm.EMPLOYMENT_USE_ATR = 1 AND ?8 = 1)) OR (?9 =  0 AND  ?10 = 0 AND ?11 = 0)  "
			+ " ) TBL";
