module nts.uk.com.view.cmf001.j.viewmodel {
    ...
    export class ScreenModel {
        ...
        setting: KnockoutObservable<model.InstantTimeDataFormatSetting> = ko.observable();

        itemsDigit: KnockoutObservableArray<model.ItemModel> = ko.observableArray([]);

        itemsDecimalType: KnockoutObservableArray<model.ItemModel> = ko.observableArray([]);

        itemsTimeType: KnockoutObservableArray<model.ItemModel> = ko.observableArray([]);

        itemsDelimiterSet: KnockoutObservableArray<model.ItemModel> = ko.observableArray([]);

        itemsRoundProcess: KnockoutObservableArray<model.ItemModel> = ko.observableArray([]);

        itemsRoundProcessContent: KnockoutObservableArray<model.ItemModel> = ko.observableArray([]);
