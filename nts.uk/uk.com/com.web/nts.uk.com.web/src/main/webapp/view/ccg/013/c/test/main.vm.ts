module nts.uk.sys.view.ccg013.c.test.viewmodel {
    export class ScreenModel {
        ...
        openDialog() {
            ...
            nts.uk.ui.windows.sub.modal("/view/ccg/013/c/index.xhtml").onClosed(() => {
                var self = this;
                var returnItem = nts.uk.ui.windows.getShared("CCG013C_MenuBar");
