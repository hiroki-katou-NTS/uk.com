...
//                            __viewContext["viewModel"].currentCategory().itemList()[itemChilds[i].indexItem - 1].enableControl(data1);
//                            __viewContext["viewModel"].currentCategory().itemList()[itemChilds[i + 1].indexItem - 1].enableControl(data1);
