...
function init() {
    $("#grid2").ntsGrid({
        ...
        columns: [
            ...
            { headerText: nts.uk.resource.getText('CPS001_83'), key: 'id', dataType: 'string', width: '25px', unbound: true, ntsControl: 'Button' }

        ],
        features: [{ name: 'Sorting', type: 'local' }],
        ntsControls: [
            { name: 'Combobox', options: __viewContext['viewModel'].comboItems, optionsValue: 'categoryCode', optionsText: 'categoryName', columns: __viewContext['viewModel'].comboColumns, controlType: 'ComboBox', enable: true },
