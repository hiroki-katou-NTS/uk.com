            ...
            private AuthContract() {
                ...
                if (!nts.uk.ui.errors.hasError()) {
                    service.submitForm({ contractCode: _.escape(self.contractCode()), password: _.escape(self.password()) }).done(function () {
                        $.Deferred().resolve()
                            .then(() => nts.uk.characteristics.remove("contractInfo"))
                            .then(() => nts.uk.characteristics.save("contractInfo", { contractCode: _.escape(self.contractCode()), contractPassword: _.escape(self.password()) }))
                            .then(() => {
