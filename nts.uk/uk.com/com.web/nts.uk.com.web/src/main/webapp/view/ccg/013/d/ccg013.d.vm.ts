    ...
    export class ScreenModel {
        ...
        constructor() {
            ...
            self.columns = ko.observableArray([
                { headerText: nts.uk.resource.getText("CCG013_49"), key: 'code', key: 'code', width: 55, columnCssClass: "colStyle", formatter: _.escape },
                { headerText: nts.uk.resource.getText("CCG013_50"), key: 'name', key: 'name', width: 167, columnCssClass: "colStyle", formatter: _.escape },
                { headerText: 'pk', prop: 'primaryKey', key: 'primaryKey', width: 1, hidden: true }
            ]);

            self.newColumns = ko.observableArray([
                { headerText: nts.uk.resource.getText("CCG013_51"), key: 'code', width: 55, columnCssClass: "text-limited", formatter: _.escape },
                { headerText: nts.uk.resource.getText("CCG013_52"), key: 'targetItem', width: 160, columnCssClass: "text-limited", formatter: _.escape },
                { headerText: nts.uk.resource.getText("CCG013_53"), key: 'name', width: 160, columnCssClass: "text-limited" ,formatter: _.escape },
                { headerText: 'pk', key: 'primaryKey', width: 1, hidden: true }
            ]);
        ...
        start(): JQueryPromise<any> {
            ...
            self.currentCodeList(titleBar.treeMenus);
            ...
            $.when(self.findAllDisplay()).done(function() {
                ...
                self.currentCodeList(selectedItems);
       ...
       /** remove(): void {
        ...
        submit() {
            var self = this;
            nts.uk.ui.windows.setShared("CCG013D_MENUS", self.currentCodeList());
            nts.uk.ui.windows.close();
        }
        $swap.igGrid({ features: [
            {
                name: "Tooltips"
            }
        ]});
