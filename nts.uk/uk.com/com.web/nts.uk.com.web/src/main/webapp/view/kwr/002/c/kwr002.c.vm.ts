...
//            service.findAllAttendanceRecExportDaily(1).then(function(listAttendanceRecExpList: Array<model.AttendanceRecExp>){
//            if(listAttendanceRecExpList.length > 0){
//                self.attendanceRecExp(listAttendanceRecExpList);    
//            }    
//            });
            blockUI.clear();
            return dfd.promise();
