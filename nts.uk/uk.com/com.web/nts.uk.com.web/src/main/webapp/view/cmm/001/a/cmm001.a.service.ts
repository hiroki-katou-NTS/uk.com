module cmm001.a.service {
    ...
    //saveAsExcel
        export function saveAsExcel(languageId: string): JQueryPromise<any> {
            return nts.uk.request.exportFile('/masterlist/report/print', {domainId: "Company", languageId: languageId, domainType: "CMM001"+ __viewContext.program.programName, reportType: 0});
        }
}