...
function InitIggrid() {
    ...
    $("#grid").igGrid({
        columns: [
            ...
            {
                headerText: text('CAS001_30')+"</br><input class='selfAuth' type='checkbox'  tabindex='2' ></input>", key: 'selfAuth',
            ...
            {
                headerText: text('CAS001_31')+"</br><input class='otherAuth' type='checkbox'  tabindex='3'></input>", key: 'otherAuth',
                width: "35px", height: "40px",
