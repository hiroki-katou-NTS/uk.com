...
//			"/ctx/sys/gateway/changepassword/.*",
			"/ctx/sys/gateway/changepassword/submitchangepass",
			"/ctx/sys/gateway/changepassword/getUserNameByLoginId/.*",
			"/ctx/sys/gateway/changepassword/getUserNameByEmployeeCode",
			"/ctx/sys/gateway/changepassword/username/mobile",
			"/ctx/sys/gateway/changepassword/getPasswordPolicy/.*",
