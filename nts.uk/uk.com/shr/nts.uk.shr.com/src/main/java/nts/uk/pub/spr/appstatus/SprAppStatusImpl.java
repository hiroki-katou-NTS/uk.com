...
public class SprAppStatusImpl implements SprAppStatusService {
	...
	public void checkParam(String loginEmpCD, String employeeCD, String startDate, String endDate) {
		...
		employeeSprService.validateEmpCodeSpr(loginEmpCD);
	...
	public List<AppStatusSpr> getOverTimeAppStatus(String employeeID, GeneralDate startDate, GeneralDate endDate) {
		...
		for(GeneralDate loopDate = startDate; loopDate.beforeOrEquals(endDate); loopDate.addDays(1)){
			// 早出残業申請状況確認
			AppOvertimeStatusSpr appOvertimeStatusSpr1 = this.getOverTimeAppInfo(loopDate, employeeID, 0);
			// 通常残業申請状況確認
			AppOvertimeStatusSpr appOvertimeStatusSpr2 = this.getOverTimeAppInfo(loopDate, employeeID, 1);
	...
	public AppOvertimeStatusSpr getOverTimeAppInfo(GeneralDate appDate, String employeeID, Integer overTimeAtr) {
		...
		AppOverTimeSpr appOverTimeSpr = opAppOverTimeSpr.get();
