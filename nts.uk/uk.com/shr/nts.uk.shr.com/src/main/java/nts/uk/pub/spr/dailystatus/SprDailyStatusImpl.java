...
public class SprDailyStatusImpl implements SprDailyStatusService {
	...
	@Inject
	private SprAppRootStateService sprAppRootStateService;
	...
	public Integer getManagerStatus(GeneralDate appDate, String employeeID) {
		List<AppRootStateStatusSpr> appRootStateStatusSprList = sprAppRootStateService.getStatusByEmpAndDate(
				employeeID, 
				appDate, 
				appDate,
				1);
