...
public interface MailSender {
	 ...
	 */
	void sendFromAdmin(MailRecipient to, MailContents contents, String companyId)
	 ...
	 * @throws SendMailFailedException thrown when any problem occurs about connect mail server
	 */
	void send(MailOriginator from, MailRecipient to, MailContents contents, String companyId)
			throws SendMailFailedException;
