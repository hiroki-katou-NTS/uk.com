 ...
 */
@Entity
@Table(name = "WWFDT_WP_APPROVAL_ROOT")
@AllArgsConstructor
@NoArgsConstructor
public class WwfdtWpApprovalRoot extends UkJpaEntity implements Serializable{
	private static final long serialVersionUID = 1L;

	/*主キー*/
	@EmbeddedId
	public WwfdtWpApprovalRootPK wwfdtWpApprovalRootPK;
	/*分岐ID*/
