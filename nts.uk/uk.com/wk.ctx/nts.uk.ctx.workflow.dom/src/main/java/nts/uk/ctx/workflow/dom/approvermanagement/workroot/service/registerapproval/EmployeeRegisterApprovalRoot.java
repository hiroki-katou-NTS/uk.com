...
public interface EmployeeRegisterApprovalRoot {
	 ...
	 * @return
	 */
	Map<String, WpApproverAsAppOutput> lstEmps(String companyID, GeneralDate baseDate, List<String> lstEmpIds, EmploymentRootAtr rootAtr, List<ApplicationType> lstApps);
}
