...
public class RegulationInfoEmployeePubImpl implements RegulationInfoEmployeePub {
	...
	private RegulationInfoEmpQueryDto toQueryModel(EmployeeSearchQueryDto query) {
		return RegulationInfoEmpQueryDto.builder()
			.baseDate(query.getBaseDate() != null ? query.getBaseDate().toString(GENERAL_DATE_FORMAT) : null)
			...
			.periodEnd(query.getPeriodEnd() != null ? query.getPeriodEnd().toString(GENERAL_DATE_FORMAT) : null)
			.periodStart(query.getPeriodStart() != null ? query.getPeriodStart().toString(GENERAL_DATE_FORMAT) : null)
			.referenceRange(query.getReferenceRange())
			.retireEnd(query.getRetireEnd() != null ? query.getRetireEnd().toString(GENERAL_DATE_FORMAT) : null)
			.retireStart(query.getRetireStart() != null ? query.getRetireStart().toString(GENERAL_DATE_FORMAT) : null)
