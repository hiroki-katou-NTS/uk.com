...
public class TotalWorkingTimeDto {
	//総労働時間
		...
		private WithinStatutoryTimeOfDailyDto withinStatutoryTimeOfDaily;
		 
		//日別実績の所定外時間 - 所定外時間 (new)
		private ExcessOfStatutoryTimeOfDailyDto excessOfStatutoryTimeOfDaily;
		
		//日別実績の遅刻時間
		private List<LateTimeOfDailyDto> lateTimeOfDaily;
