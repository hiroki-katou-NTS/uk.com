package nts.uk.ctx.exio.app.find.qmm.itemrangeset;
 ...
 */
@Value
public class ItemRangeSettingInitialValueDto {
	...
	public static ItemRangeSettingInitialValueDto fromDomain(ItemRangeSettingInitialValue domain) {
		return new ItemRangeSettingInitialValueDto(domain.getCid(), domain.getSalaryItemId(), domain.getRangeValueAtr().value,
