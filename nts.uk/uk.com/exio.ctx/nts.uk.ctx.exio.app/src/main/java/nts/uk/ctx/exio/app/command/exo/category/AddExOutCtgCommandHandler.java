...
public class AddExOutCtgCommandHandler extends CommandHandler<ExOutCtgCommand> {
	...
	protected void handle(CommandHandlerContext<ExOutCtgCommand> context) {
		...
		repository.add(new ExOutCtg(addCommand.getCategoryId(), addCommand.getOfficeHelperSysAtr(),
				addCommand.getCategoryName(), addCommand.getCategorySet(), addCommand.getPersonSysAtr(),
				addCommand.getAttendanceSysAtr(), addCommand.getPayrollSysAtr(), addCommand.getFunctionNo(),
				addCommand.getFunctionName(), addCommand.getExplanation(), addCommand.getDisplayOrder(),
				addCommand.isDefaultValue()));
