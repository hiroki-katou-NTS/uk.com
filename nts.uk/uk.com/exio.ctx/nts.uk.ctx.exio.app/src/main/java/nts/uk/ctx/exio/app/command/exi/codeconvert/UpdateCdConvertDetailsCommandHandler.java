...
public class UpdateCdConvertDetailsCommandHandler extends CommandHandler<CdConvertDetailsCommand>
{
    ...
    protected void handle(CommandHandlerContext<CdConvertDetailsCommand> context) {
        ...
        repository.update(CdConvertDetails.createFromJavaType(0L, updateCommand.getCid(), updateCommand.getConvertCd(), updateCommand.getLineNumber(), updateCommand.getOutputItem(), updateCommand.getSystemCd()));
