...
public class ExAcOpManageDto
{
    ...
    */
    ...
    {
        return new ExAcOpManageDto(domain.getCid(), domain.getProcessId(), domain.getErrorCount(), domain.getInterruption(), domain.getProcessCount(), domain.getProcessTotalCount(), domain.getStateBehavior(), domain.getVersion());
    }
