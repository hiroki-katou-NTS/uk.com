...
public class AddExAcOpManageCommandHandler extends CommandHandler<ExAcOpManageCommand>
{
    ...
    protected void handle(CommandHandlerContext<ExAcOpManageCommand> context) {
        ...
        repository.add(ExAcOpManage.createFromJavaType(0L, addCommand.getCid(), addCommand.getProcessId(), addCommand.getErrorCount(), addCommand.getInterruption(), addCommand.getProcessCount(), addCommand.getProcessTotalCount(), addCommand.getStateBehavior()));
