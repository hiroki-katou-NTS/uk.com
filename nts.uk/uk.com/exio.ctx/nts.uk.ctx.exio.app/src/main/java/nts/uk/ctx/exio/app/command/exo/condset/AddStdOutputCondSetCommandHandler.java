...
public class AddStdOutputCondSetCommandHandler extends CommandHandler<StdOutputCondSetCommand>
{
    ...
    protected void handle(CommandHandlerContext<StdOutputCondSetCommand> context) {
        ...
        repository.add(StdOutputCondSet.createFromJavaType(addCommand.getCid(), addCommand.getConditionSetCd(), addCommand.getCategoryId(), addCommand.getDelimiter(), addCommand.getItemOutputName(), addCommand.getAutoExecution(), addCommand.getConditionSetName(), addCommand.getConditionOutputName(), addCommand.getStringFormat()));
