...
public class JpaInsTimeDatFmSetRepository extends JpaRepository implements InsTimeDatFmSetRepository {
	...
	private static final String SELECT_BY_KEY_STRING = SELECT_ALL_QUERY_STRING
			+ " WHERE  f.insTimeDatFmSetPk.cid =:cid AND  f.insTimeDatFmSetPk.conditionSetCd =:conditionSetCd AND  f.insTimeDatFmSetPk.acceptItemNum =:acceptItemNum ";
	...
	public Optional<InsTimeDatFmSet> getInsTimeDatFmSetById(String cid, String conditionSetCd, int acceptItemNum) {
		return this.queryProxy().query(SELECT_BY_KEY_STRING, OiomtInsTimeDatFmSet.class).setParameter("cid", cid)
				.setParameter("conditionSetCd", conditionSetCd).setParameter("acceptItemNum", acceptItemNum)
	...
	public void update(InsTimeDatFmSet domain) {
		...
		OiomtInsTimeDatFmSet updateInsTimeDatFmSet = this.queryProxy()
				.find(newInsTimeDatFmSet.insTimeDatFmSetPk, OiomtInsTimeDatFmSet.class).get();
	...
	public void remove(String cid, String conditionSetCd, int acceptItemNum) {
		this.commandProxy().remove(OiomtInsTimeDatFmSet.class,
				new OiomtInsTimeDatFmSetPk(cid, conditionSetCd, acceptItemNum));
	}

	private static InsTimeDatFmSet toDomain(OiomtInsTimeDatFmSet entity) {
		return new InsTimeDatFmSet(entity.insTimeDatFmSetPk.cid, entity.insTimeDatFmSetPk.conditionSetCd,
				entity.insTimeDatFmSetPk.acceptItemNum, entity.delimiterSet, entity.fixedValue, entity.hourMinSelect,
				entity.effectiveDigitLength, entity.roundProc, entity.decimalSelect, entity.valueOfFixedValue,
				entity.startDigit, entity.endDigit, entity.roundProcCls);
	}

	private OiomtInsTimeDatFmSet toEntity(InsTimeDatFmSet domain) {
		return new OiomtInsTimeDatFmSet(domain.getVersion(),
				new OiomtInsTimeDatFmSetPk(domain.getCid(), domain.getConditionSetCd(), domain.getAcceptItemNum()),
				...
				domain.getEndDigit().get().v(), domain.getRoundProcCls().get().value);
	}
