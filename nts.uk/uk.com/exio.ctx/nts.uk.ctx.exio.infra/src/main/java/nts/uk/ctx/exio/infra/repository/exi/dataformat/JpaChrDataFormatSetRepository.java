...
public class JpaChrDataFormatSetRepository extends JpaRepository implements ChrDataFormatSetRepository {
	...
	private static final String SELECT_BY_KEY_STRING = SELECT_ALL_QUERY_STRING
			+ " WHERE  f.chrDataFormatSetPk.cid =:cid AND  f.chrDataFormatSetPk.conditionSetCd =:conditionSetCd AND  f.chrDataFormatSetPk.acceptItemNum =:acceptItemNum ";
	...
	public Optional<ChrDataFormatSet> getChrDataFormatSetById(String cid, String conditionSetCd, int acceptItemNum) {
		return this.queryProxy().query(SELECT_BY_KEY_STRING, OiomtChrDataFormatSet.class).setParameter("cid", cid)
	...
	public void update(ChrDataFormatSet domain) {
		...
		OiomtChrDataFormatSet updateChrDataFormatSet = this.queryProxy()
				.find(newChrDataFormatSet.chrDataFormatSetPk, OiomtChrDataFormatSet.class).get();
	...
	public void remove(String cid, String conditionSetCd, int acceptItemNum) {
		this.commandProxy().remove(OiomtChrDataFormatSet.class,
				new OiomtChrDataFormatSetPk(cid, conditionSetCd, acceptItemNum));
	}

	private static ChrDataFormatSet toDomain(OiomtChrDataFormatSet entity) {
		return new ChrDataFormatSet(entity.chrDataFormatSetPk.cid, entity.chrDataFormatSetPk.conditionSetCd,
				entity.chrDataFormatSetPk.acceptItemNum, entity.cdEditing, entity.fixedValue,
				entity.effectiveDigitLength, entity.cdConvertCd, entity.cdEditMethod, entity.cdEditDigit,
				entity.fixedVal, entity.startDigit, entity.endDigit);
	}

	private OiomtChrDataFormatSet toEntity(ChrDataFormatSet domain) {
		return new OiomtChrDataFormatSet(domain.getVersion(),
				new OiomtChrDataFormatSetPk(domain.getCid(), domain.getConditionSetCd(), domain.getAcceptItemNum()),
