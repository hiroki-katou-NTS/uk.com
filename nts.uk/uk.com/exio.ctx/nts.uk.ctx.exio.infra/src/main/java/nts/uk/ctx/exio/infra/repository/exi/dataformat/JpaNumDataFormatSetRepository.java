...
public class JpaNumDataFormatSetRepository extends JpaRepository implements NumDataFormatSetRepository {
	...
	private static final String SELECT_BY_KEY_STRING = SELECT_ALL_QUERY_STRING
			+ " WHERE  f.numDataFormatSetPk.cid =:cid AND  f.numDataFormatSetPk.conditionSetCd =:conditionSetCd AND  f.numDataFormatSetPk.acceptItemNum =:acceptItemNum ";
	...
	public Optional<NumDataFormatSet> getNumDataFormatSetById(String cid, String conditionSetCd, int acceptItemNum) {
		return this.queryProxy().query(SELECT_BY_KEY_STRING, OiomtNumDataFormatSet.class).setParameter("cid", cid)
	...
	public void update(NumDataFormatSet domain) {
		...
		OiomtNumDataFormatSet updateNumDataFormatSet = this.queryProxy()
				.find(newNumDataFormatSet.numDataFormatSetPk, OiomtNumDataFormatSet.class).get();
	...
	public void remove(String cid, String conditionSetCd, int acceptItemNum) {
		this.commandProxy().remove(OiomtNumDataFormatSet.class,
				new OiomtNumDataFormatSetPk(cid, conditionSetCd, acceptItemNum));
	}

	private static NumDataFormatSet toDomain(OiomtNumDataFormatSet entity) {
		return new NumDataFormatSet(entity.numDataFormatSetPk.cid, entity.numDataFormatSetPk.conditionSetCd,
				entity.numDataFormatSetPk.acceptItemNum, entity.fixedValue, entity.decimalDivision,
				entity.effectiveDigitLength, entity.cdConvertCd, entity.valueOfFixedValue, entity.decimalDigitNum,
				entity.startDigit, entity.endDigit, entity.decimalPointCls, entity.decimalFraction);
	}

	private OiomtNumDataFormatSet toEntity(NumDataFormatSet domain) {
		return new OiomtNumDataFormatSet(domain.getVersion(),
				new OiomtNumDataFormatSetPk(domain.getCid(), domain.getConditionSetCd(), domain.getAcceptItemNum()),
