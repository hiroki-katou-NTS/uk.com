...
import nts.uk.ctx.exio.dom.input.validation.condition.user.type.time.ImportingConditionTimeMoment;
...
public class InsTimeDatFmSet extends DataFormatSetting {
	 ...
	 * 固定値の値
	 */
	private Optional<ImportingConditionTimeMoment> valueOfFixedValue;
	...
	public InsTimeDatFmSet(int itemType, int delimiterSet, int fixedValue, int hourMinSelect, int effectiveDigitLength,
		...
		this.valueOfFixedValue = Optional.ofNullable(valueOfFixedValue == null ? null : new ImportingConditionTimeMoment(valueOfFixedValue));
