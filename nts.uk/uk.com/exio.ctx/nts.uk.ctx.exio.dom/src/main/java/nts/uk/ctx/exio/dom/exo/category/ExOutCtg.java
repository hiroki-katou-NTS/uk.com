...
public class ExOutCtg extends DescriptionOfAvailabilityPermissionBase {
	...
	public ExOutCtg(int categoryId, int officeHelperSysAtr, String categoryName, int categorySet, int personSysAtr,
			int attendanceSysAtr, int payrollSysAtr, int functionNo, String functionName, String explanation,
			int displayOrder, boolean defaultValue) {
