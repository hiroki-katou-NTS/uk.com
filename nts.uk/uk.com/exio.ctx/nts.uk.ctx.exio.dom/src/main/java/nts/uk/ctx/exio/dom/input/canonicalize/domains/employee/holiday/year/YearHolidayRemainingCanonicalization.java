 ...
 * 年休付与残数データ 
 */
public class YearHolidayRemainingCanonicalization extends IndependentCanonicalization{
	...
	public YearHolidayRemainingCanonicalization(DomainWorkspace workspace) {
		super(workspace);
