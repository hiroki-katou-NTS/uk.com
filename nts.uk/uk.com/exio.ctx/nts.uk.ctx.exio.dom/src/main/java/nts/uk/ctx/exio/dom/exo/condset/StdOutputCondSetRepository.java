...
public interface StdOutputCondSetRepository
{
    ...
    List<StdOutputCondSet> getOutputCondSetByCidAndconditionSetCd(String Cid, String conditionSetCd);
    

    List<StdOutputCondSet> getStdOutputCondSetByCid(String cid);
