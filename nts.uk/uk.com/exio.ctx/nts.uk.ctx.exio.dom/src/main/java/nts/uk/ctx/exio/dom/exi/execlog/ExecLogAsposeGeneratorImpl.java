...
@Stateless
public class ExecLogAsposeGeneratorImpl extends AsposeCellsReportGenerator implements ExecLogAsposeGenerator {
...
//			horizontalBreaks.add(lastCell);
			...
			//workbook.save(this.createNewFile(context, "test.csv"), null);
			ctx.saveAsCSV(this.createNewFile(context, "test.csv"));
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
	...
	@Override
	public void generateFile(FileGeneratorContext context, ExacErrorExportFile exportFile) {
