...
import nts.uk.nrl.exceptions.FrameParsingException;
import nts.uk.nrl.exceptions.InvalidFrameException;
...
public class Frame implements MeanCarryable {
	...
	/* (non-Javadoc)
	 * @see nts.uk.nrl.response.MeanCarryable#putItem(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.nrl.response.MeanCarryable#pickItem(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.nrl.response.MeanCarryable#getBytes(java.util.List)
	 */
	@Override
