package nts.uk.ctx.pereg.ac.info.setting.event.no16;
...
public class NursingLeaveSettingEventSubcriber implements DomainEventSubscriber<NursingLeaveSettingDomainEvent>{
	...
	private static final List<String> itemCdLst = Arrays.asList(new String[] { "IS00380", "IS00381","IS00382","IS00383","IS00384","IS01102" });


	@Override
	public Class<NursingLeaveSettingDomainEvent> subscribedToEventType() {
		return NursingLeaveSettingDomainEvent.class;
	}

	@Override
	public void handle(NursingLeaveSettingDomainEvent domainEvent) {
