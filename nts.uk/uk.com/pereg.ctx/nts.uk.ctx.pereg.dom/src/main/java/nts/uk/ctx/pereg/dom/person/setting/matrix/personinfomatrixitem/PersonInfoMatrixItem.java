...
public class PersonInfoMatrixItem {
		...
		private RegulationATR regulationATR;
			...
			public static PersonInfoMatrixItem createFromJavatype (String pInfoCategoryID , String pInfoItemDefiID , int columnWidth , int regulationATR){
				if (columnWidth >= 20 && columnWidth <= 9999){
					return new PersonInfoMatrixItem(
							pInfoCategoryID, 
							pInfoItemDefiID, 
							columnWidth, 
