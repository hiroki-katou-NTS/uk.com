...
public class MatrixDisplaySetting {
	...
	private NotUseAtr employmentATR;
			...
			public static MatrixDisplaySetting createFromJavaType ( String companyID , String userID , int cursorDirection , int clsATR , int positionATR , int workPlaceATR , int departmentATR , int employmentATR ){
				return new MatrixDisplaySetting(
						companyID,
						userID,
						EnumAdaptor.valueOf(cursorDirection, CursorDirection.class),
						EnumAdaptor.valueOf(clsATR , NotUseAtr.class),
						EnumAdaptor.valueOf(positionATR , NotUseAtr.class),
						EnumAdaptor.valueOf(workPlaceATR , NotUseAtr.class),
						EnumAdaptor.valueOf(departmentATR , NotUseAtr.class),
