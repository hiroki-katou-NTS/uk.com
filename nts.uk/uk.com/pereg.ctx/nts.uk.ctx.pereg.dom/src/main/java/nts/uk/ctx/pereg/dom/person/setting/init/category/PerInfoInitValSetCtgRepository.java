...
public interface PerInfoInitValSetCtgRepository {
	 ...
	 * @return List<PerInfoInitValueSettingCtg>
	 */
	List<PerInfoInitValueSettingCtg> getAllCategory(String companyId, String settingId, int salaryUseAtr, int personnelUseAtr, int employmentUseAtr, String contractCode);
