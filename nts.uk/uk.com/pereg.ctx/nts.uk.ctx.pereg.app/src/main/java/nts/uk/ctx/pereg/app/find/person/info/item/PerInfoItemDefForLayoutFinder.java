...
public class PerInfoItemDefForLayoutFinder {
	...
	public List<PerInfoItemDefForLayoutDto> getChildrenItems(List<PersonInfoItemDefinition> fullItemDefinitionList, PersonInfoCategory category,
	...
	private List<PersonInfoItemDefinition> getChildItems(List<PersonInfoItemDefinition> fullItemDefinitionList, String itemCode) {
	...
	public PerInfoItemDefForLayoutDto createItemLayoutDto(PersonInfoCategory category,
		...
		System.out.println("convet to layout Item " + itemDefinition.getItemName().v() + " "  + (System.currentTimeMillis() - start));
	...
	public List<ComboBoxObject> getLstComboBoxValue(SelectionItemDto selectionItemDto, String empId,
			GeneralDate baseDate, boolean isRequired, PersonEmployeeType perEmplType, boolean isDataType6, String categoryCode) {
		...
		return comboBoxRetrieveFactory.getComboBox(selectionItemDto, empId, standardDate, isRequired, perEmplType, isDataType6, categoryCode);
	}
}
