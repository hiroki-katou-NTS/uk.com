...
public class EmpCtgFinder {
	...
	public List<PerInfoCtgFullDto> getAllPerInfoCtgByCps003(String selectedEmployeeIdId) {
		...
		// get list Category
		List<PersonInfoCategory> listCategory = perInfoCategoryRepositoty.getAllCtgWithAuthCPS003(loginCompanyId,
				roleIdOfLogin, !curEmCompanyId.equals(loginCompanyId), forAttendance, forPayroll, forPersonnel);
