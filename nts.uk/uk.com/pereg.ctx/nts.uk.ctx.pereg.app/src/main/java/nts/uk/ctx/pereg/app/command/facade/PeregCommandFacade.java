...
public class PeregCommandFacade {
	...
	private String addNonTransaction(PeregInputContainer container) {
		...
		String CS00020HID = "", personId = container.getPersonId(), employeeId = container.getEmployeeId();

		for (val itemsByCategory : addInputs.stream()
				.sorted((o1, o2) -> o1.getCategoryCd().compareToIgnoreCase(o2.getCategoryCd()))
				.collect(Collectors.toList())) {
			if (!itemsByCategory.getCategoryCd().equals("CS00070")) {
				...
				if (itemsByCategory.getCategoryCd().equals("CS00020")) {
					CS00020HID = recordId;
				}
			} else {
				itemsByCategory.setRecordId(CS00020HID);
			}
		}
