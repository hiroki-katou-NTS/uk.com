...
public class PeregCommandFacade {
	...
	public void add(PeregInputContainer container) {
		...
		addPeregInputContainer.getInputs().forEach(itemsByCategory -> {
			...
			ItemsByCategory sameCategoryItem = container.getInputs().stream().filter(c -> c.getCategoryCd().equals(itemsByCategory) && StringUtils.isNotEmpty(c.getRecordId())).findFirst().orElse(null);
