...
public class FacadeUtils {
	...
	public List<ItemValue> getListDefaultCS00020(List<ItemBasicInfo> listItemIfo){
		...
		String[][] cs00020Item = { { "IS00253", numberType, "0" , ItemValue.formatMinutesToTime(0)},
	...
	public List<ItemValue> getListDefaultCS00025(List<ItemBasicInfo> listItemIfo){
		String[][] cs00025Item = {
				{ "IS00296", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00026(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00026Item = {
				{ "IS00303", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00027(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00027Item = {
				{ "IS00310", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00028(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00028Item = {
				{ "IS00317", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00029(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00029Item = {
				{ "IS00324", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00030(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00030Item = {
				{ "IS00331", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00031(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00031Item = {
				{ "IS00338", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00032(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00032Item = {
				{ "IS00345", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない"  } };
	...
	public List<ItemValue> getListDefaultCS00033(List<ItemBasicInfo> listItemIfo) {
		String[][] cs00033Item = {
				{ "IS00352", String.valueOf(ItemValueType.NUMERIC.value), String.valueOf(UseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00034(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00034Item = { { "IS00359", numberType,String.valueOf(NotUseAtr.NOT_USE.value), "管理しない" } };
	...
	public List<ItemValue> getListDefaultCS00037(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00037Item = { { "IS00387", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00038(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00038Item = { { "IS00400", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00039(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00039Item = { { "IS00411", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00040(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00040Item = { { "IS00426", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00041(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00041Item = { { "IS00441", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00042(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00042Item = { { "IS00456", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00043(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00043Item = { { "IS00471", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00044(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00044Item = { { "IS00486", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00045(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00045Item = { { "IS00501", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00046(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00046Item = { { "IS00516", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value),"使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00047(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00047Item = { { "IS00531", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00048(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00048Item = { { "IS00546", numberType, String.valueOf(LeaveExpirationStatus.AVAILABLE.value), "使用可能" }};
	...
	public List<ItemValue> getListDefaultCS00049(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00049Item = { { "IS00560", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00050(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00050Item = { { "IS00567", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00051(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00051Item = { { "IS00574", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00052(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00052Item = { { "IS00581", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00053(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00053Item = { { "IS00588", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない"}};
	...
	public List<ItemValue> getListDefaultCS00054(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00054Item = { { "IS00595", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00055(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00055Item = { { "IS00602", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00056(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00056Item = { { "IS00609", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00057(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00057Item = { { "IS00616", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
	...
	public List<ItemValue> getListDefaultCS00058(List<ItemBasicInfo> listItemIfo) {
		String numberType = String.valueOf(ItemValueType.NUMERIC.value);
		String[][] cs00058Item = { { "IS00623", numberType, String.valueOf(UseAtr.NOT_USE.value), "管理しない" }};
