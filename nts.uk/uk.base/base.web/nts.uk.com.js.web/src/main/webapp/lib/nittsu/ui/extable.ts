    ...
    module intan {
        ...
        export class Cloud {
            ...
            detCellsIn() {
                ...
                if (!det) return;
                self.eachKey(det, obj => obj.columnKey, $cell => helper.markCellWith(style.DET_CLS, $cell));
            }
            ...
            madeUpCellsIn() {
                ...
                self.eachKey(dCellsStyle, obj => obj.columnKey, ($cell, obj) => {
             ...
             * Each key.
             */
            eachKey(obj: any, key: any, cb: any) {
                let self = this;
