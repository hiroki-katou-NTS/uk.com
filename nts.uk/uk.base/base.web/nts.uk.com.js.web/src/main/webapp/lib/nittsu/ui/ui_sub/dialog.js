    ...
    (function (uk) {
        ...
        (function (ui_1) {
            ...
            (function (dialog_1) {
                ...
                dialog_1.getMaxZIndex = getMaxZIndex;
                ...
                dialog_1.caution = caution;
                function error(message) {
                    return simpleDialog(message, { title: ui_1.toBeResource.error });
                }
                dialog_1.error = error;
                function alertError(message) {
                    return error(message);
                }
                dialog_1.alertError = alertError;
                function alert(message) {
                    return error(message);
                }
                dialog_1.alert = alert;
                ;
                ...
                dialog_1.confirm = confirm;
                ;
                function confirmDanger(message) {
                    return confirm(message);
                }
                dialog_1.confirmDanger = confirmDanger;
                function confirmProceed(message) {
                    return confirm(message, { buttonStyles: { yes: "proceed" } });
                }
                dialog_1.confirmProceed = confirmProceed;
                ...
                dialog_1.bundledErrors = bundledErrors;
                ;
