...
public class JpaEarthquakeInsuranceRepository extends JpaRepository implements EarthquakeInsuranceRepository {
    ...
    private static final String SELECT_ALL_QUERY_CID = SELECT_ALL_QUERY_STRING + " WHERE  f.earthQuakeInsuPk.cid =:cid ";
    ...
    @Override
    public List<EarthquakeInsurance> getEarthquakeInsuranceByCid(String cid) {
        return this.queryProxy().query(SELECT_ALL_QUERY_CID, QetmtEarthQuakeInsu.class).setParameter("cid", cid)
                .getList(item -> item.toDomain());
    }
