...
import nts.uk.ctx.pr.shared.infra.entity.payrollgeneralpurposeparameters.QpbmtSalGenParaYmHis;
import nts.uk.ctx.pr.shared.infra.entity.payrollgeneralpurposeparameters.QpbmtSalGenParaYmHisPk;
...
public class JpaSalGenParaYMHistRepository extends JpaRepository implements SalGenParaYMHistRepository
{
    ...
    @Override
    public List<SalGenParaYearMonthHistory> getAllSalGenParaYMHist(){
         this.queryProxy().query(SELECT_ALL_QUERY_STRING, QpbmtSalGenParaYmHis.class)
                .getList();
         return new ArrayList<SalGenParaYearMonthHistory>();
    }
