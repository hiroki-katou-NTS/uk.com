...
@Stateless
@Transactional
public class UpdateMultiEmpWorkInfoCommandHandler extends CommandHandler<MultiEmpWorkInfoCommand>
{
    ...
    protected void handle(CommandHandlerContext<MultiEmpWorkInfoCommand> context) {
        ...
        repository.update(new MultiEmpWorkInfo(command.getEmpId(), command.getIsMoreEmp()));
