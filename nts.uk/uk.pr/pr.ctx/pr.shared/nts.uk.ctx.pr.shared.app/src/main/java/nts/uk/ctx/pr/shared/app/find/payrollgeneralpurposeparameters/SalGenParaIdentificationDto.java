...
public class SalGenParaIdentificationDto
{
    ...
    */
    ...
    {
        return new SalGenParaIdentificationDto(domain.getParaNo().v(), domain.getCID(), domain.getName().v(), domain.getAttributeType().value, domain.getHistoryAtr().value, domain.getExplanation().orElse(null));
    }
