...
@Stateless
@Transactional
public class UpdateEmpHealthInsurUnionCommandHandler extends CommandHandler<EmpHealthInsurUnionCommand>
{
    ...
    protected void handle(CommandHandlerContext<EmpHealthInsurUnionCommand> context) {
        ...
        repository.update(new EmpHealthInsurUnion(command.getEmployeeId(), command.getHealthInsurInherentProject()));
