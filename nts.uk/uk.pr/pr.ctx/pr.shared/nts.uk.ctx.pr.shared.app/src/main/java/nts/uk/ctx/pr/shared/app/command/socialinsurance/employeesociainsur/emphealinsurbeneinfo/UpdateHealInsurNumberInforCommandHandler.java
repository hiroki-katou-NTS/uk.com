...
@Stateless
@Transactional
public class UpdateHealInsurNumberInforCommandHandler extends CommandHandler<HealInsurNumberInforCommand>
{
    ...
    protected void handle(CommandHandlerContext<HealInsurNumberInforCommand> context) {
        ...
        repository.update(new HealInsurNumberInfor(command.getHistoryId(), command.getCareInsurNumber(), command.getHealInsNumber()));
