...
public class QcamtItemNotePK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemNotePK)) {
            return false;
        }
        QcamtItemNotePK other = (QcamtItemNotePK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemNotePK[ ccd=" + ccd + ", ctgAtr=" + ctgAtr + ", itemCd=" + itemCd + " ]";
    }
