...
@NoArgsConstructor
@Embeddable
public class QcamtItemPeriodPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemPeriodPK)) {
            return false;
        }
        QcamtItemPeriodPK other = (QcamtItemPeriodPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemPeriodPK[ ccd=" + ccd + ", ctgAtr=" + ctgAtr + ", itemCd=" + itemCd + " ]";
    }
