...
public class QcamtOtherItemPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtOtherItemPK)) {
            return false;
        }
        QcamtOtherItemPK other = (QcamtOtherItemPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtOtherItemPK[ ccd=" + ccd + ", ctgAtr=" + ctgAtr + ", itemCd=" + itemCd + " ]";
    }
