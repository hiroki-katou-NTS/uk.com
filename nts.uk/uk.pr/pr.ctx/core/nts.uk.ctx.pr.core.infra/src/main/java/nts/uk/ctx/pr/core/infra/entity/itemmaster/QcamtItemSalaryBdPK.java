...
@NoArgsConstructor
@Embeddable
public class QcamtItemSalaryBdPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemSalaryBdPK)) {
            return false;
        }
        QcamtItemSalaryBdPK other = (QcamtItemSalaryBdPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemSalaryBdPK[ ccd=" + ccd + ", itemCd=" + itemCd + ", itemBreakdownCd=" + itemBreakdownCd + " ]";
    }
