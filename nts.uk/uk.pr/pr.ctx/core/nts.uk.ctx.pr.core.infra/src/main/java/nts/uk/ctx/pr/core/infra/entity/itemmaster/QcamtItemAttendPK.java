...
@NoArgsConstructor
@Embeddable
public class QcamtItemAttendPK {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemAttendPK)) {
            return false;
        }
        QcamtItemAttendPK other = (QcamtItemAttendPK) object;
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemAttendPK[ ccd=" + ccd + ", itemCd=" + itemCd + " ]";
    }
