...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "QCAMT_ITEM_BREAKDOWN")
@Entity
public class QcamtItemBreakdown extends UkJpaEntity implements Serializable {

    public static final long serialVersionUID = 1L;
    @EmbeddedId
    public QcamtItemBreakdownPK qcamtItemBreakdownPK;
    ...
    public int hashCode() {
        int hash = 0;
        hash += (qcamtItemBreakdownPK != null ? qcamtItemBreakdownPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemBreakdown)) {
            return false;
        }
        QcamtItemBreakdown other = (QcamtItemBreakdown) object;
        if ((this.qcamtItemBreakdownPK == null && other.qcamtItemBreakdownPK != null) || (this.qcamtItemBreakdownPK != null && !this.qcamtItemBreakdownPK.equals(other.qcamtItemBreakdownPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemBreakdown[ qcamtItemBreakdownPK=" + qcamtItemBreakdownPK + " ]";
    }
    
    @Override
    protected QcamtItemBreakdownPK getKey() {
    	return this.qcamtItemBreakdownPK;
    }
