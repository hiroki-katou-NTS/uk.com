...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "QCAMT_ITEM_DEDUCT_PERIOD")
@Entity
public class QcamtItemDeductPeriod extends UkJpaEntity implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    public QcamtItemDeductPeriodPK qcamtItemDeductPeriodPK;
    ...
    public int hashCode() {
        int hash = 0;
        hash += (qcamtItemDeductPeriodPK != null ? qcamtItemDeductPeriodPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QcamtItemDeductPeriod)) {
            return false;
        }
        QcamtItemDeductPeriod other = (QcamtItemDeductPeriod) object;
        if ((this.qcamtItemDeductPeriodPK == null && other.qcamtItemDeductPeriodPK != null) || (this.qcamtItemDeductPeriodPK != null && !this.qcamtItemDeductPeriodPK.equals(other.qcamtItemDeductPeriodPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "entity.itemmaster.QcamtItemDeductPeriod[ qcamtItemDeductPeriodPK=" + qcamtItemDeductPeriodPK + " ]";
    }
    
    @Override
    protected Object getKey() {
    	return this.qcamtItemDeductPeriodPK;
    }
}
