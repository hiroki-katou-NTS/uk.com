...
public class ItemSalaryPeriod extends AggregateRoot {
	...
	public static ItemSalaryPeriod createFromJavaType(String itemCode, int periodAtr, int strY, int endY, int cycleAtr,
		...
		return new ItemSalaryPeriod(new ItemCode(itemCode), EnumAdaptor.valueOf(periodAtr, PeriodAtr.class),
