...
public class UnitPriceNameWebService extends WebService {
	...
	public SalaryPerUnitPriceDataDto getStatementItemData(@PathParam("cid") String cid,
	...
	public List<SalaryPerUnitPriceNameDto> getAllUnitPriceName(
			@PathParam("isdisplayAbolition") boolean isdisplayAbolition) {
