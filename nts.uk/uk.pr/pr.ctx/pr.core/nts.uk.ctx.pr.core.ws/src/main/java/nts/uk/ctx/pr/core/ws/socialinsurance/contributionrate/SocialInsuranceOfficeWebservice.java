package nts.uk.ctx.pr.core.ws.socialinsurance.contributionrate;
...
import nts.uk.ctx.pr.core.app.find.socialinsurance.contributionrate.ContributionRateFinder;
