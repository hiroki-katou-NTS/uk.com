...
@Stateless
@Transactional
public class DeleteWelfarePensionInsuranceCommandHandler extends CommandHandler<WelfarePensionInsuraceRateCommand> {
	...
	protected void handle(CommandHandlerContext<WelfarePensionInsuraceRateCommand> context) {
		...
		socialInsuranceOfficeAndHistoryService.deleteHistory(officeCode, yearMonthItem);
	}
