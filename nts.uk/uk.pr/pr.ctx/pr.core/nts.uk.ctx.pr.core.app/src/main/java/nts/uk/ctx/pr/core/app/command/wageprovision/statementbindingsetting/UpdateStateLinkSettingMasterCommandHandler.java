...
@Stateless
@Transactional
public class UpdateStateLinkSettingMasterCommandHandler extends CommandHandler<ListStateLinkSettingMasterCommand> {
    ...
    protected void handle(CommandHandlerContext<ListStateLinkSettingMasterCommand> context) {
        ...
        repository.updateAll(stateLinkSettingMaster);
    }
}
