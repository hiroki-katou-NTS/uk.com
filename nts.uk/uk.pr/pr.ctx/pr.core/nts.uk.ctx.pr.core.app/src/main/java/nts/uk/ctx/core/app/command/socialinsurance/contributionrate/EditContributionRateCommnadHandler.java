...
@Stateless
@Transactional
public class EditContributionRateCommnadHandler extends CommandHandler<AddContributionRateHistoryCommand> {
	...
	protected void handle(CommandHandlerContext<AddContributionRateHistoryCommand> context) {
		...
		contributionService.updateHistory(officeCode, yearMonthItem);
	}
