...
public class GetMonPenInsStandRemu {
    ...
    // 等級から厚生年金保険標準報酬月額を取得する cps003 <sid, long>
    public Map<String, Long> getMonthlyPensionInsStandardRemuneration(List<HealthInsStandardMonthlyInformation> params) {
    	...
    	params.stream().forEach(param ->{
            ...
            result.put(param.getSId(), standardMonthlyFee);
    ...
    // 報酬月額から厚生年金保険標準報酬月額と厚生年金保険等級を取得する
    public Map<String, WelfarePensStandGradePerMonthDto> getWelfarePensionStandardGradePerMonth(List<HealthInsStandardMonthlyInformation> params) {

    	 Map<String, WelfarePensStandGradePerMonthDto> results = new HashMap<>(); 
    	...
    	params.stream().forEach(param ->{
            ...
            results.put(param.getSId(), perMonthDto);
