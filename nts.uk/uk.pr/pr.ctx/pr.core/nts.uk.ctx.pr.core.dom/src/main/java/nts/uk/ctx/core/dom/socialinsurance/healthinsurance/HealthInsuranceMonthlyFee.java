...
public class HealthInsuranceMonthlyFee extends AggregateRoot {
        ...
        if (AutoCalculationExecutionCls.AUTO.equals(this.getAutoCalculationCls())) {
            ...
            if (healthInsuranceStandardMonthlyOptional.isPresent()) {
                ...
                standardGradePerMonth.forEach(x -> {
                    ...
                    val insuredHealthInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, individualBurdenRatio.getHealthInsuranceRate().v(), individualFractionCls, ROUND_1_AFTER_DOT);
                    val insuredNursingCare = calculationHealthInsuranceContributionFee(standardMonthlyFee, individualBurdenRatio.getLongCareInsuranceRate().v(), individualFractionCls, ROUND_1_AFTER_DOT);
                    val insuredSpecInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, individualBurdenRatio.getSpecialInsuranceRate().v(), individualFractionCls, ROUND_3_AFTER_DOT);
                    val insuredBasicInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, individualBurdenRatio.getBasicInsuranceRate().v(), individualFractionCls, ROUND_3_AFTER_DOT);
                    ...
                    if (EmployeeShareAmountMethod.SUBTRACT_INSURANCE_PREMIUM.equals(employeeShareAmountMethod)) {
                        employeeHealthInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, bonusHealthInsuranceRateIndividualBurden.getHealthInsuranceRate().v(), individualFractionCls, ROUND_1_AFTER_DOT);
                        employeeNursingCare = calculationHealthInsuranceContributionFee(standardMonthlyFee, bonusHealthInsuranceRateIndividualBurden.getLongCareInsuranceRate().v(), individualFractionCls, ROUND_1_AFTER_DOT);
                        employeeSpecInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, bonusHealthInsuranceRateIndividualBurden.getSpecialInsuranceRate().v(), individualFractionCls, ROUND_3_AFTER_DOT);
                        employeeBasicInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, bonusHealthInsuranceRateIndividualBurden.getBasicInsuranceRate().v(), individualFractionCls, ROUND_3_AFTER_DOT);
                    } else {
                        employeeHealthInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, employeeBurdenRatio.getHealthInsuranceRate().v(), individualFractionCls, ROUND_1_AFTER_DOT);
                        employeeNursingCare = calculationHealthInsuranceContributionFee(standardMonthlyFee, employeeBurdenRatio.getLongCareInsuranceRate().v(), individualFractionCls, ROUND_1_AFTER_DOT);
                        employeeSpecInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, employeeBurdenRatio.getSpecialInsuranceRate().v(), individualFractionCls, ROUND_3_AFTER_DOT);
                        employeeBasicInsurancePremium = calculationHealthInsuranceContributionFee(standardMonthlyFee, employeeBurdenRatio.getBasicInsuranceRate().v(), individualFractionCls, ROUND_3_AFTER_DOT);
                    }
     ...
     * @return Round value
     */
    public static BigDecimal calculationHealthInsuranceContributionFee(long standardMonthlyFee, BigDecimal rate, InsurancePremiumFractionClassification fractionCls, int scale) {
