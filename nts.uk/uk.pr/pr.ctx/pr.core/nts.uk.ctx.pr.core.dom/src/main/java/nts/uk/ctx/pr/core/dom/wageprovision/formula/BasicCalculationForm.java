...
public class BasicCalculationForm extends DomainObject {
    ...
    */
    ...
    public BasicCalculationForm(BasicCalculationStandardAmount basicCalculationStandardAmount, BasicCalculationFactorClassification basicCalculationFactorClassification, int formulaType, int roundingResult, int adjustmentClassification,  Optional<BasicCalculationItemCategory> basicCalculationItemCategory, Integer premiumRate, Integer roundingMethod) {
        ...
        this.roundingMethod = roundingMethod == null || formulaType == FormulaType.CALCULATION_FORMULA_TYPE1.value ? Optional.empty() : Optional.of(EnumAdaptor.valueOf(roundingMethod, RoundingMethod.class));
        this.premiumRate = premiumRate == null || formulaType == FormulaType.CALCULATION_FORMULA_TYPE1.value ? Optional.empty() : Optional.of(new PremiumRate(premiumRate));
