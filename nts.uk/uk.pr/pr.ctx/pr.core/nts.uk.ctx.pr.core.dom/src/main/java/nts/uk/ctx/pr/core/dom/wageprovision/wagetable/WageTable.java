...
public class WageTable extends AggregateRoot {
	...
	public WageTable(String cid, String wageTableCode, String wageTableName, Integer oneMasterNumericClassification,
			Integer oneFixedElement, String oneOptionalAdditionalElement, Integer twoMasterNumericClassification,
			Integer twoFixedElement, String twoOptionalAdditionalElement, Integer threeMasterNumericClassification,
			Integer threeFixedElement, String threeOptionalAdditionalElement, int elementSetting,
