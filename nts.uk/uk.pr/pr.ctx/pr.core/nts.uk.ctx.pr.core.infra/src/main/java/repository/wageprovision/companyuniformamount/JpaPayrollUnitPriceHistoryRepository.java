...
public class JpaPayrollUnitPriceHistoryRepository extends JpaRepository implements PayrollUnitPriceHistoryRepository {
    ...
    private static final String SELECT_BY_KEY_STRING = SELECT_ALL_QUERY_STRING + " WHERE  f.payUnitPriceHisPk.cid =:cid AND  f.payUnitPriceHisPk.hisId =:hisId ";
    ...
    @Override
    public Optional<PayrollUnitPriceHistory> getPayrollUnitPriceHistoryById(String cid, String hisId) {
    ...
    public void remove(String cid, String hisId) {
        this.commandProxy().remove(QpbmtPayUnitPrice.class, new QpbmtPayUnitPricePk(cid, hisId));
    }
}
