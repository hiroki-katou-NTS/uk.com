...
public class JpaPublicEmploymentSecurityOfficeRepository extends JpaRepository implements PublicEmploymentSecurityOfficeRepository {
    ...
    private static final String SELECT_BY_CID_AND_CODES = SELECT_ALL_QUERY_STRING + " WHERE f.qpbmtPubEmpSecOffPk.cid = :cid AND f.qpbmtPubEmpSecOffPk.pubEmpSecOffCode IN :codes";
    ...
    public List<PublicEmploymentSecurityOffice> getByCidAndCodes(String cid, List<String> codes) {
        ...
        CollectionUtil.split(codes, DbConsts.MAX_CONDITIONS_OF_IN_STATEMENT, codeList ->
                result.addAll(this.queryProxy().query(SELECT_BY_CID_AND_CODES, QpbmtPubEmpSecOff.class)
                        .setParameter("cid", cid)
                        .setParameter("codes", codes)
                        .getList(QpbmtPubEmpSecOff::toDomain))
        );
        return result;
    }
}
