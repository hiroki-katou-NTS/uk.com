...
public class QpbmtHealthInsurancePerGradeFee extends UkJpaEntity implements Serializable {
    ...
    public static List<QpbmtHealthInsurancePerGradeFee> toEntity(HealthInsuranceMonthlyFee domain) {
        return domain.getHealthInsurancePerGradeFee().stream().map(x -> new QpbmtHealthInsurancePerGradeFee(new QpbmtHealthInsurancePerGradeFeePk(domain.getHistoryId(), x.getHealthInsuranceGrade()),
