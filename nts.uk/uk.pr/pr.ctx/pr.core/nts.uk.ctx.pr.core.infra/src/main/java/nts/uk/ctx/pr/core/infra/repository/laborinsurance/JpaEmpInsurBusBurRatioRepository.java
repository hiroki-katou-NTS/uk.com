...
public class JpaEmpInsurBusBurRatioRepository extends JpaRepository implements EmpInsurBusBurRatioRepository
{
    ...
    private static final String SELECT_BY_HIS_ID = SELECT_ALL_QUERY_STRING + " WHERE  f.empInsurBusBurRatioPk.hisId =:hisId ORDER BY empInsurBusBurRatioPk.empPreRateId";
