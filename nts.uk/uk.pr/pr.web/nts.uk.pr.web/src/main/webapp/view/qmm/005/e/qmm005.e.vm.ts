        ...
        startPage(): JQueryPromise<any> {
            ...
            service.findReflectSystemReferenceDateInfo(params.processCateNo, params.processingYear).done(function (data) {
                ...
                let tranferModel = {
                    ...
                    E2_19_0: getText(ENUM_MONTH_SELECTION_SEGMENT[advancedSetting.empInsurStanDate.baseMonth - 1]),
                    ...
                    E2_23_1: getText(ENUM_MONTH_SELECTION_SEGMENT[advancedSetting.incomTaxBaseYear.baseMonth - 1]),
