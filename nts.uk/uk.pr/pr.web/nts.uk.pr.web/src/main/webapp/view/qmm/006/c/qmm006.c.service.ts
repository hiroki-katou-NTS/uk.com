module nts.uk.pr.view.qmm006.c.service {
    ...
    let paths = {
        ...
        integration: "ctx/pr/transfer/emppaymentinfo/source-bank-integration/{0}"
    };
    ...
    export function integration(code: string): JQueryPromise<any> {
        return ajax('pr', format(paths.integration, code));
    }
