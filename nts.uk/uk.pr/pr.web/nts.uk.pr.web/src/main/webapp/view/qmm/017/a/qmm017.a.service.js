...
(function (nts) {
    ...
    (function (qmm017) {
        ...
        (function (service) {
            ...
            function getListSimpleCalSetting() {
                var dfd = $.Deferred();
            ...
            service.getListSimpleCalSetting = getListSimpleCalSetting;
        ...
        (function (model) {
            ...
            var SimpleCalSettingDto = (function () {
                function SimpleCalSettingDto() {
                }
                return SimpleCalSettingDto;
            }());
            model.SimpleCalSettingDto = SimpleCalSettingDto;
