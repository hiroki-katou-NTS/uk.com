...
public class GuaByTheInsurExportService extends ExportService<GuaByTheInsurExportQuery> {
    ...
    private List<GuaByTheInsurExportDto> insurQualiNotiProcess(List<String> employeeIds, GeneralDate startDate, GeneralDate endDate, CompanyInfor company) {
        ...
        dataExport.forEach(element -> {
            ...
            //C2_22
            //C2_23
            temp.setDependentNo(element[21] != null ? Integer.valueOf( element[21].toString()) : null);

            //C2_24
            temp.setMonRemunerationAmountInCurrency(element[22] != null ? Integer.valueOf( element[22].toString()) : null);
            //C2_25
            temp.setMonRemunerationAmountOfActualItem(element[23] != null ? Integer.valueOf( element[23].toString()) : null);
            //C2_26
