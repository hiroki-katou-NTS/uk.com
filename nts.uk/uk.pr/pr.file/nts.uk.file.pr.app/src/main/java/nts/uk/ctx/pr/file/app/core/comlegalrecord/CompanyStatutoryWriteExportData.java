...
@NoArgsConstructor
@AllArgsConstructor
public class CompanyStatutoryWriteExportData {
    ...
    public static CompanyStatutoryWriteExportData fromDomain(CompanyStatutoryWrite domain) {
        return new CompanyStatutoryWriteExportData(domain.getCID(), domain.getCode().v(), domain.getName().v(),
