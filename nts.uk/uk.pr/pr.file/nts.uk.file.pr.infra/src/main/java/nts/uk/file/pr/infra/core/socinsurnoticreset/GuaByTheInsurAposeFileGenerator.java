...
import nts.uk.ctx.pr.file.app.core.socialinsurnoticreset.GuaByTheInsurExportGenerator;
...
@Stateless
public class GuaByTheInsurAposeFileGenerator extends AsposeCellsReportGenerator implements GuaByTheInsurExportGenerator {
    ...
    @Override
    public void generate(FileGeneratorContext fileContext, List<CompanyStatutoryWriteExportData> exportData) {
        try(AsposeCellsReportContext reportContext = this.createContext(TEMPLATE_FILE)){
            Workbook wb = reportContext.getWorkbook();
            WorksheetCollection wsc = wb.getWorksheets();
            this.writeFileExcel(wsc,exportData,"");
