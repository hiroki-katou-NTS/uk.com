package nts.uk.pr.file.infra.comparingsalarybonus.result;
...
public class PaymentDetailDto {
	 ...
	 * @param itemPosColumn
	 */
	public PaymentDetailDto(String companyCode, String personId, int processingNo, int payBonusAtr, int processingYm,
			int sparePayAtr, int ctgAtr, BigDecimal itemCode, int val, int correctFlg, int taxAtr, int limitMny,
