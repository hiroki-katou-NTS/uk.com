		...
		<div class="pull-left">
			<table id="kaf005_overtimeAgreement_table">
				...
				<thead>
					<tr>
						<!--A2_9 年月ラベル-->
						<th class="kaf005_overtimeAgreement_header" data-bind="text: $i18n('KAF005_24')"></th>
						<!--A2_10  限度ラベル-->
						<th class="kaf005_overtimeAgreement_header" data-bind="text: $i18n('KAF005_25')"></th>
						<!--A2_11 実績ラベル-->
						<th class="kaf005_overtimeAgreement_header" data-bind="text: $i18n('KAF005_26')"></th>
						<!--A2_12  申請ラベル-->
						<th class="kaf005_overtimeAgreement_header" style="display: none" data-bind="text: $i18n('KAF005_27')"></th>
						<!--A2_13  合計ラベル-->
