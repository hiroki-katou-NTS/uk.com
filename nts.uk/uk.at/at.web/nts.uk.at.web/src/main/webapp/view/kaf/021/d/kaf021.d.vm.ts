...
module nts.uk.at.kaf021.d {
    ...
    class ViewModel extends ko.ViewModel {
        ...
        getHeaderStyles(): Array<any> {
            const vm = this;
            return [
                { key: "approvalChecked", colors: ['#6A6A6A'] },
                { key: "denialChecked", colors: ['#6A6A6A'] },
                { key: "appType", colors: ['#6A6A6A'] },
                { key: "workplaceName", colors: ['#6A6A6A'] },
                { key: "employee", colors: ['#6A6A6A'] },
                { key: "month", colors: ['#6A6A6A'] },
                { key: "year", colors: ['#6A6A6A'] },
                ...
                { key: "currentMax", colors: ['#daa520'] },
                { key: "newMax", colors: ['#daa520'] },
                { key: "reason", colors: ["#6A6A6A"] },
                { key: "comment", colors: ['#daa520'] },
                { key: "applicant", colors: ["#6A6A6A"] },
                { key: "inputDateStr", colors: ["#6A6A6A"] },
                { key: "approver", colors: ["#6A6A6A"] },
                { key: "approverStatusStr", colors: ["#6A6A6A"] },
                { key: "confirmer", colors: ["#6A6A6A"] },
                { key: "confirmStatusStr", colors: ["#6A6A6A"] },
            ]
        }
