module nts.uk.at.view.kdl005.test.viewmodel {
	export class ScreenModel {
		...
		openDialog() {
			...
			if (empIds.length > 1)
				nts.uk.ui.windows.sub.modal("/view/kdl/005/a/index.xhtml",{  width: 1060, height: 730 });
			else
				nts.uk.ui.windows.sub.modal("/view/kdl/005/a/index.xhtml",{  width: 750, height: 730 });
		}
	}
