module nts.uk.at.view.kdl020.a {
	export module service {
		...
		var servicePath: any = {
			...
			findAnnualHoliday: "at/request/dialog/annualholidays/findAnnualHolidays"
		};
		...
		export function findAnnualHoliday(param : any): JQueryPromise<any> {
            return nts.uk.request.ajax( "at", servicePath.findAnnualHoliday, param);
        }
	}
}