module nts.uk.at.view.test.vm {
    ...
    export class ScreenModel {
        ...
        isNursingAndtimeChildNull :KnockoutObservable<boolean> = ko.observable(false);
        ...
        atWork1RangeNull: KnockoutObservable<boolean> = ko.observable(false);
        atWork2RangeNull: KnockoutObservable<boolean> = ko.observable(false);
        offWork1RangeNull: KnockoutObservable<boolean> = ko.observable(false);
        ...
        constructor() {
            ...
            self.selectedWorkplaceId.subscribe((val) => {
                if (val && self.selectedFilter() == 1) {
                    ...
                    let data = _.find(lwps, function(o) { return o.id == val; });
                    if (data) {
            ...
            self.selectedFilter.subscribe((val) => {
                ...
                if (val == 0) {
                    ...
                    self.workplaceName(lwps[0].name)
                } else {
                    $("#workplace-group").show();
                    $("#multi-list-table").hide();
                }
        ...
        openDialog() {
            ...
            let listShortTime = [];
            if(!self.isNursingAndtimeChildNull()){
                if (self.isNursing()) {
            ...
            let workInfoDto: shareModelData.IEmployeeWorkInfoDto = {
                ...
                employeeId: self.listEmpSetShare()[0].id,//ok
            ...
            let paramKsu003: shareModelData.ParamKsu003 = {
                ...
                targetId: self.selectedFilter() == 0 ? self.selectedWorkplaceId() : self.currentIds(),
                workplaceName: self.selectedFilter() == 0 ? self.selectedWorkplaceId() : self.currentNames(),
            };
