module nts.uk.at.view.kmf003.a.service {
    ...
    export function saveAsExcel(languageId: string): JQueryPromise<any> {
        return nts.uk.request.exportFile('/masterlist/report/print', { domainId: "YearHoliday", languageId: languageId, domainType: "KMF003"+__viewContext.program.programName reportType: 0 });
    }
