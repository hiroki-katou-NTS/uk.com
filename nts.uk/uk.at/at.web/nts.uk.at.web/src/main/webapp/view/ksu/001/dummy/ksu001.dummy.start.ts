module nts.uk.at.view.ksu001.dummy {
    let __viewContext: any = window["__viewContext"] || {};

    __viewContext.ready(function() {
        __viewContext.viewModel = {
            viewO: new ksu001.o.viewmodel.ScreenModel(),
            viewQ: new ksu001.test1.viewmodel.ScreenModel(),
            viewA: new ksu001.dummy.viewmodel.ScreenModel()
        };
        nts.uk.ui.block.grayout();
        __viewContext.viewModel.viewA.startKSU001().done(() => {
            __viewContext.bind(__viewContext.viewModel);
            setTimeout(function(){ __viewContext.viewModel.viewA.selectedModeDisplay(3); }, 1000);
