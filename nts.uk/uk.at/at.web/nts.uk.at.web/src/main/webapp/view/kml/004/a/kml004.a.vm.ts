    ...
    export class ScreenModel {
        ...
        constructor() {
            ...
            self.columns = ko.observableArray([
                { headerText: nts.uk.resource.getText('KML004_6'), key: 'specialHolidayCode', width: '100px' },
                { headerText: nts.uk.resource.getText('KML004_7'), key: 'specialHolidayName', width: '200px' }
            ]);
