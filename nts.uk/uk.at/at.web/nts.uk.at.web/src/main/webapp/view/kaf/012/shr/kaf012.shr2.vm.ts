                    ...
                    <table id="kaf012-calc-table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="bg-green" style="width: 160px" data-bind="css: {hidden: (leaveType() != 2 &amp;&amp; leaveType() != 6) &#124;&#124; !displayChiCol()}">
                                ...
                                <th class="bg-green" style="width: 160px" data-bind="css: {hidden: (leaveType() != 5 &amp;&amp; leaveType() != 6) &#124;&#124; !displaySpeCol()}">
