...
module nts.uk.ui.at.kcp015.shared {
    ...
    const COMPONENT_NAME = 'kcp015';

    const GET_SETTING = 'screen/at/kcp015/get';
    ...
    @component({
        ...
        template: `<!-- ko let: {text: nts.uk.resource.getText } -->
             ...
             <div id="A1" class="popup-area popup-panel btn10">
                <div id="button-top">
                    <button id="A3_1" class="small compensation" data-bind="text: text('Com_CompensationHoliday'), click: openKDL005, visible: visibleA31Com "></button>
                    <button id="A3_3" class="small paid"         data-bind="text: text('Com_PaidHoliday'),         click: openKDL020, visible: visibleA33Com "></button>
                    <button id="A3_5" class="small exsess"       data-bind="text: text('Com_ExsessHoliday'),       click: openKDL017, visible: visibleA35Com "></button>
                </div>
                <div id="button-bot">
                    <button id="A3_2" class="small substitute" data-bind="text: text('Com_SubstituteHoliday'), click: openKDL009, visible: visibleA32Com "></button>
                    <button id="A3_4" class="small fundedPaid" data-bind="text: text('Com_FundedPaidHoliday'), click: openKDL029, visible: visibleA34Com "></button>
                    <button id="A3_6" class="small supportsetting" data-bind="text: text('KCP015_2'),          click: openKDL039, visible: visibleA36Com "></button>
                </div>
             </div><!-- /ko -->`
    })
