        ...
        addListError(errorsRequest: Array<string>) {
            ...
            _.forEach(errorsRequest, function(err) {
                ...
                if (errSplits.length == 1) {
                    ...
                    errors.push({ message: nts.uk.resource.getMessage(errSplits[0],nts.uk.resource.getText(errSplits[1]),nts.uk.resource.getText(errSplits[2])), messageId: err, supplements: {} });
                }
            });
