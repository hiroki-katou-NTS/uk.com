...
module nts.uk.at.view.kmt001.a {
    ...
    const PATH = {
        ...
        saveRegistrationWork: 'at/shared/scherec/workmanagement/work/kmt001/update',
    ...
    class ViewModel extends ko.ViewModel {
        ...
        getRegistrationWorkList() {
            ...
            //
            // ]);
            vm.$ajax(PATH.getRegistrationWork).done((data: any) => {
                if (data.length > 0) {
                    vm.registrationWorkList(data);
                    vm.selectedWorkCode(data[0].listCode);
                }
                vm.$blockui("hide");
            });
