            ...
            return [
                {
                    ...
                    template: `<input data-bind="ntsTimeEditor: {name:'#[KMK003_174]',inputFormat: 'time',mode: 'time',enable: true}" />`,
                ...
                },
                {
                    ...
                    template: `<input data-bind="ntsTimeEditor: {name:'#[KMK003_176]',inputFormat: 'time',mode: 'time',enable: true}" />`,
                    cssClassName: 'column-time-editor',
