        ...
        (function (viewmodel) {
            var ScreenModel = (function () {
                function ScreenModel() {
                    ...
                    self.selectedBudgetCode.subscribe(function (newCode) {
                ...
                ScreenModel.prototype.start = function () {
                    ...
                    var dfd = $.Deferred();
                    // Get list budget   
                    a.service.getListExternalBudget().done(function (lstBudget) {
                ...
                ScreenModel.prototype.register = function () {
                    ...
                    if (self.isNew()) {
                        ...
                        var currentCode = self.currentItem().externalBudgetCode();
                        self.currentItem().externalBudgetCode(self.padZero(currentCode));
                        //insert process
                        a.service.insertExternalBudget(self.currentItem()).done(function () {
                        ...
                        a.service.updateExternalBudget(self.currentItem()).done(function () {
                            nts.uk.ui.dialog.alert(nts.uk.resource.getMessage('Msg_15'));
                            //update list source
                            var updateItem = _.find(self.listBudget(), ['externalBudgetCode', self.selectedBudgetCode()]);
                ...
                ScreenModel.prototype.del = function () {
                    ...
                    nts.uk.ui.dialog.confirm(nts.uk.resource.getMessage('Msg_18')).ifYes(function () {
                        //削除後処理 
                        a.service.deleteExternalBudget(self.currentItem()).done(function () {
                ...
                ScreenModel.prototype.findBudgetByCode = function (externalBudgetCode) {
                    var self = this;
                ...
                ScreenModel.prototype.findItemByIndex = function (index) {
                    var self = this;
                ...
                ScreenModel.prototype.padZero = function (code) {
                    var format = "000";
            ...
            var BudgetItem = (function () {
                function BudgetItem(externalBudgetCode, externalBudgetName, budgetAtr, unitAtr) {
                    var self = this;
...
//# sourceMappingURL=kdl024.a.vm.js.map