			...
			<div id="contents-area"
				...
				<div class="two-panel" style="height: 100%; width: 1260px">
					<div class="left-panel"
						style="width: calc(1260px - 410px); height: inherit; padding-bottom: 5px;">
					...
					<div class="right-panel" style="width: 410px; padding-bottom: 5px; height: inherit; padding-right: 0px">
