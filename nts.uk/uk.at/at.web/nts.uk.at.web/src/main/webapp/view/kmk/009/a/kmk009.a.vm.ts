    ...
    export class ScreenModel {
        ...
        constructor() {
            ...
            self.columns = ko.observableArray([
                { headerText: nts.uk.resource.getText('KMK009_4'), key: 'divTimeId', width: 50 },
                { headerText: nts.uk.resource.getText('KMK009_5'), key: 'divTimeId', width: 80 },
                { headerText: nts.uk.resource.getText('KMK009_6'), key: 'divTimeName',formatter: _.escape, width: 150 },
                { headerText: nts.uk.resource.getText('KMK009_14'), key: 'divTimeName',formatter: _.escape, width: 100 }
            ]);
