module nts.uk.at.view.kdl0005.test.viewmodel {
	export class ScreenModel {
		...
		constructor(data: any) {
			...
			_.forEach(data, (a: any, ind) => {
				self.employeeList.push({ id: a, code: "00000000000" + ind, name: a, workplaceName: 'HN' })
			});
		...
		openDialog() {
			...
			nts.uk.ui.windows.sub.modal("/view/kdl/0005/a/index.xhtml");
		}
	}
