module nts.uk.at.view.kaf010.a.viewmodel {
    ...
    class KAF010BViewModel extends ko.ViewModel {
		...
		bindWorkInfo(res: AppHdWorkDispInfo, isSelectWork?: boolean) { // dummy data 
			const self = this;
		...
		bindHolidayTime(res: AppHdWorkDispInfo, mode?: number) {
			...
			if (mode == 0) {
				...
				console.log(self.appHolidayWork.applicationTime.applicationTime, "holidayTime");
