        ...
        initIGrid() {
            ...
            $("#list").igGrid({
                ...
                columns: [
                    ...
                    { headerText: getText('KFP001_56'), key: 'executorCode', dataType: 'string', width: '150px' },
                    { headerText: getText('KFP001_57'), key: 'executorName', dataType: 'string', width: '140px' },
                    { headerText: getText('KFP001_58'), key: 'aggregationPeriod', dataType: 'string', width: '200px' },
