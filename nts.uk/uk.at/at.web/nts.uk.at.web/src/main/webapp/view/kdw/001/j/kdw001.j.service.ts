module nts.uk.at.view.kdw001.j {
    export module service {
        let servicePath = {
            ...
            getCaseSpecExeContentById: 'at/record/case/getCaseSpecExeContentById/{0}'
        };
        ...
        export function getAllCaseSpecExeContent() {
         ...
         export function getCaseSpecExeContentById(caseSpecExeContentID): JQueryPromise<any>  {
            return nts.uk.request.ajax(nts.uk.text.format(servicePath.getAllCaseSpecExeContent ,caseSpecExeContentID));
        };
