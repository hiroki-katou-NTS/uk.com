module kdl002.b.viewmodel {
    export class ScreenModel {
        ...
        Code: KnockoutObservableArray<string>;
        constructor() {
            var self = this;
            self.isMulti = true;
            self.Code = ko.observableArray(null);
...
//            nts.uk.ui.windows.setShared('KDL002_SelectedItemId',['001','003','008'],true);
            nts.uk.ui.windows.setShared('KDL002_SelectedItemId',lst,true);
