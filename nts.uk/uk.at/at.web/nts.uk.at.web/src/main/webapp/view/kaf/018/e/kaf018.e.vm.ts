		...
		createIggrid() {
			...
			$("#eGrid").igGrid({
				...
				columns: [
					...
					{ headerText: vm.$i18n('KAF018_386'), key: 'content', width: 610, formatter: vm.createLimitedInfo },
					...
					{ headerText: vm.$i18n('KAF018_388'), key: 'approvalStatus', width: 75, formatter: vm.createApprovalStatus },
