...
public class JpaOvertimeHoursRepository extends JpaRepository implements OvertimeHoursRepository {
	...
	private static final String SELECT_BY_LIST_EMPTCODE_DATEPERIOD = "SELECT ehi.sid FROM BsymtEmploymentHistItem ehi INNER JOIN  BsymtAffEmpHist eh on eh.hisId = ehi.hisId  AND eh.companyId = :companyId"
