...
public class JpaFindEmployeeBaseRepo extends JpaRepository implements FindEmployeeBase{
	...
	private static final String SEARCH_QUERY_STRING = "SELECT e, p, wp From BsymtEmployeeDataMngInfo e "
			...
			+ " LEFT JOIN BsymtWorkplaceInfor wp ON wp.pk.companyId = e.companyId "
			+ " AND hi.workPlaceId = wp.pk.workplaceId"
