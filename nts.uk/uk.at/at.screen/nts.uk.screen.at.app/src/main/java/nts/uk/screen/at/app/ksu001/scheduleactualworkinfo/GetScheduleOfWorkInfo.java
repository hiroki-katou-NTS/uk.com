...
public class GetScheduleOfWorkInfo {
	...
	public List<WorkScheduleWorkInforDto> getDataScheduleOfWorkInfo(DisplayInWorkInfoParam param) {
		...
		Map<EmployeeWorkingStatus, Optional<WorkSchedule>> mngStatusAndWScheMap =  GetWorkScheduleByWorkingStatusService.getScheduleManagement(RequireImpl, param.listSid, period);
