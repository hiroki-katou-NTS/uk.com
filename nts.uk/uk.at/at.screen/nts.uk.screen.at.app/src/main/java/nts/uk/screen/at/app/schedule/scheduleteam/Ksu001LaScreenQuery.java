...
public class Ksu001LaScreenQuery {
	...
	public List<EmployeeOrganizationInfoDto> getEmployeesOrganizationInfo(GeneralDate baseDate, String WKPGRID){
		...
		List<EmployeeAffiliation> employeeAffiliations =
				GetAllEmpWhoBelongWorkplaceGroupService.getAllEmp(getAllEmpWhoBelongWorkplaceGroupImpl, DatePeriod.oneDay(baseDate), WKPGRID);
