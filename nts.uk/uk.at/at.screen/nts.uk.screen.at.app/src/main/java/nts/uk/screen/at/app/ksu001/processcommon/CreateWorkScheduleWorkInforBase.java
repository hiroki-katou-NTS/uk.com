...
public class CreateWorkScheduleWorkInforBase {
	...
	public List<WorkScheduleWorkInforDto> getDataScheduleOfWorkInfo(
		...
		map.forEach((employeeWorkingStatus, integrationOfDaily) -> {
			...
			WorkScheduleWorkInforDto dto = new WorkScheduleWorkInforDto(integrationOfDaily, employeeWorkingStatus, workTypeInfor, workTimeSetting, targetOrg, wTypeWTimeUseDailyAttendRecord);
