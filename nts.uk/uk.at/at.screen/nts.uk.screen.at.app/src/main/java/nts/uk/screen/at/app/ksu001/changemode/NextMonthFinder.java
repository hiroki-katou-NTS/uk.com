...
public class NextMonthFinder {
	...
	public StartKSU001Dto getDataStartScreen(StartKSU001Param param) {
		...
		// step 1 start
		GeneralDate startDate = GeneralDate.ymd(2020, 8, 1);
		GeneralDate endDate =  GeneralDate.ymd(2020, 8, 31);
		...
		DataSpecDateAndHolidayDto resultStep3 = eventInfoAndPersonalCondPeriod.getForNextMonth(param3);
		// step 3 end
		...
		resultStep4 = displayInWorkInfo.getDataNextMonth(param4);
		...
		// step5.1
		WorkScheduleShiftResult resultStep51 = getWorkScheduleShift.getDataNextMonth(new GetWorkScheduleShiftParam());
