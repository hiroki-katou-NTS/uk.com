...
public class SettingScheCorrectionByWorkDto {
    ...
    public static SettingScheCorrectionByWorkDto getDto(Optional<DisplaySettingByWorkplace> displaySettingByWkp, Optional<ScheFunctionCtrlByWorkplace> scheFuncCtrlByWkp,
        ...
        return new SettingScheCorrectionByWorkDto(
                ...
                displaySettingByWkp.isPresent() ? displaySettingByWkp.get().getEndDay().getClosingDate().getDay() : 0,
                ...
                scheFuncCtrlByWkp.isPresent() && scheFuncCtrlByWkp.get().getCompletionMethodControl().isPresent() ? scheFuncCtrlByWkp.get().getCompletionMethodControl().get().getCompletionExecutionMethod().value : 0,
                scheFuncCtrlByWkp.isPresent() && scheFuncCtrlByWkp.get().getCompletionMethodControl().isPresent() ? BooleanUtils.toInteger(scheFuncCtrlByWkp.get().getCompletionMethodControl().get().isCompletionMethodControl(FuncCtrlCompletionMethod.Confirm)) : 0,
                scheFuncCtrlByWkp.isPresent() && scheFuncCtrlByWkp.get().getCompletionMethodControl().isPresent() ? BooleanUtils.toInteger(scheFuncCtrlByWkp.get().getCompletionMethodControl().get().isCompletionMethodControl(FuncCtrlCompletionMethod.AlarmCheck)) : 0,
                checkConditionList,
