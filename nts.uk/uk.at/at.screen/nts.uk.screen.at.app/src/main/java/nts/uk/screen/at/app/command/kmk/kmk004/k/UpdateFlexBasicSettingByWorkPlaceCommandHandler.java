 ...
 */
@Stateless
public class UpdateFlexBasicSettingByWorkPlaceCommandHandler extends CommandHandler<WkpFlexMonthActCalSetCommand> {
	...
	protected void handle(CommandHandlerContext<WkpFlexMonthActCalSetCommand> context) {
		// 職場別フレックス勤務集計方法
		this.wkpFlexMonthActCalSetRepo.update(context.getCommand().toDomain());
	}
