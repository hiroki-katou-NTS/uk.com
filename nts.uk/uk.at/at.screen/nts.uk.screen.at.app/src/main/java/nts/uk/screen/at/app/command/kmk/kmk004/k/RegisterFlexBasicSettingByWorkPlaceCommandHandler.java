 ...
 */
@Stateless
public class RegisterFlexBasicSettingByWorkPlaceCommandHandler extends CommandHandler<UpdateFlexBasicSettingByWorkPlaceCommand> {
	...
	protected void handle(CommandHandlerContext<UpdateFlexBasicSettingByWorkPlaceCommand> context) {
		// 職場別フレックス勤務集計方法を登録する
		this.wkpFlexMonthActCalSetRepo.add(context.getCommand().getFlexMonthActCalSet().toDomain());
	}
