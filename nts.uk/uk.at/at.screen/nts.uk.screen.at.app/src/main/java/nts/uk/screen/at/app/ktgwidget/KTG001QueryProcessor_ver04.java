...
public class KTG001QueryProcessor_ver04 {
	 ...
	 */
	public ApprovedDataWidgetStartDto getApprovedDataWidgetStart(int closureId) {
		ApprovedDataWidgetStartDto approvedDataWidgetStartDto = new ApprovedDataWidgetStartDto();
		String companyId = AppContexts.user().companyId();
		
		//call 承認すべきデータのウィジェットを起動する
		approvedDataWidgetStartDto.setApprovedDataExecutionResultDto(finder.getApprovedDataExecutionResult(closureId));
