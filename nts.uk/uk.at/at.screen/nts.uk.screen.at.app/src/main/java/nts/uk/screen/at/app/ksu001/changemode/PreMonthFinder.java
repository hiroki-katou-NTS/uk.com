...
public class PreMonthFinder {
	...
	public StartKSU001Dto getDataStartScreen(StartKSU001Param param) {
		...
		DataSpecDateAndHolidayDto resultStep3 = eventInfoAndPersonalCondPeriod.getForPreMonth(param3);
		// step 3 end
		...
		resultStep4 = displayInWorkInfo.getDataPreMonth(param4);
		...
		// step5.1
		WorkScheduleShiftResult resultStep51 = getWorkScheduleShift.getDataPreMonth(new GetWorkScheduleShiftParam());
