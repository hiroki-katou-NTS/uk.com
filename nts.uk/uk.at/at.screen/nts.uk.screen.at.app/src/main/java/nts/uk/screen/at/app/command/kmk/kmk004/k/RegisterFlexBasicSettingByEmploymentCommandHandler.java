 ...
 */
@Stateless
public class RegisterFlexBasicSettingByEmploymentCommandHandler extends CommandHandler<EmpFlexMonthActCalSetCommand> {
	...
	protected void handle(CommandHandlerContext<EmpFlexMonthActCalSetCommand> context) {
		// 雇用別フレックス勤務集計方法を登録する
		this.empFlexMonthActCalSetRepo.add(context.getCommand().toDomain());
