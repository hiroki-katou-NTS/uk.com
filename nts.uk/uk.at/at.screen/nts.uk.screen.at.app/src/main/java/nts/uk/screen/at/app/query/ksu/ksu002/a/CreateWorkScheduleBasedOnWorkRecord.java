		...
		param.forEach((key, value) -> {
			...
			if (value.isPresent()) {
				...
				WorkScheduleWorkInforDto dto = WorkScheduleWorkInforDto.builder()
						...
						.workTypeName(workTypeInfor.map(m -> m.getAbbreviationName()).orElse(workTypeCode == null ? null : "KSU002_31"))
						.workTypeEditStatus(null)
						.workTimeCode(workTimeCode)
						.workTimeName(workTimeSetting.map(m -> m.getWorkTimeDisplayName().getWorkTimeName().v()).orElse(workTimeCode == null ? null : "KSU002_31"))
