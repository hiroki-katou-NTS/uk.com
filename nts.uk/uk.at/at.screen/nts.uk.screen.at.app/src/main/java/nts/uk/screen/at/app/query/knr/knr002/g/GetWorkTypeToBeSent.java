 ...
 */
@Stateless
public class GetWorkTypeToBeSent {
	...
	public GetWorkTypeToBeSentDto getWorkTypeToBeSent(String empInforTerCode) {
		ContractCode contractCode = new ContractCode(AppContexts.user().contractCode());
		String companyId = AppContexts.user().companyId();
		//	1. get*(会社ID、廃止区分＝false): 勤務種類<List>
		List<WorkType> selectableWorkTypeList = this.workTypeRepository.findWorkByDeprecate(companyId, 0);
		...
		GetWorkTypeToBeSentDto dto = new GetWorkTypeToBeSentDto();
		dto.setSelectableWorks(selectableWorkTypeList
