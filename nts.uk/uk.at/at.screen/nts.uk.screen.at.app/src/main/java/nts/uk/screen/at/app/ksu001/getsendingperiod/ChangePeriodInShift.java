...
public class ChangePeriodInShift {
	...
	public ChangePeriodInShiftResult getData(ChangePeriodInShiftParam param) {
		...
		ExtractTargetEmployeesParam param2 = new ExtractTargetEmployeesParam(GeneralDate.fromString(param.endDate, DATE_FORMAT), targetOrgIdenInfor);
		...
		EventInfoAndPerCondPeriodParam param1 = new EventInfoAndPerCondPeriodParam(
				GeneralDate.fromString(param.startDate, DATE_FORMAT),
				GeneralDate.fromString(param.endDate, DATE_FORMAT), sids, targetOrgIdenInfor);
		...
		SchedulesbyShiftParam paramStep2 = new SchedulesbyShiftParam(param.listShiftMasterNotNeedGetNew, sids,
				GeneralDate.fromString(param.startDate, DATE_FORMAT),
				GeneralDate.fromString(param.endDate, DATE_FORMAT), param.getActualData);
