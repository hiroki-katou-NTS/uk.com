...
public class AppOverTimeReceptionDataImport extends ApplicationReceptionDataImport {
	...
	public AppOverTimeReceptionDataImport(AppOverTimBuilder builder) {
	...
	public static class AppOverTimBuilder extends ApplicationReceptionDataImport {
		...
		public AppOverTimeReceptionDataImport build() {
			return new AppOverTimeReceptionDataImport(this);
		}
	}
