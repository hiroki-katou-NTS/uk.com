...
public class MulMonCheckCondDomainEventDto {
	...
	/** 複数月のﾁｪｯｸ条件 */
	private AttendanceItemConAdapterDto checkConMulMon;
	...
	public MulMonCheckCondDomainEventDto(String errorAlarmCheckID, String nameAlarmMulMon, boolean useAtr,
			...
			AttendanceItemConAdapterDto checkConMulMon, int continuousMonths, int times, int compareOperator) {
		super();
		...
		this.checkConMulMon = checkConMulMon;
