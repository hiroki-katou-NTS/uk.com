...
@Stateless
public class GenerateValueAlarmOfDailyPerformanceService {
	// 社員の日別実績エラー一覧
	@Inject
	...
	public void AggregationProcess(DailyAlarmCondition dailyAlarmCondition, PeriodByAlarmCategory period,
