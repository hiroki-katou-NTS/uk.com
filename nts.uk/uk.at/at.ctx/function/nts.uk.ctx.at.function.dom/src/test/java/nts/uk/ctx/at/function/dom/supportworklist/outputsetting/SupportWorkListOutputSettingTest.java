...
public class SupportWorkListOutputSettingTest {
    @Injectable
    SupportWorkOutputDataRequire require;

    @Test
    public void testGetters() {
        SupportWorkListOutputSetting setting = new SupportWorkListOutputSetting(
                new SupportWorkOutputCode("001"),
                new SupportWorkOutputName("name1"),
