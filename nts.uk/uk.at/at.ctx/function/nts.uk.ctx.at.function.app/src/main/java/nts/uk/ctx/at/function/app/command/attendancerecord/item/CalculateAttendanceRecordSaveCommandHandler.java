...
public class CalculateAttendanceRecordSaveCommandHandler extends CommandHandler<CalculateAttendanceRecordSaveCommand> {
	...
	@Override
	protected void handle(CommandHandlerContext<CalculateAttendanceRecordSaveCommand> context) {
		CalculateAttendanceRecordSaveCommand command = context.getCommand();
