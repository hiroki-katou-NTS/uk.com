...
public class AddItemOutTblBookCommandHandler extends CommandHandler<ItemOutTblBookCommand> {
	...
	protected void handle(CommandHandlerContext<ItemOutTblBookCommand> context) {
		...
		repository.add(new ItemOutTblBook(addCommand.getCid(), addCommand.getCode(), addCommand.getSortBy(), addCommand.getUseClass(), addCommand.getValOutFormat(), addCommand.getHeadingName()));
	}
}
