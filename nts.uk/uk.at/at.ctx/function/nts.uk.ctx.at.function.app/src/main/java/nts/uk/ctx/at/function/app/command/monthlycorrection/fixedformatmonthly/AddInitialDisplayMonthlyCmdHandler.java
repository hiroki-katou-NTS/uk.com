...
@Stateless
public class AddInitialDisplayMonthlyCmdHandler  extends CommandHandler<InitialDisplayMonthlyCmd>{
	...
	protected void handle(CommandHandlerContext<InitialDisplayMonthlyCmd> context) {
		...
		if(!checkData.isPresent())
			repo.addInitialDisplayMonthly(InitialDisplayMonthlyCmd.fromCommand(command));
		else
