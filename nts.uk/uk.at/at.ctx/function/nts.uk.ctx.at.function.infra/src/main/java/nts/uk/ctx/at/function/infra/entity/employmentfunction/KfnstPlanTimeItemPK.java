...
/**
 * The Class KfnstPlanTimeItemPK.
 */
@Getter
@Setter
@Embeddable
public class KfnstPlanTimeItemPK implements Serializable {
	/**
	 * 
	 */
     ...
     */
    public KfnstPlanTimeItemPK(String cid, String scheduleId, Integer atdId) {
        this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KfnstPlanTimeItemPK other = (KfnstPlanTimeItemPK) obj;
		if (atdId == null) {
			if (other.atdId != null)
				return false;
