...
public class KfnmtAlarmCheckConditionCategory extends ContractUkJpaEntity implements Serializable {
	...
	public KfnmtAlarmCheckConditionCategory(String companyId, int category, String code, String name,
			...
			KfnmtAlCheckSubConAg alCheckSubConAg,KrqmtAppApprovalCondition appApprovalCondition, KrcmtMasterCheckAlarmCheckCondition masterCheckAlarmCheckCon,List<KfndtScheCondDayLink> scheduleCondDayLinks) {
		super();
