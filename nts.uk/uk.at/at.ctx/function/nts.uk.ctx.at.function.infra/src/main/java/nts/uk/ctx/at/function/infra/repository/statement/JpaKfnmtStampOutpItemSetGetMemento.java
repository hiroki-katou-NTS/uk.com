 ...
 */
public class JpaKfnmtStampOutpItemSetGetMemento implements StampingOutputItemSetGetMemento{
	 ...
	 */
	public JpaKfnmtStampOutpItemSetGetMemento(KfnmtStampOutpItemSet entity) {
		super();
		this.entity = entity;
	}
