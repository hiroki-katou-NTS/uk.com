...
@NoArgsConstructor
@Entity
@Table(name = "KFNMT_MON_FORM_BUS_SHEET")
public class KrcmtMonthlyActualResultRC extends UkJpaEntity implements Serializable {
	...
	@JoinTable(name = "KFNMT_MON_FORM_BUS_ITEM")
