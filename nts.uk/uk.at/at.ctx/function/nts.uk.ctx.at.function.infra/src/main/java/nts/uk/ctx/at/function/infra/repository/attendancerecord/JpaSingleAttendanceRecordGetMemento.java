...
public class JpaSingleAttendanceRecordGetMemento implements SingleAttendanceRecordGetMemento {
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.function.dom.attendancerecord.item.SingleAttendanceRecordGetMemento#getAttribute()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.function.dom.attendancerecord.item.SingleAttendanceRecordGetMemento#getName()
	 */
	@Override
