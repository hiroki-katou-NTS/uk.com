...
/**
 * The Class KfnmtStampOutpItemPK.
 */
@Embeddable
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class KfnmtStampOutpItemPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof KfnmtStampOutpItemPK)) {
			return false;
		}
		KfnmtStampOutpItemPK castOther = (KfnmtStampOutpItemPK)other;
		return 
