...
@Getter
@Setter
public class MonthlyPatternUpdateCommand {
	...
	class MonthlyPatternGetMementoImpl implements MonthlyPatternGetMemento{
		...
		/** The command. */
		private MonthlyPatternUpdateCommand command;
		...
		public MonthlyPatternGetMementoImpl(MonthlyPatternUpdateCommand command, String companyId) {
