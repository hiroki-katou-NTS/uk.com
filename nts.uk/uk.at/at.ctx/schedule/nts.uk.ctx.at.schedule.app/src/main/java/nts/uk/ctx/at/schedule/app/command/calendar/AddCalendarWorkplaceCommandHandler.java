...
@Stateless
public class AddCalendarWorkplaceCommandHandler extends CommandHandler<AddCalendarWorkplaceCommand> {

	@Inject
	private CalendarRepository calendarWorkplaceRepo;

	@Override
	protected void handle(CommandHandlerContext<AddCalendarWorkplaceCommand> context) {
