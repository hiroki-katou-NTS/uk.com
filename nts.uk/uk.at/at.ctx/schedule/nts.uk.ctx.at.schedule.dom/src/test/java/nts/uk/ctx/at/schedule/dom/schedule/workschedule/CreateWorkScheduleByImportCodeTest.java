...
public class CreateWorkScheduleByImportCodeTest {
	...
	@Test
	public void testCreate_Msg_2183 (@Injectable WorkSchedule oldWorkSchedule) {
		...
		new Expectations() {{
			...
			require.getWorkSchedule(employeeId, date);
			result = Optional.of(oldWorkSchedule);
	...
	public void testCreate_update (
			@Injectable WorkSchedule oldWorkSchedule,
			@Injectable ShiftMaster shiftMaster,
			@Injectable WorkSchedule newWorkSchedule,
			@Injectable WorkSchedule correctedResult) {
