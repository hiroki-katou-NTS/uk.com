 ...
 */
@Getter
public class AutoCalWorkplaceSetting extends AggregateRoot {
	 ...
	 */
	public AutoCalWorkplaceSetting(CompanyId companyId, WorkplaceId wkpId, AutoCalOvertimeSetting normalOTTime,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AutoCalWorkplaceSetting other = (AutoCalWorkplaceSetting) obj;
		if (companyId == null) {
