...
public class GetWorkplaceNotWorkgroupService {
	...
	public static List<WorkplaceInfoImport> getWorkplace(Require require, GeneralDate baseDate){
		...
		List<WorkplaceInfoImport> lstInfoImports = require.getAllActiveWorkplace(CID, baseDate);
		...
		List<AffWorkplaceGroup> workplaceGroup = require.getAll(CID);
	...
	public static interface Require {
		...
		List<AffWorkplaceGroup> getAll(String CID);
	}
}
