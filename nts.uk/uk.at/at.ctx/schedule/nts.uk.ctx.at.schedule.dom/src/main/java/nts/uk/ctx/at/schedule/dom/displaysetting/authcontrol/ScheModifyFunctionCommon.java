 ...
 *
 */
public class ScheModifyFunctionCommon extends DescriptionOfAvailabilityPermissionBase {
	 ...
	 */
	public ScheModifyFunctionCommon(int functionNo, String name, String explanation, int displayOrder,
