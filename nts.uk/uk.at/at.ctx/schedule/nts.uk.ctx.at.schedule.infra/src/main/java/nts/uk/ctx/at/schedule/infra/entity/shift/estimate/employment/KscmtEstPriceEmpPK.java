...
/**
 * The Class KscmtEstPriceEmpPK.
 */
@Getter
@Setter
@Embeddable
public class KscmtEstPriceEmpPK implements Serializable {
     ...
     */
    public KscmtEstPriceEmpPK(String cid, String empcd, int targetYear, int targetCls) {
        this.cid = cid;
        this.empcd = empcd;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstPriceEmpPK other = (KscmtEstPriceEmpPK) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
