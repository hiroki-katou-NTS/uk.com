package nts.uk.ctx.at.schedule.infra.repository.schedule.alarm.consecutiveattendance.limitworktime;
...
public class JpaMaxDayOfWorkTimeOrganization extends JpaRepository implements MaxDayOfWorkTimeOrganizationRepo {
	...
	@Override
	public boolean exists(String companyId, TargetOrgIdenInfor targetOrg, WorkTimeMaximumCode code) {
	...
	@Override
	public void delete(String companyId, TargetOrgIdenInfor targetOrg, WorkTimeMaximumCode code) {
