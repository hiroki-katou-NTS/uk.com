...
/**
 * The Class KscmtChildCareSchPK.
 */
@Getter
@Setter
@Embeddable
public class KscmtChildCareSchPK implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KscmtChildCareSchPK)) {
            return false;
        }
        KscmtChildCareSchPK other = (KscmtChildCareSchPK) object;
