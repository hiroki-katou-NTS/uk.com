...
/**
 * The Class KshmtAutoRestTimeCalPK.
 */
@Embeddable
public class KshmtAutoRestTimeCalPK implements Serializable {
    ...
    /**
     * Instantiates a new kshmt auto rest time cal PK.
     */
    public KshmtAutoRestTimeCalPK() {
    }
     ...
     */
    public KshmtAutoRestTimeCalPK(String cid, short wkpid, short jobid, short autoCalAtr) {
        this.cid = cid;
        this.wkpid = wkpid;
        this.jobid = jobid;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KshmtAutoRestTimeCalPK)) {
            return false;
        }
        KshmtAutoRestTimeCalPK other = (KshmtAutoRestTimeCalPK) object;
    ...
    public String toString() {
        return "entity.KshmtAutoRestTimeCalPK[ cid=" + cid + ", wkpid=" + wkpid + ", jobid=" + jobid + ", autoCalAtr=" + autoCalAtr + " ]";
    }
