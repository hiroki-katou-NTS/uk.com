...
@Entity
@NoArgsConstructor
@Table(name="KSCDT_SCH_GOING_OUT")
@Getter
public class KscdtSchGoingOut extends ContractUkJpaEntity {
	
	@EmbeddedId
	public KscdtSchGoingOutPK pk;
	...
	public KscdtSchGoingOut(KscdtSchGoingOutPK pk, String cid, int useHourlyHdPaid, int useHourlyHdCom,
	...
	public static KscdtSchGoingOut toEntity(String sid, GeneralDate ymd,String cid,int reason,TimevacationUseTimeOfDaily timePaidUseTime) {
		KscdtSchGoingOut entity =  new KscdtSchGoingOut(
				new KscdtSchGoingOutPK(sid, ymd, reason), 
				cid, 
