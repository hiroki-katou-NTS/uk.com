...
/**
 * The Class KscmtEstPriceComSet.
 */
@Getter
@Setter
@Entity
@Table(name = "KSCMT_EST_PRICE_COM_SET")
public class KscmtEstPriceComSet extends ContractUkJpaEntity implements Serializable {
     ...
     */
    public KscmtEstPriceComSet(KscmtEstPriceComSetPK kscmtEstPriceComSetPK) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstPriceComSet other = (KscmtEstPriceComSet) obj;
