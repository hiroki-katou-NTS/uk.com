...
@Setter
@Embeddable
public class KscmtWsPersonFeeTimePK implements Serializable {
     ...
     * @param no the no
     */
    public KscmtWsPersonFeeTimePK(String sid, GeneralDate ymd, short no) {
        this.sid = sid;
        this.ymd = ymd;
        this.no = no;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KscmtWsPersonFeeTimePK)) {
            return false;
        }
        KscmtWsPersonFeeTimePK other = (KscmtWsPersonFeeTimePK) object;
