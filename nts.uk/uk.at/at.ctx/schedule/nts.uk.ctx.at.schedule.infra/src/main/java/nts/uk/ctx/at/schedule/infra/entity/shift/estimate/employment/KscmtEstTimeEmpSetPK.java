...
/**
 * The Class KscmtEstTimeEmpSetPK.
 */
@Getter
@Setter
@Embeddable
public class KscmtEstTimeEmpSetPK implements Serializable {
     ...
     */
    public KscmtEstTimeEmpSetPK(String cid, String empcd, int targetYear, int targetCls) {
        this.cid = cid;
        this.empcd = empcd;
