...
/**
 * The Class KscmtEstPriceEmpSetPK.
 */
@Getter
@Setter
@Embeddable
public class KscmtEstPriceEmpSetPK implements Serializable {
    ...
    /**
     * Instantiates a new kscmt est price emp set PK.
     */
    public KscmtEstPriceEmpSetPK() {
    }
     ...
     */
    public KscmtEstPriceEmpSetPK(String cid, String empcd, int targetYear, int targetCls) {
        this.cid = cid;
        this.empcd = empcd;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstPriceEmpSetPK other = (KscmtEstPriceEmpSetPK) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
