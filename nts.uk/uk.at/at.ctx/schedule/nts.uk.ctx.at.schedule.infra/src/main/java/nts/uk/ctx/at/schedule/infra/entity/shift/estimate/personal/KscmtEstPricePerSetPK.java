...
/**
 * The Class KscmtEstPricePerSetPK.
 */
@Getter
@Setter
@Embeddable
public class KscmtEstPricePerSetPK implements Serializable {
     ...
     */
    public KscmtEstPricePerSetPK(String sid, int targetYear, int targetCls) {
        this.sid = sid;
