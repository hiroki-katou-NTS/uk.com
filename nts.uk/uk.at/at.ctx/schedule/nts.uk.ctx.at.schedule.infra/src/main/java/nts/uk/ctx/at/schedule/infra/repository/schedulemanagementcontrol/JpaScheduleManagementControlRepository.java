...
import nts.uk.ctx.at.schedule.infra.entity.schedulemanagementcontrol.KscmtSchManaContr;
...
public class JpaScheduleManagementControlRepository extends JpaRepository
	...
	public Optional<ScheduleManagementControl> findById(String employeeId) {
		return this.queryProxy().find(employeeId, KscmtSchManaContr.class)
	 ...
	 */
	private ScheduleManagementControl toDomain(KscmtSchManaContr entity) {
