...
/**
 * The Class KscmtEstTimePerSetPK.
 */
@Getter
@Setter
@Embeddable
public class KscmtEstTimePerSetPK implements Serializable {
     ...
     */
    public KscmtEstTimePerSetPK(String sid, int targetYear, int targetCls) {
        this.sid = sid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstTimePerSetPK other = (KscmtEstTimePerSetPK) obj;
		if (sid == null) {
			if (other.sid != null)
				return false;
