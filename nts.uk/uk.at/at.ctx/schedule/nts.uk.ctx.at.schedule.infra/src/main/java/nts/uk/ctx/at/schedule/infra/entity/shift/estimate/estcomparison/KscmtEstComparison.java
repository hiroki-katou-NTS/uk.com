...
/**
 * The Class KscmtEstComparison.
 */
@Getter
@Setter
@Entity
@Table(name = "KSCMT_EST_COMPARISON")
public class KscmtEstComparison extends UkJpaEntity implements Serializable {
     ...
     */
    public KscmtEstComparison(String cid, int comparisonAtr) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstComparison other = (KscmtEstComparison) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
