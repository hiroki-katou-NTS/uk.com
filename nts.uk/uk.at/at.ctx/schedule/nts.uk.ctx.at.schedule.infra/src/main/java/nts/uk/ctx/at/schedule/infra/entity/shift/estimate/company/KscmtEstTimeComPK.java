...
/**
 * The Class KscmtEstTimeComPK.
 */
@Getter
@Setter
@Embeddable
public class KscmtEstTimeComPK implements Serializable {
     ...
     */
    public KscmtEstTimeComPK(String cid, int targetYear, int targetCls) {
        this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstTimeComPK other = (KscmtEstTimeComPK) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
