...
@Entity
@NoArgsConstructor
@Table(name="KSCDT_SCH_LEAVE_EARLY")
@Getter
public class KscdtSchLeaveEarly extends ContractUkJpaEntity {
	
	@EmbeddedId
	public KscdtSchLeaveEarlyPK pk;
	...
	public KscdtSchLeaveEarly(KscdtSchLeaveEarlyPK pk, String cid, int useHourlyHdPaid, int useHourlyHdCom,
	...
	public static KscdtSchLeaveEarly toEntity(String sid, GeneralDate ymd,String cid,int workNo,TimevacationUseTimeOfDaily timePaidUseTime) {
		KscdtSchLeaveEarly entity =  new KscdtSchLeaveEarly(
				new KscdtSchLeaveEarlyPK(sid, ymd, workNo), 
				cid, 
