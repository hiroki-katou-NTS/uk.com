...
@Setter
@Embeddable
public class KscmtEstDaysSyaPK implements Serializable {
	 ...
	 */
	public KscmtEstDaysSyaPK(String sid, int targetYear, int targetCls) {
		this.sid = sid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstDaysSyaPK other = (KscmtEstDaysSyaPK) obj;
		if (sid == null) {
			if (other.sid != null)
				return false;
