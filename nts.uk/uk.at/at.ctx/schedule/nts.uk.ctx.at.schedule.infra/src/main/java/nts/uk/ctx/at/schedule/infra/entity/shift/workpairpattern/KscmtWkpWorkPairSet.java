...
public class KscmtWkpWorkPairSet extends ContractUkJpaEntity implements Serializable {
	...
	private KscmtWkpPatternItem kscmtWkpPatternItem;
	...
	public KscmtWkpWorkPairSet(KscmtWkpWorkPairSetPK kscmtWkpWorkPairSetPk, String workTypeCode, String workTimeCode) {
		super();
