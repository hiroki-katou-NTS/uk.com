...
public class KscmtAlchkConsecutiveWktmOrg extends ContractUkJpaEntity implements Serializable {
	 ...
	 * @return
	 */
	public static KscmtAlchkConsecutiveWktmOrg of (String companyId, MaxNumberDaysOfContinuousWorkTimeOrg domain) {
	 ...
	 * @return
	 */
	public MaxNumberDaysOfContinuousWorkTimeOrg toDomain(List<KscmtAlchkConsecutiveWktmOrgDtl> details) {
