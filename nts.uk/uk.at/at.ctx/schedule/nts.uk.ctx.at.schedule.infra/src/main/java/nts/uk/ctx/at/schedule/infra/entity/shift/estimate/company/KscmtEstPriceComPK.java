...
/**
 * The Class KscmtEstPriceComPK.
 */

@Getter
@Setter
@Embeddable
public class KscmtEstPriceComPK implements Serializable {
     ...
     */
    public KscmtEstPriceComPK(String cid, int targetYear, int targetCls) {
        this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KscmtEstPriceComPK other = (KscmtEstPriceComPK) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
