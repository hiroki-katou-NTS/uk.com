...
public class KagmtCriterionAmountForEmployment extends ContractUkJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	public KagmtCriterionAmountForEmploymentPK pk;
	...
	public static List<KagmtCriterionAmountForEmployment> toEntity(String companyId,
			CriterionAmountForEmployment domain) {
		List<KagmtCriterionAmountForEmployment> result = new ArrayList<>();
		// 0：年間目安金額
		for (CriterionAmountByNo temp : domain.getCriterionAmount().getYearly().getList()) {
			result.add(new KagmtCriterionAmountForEmployment(new KagmtCriterionAmountForEmploymentPK(companyId,
	...
	public static CriterionAmountForEmployment toDomain(String employmentCode,
			List<KagmtCriterionAmountForEmployment> entitys) {
		List<KagmtCriterionAmountForEmployment> listYearly = new ArrayList<>();
		List<KagmtCriterionAmountForEmployment> listMonthly = new ArrayList<>();
		for (KagmtCriterionAmountForEmployment ent : entitys) {
			// 0：年間目安金額
