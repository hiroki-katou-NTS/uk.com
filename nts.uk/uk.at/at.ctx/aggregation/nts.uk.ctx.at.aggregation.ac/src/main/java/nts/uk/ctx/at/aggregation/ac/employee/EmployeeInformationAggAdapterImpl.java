package nts.uk.ctx.at.aggregation.ac.employee;

import nts.gul.collection.CollectionUtil;
import nts.uk.ctx.at.aggregation.dom.adapter.employee.*;
...
@Stateless
public class EmployeeInformationAggAdapterImpl implements EmployeeInformationAggAdapter {
    @Inject
