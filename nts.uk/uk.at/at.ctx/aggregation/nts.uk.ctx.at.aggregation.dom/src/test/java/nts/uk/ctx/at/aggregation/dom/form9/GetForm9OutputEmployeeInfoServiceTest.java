...
public class GetForm9OutputEmployeeInfoServiceTest {
	...
	public void testGet_empty() {
		...
		new Expectations(
				...
				,	GetEmpCanReferBySpecOrganizationService.class) {
			{
				require.getLoginEmployeeId();
				result = loginEmployeeId;
				
				GetEmpCanReferBySpecOrganizationService.getListEmpID(require, baseDate, loginEmployeeId, targetOrg);
	...
	public void testGet(
		...
		new Expectations(
				...
				,	GetEmpCanReferBySpecOrganizationService.class) {
			{
				...
				GetEmpCanReferBySpecOrganizationService.getListEmpID(require, (GeneralDate) any, loginEmployeeId, targetOrg);
				result = employeeRangeIds;
