...
public class GetPersonalInfoForScheduleTableServiceTest {
	...
	public void testGet_AllInfo() {
		...
		new Expectations(GetEmpLicenseClassificationService.class, EnumAdaptor.class) {{
			...
			result = Arrays.asList(
							EmpLicenseClassification.createEmpLicenseClassification("employee-id1", Hepler.createNurseClass(LicenseClassification.NURSE, true))
						,	EmpLicenseClassification.createEmpLicenseClassification("employee-id2", Hepler.createNurseClass(LicenseClassification.NURSE_ASSIST, false))
					);
