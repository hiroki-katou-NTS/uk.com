...
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.LegalAggrSetOfIrgForEmpRepository;
...
public class JpaLegalAggrSetOfIrgForEmp extends JpaRepository implements LegalAggrSetOfIrgForEmpRepository {
	...
	public void update(String companyId, String employmentCd, LegalAggrSetOfIrg legalAggrSetOfIrg) {
		this.toUpdate(companyId, employmentCd, legalAggrSetOfIrg);
	}
	 ...
	 */
	private void toUpdate(String companyId, String employmentCd, LegalAggrSetOfIrg domain){
