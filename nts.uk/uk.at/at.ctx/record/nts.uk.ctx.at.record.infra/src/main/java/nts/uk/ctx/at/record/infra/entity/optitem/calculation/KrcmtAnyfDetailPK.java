...
/**
 * The Class KrcmtAnyfDetailPK.
 */
@Getter
@Setter
@Embeddable
public class KrcmtAnyfDetailPK implements Serializable {
	 ...
	 * @param pk the pk
	 */
	public KrcmtAnyfDetailPK(KrcmtAnyfPK pk) {
		super();
		this.cid = pk.getCid();
	 ...
	 */
	public KrcmtAnyfDetailPK(String cid, Integer optionalItemNo, String formulaId) {
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KrcmtAnyfDetailPK)) {
			return false;
		}
		KrcmtAnyfDetailPK other = (KrcmtAnyfDetailPK) object;
