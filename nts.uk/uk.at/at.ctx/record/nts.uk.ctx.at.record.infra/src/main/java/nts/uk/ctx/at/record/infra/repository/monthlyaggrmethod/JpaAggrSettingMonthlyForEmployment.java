...
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.AggrSettingMonthlyForEmployment;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.AggrSettingMonthlyForEmploymentRepository;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.flex.AggrMethodOfFlex36AgreementTime;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.flex.AggrSettingMonthlyOfFlx;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.flex.ExcessOutsideTimeSetting;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.flex.ExcessOutsideTimeTargetSetting;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.flex.LegalAggrSetOfFlx;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.flex.SettingOfFlex36AgreementTime;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.AggregateTimeSet;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.CalcSettingOfIrregular;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.ExcessOutsideTimeSet;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.LegalAggrSetOfIrg;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.LegalAggrSetOfReg;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.SettlementPeriod;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.SettlementPeriodOfIrg;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.TreatHolidayWorkTimeOfLessThanCriteriaPerWeek;
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.TreatOverTimeOfLessThanCriteriaPerDay;
...
public class JpaAggrSettingMonthlyForEmployment extends JpaRepository implements AggrSettingMonthlyForEmploymentRepository {
	...
	/** 登録および更新 */
	@Override
	public void persistAndUpdate(AggrSettingMonthlyForEmployment domain){
		...
		KrcstMonsetEmpRegAggr entity = this.getEntityManager().find(KrcstMonsetEmpRegAggr.class, key);
		if (entity == null){
			isNeedPersist = true;
		...
		if (entity.krcstMonsetEmpRegExot == null){
			entity.krcstMonsetEmpRegExot = new KrcstMonsetEmpRegExot();
			entity.krcstMonsetEmpRegExot.PK = key;
			entity.krcstMonsetEmpRegExot.setValue = new KrcstMonsetRegExot();
		}
		val entityRegExot = entity.krcstMonsetEmpRegExot;
		...
		if (entity.krcstMonsetEmpIrgAggr == null){
			entity.krcstMonsetEmpIrgAggr = new KrcstMonsetEmpIrgAggr();
			entity.krcstMonsetEmpIrgAggr.PK = key;
			entity.krcstMonsetEmpIrgAggr.setValue = new KrcstMonsetIrgAggr();
		}
		val entityIrgAggr = entity.krcstMonsetEmpIrgAggr;
		...
		if (entity.krcstMonsetEmpIrgExot == null){
			entity.krcstMonsetEmpIrgExot = new KrcstMonsetEmpIrgExot();
			entity.krcstMonsetEmpIrgExot.PK = key;
			entity.krcstMonsetEmpIrgExot.setValue = new KrcstMonsetIrgExot();
		}
		val entityIrgExot = entity.krcstMonsetEmpIrgExot;
		...
		if (entity.krcstMonsetEmpIrgSetls == null) entity.krcstMonsetEmpIrgSetls = new ArrayList<>();
		val entityIrgSetls = entity.krcstMonsetEmpIrgSetls;
		...
		for (val settlementPeriod : settlementPeriods){
			KrcstMonsetEmpIrgSetl entityIrgSetl = new KrcstMonsetEmpIrgSetl();
			...
			if (entityIrgSetlOpt.isPresent()){
				...
				isAddIrgSetl = true;
				entityIrgSetl.PK = new KrcstMonsetEmpIrgSetlPK(
						domain.getCompanyId(),
						domain.getEmploymentCd(),
		...
		if (entity.krcstMonsetEmpFlxAggr == null){
			entity.krcstMonsetEmpFlxAggr = new KrcstMonsetEmpFlxAggr();
			entity.krcstMonsetEmpFlxAggr.PK = key;
			entity.krcstMonsetEmpFlxAggr.setValue = new KrcstMonsetFlxAggr();
		}
		val entityFlxAggr = entity.krcstMonsetEmpFlxAggr;
