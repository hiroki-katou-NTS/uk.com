...
public class KrcstHolAutoCalSet extends UkJpaEntity implements Serializable {
    ...
    public KrcstHolAutoCalSet(String holWorkTimeId, int exclusVer, int holWorkTimeCalAtr, int holWorkTimeLimitSet, int lateNightTimeCalAtr, int lateNightTimeLimitSet) {
        this.holWorkTimeId = holWorkTimeId;
