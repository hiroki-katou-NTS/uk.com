...
/**
 * The Class KrcmtAnyfPK.
 */
@Getter
@Setter
@Embeddable
public class KrcmtAnyfPK implements Serializable {
	 ...
	 */
	public KrcmtAnyfPK(String cid, Integer optionalItemNo, String formulaId) {
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KrcmtAnyfPK)) {
			return false;
		}
		KrcmtAnyfPK other = (KrcmtAnyfPK) object;
