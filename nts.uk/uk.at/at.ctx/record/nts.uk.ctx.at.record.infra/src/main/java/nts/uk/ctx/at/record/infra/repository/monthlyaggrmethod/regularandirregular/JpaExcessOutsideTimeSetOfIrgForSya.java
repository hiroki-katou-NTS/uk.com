...
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.ExcessOutsideTimeSetOfIrgForSyaRepository;
...
public class JpaExcessOutsideTimeSetOfIrgForSya extends JpaRepository implements ExcessOutsideTimeSetOfIrgForSyaRepository {
	...
	public void update(String companyId, String employeeId, ExcessOutsideTimeSet excessOutsideTimeSetting) {
		this.toUpdate(companyId, employeeId, excessOutsideTimeSetting);
	}
	...
	private void toUpdate(String companyId, String employeeId, ExcessOutsideTimeSet domain){
		...
		KrcstMonsetSyaIrgExot entity = this.getEntityManager().find(KrcstMonsetSyaIrgExot.class, key);
