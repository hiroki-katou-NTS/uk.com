...
public class KrcmtAlstChkmonUdremvs extends UkJpaEntity implements Serializable {
	...
	public KrcmtAlstChkmonUdremvs(String errorAlarmCheckID, int compareOperator, BigDecimal daysValue, Integer timeValue) {
		super();
	...
	public static KrcmtAlstChkmonUdremvs toEntity(String errorAlarmCheckID,CompareSingleValue<CheckConValueRemainingNumber> domain) {
		return new KrcmtAlstChkmonUdremvs(
				errorAlarmCheckID,
