...
public class KrcdtMonAnnleaRemain extends UkJpaEntity implements Serializable {
	...
	public AnnLeaRemNumEachMonth toDomain(){
		...
		AnnualLeave annualLeave = AnnualLeave.of(
				AnnualLeaveUsedNumber.of(
						AnnualLeaveUsedDays.of(
								new AnnualLeaveUsedDayNumber(this.usedDays),
								new AnnualLeaveUsedDayNumber(this.usedDaysBefore),
				...
				AnnualLeaveRemainingNumber.of(
						...
						normalDetail),
				AnnualLeaveRemainingNumber.of(
						new AnnualLeaveRemainingDayNumber(this.remainingDaysBefore),
		...
		if (this.factUsedTimes != null &&
			...
			valFactUsedTime = TimeAnnualLeaveUsedTime.of(
					...
					new UsedMinutes(this.factUsedMinutes),
					new UsedMinutes(this.factUsedMinutesBefore),
		...
		RealAnnualLeave realAnnualLeave = RealAnnualLeave.of(
				AnnualLeaveUsedNumber.of(
						AnnualLeaveUsedDays.of(
								new AnnualLeaveUsedDayNumber(this.factUsedDays),
				...
				AnnualLeaveRemainingNumber.of(
						...
						realDetail),
				AnnualLeaveRemainingNumber.of(
						new AnnualLeaveRemainingDayNumber(this.factRemainingDaysBefore),
		...
		if (this.halfRemainingTimes != null &&
		...
		if (this.grantDays != null &&
			...
			annualLeaveGrant = AnnualLeaveGrant.of(
					new AnnualLeaveGrantDayNumber(this.grantDays),
					new YearlyDays((double)this.grantLaborDays),
					new YearlyDays((double)this.grantPredeterminedDays),
					new YearlyDays((double)this.grantDeductionDays),
					new MonthlyDays((double)this.deductionDaysBefore),
					new MonthlyDays((double)this.deductionDaysAfter),
					new AttendanceRate(this.attendanceRate));
		}
		
		// 上限残時間
		AnnualLeaveMaxRemainingTime maxRemainingTime = null;
		if (this.timeRemainingMinutes != null &&
			...
			maxRemainingTime = AnnualLeaveMaxRemainingTime.of(
					new RemainingMinutes(this.timeRemainingMinutes),
		...
		if (this.factTimeRemainingMinutes != null &&
			...
			realMaxRemainingTime = AnnualLeaveMaxRemainingTime.of(
					new RemainingMinutes(this.factTimeRemainingMinutes),
		...
		return AnnLeaRemNumEachMonth.of(
				...
				AnnualLeaveAttdRateDays.of(
						new MonthlyDays((double)this.laborDays),
						new MonthlyDays((double)this.predeterminedDays),
						new MonthlyDays((double)this.deductionDays)),
				(this.grantAtr != 0));
	}
	...
	public void fromDomainForPersist(AnnLeaRemNumEachMonth domain){
		...
		this.PK = new KrcdtMonAnnleaRemainPK(
	...
	public void fromDomainForUpdate(AnnLeaRemNumEachMonth domain){
		...
		// 年休月別残数明細　更新
		if (this.krcdtMonAnnleaDetails == null) this.krcdtMonAnnleaDetails = new ArrayList<>();
		...
		for (val grantDate : normalGrantDateList){
			...
			val detailOpt = this.krcdtMonAnnleaDetails.stream()
