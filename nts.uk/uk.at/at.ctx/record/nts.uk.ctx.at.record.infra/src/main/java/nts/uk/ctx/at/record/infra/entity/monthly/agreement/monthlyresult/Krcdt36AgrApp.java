package nts.uk.ctx.at.record.infra.entity.monthly.agreement.monthlyresult;

import lombok.AllArgsConstructor;
import lombok.NoArgsConstructor;
import nts.arc.enums.EnumAdaptor;
import nts.arc.time.GeneralDate;
import nts.uk.ctx.at.record.dom.monthly.agreement.monthlyresult.*;
...
public class Krcdt36AgrApp extends UkJpaEntity implements Serializable {
    ...
    public static SpecialProvisionsOfAgreement toDomain(Krcdt36AgrApp entity) {
        ...
        OneYearTime oneYearTime = new OneYearTime(new ErrorTimeInYear(new AgreementOneMonthTime(entity.yearErrorTime), new AgreementOneMonthTime(entity.yearAlarmTime)), new Year(entity.year));
