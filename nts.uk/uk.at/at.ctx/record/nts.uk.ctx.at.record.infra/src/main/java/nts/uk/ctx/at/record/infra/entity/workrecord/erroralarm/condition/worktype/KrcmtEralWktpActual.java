...
public class KrcmtEralWktpActual extends UkJpaEntity implements Serializable {
	...
	public KrcmtEralWktpActual(KrcstErAlWtPlanActualPK krcstErAlWtPlanActualPK) {
		super();
