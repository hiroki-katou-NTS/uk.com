...
public class KrcdtMcloseUpdPerLog extends ContractUkJpaEntity {
	...
	public KrcdtMcloseUpdPerLog(String employeeId, String monthlyClosureUpdateLogId, int executionResult,
			int executionStatus) {
		super();
	...
	public static KrcdtMcloseUpdPerLog fromDomain(MonthlyClosureUpdatePersonLog domain) {
		return new KrcdtMcloseUpdPerLog(domain.getEmployeeId(), domain.getMonthlyClosureUpdateLogId(),
