...
import nts.uk.ctx.at.shared.dom.monthlyaggrmethod.regularandirregular.ExcessOutsideTimeSetOfRegForEmpRepository;
...
public class JpaExcessOutsideTimeSetOfRegForEmp extends JpaRepository implements ExcessOutsideTimeSetOfRegForEmpRepository {
	...
	public void update(String companyId, String employmentCd, ExcessOutsideTimeSet excessOutsideTimeSet) {
		this.toUpdate(companyId, employmentCd, excessOutsideTimeSet);
	}
	...
	private void toUpdate(String companyId, String employmentCd, ExcessOutsideTimeSet domain){
		...
		KrcstMonsetEmpRegExot entity = this.getEntityManager().find(KrcstMonsetEmpRegExot.class, key);
