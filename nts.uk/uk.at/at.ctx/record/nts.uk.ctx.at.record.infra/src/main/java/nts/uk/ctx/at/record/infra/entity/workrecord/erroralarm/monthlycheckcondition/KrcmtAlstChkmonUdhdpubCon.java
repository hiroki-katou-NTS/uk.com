...
public class KrcmtAlstChkmonUdhdpubCon extends ContractUkJpaEntity implements Serializable  {
	...
	public KrcmtAlstChkmonUdhdpubCon(String errorAlarmCheckID, int compareOperator, BigDecimal numberDayDiffHoliday1, BigDecimal numberDayDiffHoliday2) {
		super();
	...
	public static KrcmtAlstChkmonUdhdpubCon toEntity(SpecHolidayCheckCon domain) {
		return new KrcmtAlstChkmonUdhdpubCon(
