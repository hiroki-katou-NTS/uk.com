...
public class JpaDivergenceTimeRepository extends JpaRepository implements DivergenceTimeRepository {
	...
	private final String SELECT_ATTENDANCEID = SELECT_ALL_DIVTIME + " WHERE c.divTimeUseSet = :divTimeUseSet";
	...
	private static DivergenceTime toDomainDivTime(KmkmtDivergenceTime entity) {
		val domain = DivergenceTime.createSimpleFromJavaType(entity.kmkmtDivergenceTimePK.companyId,
				entity.kmkmtDivergenceTimePK.divTimeId, entity.attendanceId, entity.divTimeName, entity.divTimeUseSet,
				entity.alarmTime, entity.errTime, entity.selectUseSet, entity.cancelErrSelReason, entity.inputUseSet,
	...
	@Override
	public List<DivergenceTime> getAttendanceId(String companyId, int divTimeUseSet) {
		return this.queryProxy().query(SELECT_ATTENDANCEID, KmkmtDivergenceTime.class)
				.setParameter("companyId", companyId).setParameter("divTimeUseSet", divTimeUseSet)
