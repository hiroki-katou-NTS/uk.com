...
/**
 * The persistent class for the KRCMT_TEMPORARY_MNG database table.
 * 
 */
@Getter
@Setter
...
public class KrcmtTemporaryMng extends UkJpaEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KrcmtTemporaryMng other = (KrcmtTemporaryMng) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
