...
@Data
@NoArgsConstructor
public class KrcmtCalcDRestTimePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof KrcmtCalcDRestTimePK)) {
			return false;
		}
		KrcmtCalcDRestTimePK castOther = (KrcmtCalcDRestTimePK)other;
		return 
