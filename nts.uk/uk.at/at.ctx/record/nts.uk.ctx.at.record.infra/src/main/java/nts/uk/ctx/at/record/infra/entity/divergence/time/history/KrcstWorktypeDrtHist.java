...
@NamedQuery(name="KrcstWorktypeDrtHist.findAll", query="SELECT k FROM KrcstWorktypeDrtHist k")
public class KrcstWorktypeDrtHist implements Serializable {
