...
@StaticMetamodel(KrcmtDvgcAttendance.class)
public class KrcstDvgcAttendance_ { 

    public static volatile SingularAttribute<KrcmtDvgcAttendance, KrcstDvgcAttendancePK> id;
