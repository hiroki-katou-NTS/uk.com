...
public class KrcstDvgcTime_ { 
    ...
    public static volatile SingularAttribute<KrcmtDvgcTime, KrcstDvgcTimePK> id;
    public static volatile SingularAttribute<KrcmtDvgcTime, BigDecimal> dvgcType;
    public static volatile ListAttribute<KrcmtDvgcTime, KrcmtDvgcAttendance> krcstDvgcAttendances;
