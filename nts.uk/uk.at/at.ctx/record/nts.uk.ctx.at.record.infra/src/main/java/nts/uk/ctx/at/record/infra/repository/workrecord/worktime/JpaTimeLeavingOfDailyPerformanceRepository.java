 			...
 			if(c.getAttendanceStamp().isPresent()){
 				...
 				if(attendanceStamp.getActualStamp() != null){
 					krcdtTimeLeavingWork.attendanceActualRoudingTime = attendanceStamp.getActualStamp().getAfterRoundingTime() == null 
 	 				...
 	 				krcdtTimeLeavingWork.attendanceActualPlaceCode = attendanceStamp.getActualStamp().getLocationCode() == null 
 	 						? null : attendanceStamp.getActualStamp().getLocationCode().v();
 	 				krcdtTimeLeavingWork.attendanceActualSourceInfo = attendanceStamp.getActualStamp().getStampSourceInfo() == null 
 	 						? 0 : attendanceStamp.getActualStamp().getStampSourceInfo().value;
 				}
 				if(attendanceStamp.getStamp().isPresent()){
 					krcdtTimeLeavingWork.attendanceStampRoudingTime = attendanceStamp.getStamp().get().getAfterRoundingTime() == null 
 	 				...
 	 				krcdtTimeLeavingWork.attendanceStampPlaceCode = attendanceStamp.getStamp().get().getLocationCode() == null 
 	 						? null : attendanceStamp.getStamp().get().getLocationCode().v();
 	 				krcdtTimeLeavingWork.attendanceStampSourceInfo = attendanceStamp.getStamp().get().getStampSourceInfo() == null 
 	 						? 0 : attendanceStamp.getStamp().get().getStampSourceInfo().value;
 				}
 			...
 			if(c.getLeaveStamp().isPresent()){
 				...
 				if(leaveStamp.getActualStamp() != null){
 					krcdtTimeLeavingWork.leaveWorkActualRoundingTime = leaveStamp.getActualStamp().getAfterRoundingTime() == null 
 	 				...
 	 				krcdtTimeLeavingWork.leaveWorkActualPlaceCode = leaveStamp.getActualStamp().getLocationCode() == null 
 	 						? null : leaveStamp.getActualStamp().getLocationCode().v();
 	 				krcdtTimeLeavingWork.leaveActualSourceInfo = leaveStamp.getActualStamp().getStampSourceInfo() == null 
 	 						? 0 : leaveStamp.getActualStamp().getStampSourceInfo().value;
 				}
 				if(leaveStamp.getStamp().isPresent()){
 					krcdtTimeLeavingWork.leaveWorkStampRoundingTime = leaveStamp.getStamp().get().getAfterRoundingTime() == null 
 	 				...
 	 				krcdtTimeLeavingWork.leaveWorkStampSourceInfo = leaveStamp.getStamp().get().getStampSourceInfo() == null 
 	 						? 0 : leaveStamp.getStamp().get().getStampSourceInfo().value;
 				}
