...
@Data
@NoArgsConstructor
public class KrcmtCalcMHdOffsetPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof KrcmtCalcMHdOffsetPK)) {
			return false;
		}
		KrcmtCalcMHdOffsetPK castOther = (KrcmtCalcMHdOffsetPK)other;
		return 
