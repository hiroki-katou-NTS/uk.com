 ...
 */
@Embeddable
public class KrcdtDaiSpeDayClaPK implements Serializable {
    ...
    public KrcdtDaiSpeDayClaPK() {
    }

    public KrcdtDaiSpeDayClaPK(String sid, GeneralDate ymd, int speDayItemNo) {
        this.sid = sid;
        this.ymd = ymd;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KrcdtDaiSpeDayClaPK)) {
            return false;
        }
        KrcdtDaiSpeDayClaPK other = (KrcdtDaiSpeDayClaPK) object;
    ...
    public String toString() {
        return "entities.KrcdtDaiSpeDayClaPK[ sid=" + sid + ", ymd=" + ymd + " ]";
    }
