...
public class KrcmtExecCaseent extends ContractUkJpaEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@EmbeddedId
	public KrcmtExecCaseentPK krcmtExecCaseentPK;
	...
	public KrcmtExecCaseent(KrcmtExecCaseentPK krcmtExecCaseentPK, int orderNumber,
		...
		super();
		this.krcmtExecCaseentPK = krcmtExecCaseentPK;
	...
	public CaseSpecExeContent toDomain() {
		val domain = CaseSpecExeContent.createFromJavaType(
				this.krcmtExecCaseentPK.caseSpecExeContentID,
	...
	protected Object getKey() {
		return this.krcmtExecCaseentPK;
	}
