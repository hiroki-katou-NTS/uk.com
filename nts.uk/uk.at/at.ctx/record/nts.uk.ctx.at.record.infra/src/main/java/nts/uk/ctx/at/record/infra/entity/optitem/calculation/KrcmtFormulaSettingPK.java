...
/**
 * The Class KrcmtFormulaSettingPK.
 */
@Getter
@Setter
@Embeddable
public class KrcmtFormulaSettingPK implements Serializable {
	 ...
	 */
	public KrcmtFormulaSettingPK(String cid, Integer optionalItemNo, String formulaId) {
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KrcmtFormulaSettingPK)) {
			return false;
		}
		KrcmtFormulaSettingPK other = (KrcmtFormulaSettingPK) object;
