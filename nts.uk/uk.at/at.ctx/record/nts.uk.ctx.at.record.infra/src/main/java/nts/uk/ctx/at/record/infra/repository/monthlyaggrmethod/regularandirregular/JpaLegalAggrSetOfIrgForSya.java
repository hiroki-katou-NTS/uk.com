...
public class JpaLegalAggrSetOfIrgForSya extends JpaRepository implements LegalAggrSetOfIrgForSyaRepository {
	...
	public void update(String companyId, String employeeId, LegalAggrSetOfIrg legalAggrSetOfIrg) {
		this.toUpdate(companyId, employeeId, legalAggrSetOfIrg);
	}
	 ...
	 */
	private void toUpdate(String companyId, String employeeId, LegalAggrSetOfIrg domain){
		...
		KrcstMonsetSyaIrgAggr entity = this.getEntityManager().find(KrcstMonsetSyaIrgAggr.class, key);
