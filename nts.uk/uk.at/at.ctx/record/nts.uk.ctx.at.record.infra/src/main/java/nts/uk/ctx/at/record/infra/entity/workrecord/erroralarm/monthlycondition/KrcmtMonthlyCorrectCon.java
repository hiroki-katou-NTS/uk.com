...
public class KrcmtMonthlyCorrectCon extends ContractUkJpaEntity implements Serializable {
	...
	public KrcmtMonthlyCorrectCon(KrcmtMonthlyCorrectConPK krcmtMonthlyCorrectConPK, String errorAlarmName,
	...
	public static MonthlyCorrectExtractCondition toDomain(KrcmtMonthlyCorrectCon entity) {
	...
	public static KrcmtMonthlyCorrectCon fromDomain(MonthlyCorrectExtractCondition domain) {
		return new KrcmtMonthlyCorrectCon(new KrcmtMonthlyCorrectConPK(AppContexts.user().companyId(), domain.getCode().v()),
