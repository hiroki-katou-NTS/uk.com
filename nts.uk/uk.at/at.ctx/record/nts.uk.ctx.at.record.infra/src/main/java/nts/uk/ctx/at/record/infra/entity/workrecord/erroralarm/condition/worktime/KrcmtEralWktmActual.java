...
public class KrcmtEralWktmActual extends UkJpaEntity implements Serializable {
	...
	public KrcmtEralWktmActual(KrcstErAlWhPlanActualPK krcstErAlWhPlanActualPK) {
		super();
