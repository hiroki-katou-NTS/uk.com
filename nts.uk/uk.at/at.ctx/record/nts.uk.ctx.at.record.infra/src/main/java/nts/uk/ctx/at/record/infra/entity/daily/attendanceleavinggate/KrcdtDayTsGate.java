...
/**
 * The persistent class for the KRCDT_DAY_TS_GATE database table.
 * 
 */
@Entity
...
// KrcdtDayTsGate k")
public class KrcdtDayTsGate extends UkJpaEntity implements Serializable {
	...
	public static List<KrcdtDayTsGate> from(AttendanceLeavingGateOfDaily domain){
