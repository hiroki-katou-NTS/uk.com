package nts.uk.ctx.at.record.infra.entity.monthly.information.care;
...
@Entity
@Table(name = "KRCDT_MON_CARE_HD_REMAIN")
@NoArgsConstructor
@AllArgsConstructor
public class KrcdtMonCareHdRemain extends UkJpaEntity implements Serializable{

	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	public KrcdtMonCareHdRemainPK hdRemainPK;
