...
//				512, 513, 514, 515, 516, 517, 530, 531, 532, 533, 534, 535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 
...
//				821, 822, 823, 824, 825, 826, 827, 828, 829, 830, 831, 832, 833, 834, 835, 836, 837
		...
		List<ItemValue> items = AttendanceItemUtil.toItemValues(new AttendanceTimeOfMonthlyDto(), itemIds, AttendanceItemType.MONTHLY_ITEM).stream()
	...
	public void test_FromItemValues() {
		List<ItemValue> itemIds = Arrays.asList(new ItemValue(ValueType.STRING, "", 1, 001),
				new ItemValue(ValueType.STRING, "", 2, 002), new ItemValue(ValueType.INTEGER, "", 3, 101),
				new ItemValue(ValueType.INTEGER, "", 4, 102), new ItemValue(ValueType.INTEGER, "", 5, 103),
				new ItemValue(ValueType.INTEGER, "", 6, 104), new ItemValue(ValueType.STRING, "", 28, 003),
				new ItemValue(ValueType.STRING, "", 29, 004), new ItemValue(ValueType.STRING, "", 623, "職場ID"),
				new ItemValue(ValueType.STRING, "", 624, "分類コード"), new ItemValue(ValueType.STRING, "", 625, "職位ID"),
				new ItemValue(ValueType.STRING, "", 626, "雇用コード"), new ItemValue(ValueType.INTEGER, "", 759, 759),
				...
				new ItemValue(ValueType.INTEGER, "", 765, 765), new ItemValue(ValueType.INTEGER, "", 766, 766),
				new ItemValue(ValueType.INTEGER, "", 86, 1), new ItemValue(ValueType.INTEGER, "", 93, 2),
				new ItemValue(ValueType.INTEGER, "", 100, 3), new ItemValue(ValueType.INTEGER, "", 107, 4),
				new ItemValue(ValueType.INTEGER, "", 114, 5), new ItemValue(ValueType.INTEGER, "", 121, 6),
				new ItemValue(ValueType.INTEGER, "", 128, 7), new ItemValue(ValueType.INTEGER, "", 135, 8),
				new ItemValue(ValueType.INTEGER, "", 142, 9), new ItemValue(ValueType.INTEGER, "", 149, 10),
				new ItemValue(ValueType.INTEGER, "", 416, 1), new ItemValue(ValueType.INTEGER, "", 417, 2),
				new ItemValue(ValueType.INTEGER, "", 418, 3), new ItemValue(ValueType.INTEGER, "", 419, 4),
				new ItemValue(ValueType.INTEGER, "", 420, 5), new ItemValue(ValueType.INTEGER, "", 421, 6),
