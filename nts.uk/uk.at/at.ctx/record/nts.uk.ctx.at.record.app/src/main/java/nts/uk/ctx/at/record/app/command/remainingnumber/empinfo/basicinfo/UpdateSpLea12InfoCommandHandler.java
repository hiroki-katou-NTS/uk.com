...
@Stateless
public class UpdateSpLea12InfoCommandHandler extends CommandHandler<SpecialleaveinformationCommand>
implements PeregUpdateCommandHandler<SpecialleaveinformationCommand>{
	...
	protected void handle(CommandHandlerContext<SpecialleaveinformationCommand> context) {
		...
		updateSpLeaInfoCommandHandler.addHandler(command, SpecialLeaveCode.CS00050.value);
	}
