...
@Stateless
public class AddChildCareCommandHandler extends AsyncCommandHandler<UpdateCareDataCommand> {
	...
	protected void handle(CommandHandlerContext<UpdateCareDataCommand> context) {
		...
		repo.add(new NursingCareLeaveRemainingData(data.getSId(), EnumAdaptor.valueOf(2, LeaveType.class),
