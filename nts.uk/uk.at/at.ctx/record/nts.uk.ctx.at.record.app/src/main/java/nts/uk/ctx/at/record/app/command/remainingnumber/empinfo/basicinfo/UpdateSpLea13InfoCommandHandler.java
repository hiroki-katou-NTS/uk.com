...
@Stateless
public class UpdateSpLea13InfoCommandHandler extends CommandHandler<SpecialleaveinformationCommand>
implements PeregUpdateCommandHandler<SpecialleaveinformationCommand>{
	...
	protected void handle(CommandHandlerContext<SpecialleaveinformationCommand> context) {
		...
		updateSpLeaInfoCommandHandler.addHandler(command, SpecialLeaveCode.CS00051.value);
	}
