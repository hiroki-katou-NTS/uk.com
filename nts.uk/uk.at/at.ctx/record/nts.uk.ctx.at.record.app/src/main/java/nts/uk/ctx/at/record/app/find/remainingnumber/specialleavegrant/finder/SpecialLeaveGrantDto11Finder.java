...
@Stateless
public class SpecialLeaveGrantDto11Finder implements PeregFinder<SpecialLeaveGrantDto11>{
	...
	@Override
	public Class<SpecialLeaveGrantDto11> dtoClass() {
		return SpecialLeaveGrantDto11.class;
	}
	...
	public PeregDomainDto getSingleData(PeregQuery query) {
		...
		return specialLeaveGrantFinder.getSingleData(query, SpecialLeaveGrantCode.CS00059.value);
	}
