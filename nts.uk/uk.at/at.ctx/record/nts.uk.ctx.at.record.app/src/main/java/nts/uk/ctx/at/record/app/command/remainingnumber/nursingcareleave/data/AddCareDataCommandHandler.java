...
@Stateless
public class AddCareDataCommandHandler extends AsyncCommandHandler<UpdateCareDataCommand> {
	...
	protected void handle(CommandHandlerContext<UpdateCareDataCommand> context) {
		...
		repo.add(new NursingCareLeaveRemainingData(data.getSId(), EnumAdaptor.valueOf(1, LeaveType.class),
