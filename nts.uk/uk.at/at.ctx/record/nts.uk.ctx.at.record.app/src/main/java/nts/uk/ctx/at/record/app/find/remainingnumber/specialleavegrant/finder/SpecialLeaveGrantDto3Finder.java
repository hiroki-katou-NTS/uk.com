...
@Stateless
public class SpecialLeaveGrantDto3Finder implements PeregFinder<SpecialLeaveGrantDto3>{
	...
	@Override
	public Class<SpecialLeaveGrantDto3> dtoClass() {
		return SpecialLeaveGrantDto3.class;
	}
	...
	public PeregDomainDto getSingleData(PeregQuery query) {
		...
		return specialLeaveGrantFinder.getSingleData(query, SpecialLeaveGrantCode.CS00041.value);
	}
