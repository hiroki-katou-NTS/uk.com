...
@Stateless
public class AddSpLea14InfoCommandHandler extends CommandHandlerWithResult<SpecialleaveinformationCommand, PeregAddCommandResult>
implements PeregAddCommandHandler<SpecialleaveinformationCommand>{
	...
	protected PeregAddCommandResult handle(CommandHandlerContext<SpecialleaveinformationCommand> context) {
		...
		return new PeregAddCommandResult(addSpLeaInfoCommandHandler.addHandler(command, SpecialLeaveCode.CS00052.value));
	}
