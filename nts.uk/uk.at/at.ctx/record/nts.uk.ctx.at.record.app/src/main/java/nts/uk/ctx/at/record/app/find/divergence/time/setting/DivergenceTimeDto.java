...
public class DivergenceTimeDto implements DivergenceTimeSetMemento {
	 ...
	 * 
	 * @see
	 * nts.uk.ctx.at.record.dom.divergence.time.setting.DivergenceTimeSetMemento
	 ...
	 * @see
	 * nts.uk.ctx.at.record.dom.divergence.time.setting.DivergenceTimeSetMemento
	 * #setDivTimeUseSet(nts.uk.ctx.at.record.dom.divergence.time.setting.
	 ...
	 * @see
	 * nts.uk.ctx.at.record.dom.divergence.time.setting.DivergenceTimeSetMemento
	 * #setDivTimeName(nts.uk.ctx.at.record.dom.divergence.time.setting.
	 * DivergenceTimeName)
	 */
	@Override
	 ...
	 * @see
	 * nts.uk.ctx.at.record.dom.divergence.time.setting.DivergenceTimeSetMemento
	 * #setDivType(nts.uk.ctx.at.record.dom.divergence.time.history.
	 * DivergenceType)
	 */
	@Override
	 ...
	 * @see
	 * nts.uk.ctx.at.record.dom.divergence.time.setting.DivergenceTimeSetMemento
	 * #setErrorCancelMedthod(nts.uk.ctx.at.record.dom.divergence.time.setting.
