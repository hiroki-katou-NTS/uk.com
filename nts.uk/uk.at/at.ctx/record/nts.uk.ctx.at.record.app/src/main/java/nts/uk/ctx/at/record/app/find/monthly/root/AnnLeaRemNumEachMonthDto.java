...
public class AnnLeaRemNumEachMonthDto extends MonthlyItemCommon {
	...
	/** 年休 */
	@AttendanceItemLayout(jpPropertyName = "年休", layout = "C")
	private AnnualLeaveDto annualLeave;

	/** 実年休 */
	@AttendanceItemLayout(jpPropertyName = "実年休", layout = "D")
	private AnnualLeaveDto realAnnualLeave;

	/** 半日年休 */
	@AttendanceItemLayout(jpPropertyName = "半日年休", layout = "E")
	private HalfDayAnnualLeaveDto halfDayAnnualLeave;

	/** 実半日年休 */
	@AttendanceItemLayout(jpPropertyName = "実半日年休", layout = "F")
	private HalfDayAnnualLeaveDto realHalfDayAnnualLeave;

	/** 年休付与情報 */
	@AttendanceItemLayout(jpPropertyName = "年休付与情報", layout = "G")
	private AnnualLeaveGrantDto annualLeaveGrant;

	/** 上限残時間 */
	@AttendanceItemLayout(jpPropertyName = "上限残時間", layout = "H")
	private TimeAnnualLeaveUsedTimeDto maxRemainingTime;

	/** 実上限残時間 */
	@AttendanceItemLayout(jpPropertyName = "実上限残時間", layout = "I")
	private TimeAnnualLeaveUsedTimeDto realMaxRemainingTime;

	/** 年休出勤率日数 */
	@AttendanceItemLayout(jpPropertyName = "年休出勤率日数", layout = "J")
	private AnnualLeaveAttdRateDaysDto attendanceRateDays;

	/** 付与区分 */
	@AttendanceItemLayout(jpPropertyName = "付与区分", layout = "K")
