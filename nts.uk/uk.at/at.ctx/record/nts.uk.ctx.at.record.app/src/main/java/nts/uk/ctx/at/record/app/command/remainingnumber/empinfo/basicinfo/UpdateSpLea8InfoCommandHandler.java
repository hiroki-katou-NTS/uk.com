...
@Stateless
public class UpdateSpLea8InfoCommandHandler extends CommandHandler<SpecialleaveinformationCommand>
implements PeregUpdateCommandHandler<SpecialleaveinformationCommand>{
	...
	protected void handle(CommandHandlerContext<SpecialleaveinformationCommand> context) {
		...
		updateSpLeaInfoCommandHandler.addHandler(command, SpecialLeaveCode.CS00032.value);
	}
