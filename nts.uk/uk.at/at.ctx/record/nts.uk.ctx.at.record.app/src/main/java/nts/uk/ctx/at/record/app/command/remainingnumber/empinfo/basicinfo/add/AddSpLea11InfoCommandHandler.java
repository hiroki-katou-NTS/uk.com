...
@Stateless
public class AddSpLea11InfoCommandHandler extends CommandHandlerWithResult<AddSpecialleave11informationCommand, PeregAddCommandResult>
...
String cid = AppContexts.user().companyId();
		...
		SpecialLeaveBasicInfo domain = new SpecialLeaveBasicInfo(cid, command.getSID(), SpecialLeaveCode.CS00049.value, command.getUseAtr(), command.getAppSet(), command.getGrantDate(),
