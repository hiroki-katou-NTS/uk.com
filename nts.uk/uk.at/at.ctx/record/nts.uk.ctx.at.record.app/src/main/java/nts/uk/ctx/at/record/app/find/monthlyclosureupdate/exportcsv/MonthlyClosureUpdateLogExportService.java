...
@Stateless
public class MonthlyClosureUpdateLogExportService extends ExportService<List<MonthlyClosureErrorInforDto>> {
	...
	@Override
	protected void handle(ExportServiceContext<List<MonthlyClosureErrorInforDto>> context) {
		List<MonthlyClosureErrorInforDto> data = context.getQuery();
		...
		CSVFileData fileData = new CSVFileData(FILE_NAME, header, dataSource);
