...
@Stateless
public class AddSpLea6InfoCommandHandler extends CommandHandlerWithResult<SpecialleaveinformationCommand, PeregAddCommandResult>
implements PeregAddCommandHandler<SpecialleaveinformationCommand>{
	...
	protected PeregAddCommandResult handle(CommandHandlerContext<SpecialleaveinformationCommand> context) {
		...
		return new PeregAddCommandResult(addSpLeaInfoCommandHandler.addHandler(command, SpecialLeaveCode.CS00030.value));
	}
