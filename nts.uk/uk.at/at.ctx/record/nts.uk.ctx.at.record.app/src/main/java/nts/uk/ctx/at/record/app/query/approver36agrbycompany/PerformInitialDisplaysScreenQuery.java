...
public class PerformInitialDisplaysScreenQuery {
    ...
    public PerformInitialDisplaysScreenDto getApprove36AerByCompany(){
        ...
        return new PerformInitialDisplaysScreenDto(byCompanyList,rsApproveList,rsConfirmedList);
    }
    ...
    private List<PersonEmpBasicInfoDto> getPersonInfo(List<String> listEmployIds){
        ...
        if(!listPerson.isEmpty()){
            ...
            val personInfo = personInfoAdapter.getByListId(listPersonId);
