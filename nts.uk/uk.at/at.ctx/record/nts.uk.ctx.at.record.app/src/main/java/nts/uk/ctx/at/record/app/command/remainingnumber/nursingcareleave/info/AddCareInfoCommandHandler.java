...
@Stateless
public class AddCareInfoCommandHandler extends AsyncCommandHandler<UpdateCareInfoCommand>{
	...
	protected void handle(CommandHandlerContext<UpdateCareInfoCommand> context) {
		...
		repo.add(new NursingCareLeaveRemainingInfo(data.getSId(), EnumAdaptor.valueOf(1, LeaveType.class), 
