...
/**
 * The Class UpdateEmploymentLaborDeforSetTemporaryCommand.
 */
@Getter
@Setter
public class UpdateEmploymentLaborDeforSetTemporaryCommand implements EmpLaborDeforSetTemporaryGetMemento {
	 ...
	 * EmploymentLaborDeforSetTemporaryGetMemento#getCompanyId()
	 */
	@Override
	 ...
	 * 
	 * @see nts.uk.ctx.at.record.dom.workrecord.monthlyresult.employment.
	 * EmploymentLaborDeforSetTemporaryGetMemento#getEmploymentCode()
	 */
	@Override
	 ...
	 * 
	 * @see nts.uk.ctx.at.record.dom.workrecord.monthlyresult.employment.
	 * EmploymentLaborDeforSetTemporaryGetMemento#getLegalAggrSetOfIrgNew()
	 */
	@Override
