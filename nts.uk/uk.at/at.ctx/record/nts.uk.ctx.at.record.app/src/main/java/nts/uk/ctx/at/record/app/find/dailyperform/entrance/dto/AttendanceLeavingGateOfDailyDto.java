package nts.uk.ctx.at.record.app.find.dailyperform.entrance.dto;
...
public class AttendanceLeavingGateOfDailyDto implements ConvertibleAttendanceItem {
	...
	@AttendanceItemLayout(layout = "A", jpPropertyName = "入退門時刻", isList = true)
	private List<TimeSheetDto> entranceTime;
}
