...
import nts.uk.ctx.at.record.dom.workrecord.monthlyresult.company.ComLaborDeforSetMonthlySetMemento;
...
public class CompanyLaborDeforSetMonthlyDto implements ComLaborDeforSetMonthlySetMemento{
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.record.dom.workrecord.monthlyresult.company.CompanyLaborDeforSetMonthlySetMemento#setLegalAggrSetOfIrgNew(nts.uk.ctx.at.record.dom.workrecord.monthlyresult.LegalAggrSetOfIrgNew)
	 */
	@Override
