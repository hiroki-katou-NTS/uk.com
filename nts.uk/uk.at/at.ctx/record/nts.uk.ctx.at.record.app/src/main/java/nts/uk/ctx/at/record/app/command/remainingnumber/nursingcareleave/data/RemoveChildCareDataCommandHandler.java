...
@Stateless
public class RemoveChildCareDataCommandHandler extends AsyncCommandHandler<RemoveCareDataCommand> {
	...
	protected void handle(CommandHandlerContext<RemoveCareDataCommand> context) {
		...
		updateObj.setLeaveType(EnumAdaptor.valueOf(2, LeaveType.class));
