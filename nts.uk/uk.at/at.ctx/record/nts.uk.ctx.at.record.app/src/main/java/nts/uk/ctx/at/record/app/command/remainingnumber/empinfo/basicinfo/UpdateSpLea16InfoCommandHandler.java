...
@Stateless
public class UpdateSpLea16InfoCommandHandler extends CommandHandler<SpecialleaveinformationCommand>
implements PeregUpdateCommandHandler<SpecialleaveinformationCommand>{
	...
	protected void handle(CommandHandlerContext<SpecialleaveinformationCommand> context) {
		...
		updateSpLeaInfoCommandHandler.addHandler(command, SpecialLeaveCode.CS00054.value);
	}
