...
public class GetOmissionContentsFinder {
	...
	public DailyAttdErrorInfoDto getOmissionContents(int pageNo, int buttonDisNo) {
		...
		CheckAttdErrorAfterStampRequiredImpl required = new CheckAttdErrorAfterStampRequiredImpl(new CacheCarrier());
	...
	@AllArgsConstructor
	private class CheckAttdErrorAfterStampRequiredImpl implements 
		CheckAttdErrorAfterStampService.Require, ClosureService.RequireM3 {
