...
@Data
@Builder
public class ScheFixItemDayDto {
	 ...
	 */
	public static ScheFixItemDayDto fromDomain(FixedExtractionSDailyItems domain) {
		String initMessage = domain.getInitMsg() != null ? domain.getInitMsg().get().v() : "";
		
		return ScheFixItemDayDto.builder()
				.fixedCheckDayItems(domain.getFixedCheckDayItems().value)
