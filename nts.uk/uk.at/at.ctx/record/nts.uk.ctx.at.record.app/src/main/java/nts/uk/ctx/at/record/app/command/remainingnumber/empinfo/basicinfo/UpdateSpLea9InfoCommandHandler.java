...
@Stateless
public class UpdateSpLea9InfoCommandHandler extends CommandHandler<SpecialleaveinformationCommand>
implements PeregUpdateCommandHandler<SpecialleaveinformationCommand>{
	...
	protected void handle(CommandHandlerContext<SpecialleaveinformationCommand> context) {
		...
		updateSpLeaInfoCommandHandler.addHandler(command, SpecialLeaveCode.CS00033.value);
	}
