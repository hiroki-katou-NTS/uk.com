...
@Stateless
public class UpdateCareDataCommandHandler extends AsyncCommandHandler<UpdateCareDataCommand>{
	...
	protected void handle(CommandHandlerContext<UpdateCareDataCommand> context) {
		...
		repo.update(new NursingCareLeaveRemainingData(data.getSId(), EnumAdaptor.valueOf(1, LeaveType.class),
