...
@Stateless
public class AddSpeLeaGrant9CommandHandler
		extends CommandHandlerWithResult<AddSpecialLeaveGrant9Command, PeregAddCommandResult>
		implements PeregAddCommandHandler<AddSpecialLeaveGrant9Command> {
	...
	@Override
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialLeaveGrant9Command> context) {
