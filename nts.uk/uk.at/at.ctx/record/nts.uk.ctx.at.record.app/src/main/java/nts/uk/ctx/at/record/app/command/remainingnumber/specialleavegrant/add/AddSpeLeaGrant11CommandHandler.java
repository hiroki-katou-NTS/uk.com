...
@Stateless
public class AddSpeLeaGrant11CommandHandler
		extends CommandHandlerWithResult<AddSpecialLeaveGrant11Command, PeregAddCommandResult>
		implements PeregAddCommandHandler<AddSpecialLeaveGrant11Command> {
	...
	@Override
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialLeaveGrant11Command> context) {
