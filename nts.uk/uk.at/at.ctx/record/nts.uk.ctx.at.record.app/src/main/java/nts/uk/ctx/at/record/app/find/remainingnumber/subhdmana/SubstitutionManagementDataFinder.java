...
public class SubstitutionManagementDataFinder {
	...
	public ExtraHolidayManagementDataDto getExtraHolidayManagementData(SubDataSearchConditionDto dto){
		ExtraHolidayManagementOutput extraHolidayOutput = extraHolidayManagementService.dataExtractionProcessing(dto.getEmployeeId(), dto.getStartDate(), dto.getEndDate());
