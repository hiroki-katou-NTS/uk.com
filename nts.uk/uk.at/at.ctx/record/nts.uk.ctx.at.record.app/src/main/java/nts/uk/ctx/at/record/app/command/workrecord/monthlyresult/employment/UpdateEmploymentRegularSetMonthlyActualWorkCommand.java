...
/**
 * The Class UpdateEmploymentRegularSetMonthlyActualWorkCommand.
 */
@Getter
 ...
 *
 * @param legalAggrSetOfRegNew
 *            the new legal aggr set of reg new
 */
@Setter
public class UpdateEmploymentRegularSetMonthlyActualWorkCommand
