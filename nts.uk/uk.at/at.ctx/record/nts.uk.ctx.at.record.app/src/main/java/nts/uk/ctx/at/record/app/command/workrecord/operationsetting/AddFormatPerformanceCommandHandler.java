...
@Stateless
@Transactional
public class AddFormatPerformanceCommandHandler extends CommandHandler<FormatPerformanceCommand>
{
    ...
    protected void handle(CommandHandlerContext<FormatPerformanceCommand> context) {
        FormatPerformanceCommand addCommand = context.getCommand();
        repository.add(FormatPerformance.createFromJavaType(addCommand.getCid(), addCommand.getSettingUnitType()));
