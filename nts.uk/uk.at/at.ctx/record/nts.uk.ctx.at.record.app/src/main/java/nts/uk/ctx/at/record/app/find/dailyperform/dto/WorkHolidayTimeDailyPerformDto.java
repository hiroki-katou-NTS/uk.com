...
public class WorkHolidayTimeDailyPerformDto {
	...
	public static WorkHolidayTimeDailyPerformDto fromOverTimeWorkDailyPerform(HolidayWorkTimeOfDaily domain) {
		return domain == null ? null
				: new WorkHolidayTimeDailyPerformDto(
						domain.getHolidayWorkFrameTimeSheet().stream()
								.map(c -> new HolidayWorkFrameTimeSheetDto(
										new TimeSpanForCalcDto(c.getTimeSheet().getStart().valueAsMinutes(),
												c.getTimeSheet().getEnd().valueAsMinutes()),
						...
						ConvertHelper.mapTo(domain.getHolidayWorkFrameTime(), (c) -> new HolidayWorkFrameTimeDto(
								new CalcAttachTimeDto(
										c.getHolidayWorkTime().get().getCalcTime().valueAsMinutes(),
								...
								c.getBeforeApplicationTime().get().valueAsMinutes(), c.getHolidayFrameNo().v())));
	}
