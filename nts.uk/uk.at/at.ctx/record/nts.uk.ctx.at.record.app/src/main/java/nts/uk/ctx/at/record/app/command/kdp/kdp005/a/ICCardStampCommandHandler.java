...
public class ICCardStampCommandHandler extends CommandHandlerWithResult<ICCardStampCommand,GeneralDate> {
	...
	protected GeneralDate handle(CommandHandlerContext<ICCardStampCommand> context) {
		...
		EnterStampFromICCardServiceRequireImpl require = new EnterStampFromICCardServiceRequireImpl(stampSetCommunalRepository, stampCardRepo, stampCardEditRepo, companyAdapter, sysEmpPub, stampRecordRepo, stampDakokuRepo, createDailyResultDomainServiceNew);
