...
@Stateless
public class AddChildCareInfoCommandHandler extends AsyncCommandHandler<UpdateCareInfoCommand>{
	...
	protected void handle(CommandHandlerContext<UpdateCareInfoCommand> context) {
		...
		repo.add(new NursingCareLeaveRemainingInfo(data.getSId(), EnumAdaptor.valueOf(2, LeaveType.class), 
