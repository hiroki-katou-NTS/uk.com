...
@Stateless
public class GetRemainingNumberNursingPubImp implements GetRemainingNumberNursingPub {
    
    @Inject
    private GetRemainingNumberNursing getRemainingNumberNursing;

    @Override
    public ChildCareNursePeriodExport getRemainingNumberNursing(String cId, String sId, GeneralDate date) {
        
        AggrResultOfChildCareNurse result = getRemainingNumberNursing.getRemainingNumberNursing(cId, sId, date);
