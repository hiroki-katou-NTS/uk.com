...
@Getter
@NoArgsConstructor
public class CompanyAgreedHours extends AggregateRoot {
    /**
     * The companyId.
     * 会社ID
     */
    ...
    public CompanyAgreedHours(String companyId, ClassificationCode classificationCode, LaborSystemtAtr laborSystemtAtr, BasicAgreementSetting basicAgreementSetting) {
