...
public interface DailyCalculationEmployeeService {
	 ...
	 * @return 
	 */
	void calculate(AsyncCommandHandlerContext asyncContext, List<String> employeeId,DatePeriod datePeriod, Consumer<ProcessState> counter, ExecutionType reCalcAtr);
