...
public class FlexTimeOfMonthly implements SerializableWithOptional{
	 ...
	 * @param aggregateTotalWorkingTime 集計総労働時間
	 */
	private void aggregateForConvenience(DatePeriod datePeriod, MonthlyAggregateAtr aggregateAtr,
			SettingRequiredByFlex settingsByFlex, AggregateTotalWorkingTime aggregateTotalWorkingTime){
	 ...
	 * @param aggregateTotalWorkingTime 集計総労働時間
	 */
	private void calcFlexMultiForConvenience(DatePeriod period, MonthlyAggregateAtr aggregateAtr,
