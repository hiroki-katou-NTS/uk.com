...
@Getter
// 変形労働会社別月別実績集計設定
public class ComLaborDeforSetMonthly extends AggregateRoot implements SetMonthlyCalTransLabor {
	 ...
	 *            the memento
	 */
	public ComLaborDeforSetMonthly(ComLaborDeforSetMonthly memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ComLaborDeforSetMonthlySetMemento memento) {
