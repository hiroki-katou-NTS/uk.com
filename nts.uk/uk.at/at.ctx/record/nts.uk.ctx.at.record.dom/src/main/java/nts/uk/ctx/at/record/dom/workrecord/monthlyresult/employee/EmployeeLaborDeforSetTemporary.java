...
@Getter
// * 変形労働社員別月別実績集計設定.
public class EmployeeLaborDeforSetTemporary extends AggregateRoot implements SetMonthlyCalTransLabor {
	 ...
	 *            the memento
	 */
	public EmployeeLaborDeforSetTemporary(EmployeeLaborDeforSetTemporary memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(EmployeeLaborDeforSetTemporarySetMemento memento) {
