...
public class DeterminingReqStatusTerminal {
	...
	// [1] 端末のリクエスト状態の判断
	public static Map<EmpInfoTerminalCode, Boolean> determiningReqStatusTerminal(Require require, ContractCode contractCode, List<EmpInfoTerminal> empInfoTerminalList) {
