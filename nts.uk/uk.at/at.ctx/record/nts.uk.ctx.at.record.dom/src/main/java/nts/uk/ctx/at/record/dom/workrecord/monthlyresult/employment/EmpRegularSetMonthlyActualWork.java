...
@Getter
//* 通常勤務雇用別月別実績集計設定.
public class EmpRegularSetMonthlyActualWork extends AggregateRoot implements SetRegularActualWorkMonthly{
	 ...
	 */
	public EmpRegularSetMonthlyActualWork (EmpRegularSetMonthlyActualWork memento) {
	 ...
	 * @param memento the memento
	 */
	public void saveToMemento (EmpRegularSetMonthlyActualWorkSetMemento memento) {
