...
@Getter
// 通常勤務社員別月別実績集計設定
public class ShainRegularSetMonthlyActual extends AggregateRoot implements SetRegularActualWorkMonthly {
	 ...
	 *            the memento
	 */
	public ShainRegularSetMonthlyActual(ShainRegularSetMonthlyActual memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ShainRegularSetMonthlyActualSetMemento memento) {
