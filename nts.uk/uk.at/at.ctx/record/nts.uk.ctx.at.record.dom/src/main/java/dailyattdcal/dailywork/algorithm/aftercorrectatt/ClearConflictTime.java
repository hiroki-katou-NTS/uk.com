...
import nts.uk.ctx.at.record.dom.daily.holidayworktime.ClearHolidayWorkTime;
import nts.uk.ctx.at.record.dom.daily.overtimework.ClearOvertimeHour;
...
//	private WorkTypeRepository workTypeRepo;
	...
	public IntegrationOfDaily process(IntegrationOfDaily domainDaily) {
		...
		// 属性：編集状態を取得する
		List<EditStateOfDailyPerformance> lstEditState = domainDaily.getEditState().stream()
