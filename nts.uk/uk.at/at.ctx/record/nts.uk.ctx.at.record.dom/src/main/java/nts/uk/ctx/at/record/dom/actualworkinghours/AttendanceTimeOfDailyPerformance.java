...
public class AttendanceTimeOfDailyPerformance extends AggregateRoot {
	 ...
	 * @return 日別実績の勤怠時間
	 */
	public static AttendanceTimeOfDailyPerformance allZeroValue(String employeeId, GeneralDate ymd) {
		return new AttendanceTimeOfDailyPerformance(employeeId, ymd, AttendanceTimeOfDailyAttendance.allZeroValue());
	}
}
