...
@Getter
// * フレックス雇用別月別実績集計設定.
public class EmploymentCalMonthlyFlex extends AggregateRoot implements SetCalMonthlyFlex {
	 ...
	 *            the memento
	 */
	public EmploymentCalMonthlyFlex(EmploymentCalMonthlyFlex memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(EmploymentCalMonthlyFlexSetMemento memento) {
