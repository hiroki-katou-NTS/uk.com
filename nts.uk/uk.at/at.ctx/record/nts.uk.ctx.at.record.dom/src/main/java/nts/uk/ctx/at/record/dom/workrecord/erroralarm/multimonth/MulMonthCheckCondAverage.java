...
// 複数月のチェック条件(平均)
@Getter
public class MulMonthCheckCondAverage<V> extends AggregateRoot {
	...
	public MulMonthCheckCondAverage(String mulMonAlarnCondID, boolean isUsedFlg, CountableTarget countableTarget,
