...
import nts.uk.ctx.at.record.dom.statutoryworkinghours.GetShainLaborTimeImpl.Require;
...
public interface GetShainLaborTime {
	...
	Optional<WorkingTimeSetting> getShainWorkingTimeSettingRequire(Require require, String companyId, String employeeId,
