...
public class PayDaysOfMonthly {
	...
	/** 給与出勤日数 */
	private AttendanceDaysMonthDom payAttendanceDays;
	/** 給与欠勤日数 */
	private AttendanceDaysMonthDom payAbsenceDays;
	...
	public PayDaysOfMonthly(){
		...
		this.payAttendanceDays = new AttendanceDaysMonthDom(0.0);
		this.payAbsenceDays = new AttendanceDaysMonthDom(0.0);
	}
	...
	public static PayDaysOfMonthly of(
			AttendanceDaysMonthDom payAttendanceDays,
			AttendanceDaysMonthDom payAbsenceDays){
