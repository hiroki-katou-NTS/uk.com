...
public class ReflectWork {
	...
	public ReflectStampOuput reflectWork(String companyId, Stamp stamp,
		...
		if (outputCheckRangeReflectAttd == OutputCheckRangeReflectAttd.FIRST_TIME) {
			reflectStampOuput = reflectAttendanceClock.reflect(companyId, stamp, AttendanceAtr.GOING_TO_WORK, 
