...
public interface RepositoriesRequiredByMonthlyAggr {
	...
	/** 日の法定労働時間の取得 */
	DailyStatutoryLaborTime getDailyStatutoryWorkingHours();
	/** 週・月の法定労働時間の取得*/
	...
	/*Require用*/
	WkpRegulaMonthActCalSetRepository getWkpRegulaMonthActCalSetRepository();
	EmpRegulaMonthActCalSetRepository getEmpRegulaMonthActCalSetRepository();
	WkpDeforLaborMonthActCalSetRepository getWkpDeforLaborMonthActCalSetRepository();
	EmpDeforLaborMonthActCalSetRepository getEmpDeforLaborMonthActCalSetRepository();
	WkpFlexMonthActCalSetRepository getWkpFlexMonthActCalSetRepository();
	EmpFlexMonthActCalSetRepository getEmpFlexMonthActCalSetRepository();
	ComNormalSettingRepository getComNormalSettingRepository();
	ComDeforLaborSettingRepository getComDeforLaborSettingRepository();
	EmpNormalSettingRepository getEmpNormalSettingRepository();
	EmpDeforLaborSettingRepository getEmpDeforLaborSettingRepository();
	WkpNormalSettingRepository getWkpNormalSettingRepository();
	WkpDeforLaborSettingRepository getWkpDeforLaborSettingRepository();
	ShainNormalSettingRepository getShainNormalSettingRepository();
	ShainDeforLaborSettingRepository getShainDeforLaborSettingRepository();
	ShainFlexSettingRepository getShainFlexSettingRepository();
	WkpFlexSettingRepository getWkpFlexSettingRepository();
	EmpFlexSettingRepository getEmpFlexSettingRepository();
	ComFlexSettingRepository getComFlexSettingRepository();
	WorkTimeSettingRepository getWorkTimeSetRepository();
	FixedWorkSettingRepository getFixedWorkSetRepository();
	FlowWorkSettingRepository getFlowWorkSetRepository();
	DiffTimeWorkSettingRepository getDiffWorkSetRepository();
	FlexWorkSettingRepository getFlexWorkSetRepository();
	InterimRemainRepository getInterimRemainRepository();
	InterimRecAbasMngRepository getInterimRecAbasMngRepository();
	SubstitutionOfHDManaDataRepository getSubstitutionOfHDManaDataRepository();
	CompensLeaveEmSetRepository getCompensLeaveEmSetRepository();
	EmpSubstVacationRepository getEmpSubstVacationRepository();
	PayoutManagementDataRepository getPayoutManagementDataRepository();
	AnnLeaMaxDataRepository getAnnLeaMaxDataRepository();
	GrantYearHolidayRepository getGrantYearHolidayRepository();
	TmpResereLeaveMngRepository getTmpResereLeaveMngRepository();
	SpecialLeaveGrantRepository getSpecialLeaveGrantRepository();
	SpecialLeaveBasicInfoRepository getSpecialLeaveBasicInfoRepository();
	SpecialHolidayRepository getSpecialHolidayRepository();
	InterimSpecialHolidayMngRepository getInterimSpecialHolidayMngRepository();
	GrantDateTblRepository getGrantDateTblRepository();
	LeaveManaDataRepository getLeaveManaDataRepository();
	ComDayOffManaDataRepository getComDayOffManaDataRepository();
	InterimBreakDayOffMngRepository getInterimBreakDayOffMngRepository();
}