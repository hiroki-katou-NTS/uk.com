...
import dailyattdcal.dailywork.algorithm.aftercorrectatt.CorrectionAfterTimeChange;
import dailyattdcal.dailywork.algorithm.aftercorrectwork.CorrectionAfterChangeWorkInfo;
...
public class CorrectionAttendanceRule implements ICorrectionAttendanceRule {
	...
	public IntegrationOfDaily process(IntegrationOfDaily domainDaily, ChangeDailyAttendance changeAtt) {
		...
		// 手修正を基に戻す
		DailyRecordToAttendanceItemConverter afterConverter = attendanceItemConvertFactory.createDailyConverter()
				.setData(afterDomain).completed();
