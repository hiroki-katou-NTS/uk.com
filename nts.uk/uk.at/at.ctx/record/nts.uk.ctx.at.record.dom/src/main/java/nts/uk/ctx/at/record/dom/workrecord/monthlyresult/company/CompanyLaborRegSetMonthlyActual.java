...
@Getter
// * 通常勤務労働会社別月別実績集計設定.
public class CompanyLaborRegSetMonthlyActual extends AggregateRoot implements SetRegularActualWorkMonthly {
	 ...
	 *            the memento
	 */
	public CompanyLaborRegSetMonthlyActual(CompanyLaborRegSetMonthlyActual memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(CompanyLaborRegSetMonthlyActualSetMemento memento) {
