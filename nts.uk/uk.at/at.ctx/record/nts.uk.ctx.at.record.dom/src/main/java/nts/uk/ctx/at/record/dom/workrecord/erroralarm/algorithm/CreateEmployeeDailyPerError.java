...
public class CreateEmployeeDailyPerError {
	 ...
	 * @param durationDate: 対象日一覧：List＜年月日＞
	...
	public boolean employeeDailyRecordErrorCheck(String companyID, String employeeID, DatePeriod durationDate){		
		return employeeDailyPerErrorRepository.checkExistRecordErrorListDate(companyID, employeeID, getDaysBetween(durationDate.start(), durationDate.end()));
	}
