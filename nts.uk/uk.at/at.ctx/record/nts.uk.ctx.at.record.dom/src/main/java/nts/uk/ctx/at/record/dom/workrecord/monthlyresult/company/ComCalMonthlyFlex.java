...
@Getter
// フレックス会社別月別実績集計設定.
public class ComCalMonthlyFlex extends AggregateRoot implements SetCalMonthlyFlex {
	 ...
	 *            the memento
	 */
	public ComCalMonthlyFlex(ComCalMonthlyFlex memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ComCalMonthlyFlexSetMemento memento) {
