...
@Getter
// * 変形労働雇用別月別実績集計設定.
public class EmploymentLaborDeforSetTemporary extends AggregateRoot implements SetMonthlyCalTransLabor {
	 ...
	 *            the memento
	 */
	public EmploymentLaborDeforSetTemporary(EmploymentLaborDeforSetTemporary memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(EmploymentLaborDeforSetTemporarySetMemento memento) {
