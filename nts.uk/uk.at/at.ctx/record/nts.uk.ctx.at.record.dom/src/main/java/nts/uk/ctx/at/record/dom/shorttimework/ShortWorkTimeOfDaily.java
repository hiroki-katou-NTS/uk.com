...
public class ShortWorkTimeOfDaily {
	...
	public static ShortWorkTimeOfDaily calcShortWorkTime(ManageReGetClass recordClass,ChildCareAttribute careAtr) {
	 ...
	 * @return
	 */
	public static DeductionTotalTime calculationDedBreakTime(ConditionAtr conditionAtr,DeductionAtr dedAtr, CalculationRangeOfOneDay oneDay) {
		return createDudAllTime(conditionAtr,dedAtr,TimeSheetRoundingAtr.PerTimeSheet,oneDay);
	}
