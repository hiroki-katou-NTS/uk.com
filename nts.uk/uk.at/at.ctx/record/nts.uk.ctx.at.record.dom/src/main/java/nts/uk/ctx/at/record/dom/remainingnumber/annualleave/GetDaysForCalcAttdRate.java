...
import nts.uk.ctx.at.record.dom.remainingnumber.annualleave.GetDaysForCalcAttdRateImpl.Require;
...
public interface GetDaysForCalcAttdRate {
	 ...
	 * @return 年休出勤率計算結果
	 */
	CalYearOffWorkAttendRate algorithm(Require require, String companyId, String employeeId, DatePeriod period);
