...
public class GetDaysForCalcAttdRate {
	...
	public static CalYearOffWorkAttendRate algorithm(RequireM1 require, String companyId, String employeeId, DatePeriod period) {
		...
		// 「日別実績の勤務情報」を取得
		val workInfos = require.dailyWorkInfoWithOrder(employeeId, period);
	...
	public static interface RequireM1 {
		...
		List<WorkInfoOfDailyPerformance> dailyWorkInfoWithOrder(String employeeId, DatePeriod datePeriod);
