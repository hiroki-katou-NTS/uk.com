...
public class AggregateChildCareNurseTest {
	...
	public void testNextPeriodEndUsedNumber2() {
		...
		val childCare = createChildCare(YearAtr.NEXT_YEAR, 0.0, 0, 0, 0, 0);//使用日数0.0日、使用時間0:00、上限日数0、時間休暇使用回数0、時間休暇使用日数0
		val usedNumber = childCare.nextPeriodEndUsedNumber();
	...
	// 子の看護介護集計期間
	private AggregateChildCareNurse createChildCare(YearAtr secondYear, double useDay, Integer usedTimes, Integer upperLimit, int usedCount, int usedDays) {
	...
	public void testGetHolidayInfoStartMonthDay() {
		val childCare = createChildCare(0, 0, 0.0, null, 0); //使用日数0.0日、使用時間0:00、上限日数0、時間休暇使用回数なし、時間休暇使用日数0
	...
	//  子の看護介護休暇 集計期間
	private AggregateChildCareNurse createChildCare(int usedCount, int usedDays, double usedDay, Integer usedTimes, Integer upperLimit) {
		return AggregateChildCareNurse.of(
	...
	private AggregateChildCareNurseWork thisYear(double usedDay, Integer usedTimes, Integer upperLimit, int usedCount, int usedDays) {
	...
	private AggregateChildCareNurseWork nextYear(double usedDay,Integer usedTimes, Integer upperLimit, int usedCount, int usedDays) {
	...
	// 起算日から子の看護介護休暇情報
	private ChildCareNurseStartdateInfo startdateInfo(double useDay, Integer usedTimes, Integer upperLimit) {
	...
	// 本年の期間の「子の看護介護集計期間WORK」を取得する
	// 翌年の期間の「子の看護介護集計期間WORK」を取得する
	private AggregateChildCareNurseWork aggrChildCareNurseWork(YearAtr secondYear, double usedDay, Integer usedTime, Integer upperLimit) {
	...
	private AggregateChildCareNurse createChildCare() {
		...
		return AggregateChildCareNurse.of(
				Arrays.asList(AggregateChildCareNurseWork.of(null, null, null, null,
												Finally.of(ChildCareNurseCalcResultWithinPeriod.of(Arrays.asList(createError(today(), 1.0, 0, 2)), null, null))),
										AggregateChildCareNurseWork.of(null, null, null, null,
												Finally.of(ChildCareNurseCalcResultWithinPeriod.of(Arrays.asList(createError(today(), 2.0, 0, 3)), null, null)))));
	}

	//	子の看護介護エラー情報
	private ChildCareNurseErrors createError(GeneralDate ymd, double useDay, int useTime, Integer limitDays) {
