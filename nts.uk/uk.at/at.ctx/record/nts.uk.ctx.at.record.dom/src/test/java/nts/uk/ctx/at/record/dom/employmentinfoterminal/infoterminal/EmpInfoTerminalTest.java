...
public class EmpInfoTerminalTest {
	...
	public void setUp() throws Exception {
		empInfoTerminal = new EmpInfoTerminalBuilder(Optional.of(new IPAddress("192.168.1.1")), new MacAddress("AABBCCDD"),
...
//		assertThatFieldSR(resultActual.getLeft(), stampExpect);
	...
	public void getters() {
		...
		EmpInfoTerminal target = new EmpInfoTerminalBuilder(Optional.of(new IPAddress("192.168.1.1")), new MacAddress("AABBCCDD"),
				new EmpInfoTerminalCode(1), Optional.of(new EmpInfoTerSerialNo("1")), new EmpInfoTerminalName(""),
