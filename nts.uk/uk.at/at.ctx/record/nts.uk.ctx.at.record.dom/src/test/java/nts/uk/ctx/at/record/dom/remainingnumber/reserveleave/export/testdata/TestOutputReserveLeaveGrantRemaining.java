...
/**
 * テスト　積休付与残数データ 期待値　ReserveLeaveGrantRemainingクラス
 * @author masaaki_jinno
 *
 */
@Getter
public class TestOutputReserveLeaveGrantRemaining {
	...
	private static String fileName = "/nts/uk/ctx/at/record/dom/remainingnumber/Reserveleave/export/test/TestOutputReserveLeaveGrantRemaining.csv";
	
	public static List<TestOutputReserveLeaveGrantRemaining> build(){
		return CsvRecordLoader.load(fileName, builder, TestOutputReserveLeaveGrantRemaining.class);
	}

	static Function<TestDataCsvRecord, TestOutputReserveLeaveGrantRemaining> builder = record ->{
		
		TestOutputReserveLeaveGrantRemaining a = new TestOutputReserveLeaveGrantRemaining();
