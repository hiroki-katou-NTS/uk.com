...
public class AnnualPaidLeaveSettingHelper {
	public static ManageAnnualSetting createManageAnnualSetting() {
		HalfDayManage halfDayManage = HalfDayManage.builder().manageType(ManageDistinct.NO)
				.reference(MaxDayReference.CompanyUniform).maxNumberUniformCompany(new AnnualNumberDay(1))
				.roundProcesCla(RoundProcessingClassification.FractionManagementNo).build();
	...
	public static HalfDayManage createHalfDayManage(ManageDistinct manageType) {
		HalfDayManage halfDayManage =
				HalfDayManage.builder().manageType(manageType)
				.reference(MaxDayReference.CompanyUniform).maxNumberUniformCompany(new AnnualNumberDay(1))
				.roundProcesCla(RoundProcessingClassification.FractionManagementNo).build();
