...
public class CreateAttendanceTimeZoneForEachSupportWorkTest {
	...
	// List<OuenWorkTimeSheetOfDailyAttendance> result =
	// CreateAttendanceTimeZoneForEachSupportWork.create(require,
...
//
//		OuenWorkTimeSheetOfDailyAttendance ouenTimeSheet = OuenWorkTimeSheetOfDailyAttendance.create(1,
...
//		};
		...
		// List<OuenWorkTimeSheetOfDailyAttendance> result =
		// CreateAttendanceTimeZoneForEachSupportWork.create(require, empId,
		// ymd, workDetailsParams);
