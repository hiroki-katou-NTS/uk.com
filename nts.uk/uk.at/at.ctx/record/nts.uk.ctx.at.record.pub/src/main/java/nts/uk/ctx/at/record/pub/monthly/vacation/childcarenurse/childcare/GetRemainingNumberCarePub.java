 ...
 */
public interface GetRemainingNumberCarePub {
	 ...
	 */
	 // RequestList207
	ChildCareNursePeriodExport getCareRemNumWithinPeriod(String companyId, String employeeId,DatePeriod period,
	...
	public static interface Require extends GetRemainingNumberCareService.Require{
		...
		List<TempChildCareManagement> tempChildCareManagement(String employeeId, DatePeriod ymd, RemainType remainType);
