 ...
 */
@Data
public class RecordWorkInfoPubExport_Old {
...
//	private List<CommonTimeSheet> holWorkTranferTimes;
	...
	public RecordWorkInfoPubExport_Old(String workTypeCode, String workTimeCode, Integer attendanceStampTimeFirst,
	...
	public RecordWorkInfoPubExport_Old(String workTypeCode, String workTimeCode) {
		super();
		this.workTypeCode = workTypeCode;
		this.workTimeCode = workTimeCode;
	}
