 ...
 *         タイムレコードのﾘｸｴｽﾄ設定
 */
public class TimeRecordReqSettingExport implements DomainAggregate {
	...
	public TimeRecordReqSettingExport(ReqSettingBuilder builder) {
		super();
	...
	public static class ReqSettingBuilder {
		...
		public TimeRecordReqSettingExport build() {
			return new TimeRecordReqSettingExport(this);
		}
	}
