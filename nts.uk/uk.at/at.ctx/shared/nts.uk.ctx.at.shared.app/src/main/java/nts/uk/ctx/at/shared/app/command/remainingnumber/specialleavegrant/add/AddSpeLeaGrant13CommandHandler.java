...
@Stateless
public class AddSpeLeaGrant13CommandHandler
		extends CommandHandlerWithResult<AddSpecialLeaveGrant13Command, PeregAddCommandResult>
		implements PeregAddCommandHandler<AddSpecialLeaveGrant13Command> {
	...
	@Override
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialLeaveGrant13Command> context) {
