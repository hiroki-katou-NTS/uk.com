...
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant3Command>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant3Command> {
	...
	@Override
	protected List<PeregAddCommandResult> handle(CommandHandlerContext<List<AddSpecialLeaveGrant3Command>> context) {
