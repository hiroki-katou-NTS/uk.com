...
public class Specialleave17InformationFinder implements PeregFinder<Specialleave17informationDto>{
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		// 社員ID　＝　社員ID　 and 特別休暇コード＝17
		return specialleaveInformationFinder.getAllData(query, SpecialLeaveCode.CS00055.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialleaveInformationFinder.getListData(query, SpecialLeaveCode.CS00055.value);
	}
}
