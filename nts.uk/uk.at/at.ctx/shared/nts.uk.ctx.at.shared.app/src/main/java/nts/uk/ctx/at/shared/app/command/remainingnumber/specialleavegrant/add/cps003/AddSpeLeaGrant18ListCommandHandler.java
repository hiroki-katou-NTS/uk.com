...
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant18Command>, List<MyCustomizeException>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant18Command>{
	...
	@Override
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<AddSpecialLeaveGrant18Command>> context) {
