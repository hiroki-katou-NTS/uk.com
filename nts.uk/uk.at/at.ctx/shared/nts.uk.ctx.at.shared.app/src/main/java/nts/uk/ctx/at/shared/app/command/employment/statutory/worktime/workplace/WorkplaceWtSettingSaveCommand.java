 ...
 * All right reserved.                                            *
 *****************************************************************/
package nts.uk.ctx.at.shared.app.command.employment.statutory.worktime.workplace;

import lombok.Data;
import nts.uk.ctx.at.shared.app.find.employment.statutory.worktime.shared.DeformationLaborSettingDto;
import nts.uk.ctx.at.shared.app.find.employment.statutory.worktime.shared.FlexSettingDto;
import nts.uk.ctx.at.shared.app.find.employment.statutory.worktime.shared.NormalSettingDto;
