...
@Stateless
public class UpdateSpLea11InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave11informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave11informationCommand>> context) {
