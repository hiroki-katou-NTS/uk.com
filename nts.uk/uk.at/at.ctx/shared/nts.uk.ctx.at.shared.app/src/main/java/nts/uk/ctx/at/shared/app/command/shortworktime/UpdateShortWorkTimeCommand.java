...
public class UpdateShortWorkTimeCommand implements SWorkTimeHistItemGetMemento {
	...
	public List<SChildCareFrame> getLstTimeSlot() {
		...
		careFrame = new SChildCareFrame(2, new TimeWithDayAttr(startTime2.intValue()), new TimeWithDayAttr(endTime2.intValue()));
		listSChildCare.add(careFrame);
