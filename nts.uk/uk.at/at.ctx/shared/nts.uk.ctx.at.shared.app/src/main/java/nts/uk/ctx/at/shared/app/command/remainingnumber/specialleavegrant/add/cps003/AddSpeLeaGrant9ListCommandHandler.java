...
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant9Command>, List<MyCustomizeException>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant9Command> {
	...
	@Override
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<AddSpecialLeaveGrant9Command>> context) {
