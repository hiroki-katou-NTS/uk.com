...
@Stateless
public class SpecialLeaveGrantDto6Finder implements PeregFinder<SpecialLeaveGrantDto6>{
	...
	@Override
	public Class<SpecialLeaveGrantDto6> dtoClass() {
		return SpecialLeaveGrantDto6.class;
	}
	...
	public PeregDomainDto getSingleData(PeregQuery query) {
		...
		return specialLeaveGrantFinder.getSingleData(query, SpecialLeaveGrantCode.CS00044.value);
	}
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getAllData(query, SpecialLeaveGrantCode.CS00044.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getListData(query, SpecialLeaveGrantCode.CS00044.value);
	}
}
