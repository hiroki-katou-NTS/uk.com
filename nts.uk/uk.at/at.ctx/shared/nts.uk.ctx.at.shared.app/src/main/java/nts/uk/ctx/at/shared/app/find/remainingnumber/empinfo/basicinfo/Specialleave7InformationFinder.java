...
public class Specialleave7InformationFinder implements PeregFinder<Specialleave7informationDto>{
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		// 社員ID　＝　社員ID　 and 特別休暇コード＝7
		return specialleaveInformationFinder.getAllData(query, SpecialLeaveCode.CS00031.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialleaveInformationFinder.getListData(query, SpecialLeaveCode.CS00031.value);
	}
}
