...
@Stateless
public class UpdateSpLea19InfoCommandHandler extends CommandHandler<UpdateSpecialleave19informationCommand>
		implements PeregUpdateCommandHandler<UpdateSpecialleave19informationCommand> {
	...
	@Override
	protected void handle(CommandHandlerContext<UpdateSpecialleave19informationCommand> context) {
