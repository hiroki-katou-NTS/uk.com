...
@Getter
@Setter
public class Specialleave14informationDto  extends PeregDomainDto  {
	...
	public static Specialleave14informationDto createFromDomain(SpecialLeaveBasicInfo domain){
	...
	public static Specialleave14informationDto createFromDomain(Object[] domain){
		Specialleave14informationDto dto = new Specialleave14informationDto();
