...
@Stateless
public class UpdateSpLea15InfoListCommandHandler extends CommandHandlerWithResult<List<UpdateSpecialleave15informationCommand>, List<MyCustomizeException>>
	...
	@Override
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<UpdateSpecialleave15informationCommand>> context) {
