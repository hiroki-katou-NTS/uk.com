...
@Getter
@Setter
public class Specialleave7informationDto  extends PeregDomainDto  {
	...
	public static Specialleave7informationDto createFromDomain(SpecialLeaveBasicInfo domain){
