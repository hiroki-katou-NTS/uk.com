...
@Stateless
public class SpecialLeaveGrantDto13Finder implements PeregFinder<SpecialLeaveGrantDto13>{
	...
	@Override
	public Class<SpecialLeaveGrantDto13> dtoClass() {
		return SpecialLeaveGrantDto13.class;
	}
	...
	public PeregDomainDto getSingleData(PeregQuery query) {
		...
		return specialLeaveGrantFinder.getSingleData(query, SpecialLeaveGrantCode.CS00061.value);
	}
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getAllData(query, SpecialLeaveGrantCode.CS00061.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getListData(query, SpecialLeaveGrantCode.CS00061.value);
	}
}
