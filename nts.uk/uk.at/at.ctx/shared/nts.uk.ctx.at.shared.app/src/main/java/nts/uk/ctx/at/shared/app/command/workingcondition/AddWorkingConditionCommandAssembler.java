...
public class AddWorkingConditionCommandAssembler {
	public WorkingConditionItem fromDTO(String histId, AddWorkingConditionCommand command){
		...
		/** The monday. */
		// 月曜日
		getTimeZone(listTimeZone,command.getMondayStartTime1(),command.getMondayEndTime1(),command.getMondayStartTime2(),command.getMondayEndTime2());
		...
		/** The tuesday. */
		// 火曜日
		getTimeZone(listTimeZone,command.getTuesdayStartTime1(),command.getTuesdayEndTime1(),command.getTuesdayStartTime2(),command.getTuesdayEndTime2());
		...
		/** The wednesday. */
		// 水曜日
		getTimeZone(listTimeZone,command.getWednesdayStartTime1(),command.getWednesdayEndTime1(),command.getWednesdayStartTime2(),command.getWednesdayEndTime2());
		...
		/** The thursday. */
		// 木曜日
		getTimeZone(listTimeZone,command.getThursdayStartTime1(),command.getThursdayEndTime1(),command.getThursdayStartTime2(),command.getThursdayEndTime2());
		...
		/** The friday. */
		// 金曜日
		getTimeZone(listTimeZone,command.getFridayStartTime1(),command.getFridayEndTime1(),command.getFridayStartTime2(),command.getFridayEndTime2());
		...
		/** The saturday. */
		// 土曜日
		getTimeZone(listTimeZone,command.getSaturdayStartTime1(),command.getSaturdayEndTime1(),command.getSaturdayStartTime2(),command.getSaturdayEndTime2());
		...
		/** The sunday. */
		// 日曜日
		getTimeZone(listTimeZone,command.getSundayStartTime1(),command.getSundayEndTime1(),command.getSundayStartTime2(),command.getSundayEndTime2());
		...
		/** The weekday time. */
		// 平日時
		getTimeZone(listTimeZone,command.getWeekDayStartTime1(),command.getWeekDayEndTime1(),command.getWeekDayStartTime2(),command.getWeekDayEndTime2());
		...
		/** The holiday work. */
		// 休日出勤時
		getTimeZone(listTimeZone,command.getWorkInHolidayStartTime1(),command.getWorkInHolidayEndTime1(),command.getWorkInHolidayStartTime2(),command.getWorkInHolidayEndTime2());
		...
		// 法内休出時
		getTimeZone(listTimeZone,command.getInLawBreakTimeStartTime1(),command.getInLawBreakTimeEndTime1(),command.getInLawBreakTimeStartTime2(),command.getInLawBreakTimeEndTime2());
		...
		// 法外休出時
		getTimeZone(listTimeZone,command.getOutsideLawBreakTimeStartTime1(),command.getOutsideLawBreakTimeEndTime1(),command.getOutsideLawBreakTimeStartTime2(),command.getOutsideLawBreakTimeEndTime2());
		...
		// 祝日出勤時
		getTimeZone(listTimeZone,command.getHolidayAttendanceTimeStartTime1(),command.getHolidayAttendanceTimeEndTime1(),command.getHolidayAttendanceTimeStartTime2(),command.getHolidayAttendanceTimeEndTime2());
		...
		// 公休出勤時
		getTimeZone(listTimeZone,command.getWorkInPublicHolidayStartTime1(),command.getWorkInPublicHolidayEndTime1(),command.getWorkInPublicHolidayStartTime2(),command.getWorkInPublicHolidayEndTime2());
		...
		// ----------------------- BreakdownTimeDay
		BreakdownTimeDay holidayAddTimeSet = new BreakdownTimeDay(new AttendanceTime(command.getOneDay().intValue()), new AttendanceTime(command.getMorning().intValue()), new AttendanceTime(command.getAfternoon().intValue()));
		// ------------------------
		...
		WorkScheduleBusCal busCal = new WorkScheduleBusCal(
				...
				EnumAdaptor.valueOf(command.getReferenceBasicWork().intValue(), WorkScheduleMasterReferenceAtr.class),
				EnumAdaptor.valueOf(command.getReferenceType().intValue(), TimeZoneScheduledMasterAtr.class));
		...
		ScheduleMethod scheduleMethod = new ScheduleMethod(
				EnumAdaptor.valueOf(command.getBasicCreateMethod().intValue(), WorkScheduleBasicCreMethod.class),
	...
	public WorkingConditionItem fromDTO(UpdateWorkingConditionCommand command){
		...
		// ScheduleMethod
		// WorkScheduleBusCal - 営業日カレンダーによる勤務予定作成
		WorkScheduleBusCal busCal = new WorkScheduleBusCal(EnumAdaptor.valueOf(command.getReferenceBusinessDayCalendar().intValue(),WorkScheduleMasterReferenceAtr.class), EnumAdaptor.valueOf(command.getReferenceBasicWork().intValue(), WorkScheduleMasterReferenceAtr.class), EnumAdaptor.valueOf(command.getReferenceType().intValue(), TimeZoneScheduledMasterAtr.class));
		// MonthlyPatternWorkScheduleCre
	...
	private void getTimeZone(List<TimeZone> listTimeZone, BigDecimal startTime1, BigDecimal endTime1, BigDecimal startTime2, BigDecimal endTime2){
