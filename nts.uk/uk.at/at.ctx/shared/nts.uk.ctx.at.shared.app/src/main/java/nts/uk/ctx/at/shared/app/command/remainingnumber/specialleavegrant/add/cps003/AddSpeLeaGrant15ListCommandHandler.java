...
@Stateless
public class AddSpeLeaGrant15ListCommandHandler
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant15Command>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant15Command>{
	...
	public Class<?> commandClass() {
		return AddSpecialLeaveGrant15Command.class;
	}
	
	@Override
	protected List<PeregAddCommandResult> handle(CommandHandlerContext<List<AddSpecialLeaveGrant15Command>> context) {
		List<AddSpecialLeaveGrant15Command> cmd = context.getCommand();
