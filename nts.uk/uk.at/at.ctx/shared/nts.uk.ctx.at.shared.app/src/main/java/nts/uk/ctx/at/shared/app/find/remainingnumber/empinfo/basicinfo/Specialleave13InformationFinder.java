...
public class Specialleave13InformationFinder implements PeregFinder<Specialleave13informationDto>{
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		// 社員ID　＝　社員ID　 and 特別休暇コード＝13
		return specialleaveInformationFinder.getAllData(query, SpecialLeaveCode.CS00051.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialleaveInformationFinder.getListData(query, SpecialLeaveCode.CS00051.value);
	}
}
