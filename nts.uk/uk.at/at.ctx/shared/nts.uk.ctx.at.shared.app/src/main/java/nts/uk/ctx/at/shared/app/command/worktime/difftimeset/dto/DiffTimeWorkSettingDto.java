...
public class DiffTimeWorkSettingDto implements DiffTimeWorkSettingGetMemento {
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getCompanyId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getWorkTimeCode()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getRestSet()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getDayoffWorkTimezone()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getCommonSet()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#isIsUseHalfDayShift()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getChangeExtent()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getHalfDayWorkTimezones()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getStampReflectTimezone()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.difftimeset.DiffTimeWorkSettingGetMemento#getOvertimeSetting()
	 */
	@Override
