...
public class AddZeroTimeCommand {
	...
	public ZeroTime toDomain(String companyId){
		return ZeroTime.builder()
				.companyId(companyId)
				.calcFromZeroTime(calcFromZeroTime)
				.legalHd(legalHd)
				.nonLegalHd(nonLegalHd)
				.nonLegalPublicHd(nonLegalPublicHd)
				.weekday1(weekday1)
				.nonLegalHd1(nonLegalHd1)
				.nonLegalPublicHd1(nonLegalPublicHd1)
				.weekday2(weekday2)
				.legalHd2(legalHd2)
				.nonLegalHd2(nonLegalHd2)
				.weekday3(weekday3)
				.legalHd3(legalHd3)
				.nonLegalPublicHd3(nonLegalPublicHd3)
