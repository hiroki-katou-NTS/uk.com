...
public class SpecialLeaveGrantDto15Finder implements PeregFinder<SpecialLeaveGrantDto15>{
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getAllData(query, SpecialLeaveGrantCode.CS00063.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getListData(query, SpecialLeaveGrantCode.CS00063.value);
	}
}
