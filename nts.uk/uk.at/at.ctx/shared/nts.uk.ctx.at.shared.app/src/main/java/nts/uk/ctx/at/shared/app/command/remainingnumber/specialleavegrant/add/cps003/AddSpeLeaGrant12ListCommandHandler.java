...
@Stateless
public class AddSpeLeaGrant12ListCommandHandler
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant12Command>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant12Command> {
	...
	@Override
	protected List<PeregAddCommandResult> handle(CommandHandlerContext<List<AddSpecialLeaveGrant12Command>> context) {
		List<AddSpecialLeaveGrant12Command> cmd = context.getCommand();
