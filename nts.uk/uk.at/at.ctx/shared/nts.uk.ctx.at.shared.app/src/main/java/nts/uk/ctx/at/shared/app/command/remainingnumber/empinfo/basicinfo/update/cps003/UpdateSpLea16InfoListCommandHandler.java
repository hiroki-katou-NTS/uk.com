...
@Stateless
public class UpdateSpLea16InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave16informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave16informationCommand>> context) {
