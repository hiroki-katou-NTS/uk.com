...
public class WorkScheduleTimeDto {
	...
	@AttendanceItemValue(itemId=9, type=ValueType.INTEGER)
	private Integer breakTime;
	
	/** The working time. */
	//実働時間
	@AttendanceItemLayout(layout="C")
	@AttendanceItemValue(itemId=10, type=ValueType.INTEGER)
	private Integer workingTime;
	
	/** The weekday time. */
	//平日時間
	@AttendanceItemLayout(layout="D")
	@AttendanceItemValue(itemId=11, type=ValueType.INTEGER)
	private Integer weekdayTime;
	
	/** The predetermine time. */
	//所定時間
	@AttendanceItemLayout(layout="E")
	@AttendanceItemValue(itemId=12, type=ValueType.INTEGER)
	private Integer predetermineTime;
	
	/** The total labor time. */
	//総労働時間
	@AttendanceItemLayout(layout="F")
	@AttendanceItemValue(itemId=13, type=ValueType.INTEGER)
	private Integer totalLaborTime;
	
	/** The child care time. */
	//育児介護時間
	@AttendanceItemLayout(layout="G")
	@AttendanceItemValue(itemId=14, type=ValueType.INTEGER)
