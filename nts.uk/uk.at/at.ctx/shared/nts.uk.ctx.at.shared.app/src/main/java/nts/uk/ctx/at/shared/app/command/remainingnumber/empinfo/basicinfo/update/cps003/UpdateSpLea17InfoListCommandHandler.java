...
@Stateless
public class UpdateSpLea17InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave17informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave17informationCommand>> context) {
