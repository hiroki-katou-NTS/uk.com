...
@Stateless
public class UpdateSpLea5InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave5informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave5informationCommand>> context) {
