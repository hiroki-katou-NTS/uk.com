...
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant7Command>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant7Command>  {
	...
	@Override
	protected List<PeregAddCommandResult> handle(CommandHandlerContext<List<AddSpecialLeaveGrant7Command>> context) {
