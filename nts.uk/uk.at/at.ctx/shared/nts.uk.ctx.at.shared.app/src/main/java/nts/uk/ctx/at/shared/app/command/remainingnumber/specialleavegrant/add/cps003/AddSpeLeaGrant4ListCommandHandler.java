...
@Stateless
public class AddSpeLeaGrant4ListCommandHandler
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant4Command>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant4Command> {
	...
	@Override
	protected List<PeregAddCommandResult> handle(CommandHandlerContext<List<AddSpecialLeaveGrant4Command>> context) {
		List<AddSpecialLeaveGrant4Command> cmd = context.getCommand();
