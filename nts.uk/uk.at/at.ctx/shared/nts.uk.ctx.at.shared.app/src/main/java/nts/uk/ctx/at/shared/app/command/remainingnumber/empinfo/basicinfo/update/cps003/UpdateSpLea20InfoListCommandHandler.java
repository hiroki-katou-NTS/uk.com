...
@Stateless
public class UpdateSpLea20InfoListCommandHandler extends CommandHandlerWithResult<List<UpdateSpecialleave20informationCommand>, List<MyCustomizeException>>
	...
	@Override
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<UpdateSpecialleave20informationCommand>> context) {
