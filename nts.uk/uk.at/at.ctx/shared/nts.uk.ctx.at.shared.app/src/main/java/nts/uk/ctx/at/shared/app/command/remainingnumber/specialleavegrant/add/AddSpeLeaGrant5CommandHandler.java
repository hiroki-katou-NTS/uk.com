...
public class AddSpeLeaGrant5CommandHandler
	...
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialLeaveGrant5Command> context) {
		...
		boolean exist = SpecialLeaveGrantRemainingData.validate(command.getGrantDate(), command.getDeadlineDate(),  command.getNumberDayGrant(),
				command.getNumberDayUse(), null, command.getNumberDayRemain());
