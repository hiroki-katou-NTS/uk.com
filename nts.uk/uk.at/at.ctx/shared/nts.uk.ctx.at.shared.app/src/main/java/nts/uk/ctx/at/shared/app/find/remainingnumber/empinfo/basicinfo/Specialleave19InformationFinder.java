...
public class Specialleave19InformationFinder implements PeregFinder<Specialleave19informationDto>{
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		// 社員ID　＝　社員ID　 and 特別休暇コード＝19
		return specialleaveInformationFinder.getAllData(query, SpecialLeaveCode.CS00057.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialleaveInformationFinder.getListData(query, SpecialLeaveCode.CS00057.value);
	}
}
