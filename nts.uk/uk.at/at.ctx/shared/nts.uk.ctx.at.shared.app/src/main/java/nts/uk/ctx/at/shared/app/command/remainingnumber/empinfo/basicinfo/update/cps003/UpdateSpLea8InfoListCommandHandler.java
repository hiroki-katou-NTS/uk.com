...
@Stateless
public class UpdateSpLea8InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave8informationCommand>>
		implements PeregUpdateListCommandHandler<UpdateSpecialleave8informationCommand> {
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave8informationCommand>> context) {
