...
@Stateless
public class AddSpLea14InfoCommandHandler
		extends CommandHandlerWithResult<AddSpecialleave14informationCommand, PeregAddCommandResult>
		implements PeregAddCommandHandler<AddSpecialleave14informationCommand> {
	...
	@Override
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialleave14informationCommand> context) {

		val command = context.getCommand();

		String cid = AppContexts.user().companyId();

		SpecialLeaveBasicInfo domain = new SpecialLeaveBasicInfo(cid, command.getSID(), SpecialLeaveCode.CS00052.value,
