...
@Stateless
public class AddSpeLeaGrant19ListCommandHandler
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant19Command>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant19Command> {
	...
	@Override
	protected List<PeregAddCommandResult> handle(CommandHandlerContext<List<AddSpecialLeaveGrant19Command>> context) {
		List<AddSpecialLeaveGrant19Command> cmd = context.getCommand();
