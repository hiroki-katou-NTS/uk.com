...
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant19Command>, List<MyCustomizeException>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant19Command> {
	...
	@Override
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<AddSpecialLeaveGrant19Command>> context) {
