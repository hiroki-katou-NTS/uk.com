...
@Getter
@Setter
public class Specialleave20informationDto  extends PeregDomainDto {
	...
	public static Specialleave20informationDto createFromDomain(SpecialLeaveBasicInfo domain){
	...
	public static Specialleave20informationDto createFromDomain(Object[] domain){
		Specialleave20informationDto dto = new Specialleave20informationDto();
