...
@Stateless
public class UpdateSpLea12InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave12informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave12informationCommand>> context) {
