...
@Stateless
public class UpdateSpLea12InfoListCommandHandler extends CommandHandlerWithResult<List<UpdateSpecialleave12informationCommand>, List<MyCustomizeException>>
		implements PeregUpdateListCommandHandler<UpdateSpecialleave12informationCommand> {
	...
	@Override
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<UpdateSpecialleave12informationCommand>> context) {
		String cid = AppContexts.user().companyId();
		List<UpdateSpecialleave12informationCommand> cmd = context.getCommand();
