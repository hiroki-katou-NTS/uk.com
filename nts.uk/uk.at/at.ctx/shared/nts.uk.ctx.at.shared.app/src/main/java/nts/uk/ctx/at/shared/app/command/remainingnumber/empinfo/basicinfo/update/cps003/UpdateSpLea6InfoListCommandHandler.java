...
@Stateless
public class UpdateSpLea6InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave6informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave6informationCommand>> context) {
