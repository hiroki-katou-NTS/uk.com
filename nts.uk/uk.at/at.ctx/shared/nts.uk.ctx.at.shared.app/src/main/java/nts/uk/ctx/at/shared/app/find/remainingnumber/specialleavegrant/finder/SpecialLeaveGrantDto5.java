...
@Getter
@Setter
public class SpecialLeaveGrantDto5 extends PeregDomainDto {
	...
	public static SpecialLeaveGrantDto5 createFromDomain(String cid, SpecialLeaveGrantRemainingData domain) {
		SpecialLeaveGrantDto5 dto = new SpecialLeaveGrantDto5();
		dto.cid = cid;
	...
	//SpecialLeaveGrantDto5
	public static SpecialLeaveGrantDto5 createFromDomain(Object[] domain) {
		SpecialLeaveGrantDto5 dto = new SpecialLeaveGrantDto5();
