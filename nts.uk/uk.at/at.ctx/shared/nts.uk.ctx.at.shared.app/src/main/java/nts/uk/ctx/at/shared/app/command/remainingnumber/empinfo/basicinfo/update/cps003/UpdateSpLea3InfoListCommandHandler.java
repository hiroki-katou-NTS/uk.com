...
@Stateless
public class UpdateSpLea3InfoListCommandHandler extends CommandHandlerWithResult<List<UpdateSpecialleave3informationCommand>, List<MyCustomizeException>>
	...
	@Override
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<UpdateSpecialleave3informationCommand>> context) {
