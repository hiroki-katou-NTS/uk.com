...
@Stateless
public class SpecialLeaveGrantDto5Finder implements PeregFinder<SpecialLeaveGrantDto5>{
	...
	@Override
	public Class<SpecialLeaveGrantDto5> dtoClass() {
		return SpecialLeaveGrantDto5.class;
	}
	...
	public PeregDomainDto getSingleData(PeregQuery query) {
		...
		return specialLeaveGrantFinder.getSingleData(query, SpecialLeaveGrantCode.CS00043.value);
	}
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getAllData(query, SpecialLeaveGrantCode.CS00043.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getListData(query, SpecialLeaveGrantCode.CS00043.value);
	}
}
