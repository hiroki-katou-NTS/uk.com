...
@Stateless
public class AddSpeLeaGrant7CommandHandler
		extends CommandHandlerWithResult<AddSpecialLeaveGrant7Command, PeregAddCommandResult>
		implements PeregAddCommandHandler<AddSpecialLeaveGrant7Command> {
	...
	@Override
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialLeaveGrant7Command> context) {
