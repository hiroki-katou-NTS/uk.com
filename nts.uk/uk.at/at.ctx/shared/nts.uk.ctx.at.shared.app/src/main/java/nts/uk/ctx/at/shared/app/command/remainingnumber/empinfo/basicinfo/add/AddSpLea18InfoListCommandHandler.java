...
@Stateless
public class AddSpLea18InfoListCommandHandler extends CommandHandlerWithResult<List<AddSpecialleave18informationCommand>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialleave18informationCommand>{
	@Inject
	...
	protected List<PeregAddCommandResult> handle(
			CommandHandlerContext<List<AddSpecialleave18informationCommand>> context) {
		String cid = AppContexts.user().companyId();
		List<AddSpecialleave18informationCommand> cmd = context.getCommand();
