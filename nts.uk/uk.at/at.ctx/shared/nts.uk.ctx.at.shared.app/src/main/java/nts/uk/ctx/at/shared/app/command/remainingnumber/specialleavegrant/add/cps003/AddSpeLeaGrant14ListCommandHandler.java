...
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant14Command>, List<PeregAddCommandResult>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant14Command> {
	...
	@Override
	protected List<PeregAddCommandResult> handle(CommandHandlerContext<List<AddSpecialLeaveGrant14Command>> context) {
