...
@Stateless
public class UpdateSpLea7InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave7informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave7informationCommand>> context) {
