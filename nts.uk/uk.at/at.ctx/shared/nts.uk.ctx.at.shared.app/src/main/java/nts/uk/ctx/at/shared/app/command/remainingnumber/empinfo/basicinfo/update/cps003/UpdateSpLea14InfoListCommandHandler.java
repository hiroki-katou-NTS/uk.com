...
@Stateless
public class UpdateSpLea14InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave14informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave14informationCommand>> context) {
