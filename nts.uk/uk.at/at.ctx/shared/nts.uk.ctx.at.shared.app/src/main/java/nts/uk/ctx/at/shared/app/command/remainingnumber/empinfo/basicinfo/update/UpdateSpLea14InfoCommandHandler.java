...
@Stateless
public class UpdateSpLea14InfoCommandHandler extends CommandHandler<UpdateSpecialleave14informationCommand>
		implements PeregUpdateCommandHandler<UpdateSpecialleave14informationCommand> {
	...
	@Override
	protected void handle(CommandHandlerContext<UpdateSpecialleave14informationCommand> context) {
