...
extends CommandHandlerWithResult<List<AddSpecialLeaveGrant2Command>, List<MyCustomizeException>>
implements PeregAddListCommandHandler<AddSpecialLeaveGrant2Command> {
	...
	protected List<MyCustomizeException> handle(CommandHandlerContext<List<AddSpecialLeaveGrant2Command>> context) {
