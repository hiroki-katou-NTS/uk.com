...
public class AddSpeLeaGrant1CommandHandler
	...
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialLeaveGrant1Command> context) {
		...
		SpecialLeaveGrantRemainingData.validate(command.getGrantDate(), command.getDeadlineDate(), command.getNumberDayGrant(),
				command.getNumberDayUse(), new BigDecimal(0), command.getNumberDayRemain(), 
