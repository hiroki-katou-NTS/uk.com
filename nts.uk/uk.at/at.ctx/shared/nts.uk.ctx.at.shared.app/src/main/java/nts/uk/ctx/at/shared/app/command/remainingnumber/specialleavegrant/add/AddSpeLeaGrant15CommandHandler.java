...
@Stateless
public class AddSpeLeaGrant15CommandHandler
		extends CommandHandlerWithResult<AddSpecialLeaveGrant15Command, PeregAddCommandResult>
		implements PeregAddCommandHandler<AddSpecialLeaveGrant15Command> {
	...
	@Override
	protected PeregAddCommandResult handle(CommandHandlerContext<AddSpecialLeaveGrant15Command> context) {
