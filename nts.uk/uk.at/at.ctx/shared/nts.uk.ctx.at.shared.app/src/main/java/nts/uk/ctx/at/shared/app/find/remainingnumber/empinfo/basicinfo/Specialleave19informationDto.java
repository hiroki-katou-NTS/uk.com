...
@Getter
@Setter
public class Specialleave19informationDto  extends PeregDomainDto {
	...
	public static Specialleave19informationDto createFromDomain(SpecialLeaveBasicInfo domain){
	...
	public static Specialleave19informationDto createFromDomain(Object[] domain){
		Specialleave19informationDto dto = new Specialleave19informationDto();
