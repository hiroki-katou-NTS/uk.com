...
@Stateless
public class UpdateSpLea13InfoListCommandHandler extends CommandHandler<List<UpdateSpecialleave13informationCommand>>
	...
	@Override
	protected void handle(CommandHandlerContext<List<UpdateSpecialleave13informationCommand>> context) {
