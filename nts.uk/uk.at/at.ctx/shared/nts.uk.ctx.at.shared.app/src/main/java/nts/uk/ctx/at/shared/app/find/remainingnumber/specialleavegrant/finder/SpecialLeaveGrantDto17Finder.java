...
@Stateless
public class SpecialLeaveGrantDto17Finder implements PeregFinder<SpecialLeaveGrantDto17>{
	...
	@Override
	public Class<SpecialLeaveGrantDto17> dtoClass() {
		return SpecialLeaveGrantDto17.class;
	}
	...
	public PeregDomainDto getSingleData(PeregQuery query) {
		...
		return specialLeaveGrantFinder.getSingleData(query, SpecialLeaveGrantCode.CS00065.value);
	}
	...
	public List<GridPeregDomainDto> getAllData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getAllData(query, SpecialLeaveGrantCode.CS00065.value);
	}

	@Override
	public List<GridPeregDomainBySidDto> getListData(PeregQueryByListEmp query) {
		return specialLeaveGrantFinder.getListData(query, SpecialLeaveGrantCode.CS00065.value);
	}
}
