...
public class HolidayAcqManageByMDTest {
	...
	public void test_getManagementPeriod_1() {
		...
		assertThat(result.getPeriod()).isEqualTo(new DatePeriod(GeneralDate.ymd(2019, 12, 31), GeneralDate.ymd(2020, 1, 27)));
	}
	...
	public void test_getManagementPeriod_1_1() {
		...
		assertThat(result.getPeriod())
				.isEqualTo(new DatePeriod(GeneralDate.ymd(2020, 2, 1), GeneralDate.ymd(2020, 2, 28)));
	}
	...
	public void test_getManagementPeriod_1_2() {
		...
		assertThat(result.getHolidayDays().v()).isEqualTo(4.0);
		assertThat(result.getPeriod())
				.isEqualTo(new DatePeriod(GeneralDate.ymd(2020, 1, 28), GeneralDate.ymd(2020, 2, 24)));
	}
