...
public class BeforeHdWorkAppReflectTest {
	...
	@Test
	public void test1() {
		AppHolidayWorkShare holidayApp = ReflectApplicationHelper.createAppHd("005", // 勤務種類コード
				"006", // 就業時間帯コード
				1, // No
				488, // 勤務時間帯-開始時刻
				1088, // 勤務時間帯-終了時刻
		...
		assertThat(
				dailyApp.getAttendanceTimeOfDailyPerformance().get().getActualWorkingTimeOfDaily().getTotalWorkingTime()
						.getExcessOfStatutoryTimeOfDaily().getWorkHolidayTime().get().getHolidayWorkFrameTime())
								...
								.containsExactly(Tuple.tuple(1, 111));// 
