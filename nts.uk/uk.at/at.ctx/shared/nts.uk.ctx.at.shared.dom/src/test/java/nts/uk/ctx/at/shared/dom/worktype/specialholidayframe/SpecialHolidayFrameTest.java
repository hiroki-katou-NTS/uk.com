...
public class SpecialHolidayFrameTest {
	...
	// =========== Case 1
		...
		SpecialHolidayFrame maxDay = SpecialHolidayFrameHelper
				.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated, 1);
		List<Integer> lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(270, 1319);

		// 特別休暇枠No = 2 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,2);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(271, 1320);
		// 特別休暇枠No = 3 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,3);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(272, 1321);
		// 特別休暇枠No = 4 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,4);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(273, 1322);
		// 特別休暇枠No = 5 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,5);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(274, 1323);
		// 特別休暇枠No = 6 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,6);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(275, 1324);
		// 特別休暇枠No = 7 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,7);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(276, 1325);
		// 特別休暇枠No = 8 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,8);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(277, 1326);
		// 特別休暇枠No = 9 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,9);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(278, 1327);
		// 特別休暇枠No = 10 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,10);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(279, 1328);
		// 特別休暇枠No = 11 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,11);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(280, 1329);
		// 特別休暇枠No = 12 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,12);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(281, 1330);
		// 特別休暇枠No = 13 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,13);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(282, 1331);
		// 特別休暇枠No = 14 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,14);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(283, 1332);
		// 特別休暇枠No = 15 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,15);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(284, 1333);
		// 特別休暇枠No = 16 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,16);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(285, 1334);
		// 特別休暇枠No = 17 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,17);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(286, 1335);
		// 特別休暇枠No = 18 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,18);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(287, 1336);
		// 特別休暇枠No = 19 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,19);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(288, 1337);
		// 特別休暇枠No = 20 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,20);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(289, 1338);
		// 特別休暇枠No = 21 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,21);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(290, 1339);
		// 特別休暇枠No = 22 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,22);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(291, 1340);
		// 特別休暇枠No = 23 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,23);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(292, 1341);
		// 特別休暇枠No = 24 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,24);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(293, 1342);
		// 特別休暇枠No = 25 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,25);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(294, 1343);
		// 特別休暇枠No = 26 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,26);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(295, 1344);
		// 特別休暇枠No = 27 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,27);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(296, 1345);
		// 特別休暇枠No = 28 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,28);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(297, 1346);
		// 特別休暇枠No = 29 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,29);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(298, 1347);
		// 特別休暇枠No = 30 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.NotDeprecated,30);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId).extracting(d -> d).containsExactly(299, 1348);
	...
	// =========== Case 2
		...
		maxDay = SpecialHolidayFrameHelper
				.createSpecialHolidayFrame(DeprecateClassification.Deprecated, 1);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();

		// 特別休暇枠No = 2 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,2);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 3 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,3);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 4 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,4);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 5 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,5);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 6 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,6);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 7 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,7);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 8 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,8);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 9 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,9);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
		// 特別休暇枠No = 10 :
		maxDay = SpecialHolidayFrameHelper.createSpecialHolidayFrame(DeprecateClassification.Deprecated,10);
		lstId = maxDay.getMonthlyAttendanceItems();
		assertThat(lstId.isEmpty()).isTrue();
