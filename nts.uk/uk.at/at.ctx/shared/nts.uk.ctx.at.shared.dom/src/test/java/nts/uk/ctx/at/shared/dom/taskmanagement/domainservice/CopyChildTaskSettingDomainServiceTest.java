...
public class CopyChildTaskSettingDomainServiceTest {
...

    {
        ...
        static List<Tasks> createDomains(List<TaskCode> codes) {
            return codes.stream().map(e -> new Tasks(e, new TaskFrameNo(3),
        ...
        static Tasks createDomain() {
            ...
            return new Tasks(code, new TaskFrameNo(3), cooperationInfo, childWorkList, expirationDate, displayInfo);
        }
    }
}
