...
public class CancelTimeZoneApplicationTest {
	...
	public void testRemoveBreak() {
		...
		assertThat(dailyApp.getBreakTime().getBreakTimeSheets().get(0).getStartTime()).isNull();// 開始
		assertThat(dailyApp.getBreakTime().getBreakTimeSheets().get(0).getEndTime()).isNull();// 終了
	}
}
