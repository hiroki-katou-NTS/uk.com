package nts.uk.ctx.at.shared.dom.taskmanagement.aggregateroot.taskmaster;
...
import nts.uk.ctx.at.shared.dom.taskmanagement.domainservice.CheckExistenceMasterDomainService;
...
public class TasksTest {
    ...
    public void testGetter() {
        ...
        val list = Helper.childTasksList;
        ...
        val instance = Tasks.create(require, taskNo, Helper.code, Helper.expirationDate,
    ...
    public void testCaseTaskFrameNo_is05() {
        ...
        val list = Helper.childTasksList;
        val instance = Tasks.create(require, taskFrameNo, Helper.code, Helper.expirationDate,
                Helper.cooperationInfo, Helper.displayInfo, list);
     ...
     */
    @Test
    public void testChangeChildTasksLis_withFrameNo5() {
        ...
        NtsAssert.businessException("Msg_2066", () ->
                instance.changeChildTaskList(require, Helper.childTasksList));
    }
     ...
     */
    @Test
    public void testChangeChildTasksList() {

        val taskNo = new TaskFrameNo(2);
        val list = Helper.childTasksList;
        val ts = new TaskFrameNo(taskNo.v() + 1);
        val tsc = Helper.childTasksListChange;
        new Expectations(CheckExistenceMasterDomainService.class) {{
            CheckExistenceMasterDomainService.checkExistenceTaskMaster(require, ts, list);
        ...
        assertThat(instance.getChildTaskList()).isEqualTo(Helper.childTasksListChange);
    }
     ...
     */
    @Test
    public void testDeleteChildTasksList() {
...

    {
        ...
        private static final List<TaskCode> childTasksList = Arrays.asList(
                new TaskCode("CODE01"),
                new TaskCode("CODE02"),
                new TaskCode("CODE03"),
                new TaskCode("CODE04"),
        ...
        private static final List<TaskCode> childTasksListChange = Arrays.asList(
