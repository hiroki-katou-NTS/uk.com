...
public class ChangeChildWorkLinkedDomainServiceTest {
    @Injectable
    ChangeChildWorkLinkedDomainService.Require require;
    ...
    public void testCaseWorkFrameUsageSettingsAreNotSet() {
        ...
        NtsAssert.businessException("Msg_1959",
                () -> ChangeChildWorkLinkedDomainService.change(require, Helper.taskFrameNo
        ...
        new Expectations(AppContexts.class) {
            {
                ...
                require.getWorkFrameUsageSetting("cid");
                result = new WorkFrameUsageSetting(Helper.frameSettingList());

            }
        };
        NtsAssert.businessException("Msg_2066",
                () -> ChangeChildWorkLinkedDomainService.change(require, new TaskFrameNo(5)
                        , Helper.code, Helper.childWorkList));
    }
    ...
    public void testTheLowerFrameIsNotUsed() {
        ...
        NtsAssert.businessException("Msg_1957",
                () -> ChangeChildWorkLinkedDomainService.change(require, new TaskFrameNo(4)
                        , Helper.code, Helper.childWorkList));
        ...
        new Expectations(AppContexts.class) {
            {
                ...
                require.getWorkFrameUsageSetting("cid");
                result = new WorkFrameUsageSetting(Helper.frameSettingList02());
        ...
        new Expectations(AppContexts.class, Work.class) {
            {
                ...
                workOptional.changeChildWorkList(require, (List<TaskCode>) any);

            }
        };
        AtomTask atomTask = ChangeChildWorkLinkedDomainService.change(require, Helper.taskFrameNo
                , Helper.code, Helper.childWorkList);
        NtsAssert.atomTask(
                () -> atomTask,
...

    {
        ...
        static Work createDomain() {
            ...
            return new Work(code, new TaskFrameNo(5), cooperationInfo, childWorkList, expirationDate, displayInfo);
        }
    }
}
