...
public class ReflectBreakTimeTest {
	...
	public void testUpdate() {
		...
		assertThat(dailyApp.getBreakTime().getBreakTimeSheets().get(0).getStartTime().v()).isEqualTo(666);
		assertThat(dailyApp.getBreakTime().getBreakTimeSheets().get(0).getEndTime().v()).isEqualTo(1111);
	...
	public void testCreate() {
		...
		assertThat(dailyApp.getBreakTime().getBreakTimeSheets().get(1).getBreakFrameNo().v()).isEqualTo(2);
		assertThat(dailyApp.getBreakTime().getBreakTimeSheets().get(1).getStartTime().v()).isEqualTo(666);
		assertThat(dailyApp.getBreakTime().getBreakTimeSheets().get(1).getEndTime().v()).isEqualTo(1111);
