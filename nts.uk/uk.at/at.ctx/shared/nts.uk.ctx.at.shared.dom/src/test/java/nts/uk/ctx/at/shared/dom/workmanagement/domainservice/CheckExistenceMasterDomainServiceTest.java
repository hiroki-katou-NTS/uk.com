...
public class CheckExistenceMasterDomainServiceTest {
    ...
    public void testWorkHasBeenDeletedIsTrue() {
        new Expectations(AppContexts.class) {
            {
                ...
                require.getWork("cid", Helper.taskFrameNo);
        ...
        NtsAssert.businessException("Msg_2065",
                () -> CheckExistenceMasterDomainService.checkExistenceWorkMaster(require, Helper.taskFrameNo,
                        Helper.codeList));
    }
...

    {
        ...
        static List<Work> createDomain(List<TaskCode> codes) {
            return codes.stream().map(e -> new Work(e, new TaskFrameNo(5),
