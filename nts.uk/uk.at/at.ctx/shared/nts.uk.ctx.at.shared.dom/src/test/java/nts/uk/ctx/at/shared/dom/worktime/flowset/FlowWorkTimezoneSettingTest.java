...
public class FlowWorkTimezoneSettingTest {

	@Test
	public void getters() {
		FlowWorkTimezoneSetting target = new FlowWorkTimezoneSetting(
	...
	public void getInLegalOverTimesTest() {
		FlowWorkTimezoneSetting target = FlowWorkTimezoneSettingHelper.createInLegal(
