...
public class IrregularWork {
	...
	public static IrregularWork createFromJavaType(String companyId, int calcActualOperationPre,
		...
		return new IrregularWork(companyId, calcActualOperationPre, calcIntervalTimePre, calcIncludCarePre,
