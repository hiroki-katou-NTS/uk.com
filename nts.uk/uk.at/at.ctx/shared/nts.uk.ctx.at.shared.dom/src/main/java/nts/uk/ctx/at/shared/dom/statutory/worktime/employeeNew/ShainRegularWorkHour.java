...
@Getter
// 社員別通常勤務労働時間.
public class ShainRegularWorkHour extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public ShainRegularWorkHour(ShainRegularWorkHour memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ShainRegularWorkHourSetMemento memento) {
