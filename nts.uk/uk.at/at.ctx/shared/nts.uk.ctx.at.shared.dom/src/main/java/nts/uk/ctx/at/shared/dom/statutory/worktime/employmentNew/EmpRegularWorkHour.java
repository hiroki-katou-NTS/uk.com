...
@Getter
// 雇用別通常勤務労働時間.
public class EmpRegularWorkHour extends AggregateRoot implements StatutoryWorkTimeSet{
	 ...
	 */
	public EmpRegularWorkHour (EmpRegularWorkHour memento) {
	 ...
	 * @param memento the memento
	 */
	public void saveToMemento (EmpRegularWorkHourSetMemento memento) {
