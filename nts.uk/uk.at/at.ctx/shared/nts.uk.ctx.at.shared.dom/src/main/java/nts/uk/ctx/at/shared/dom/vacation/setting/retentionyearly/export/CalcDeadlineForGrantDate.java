...
public class CalcDeadlineForGrantDate {
	 ...
	 * @return 期限日
	 */
	public static GeneralDate algorithm(RequireM1 require, CacheCarrier cacheCarrier, String companyId, String employeeId, 
			GeneralDate criteriaDate, GeneralDate grantDate) {
		return algorithm(require, cacheCarrier, companyId, employeeId, criteriaDate, grantDate, Optional.empty(), Optional.empty());
	}
