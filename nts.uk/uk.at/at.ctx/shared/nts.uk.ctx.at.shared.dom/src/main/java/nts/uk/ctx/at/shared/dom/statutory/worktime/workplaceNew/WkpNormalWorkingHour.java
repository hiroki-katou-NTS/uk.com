...
@Getter
// 職場別通常勤務労働時間
public class WkpNormalWorkingHour extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public WkpNormalWorkingHour(WkpNormalWorkingHourGetMemento memento) {
