...
public interface EmTimeZoneSetPolicy {
	 ...
	 */
	void validate(BundledBusinessException be, PredetemineTimeSetting predTime, EmTimeZoneSet etzSet, DisplayMode displayMode, AmPmAtr dayAtr, boolean useHalfDayShift);
