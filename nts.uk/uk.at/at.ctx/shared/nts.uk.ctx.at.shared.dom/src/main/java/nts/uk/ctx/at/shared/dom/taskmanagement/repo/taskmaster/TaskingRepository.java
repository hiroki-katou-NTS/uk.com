package nts.uk.ctx.at.shared.dom.taskmanagement.repo.taskmaster;
...
public interface TaskingRepository {
     ...
     * @return
     */
    List<Tasks> getListTask(String cid);
     ...
     * @return
     */
    List<Tasks> getListTask(String cid, TaskFrameNo taskFrameNo);
     ...
     * @return
     */
    List<Tasks> getListTask(String cid, List<TaskFrameNo> taskFrameNos);
     ...
     * @return
     */
    List<Tasks> getListTask(String cid, GeneralDate referenceDate);
    ...
    List<Tasks> getListTask(String cid, GeneralDate referenceDate, List<TaskFrameNo> taskFrameNos);
     ...
     * @return
     */
    List<Tasks> getListTask(String cid, GeneralDate referenceDate, TaskFrameNo taskFrameNo, List<TaskCode> codes);
     ...
     * @return
     */
    List<Tasks> getListTask(String cid, TaskFrameNo taskFrameNo, TaskCode code);
