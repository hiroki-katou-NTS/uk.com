...
@Getter
// 雇用別変形労働労働時間.
public class EmpDeforLaborWorkingTime extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public EmpDeforLaborWorkingTime(EmpDeforLaborWorkingTime memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(EmpDeforLaborWorkingTimeSetMemento memento) {
