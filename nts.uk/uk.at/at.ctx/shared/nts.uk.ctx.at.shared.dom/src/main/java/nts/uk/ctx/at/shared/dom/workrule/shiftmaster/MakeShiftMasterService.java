...
public class MakeShiftMasterService {
	...
	public static AtomTask makeShiftMater(WorkInformation.Require requireWorkInfo,
		...
		ShiftMater shiftMater = new ShiftMater(companyId, new ShiftMaterCode(shiftMaterCode), displayInfor, workTypeCd,
				workTimeCdNew);
		// 2:エラー状態をチェックする
	...
	public static interface Require {
		...
		void insert(ShiftMater shiftMater, String workTypeCd, String workTimeCd);
	}
