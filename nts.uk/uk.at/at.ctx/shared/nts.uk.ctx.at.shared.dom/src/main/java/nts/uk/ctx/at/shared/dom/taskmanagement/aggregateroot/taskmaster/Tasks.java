...
@Getter
@AllArgsConstructor
public class Tasks extends AggregateRoot {
    // コード
    ...
    public static Tasks create(Require require,
        ...
        return new Tasks(code, taskFrameNo, cooperationInfo, childTaskList, expirationDate, displayInfo);
