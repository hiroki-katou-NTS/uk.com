...
@Getter
// 社員別変形労働労働時間
public class ShainSpeDeforLaborTime extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ShainSpeDeforLaborTimeSetMemento memento) {
