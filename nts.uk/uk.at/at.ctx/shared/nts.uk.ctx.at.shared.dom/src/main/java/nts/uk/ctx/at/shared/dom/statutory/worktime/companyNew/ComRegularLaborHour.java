...
// 会社別通常勤務労働時間
@Getter
public class ComRegularLaborHour extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public ComRegularLaborHour(ComRegularLaborHourGetMemento memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ComRegularLaborHourSetMemento memento) {
