...
public class AttendanceItemIdContainer implements ItemConst {
	...
	private static void getDailyKey(Map<Integer, String> temp){
		...
		for (int i = 0; i < 20; i++) {
			int idx = i + 1, plus = 10 * i, plus2 = 20 * i;
			temp.put(921 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKPLACE_BYSUPPORT, WORKLOCATIONCD + idx ));
			temp.put(922 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKPLACE_BYSUPPORT, WORKPLACEID + idx ));
//			temp.put(923 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKREMARKS + NUMBER ));
			temp.put(924 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKGROUP, WORKCODE + LAYOUT_A + idx));
			temp.put(925 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKGROUP, WORKCODE + LAYOUT_B + idx));
			temp.put(926 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKGROUP, WORKCODE + LAYOUT_C + idx));
			temp.put(927 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKGROUP, WORKCODE + LAYOUT_D + idx));
			temp.put(928 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, WORKGROUP, WORKCODE + LAYOUT_E + idx));
			temp.put(929 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, TIME_ZONE, START, CLOCK + idx));
			temp.put(930 + plus, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, TIME_ZONE, END,   CLOCK + idx));
			for (int j = 0; j < 5; j++) {
				int idx2 = j + 1;
				temp.put(2251 + plus2 + j, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, SUPP, TIME, VALUE + idx + DEFAULT_IDX_SEPERATOR + idx2));
				temp.put(2256 + plus2 + j, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, SUPP, NUMBER, VALUE + idx + DEFAULT_IDX_SEPERATOR + idx2));
				temp.put(2261 + plus2 + j, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, SUPP, REMARK, VALUE + idx + DEFAULT_IDX_SEPERATOR + idx2));
				temp.put(2266 + plus2 + j, join(DAILY_SUPPORT_TIMESHEET_NAME, FAKED, WORK_CONTENT, SUPP, SELECTION, VALUE + idx + DEFAULT_IDX_SEPERATOR + idx2));
			}
		}
...
//		temp.put(461, getText(DAILY_ATTENDACE_LEAVE_NAME, COUNT));
		...
		temp.put(2737, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(PLACE, NUMBER_4)));
		temp.put(2738, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(CLOCK, NUMBER_4)));
		temp.put(2739, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(PLACE, NUMBER_4)));
		temp.put(2740, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(CLOCK, NUMBER_4)));
		temp.put(2741, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(PLACE, NUMBER_4)));
		temp.put(2742, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(CLOCK, NUMBER_4)));
		temp.put(2743, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(PLACE, NUMBER_4)));
		temp.put(2744, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(CLOCK, NUMBER_4)));
		temp.put(2745, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(PLACE, NUMBER_5)));
		temp.put(2746, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(CLOCK, NUMBER_5)));
		temp.put(2747, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(PLACE, NUMBER_5)));
		temp.put(2748, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(CLOCK, NUMBER_5)));
		temp.put(2749, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(PLACE, NUMBER_5)));
		temp.put(2750, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(CLOCK, NUMBER_5)));
		temp.put(2751, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(PLACE, NUMBER_5)));
		temp.put(2752, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(CLOCK, NUMBER_5)));
		temp.put(2753, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(PLACE, NUMBER_6)));
		temp.put(2754, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(CLOCK, NUMBER_6)));
		temp.put(2755, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(PLACE, NUMBER_6)));
		temp.put(2756, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(CLOCK, NUMBER_6)));
		temp.put(2757, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(PLACE, NUMBER_6)));
		temp.put(2758, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(CLOCK, NUMBER_6)));
		temp.put(2759, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(PLACE, NUMBER_6)));
		temp.put(2760, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(CLOCK, NUMBER_6)));
		temp.put(2761, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(PLACE, NUMBER_7)));
		temp.put(2762, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(CLOCK, NUMBER_7)));
		temp.put(2763, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(PLACE, NUMBER_7)));
		temp.put(2764, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(CLOCK, NUMBER_7)));
		temp.put(2765, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(PLACE, NUMBER_7)));
		temp.put(2766, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(CLOCK, NUMBER_7)));
		temp.put(2767, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(PLACE, NUMBER_7)));
		temp.put(2768, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(CLOCK, NUMBER_7)));
		temp.put(2769, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(PLACE, NUMBER_8)));
		temp.put(2770, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(CLOCK, NUMBER_8)));
		temp.put(2771, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(PLACE, NUMBER_8)));
		temp.put(2772, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(CLOCK, NUMBER_8)));
		temp.put(2773, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(PLACE, NUMBER_8)));
		temp.put(2774, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(CLOCK, NUMBER_8)));
		temp.put(2775, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(PLACE, NUMBER_8)));
		temp.put(2776, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(CLOCK, NUMBER_8)));
		temp.put(2777, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(PLACE, NUMBER_9)));
		temp.put(2778, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(CLOCK, NUMBER_9)));
		temp.put(2779, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(PLACE, NUMBER_9)));
		temp.put(2780, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(CLOCK, NUMBER_9)));
		temp.put(2781, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(PLACE, NUMBER_9)));
		temp.put(2782, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(CLOCK, NUMBER_9)));
		temp.put(2783, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(PLACE, NUMBER_9)));
		temp.put(2784, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(CLOCK, NUMBER_9)));
		temp.put(2785, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(PLACE, NUMBER_1, NUMBER_0)));
		temp.put(2786, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, STAMP, joinNS(CLOCK, NUMBER_1, NUMBER_0)));
		temp.put(2787, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(PLACE, NUMBER_1, NUMBER_0)));
		temp.put(2788, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, STAMP, joinNS(CLOCK, NUMBER_1, NUMBER_0)));
		temp.put(2789, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(PLACE, NUMBER_1, NUMBER_0)));
		temp.put(2790, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, ATTENDANCE, ACTUAL, joinNS(CLOCK, NUMBER_1, NUMBER_0)));
		temp.put(2791, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(PLACE, NUMBER_1, NUMBER_0)));
		temp.put(2792, join(DAILY_TEMPORARY_TIME_NAME, TIME_ZONE, LEAVE, ACTUAL, joinNS(CLOCK, NUMBER_1, NUMBER_0)));
...
//		temp.put(757, "日別実績の遅刻時間．インターバル免除時間.免除時間");
		...
		temp.put(620, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_2)));
		temp.put(621, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_3)));
		temp.put(622, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_3)));
		temp.put(2793, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_4)));
		temp.put(2794, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_4)));
		temp.put(2795, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_5)));
		temp.put(2796, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_5)));
		temp.put(2797, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_6)));
		temp.put(2798, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_6)));
		temp.put(2799, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_7)));
		temp.put(2800, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_7)));
		temp.put(2801, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_8)));
		temp.put(2802, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_8)));
		temp.put(2803, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_9)));
		temp.put(2804, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_9)));
		temp.put(2805, join(excess, TEMPORARY, FRAMES, joinNS(TIME, NUMBER_1, NUMBER_0)));
		temp.put(2806, join(excess, TEMPORARY, FRAMES, joinNS(LATE_NIGHT, NUMBER_1, NUMBER_0)));
	...
	private static void getSupporTimeKeyFrom1To10(Map<Integer, String> temp) {
		...
		temp.put(1313, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1314, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1315, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1316, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1323, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1324, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1325, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1326, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1333, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1334, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1335, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1336, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1)));
		temp.put(1337, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1)));
		temp.put(1338, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1)));
		temp.put(1339, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1340, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1341, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1342, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1343, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1344, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1345, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1346, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1347, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1348, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠2
		...
		temp.put(1356, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1357, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1358, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1359, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1360, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1367, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1368, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1369, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1370, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1377, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_2, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1378, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_2, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1379, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_2, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1380, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_2)));
		temp.put(1381, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_2)));
		temp.put(1382, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_2)));
		temp.put(1383, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1384, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1385, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1386, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1387, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1388, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1389, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1390, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1391, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1392, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠3
		...
		temp.put(1400, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1401, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1402, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1403, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1404, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1411, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1412, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1413, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1414, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1421, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_3, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1422, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_3, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1423, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_3, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1424, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_3)));
		temp.put(1425, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_3)));
		temp.put(1426, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_3)));
		temp.put(1427, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1428, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1429, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1430, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1431, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1432, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1433, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1434, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1435, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1436, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠4
		...
		temp.put(1444, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1445, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1446, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1447, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1448, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1455, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1456, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1457, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1458, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1465, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_4, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1466, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_4, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1467, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_4, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1468, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_4)));
		temp.put(1469, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_4)));
		temp.put(1470, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_4)));
		temp.put(1471, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1472, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1473, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1474, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1475, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1476, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1477, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1478, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1479, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1480, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠5
		...
		temp.put(1488, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1489, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1490, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1491, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1492, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1499, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1500, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1501, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1502, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1509, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_5, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1510, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_5, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1511, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_5, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1512, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_5)));
		temp.put(1513, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_5)));
		temp.put(1514, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_5)));
		temp.put(1515, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1516, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1517, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1518, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1519, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1520, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1521, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1522, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1523, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1524, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠6
		...
		temp.put(1532, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1533, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1534, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1535, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1536, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1543, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1544, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1545, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1546, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1553, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_6, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1554, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_6, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1555, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_6, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1556, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_6)));
		temp.put(1557, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_6)));
		temp.put(1558, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_6)));
		temp.put(1559, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1560, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1561, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1562, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1563, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1564, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1565, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1566, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1567, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1568, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠7
		...
		temp.put(1576, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1577, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1578, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1579, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1580, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1587, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1588, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1589, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1590, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1597, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_7, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1598, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_7, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1599, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_7, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1600, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_7)));
		temp.put(1601, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_7)));
		temp.put(1602, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_7)));
		temp.put(1603, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1604, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1605, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1606, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1607, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1608, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1609, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1610, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1611, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1612, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠8
		...
		temp.put(1620, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1621, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1622, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1623, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1624, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1631, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1632, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1633, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1634, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1641, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_8, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1642, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_8, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1643, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_8, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1644, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_8)));
		temp.put(1645, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_8)));
		temp.put(1646, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_8)));
		temp.put(1647, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1648, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1649, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1650, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1651, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1652, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1653, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1654, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1655, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1656, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠9
		...
		temp.put(1664, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1665, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1666, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1667, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1668, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1675, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1676, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1677, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1678, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1685, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_9, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1686, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_9, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1687, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_9, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1688, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_9)));
		temp.put(1689, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_9)));
		temp.put(1690, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_9)));
		temp.put(1691, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1692, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1693, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1694, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1695, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1696, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1697, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1698, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1699, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1700, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠10
		...
		temp.put(1708, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1709, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1710, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1711, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1712, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1719, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1720, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1721, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1722, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1729, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_0, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1730, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_0, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1731, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_0, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1732, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_0)));
		temp.put(1733, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_0)));
		temp.put(1734, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_0)));
		temp.put(1735, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1736, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1737, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1738, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1739, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1740, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1741, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
	...
	private static void getSupporTimeKeyFrom11To20(Map<Integer, String> temp) {
		...
		temp.put(1752, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1753, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1754, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1755, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1756, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1763, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1764, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1765, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1766, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1773, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_1, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1774, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_1, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1775, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_1, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1776, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_1)));
		temp.put(1777, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_1)));
		temp.put(1778, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_1)));
		temp.put(1779, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1780, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1781, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1782, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1783, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1784, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1785, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1786, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1787, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1788, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_1, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠12
		...
		temp.put(1796, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1797, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1798, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1799, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1800, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1807, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1808, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1809, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1810, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1817, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_2, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1818, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_2, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1819, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_2, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1820, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_2)));
		temp.put(1821, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_2)));
		temp.put(1822, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_2)));
		temp.put(1823, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1824, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1825, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1826, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1827, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1828, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1829, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1830, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1831, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1832, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_2, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠13
		...
		temp.put(1840, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1841, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1842, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1843, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1844, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1851, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1852, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1853, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1854, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1861, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_3, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1862, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_3, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1863, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_3, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1864, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_3)));
		temp.put(1865, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_3)));
		temp.put(1866, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_3)));
		temp.put(1867, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1868, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1869, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1870, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1871, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1872, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1873, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1874, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1875, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1876, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_3, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠14
		...
		temp.put(1884, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1885, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1886, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1887, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1888, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1895, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1896, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1897, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1898, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1905, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_4, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1906, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_4, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1907, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_4, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1908, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_4)));
		temp.put(1909, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_4)));
		temp.put(1910, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_4)));
		temp.put(1911, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1912, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1913, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1914, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1915, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1916, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1917, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1918, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1919, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1920, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_4, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠15
		...
		temp.put(1928, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1929, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1930, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1931, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1932, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1939, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1940, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1941, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1942, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1949, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_5, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1950, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_5, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1951, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_5, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1952, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_5)));
		temp.put(1953, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_5)));
		temp.put(1954, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_5)));
		temp.put(1955, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(1956, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(1957, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1958, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1959, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1960, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1961, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(1962, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(1963, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(1964, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_5, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠16
		...
		temp.put(1972, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(1973, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1974, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1975, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1976, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1983, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(1984, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(1985, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(1986, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(1993, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_6, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1994, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_6, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1995, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_6, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(1996, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_6)));
		temp.put(1997, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_6)));
		temp.put(1998, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_6)));
		temp.put(1999, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(2000, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(2001, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2002, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2003, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2004, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2005, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(2006, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(2007, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(2008, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_6, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠17
		...
		temp.put(2016, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2017, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2018, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2019, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2020, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2027, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2028, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2029, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2030, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2037, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_7, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2038, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_7, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2039, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_7, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2040, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_7)));
		temp.put(2041, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_7)));
		temp.put(2042, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_7)));
		temp.put(2043, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(2044, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(2045, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2046, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2047, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2048, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2049, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(2050, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(2051, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(2052, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_7, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠18
		...
		temp.put(2060, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2061, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2062, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2063, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2064, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2071, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2072, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2073, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2074, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2081, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_8, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2082, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_8, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2083, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_8, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2084, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_8)));
		temp.put(2085, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_8)));
		temp.put(2086, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_8)));
		temp.put(2087, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(2088, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(2089, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2090, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2091, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2092, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2093, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(2094, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(2095, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(2096, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_8, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠19
		...
		temp.put(2104, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2105, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2106, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2107, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2108, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2115, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2116, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2117, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2118, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2125, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_1, NUMBER_9, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2126, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_1, NUMBER_9, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2127, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_9, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2128, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_1, NUMBER_9)));
		temp.put(2129, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_1, NUMBER_9)));
		temp.put(2130, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_1, NUMBER_9)));
		temp.put(2131, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(2132, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(2133, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2134, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2135, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2136, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2137, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(2138, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(2139, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(2140, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_1, NUMBER_9, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
		//応援枠20
		...
		temp.put(2148, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2149, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2150, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2151, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2152, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2159, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2160, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2161, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2162, join(supportTime, WORKING_TIME + TIME, PREMIUM + TIME, joinNS(PREMIUM + AMOUNT, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		...
		temp.put(2169, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(WORKING_TIME + TIME, NUMBER_2, NUMBER_0, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2170, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(DEDUCTION + TIME, NUMBER_2, NUMBER_0, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2171, join(supportTime, WORKING_TIME + TIME, MEDICAL + TIME, joinNS(BREAK + TIME, NUMBER_2, NUMBER_0, DEFAULT_ENUM_SEPERATOR, NIGHT_SHIFT)));
		temp.put(2172, join(supportTime, MOVE + TIME, joinNS(MOVE + TIME, NUMBER_2, NUMBER_0)));
		temp.put(2173, join(supportTime, MOVE + TIME, joinNS(WITHIN_STATUTORY + MOVE + TIME, NUMBER_2, NUMBER_0)));
		temp.put(2174, join(supportTime, MOVE + TIME, joinNS(BREAK + TIME, NUMBER_2, NUMBER_0)));
		temp.put(2175, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_1)));
		temp.put(2176, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_2)));
		temp.put(2177, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_3)));
		temp.put(2178, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_4)));
		temp.put(2179, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_5)));
		temp.put(2180, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_6)));
		temp.put(2181, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_7)));
		temp.put(2182, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_8)));
		temp.put(2183, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_9)));
		temp.put(2184, join(supportTime, MOVE + TIME, PREMIUM + TIME, joinNS(PREMIUM, NUMBER_2, NUMBER_0, DEFAULT_IDX_SEPERATOR, NUMBER_1, NUMBER_0)));
	}
	...
	private static void getMonthlyKey(Map<Integer, String> temp) {
		...
		temp.put(2247, join(MONTHLY_AFFILIATION_INFO_NAME, CONTRACT_TIME));
		...
		temp.put(12,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, FLEX, FLEX, TIME));
		temp.put(13,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, FLEX, FLEX, CALC));
		temp.put(14,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, BEFORE));
		temp.put(15,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, FLEX, LEGAL));
		temp.put(16,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, FLEX, ILLEGAL));
		temp.put(2199,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, CUR_MONTH, FLEX, FLEX, TIME));
		temp.put(2263,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, CUR_MONTH, FLEX, FLEX, CALC));
		temp.put(2261,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, CUR_MONTH, FLEX, LEGAL));
		temp.put(2262,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, CUR_MONTH, FLEX, ILLEGAL));
		temp.put(2202,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, FLEX, CUR_MONTH, EXCESS + AVERAGE));
		...
		temp.put(2266,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, EXCESS, CUR_MONTH, FLEX, FLEX, TIME));
		temp.put(2267,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, EXCESS, CUR_MONTH, FLEX, FLEX, CALC));
		temp.put(2264,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, EXCESS, CUR_MONTH, FLEX, LEGAL));
		temp.put(2265,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, EXCESS, CUR_MONTH, FLEX, ILLEGAL));
		temp.put(2268,   join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, FLEX, EXCESS, CUR_MONTH, EXCESS + AVERAGE));
		...
		temp.put(1420, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SUSPENS_WORK, OPTIONAL, DAYS + NUMBER_1));
		temp.put(1421, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SUSPENS_WORK, OPTIONAL, DAYS + NUMBER_2));
		temp.put(1422, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SUSPENS_WORK, OPTIONAL, DAYS + NUMBER_3));
		temp.put(1423, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SUSPENS_WORK, OPTIONAL, DAYS + NUMBER_4));
		...
		temp.put(832, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, RETENTION, REMAIN, BEFORE, DAYS));
//		temp.put(833, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, RETENTION, GRANT + AFTER, DAYS));
		...
		temp.put(838, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, REAL + RETENTION, REMAIN, BEFORE, DAYS));
//		temp.put(839, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, REAL + RETENTION, GRANT + AFTER, DAYS));
	...
	private static void getMonthlyKey2(Map<Integer, String> temp) {
		...
		temp.put(2248, join(MONTHLY_CHILD_CARE_HD_REMAIN_NAME, THIS_YEAR + REMAIN, DAYS));
		temp.put(2249, join(MONTHLY_CHILD_CARE_HD_REMAIN_NAME, NEXT_YEAR + REMAIN, DAYS));
		temp.put(2250, join(MONTHLY_CHILD_CARE_HD_REMAIN_NAME, THIS_YEAR + REMAIN, TIME));
		temp.put(2251, join(MONTHLY_CHILD_CARE_HD_REMAIN_NAME, NEXT_YEAR + REMAIN, TIME));
		...
		temp.put(2256, join(MONTHLY_PUBLIC_HOLIDAYREMAIN_NAME, GRANT));
		temp.put(2257, join(MONTHLY_PUBLIC_HOLIDAYREMAIN_NAME, CARRIED_FORWARD));
		temp.put(2258, join(MONTHLY_PUBLIC_HOLIDAYREMAIN_NAME,USAGE));
		temp.put(2259, join(MONTHLY_PUBLIC_HOLIDAYREMAIN_NAME, NEXT_MONTH + CARRIED_FORWARD));
		temp.put(2260, join(MONTHLY_PUBLIC_HOLIDAYREMAIN_NAME, NOT_DIGESTION));
		...
		temp.put(1398, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_1));
		temp.put(1399, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_2));
		temp.put(1400, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_3));
		temp.put(1401, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_4));
		temp.put(1402, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_5));
		temp.put(1403, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_6));
		temp.put(1404, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_7));
		temp.put(1405, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_8));
		temp.put(1406, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, DAYS + NUMBER_9));
		temp.put(1407, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, joinNS(DAYS, NUMBER_1, NUMBER_0)));
		temp.put(1408, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_1));
		temp.put(1409, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_2));
		temp.put(1410, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_3));
		temp.put(1411, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_4));
		temp.put(1412, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_5));
		temp.put(1413, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_6));
		temp.put(1414, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_7));
		temp.put(1415, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_8));
		temp.put(1416, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, HOLIDAY_WORK + NUMBER_9));
		temp.put(1417, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, DAYS, SPECIFIC, joinNS(HOLIDAY_WORK, NUMBER_1, NUMBER_0)));
		...
		temp.put(2269, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, ACTUAL, IRREGULAR + LABOR, LEGAL));
		temp.put(2270, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, ACTUAL, IRREGULAR + LABOR, ILLEGAL));
	...
	private static void getMonthlyKeySpecialHoliday(Map<Integer, String> temp) {
		...
		for(int i = 0; i< 20; i++) {
			...
			temp.put(845+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, FAKED, SPECIAL_HOLIDAY, REMAIN, GRANT + BEFORE, DAYS + (i+1)));
			...
			temp.put(857+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, FAKED, REAL + SPECIAL_HOLIDAY, REMAIN, GRANT + BEFORE, DAYS + (i+1)));
		...
		for(int i = 0; i< 20; i++) {
			...
			temp.put(1449+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, FAKED, SPECIAL_HOLIDAY, REMAIN, GRANT + BEFORE, TIME , TIME + (i+1)));
			...
			temp.put(1455+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, FAKED, REAL + SPECIAL_HOLIDAY, REMAIN, GRANT + BEFORE, TIME , TIME + (i+1)));
	...
	private static void getMonthlyKeyAnnual(Map<Integer, String> temp) {
		...
		temp.put(794, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, REMAIN, BEFORE, DAYS));
		...
		temp.put(805, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, REMAIN, BEFORE, DAYS));
		...
		temp.put(1427, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, REMAIN, BEFORE, TIME));
		...
		temp.put(1432, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, REMAIN, BEFORE, TIME));
		temp.put(1433, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, REMAIN, AFTER, TIME));
		
		temp.put(1434, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, HALF_DAY + ANNUNAL_LEAVE, USAGE, USAGE));
		temp.put(1435, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, HALF_DAY + ANNUNAL_LEAVE, USAGE, USAGE + AFTER));
		temp.put(1436, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, HALF_DAY + ANNUNAL_LEAVE, REMAIN, REMAIN + BEFORE));
		temp.put(1437, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, HALF_DAY + ANNUNAL_LEAVE, REMAIN, REMAIN + AFTER));
		
		temp.put(1438, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + HALF_DAY + ANNUNAL_LEAVE, USAGE, USAGE));
		temp.put(1439, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + HALF_DAY + ANNUNAL_LEAVE, USAGE, USAGE + AFTER));
		temp.put(1440, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + HALF_DAY + ANNUNAL_LEAVE, REMAIN, REMAIN + BEFORE));
		temp.put(1441, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + HALF_DAY + ANNUNAL_LEAVE, REMAIN, REMAIN + AFTER));
		
		temp.put(1442, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, UPPER_LIMIT + REMAIN, REMAIN + BEFORE));
		temp.put(1443, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, UPPER_LIMIT + REMAIN, REMAIN + AFTER));
		temp.put(1444, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME,  REAL + UPPER_LIMIT + REMAIN, REMAIN + BEFORE));
		temp.put(1445, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME,  REAL + UPPER_LIMIT + REMAIN, REMAIN + AFTER));
...
//		temp.put(1673, join(ANY_PERIOD_ATTENDANCE_TIME_NAME, HOLIDAY, CARE, USAGE, TIME));
		...
		temp.put(1798, join(ANY_PERIOD_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, WORK_TIME, ACTUAL));
	}
