...
//		temp.put(757, "日別実績の遅刻時間．インターバル免除時間.免除時間");
		...
		temp.put(617, join(totalLabol, TEMPORARY, joinNS(TIME, NUMBER_1)));
		temp.put(618, join(totalLabol, TEMPORARY, joinNS(LATE_NIGHT, NUMBER_1)));
		temp.put(619, join(totalLabol, TEMPORARY, joinNS(TIME, NUMBER_2)));
		temp.put(620, join(totalLabol, TEMPORARY, joinNS(LATE_NIGHT, NUMBER_2)));
		temp.put(621, join(totalLabol, TEMPORARY, joinNS(TIME, NUMBER_3)));
		temp.put(622, join(totalLabol, TEMPORARY, joinNS(LATE_NIGHT, NUMBER_3)));
