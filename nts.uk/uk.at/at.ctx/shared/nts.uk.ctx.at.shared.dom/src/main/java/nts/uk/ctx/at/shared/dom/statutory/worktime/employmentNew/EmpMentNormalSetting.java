...
@Getter
// 雇用別通常勤務月間労働時間.
public class EmpMentNormalSetting extends AggregateRoot implements MonthStatutoryWorkingHourDeforWorker{
	 ...
	 */
	public EmpMentNormalSetting (EmpMentNormalSetting memento) {
	 ...
	 * @param memento the memento
	 */
	public void saveToMemento (EmpMentNormalSettingSetMemento memento) {
