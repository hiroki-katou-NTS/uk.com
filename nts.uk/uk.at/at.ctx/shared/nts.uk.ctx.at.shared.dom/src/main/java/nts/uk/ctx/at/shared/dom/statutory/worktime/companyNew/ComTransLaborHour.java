...
// 会社別変形労働労働時間
@Getter
public class ComTransLaborHour extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public ComTransLaborHour(ComTransLaborHourGetMemento memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ComTransLaborHourSetMemento memento) {
