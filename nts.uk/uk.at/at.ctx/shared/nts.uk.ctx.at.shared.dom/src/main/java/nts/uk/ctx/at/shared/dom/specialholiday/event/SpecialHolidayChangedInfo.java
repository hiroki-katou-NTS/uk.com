...
@Getter
public class SpecialHolidayChangedInfo extends DomainEvent {
	...
	public SpecialHolidayChangedInfo(boolean isUse, int specialHolidayCode, String specialHolidayName, int typeTime) {
		super();
		this.isUse = isUse;
	...
	public static SpecialHolidayChangedInfo createFromDomain(boolean isSave,SpecialHoliday domain) {
		return new SpecialHolidayChangedInfo(isSave, domain.getSpecialHolidayCode().v(),
