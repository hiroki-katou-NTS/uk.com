...
public class WorkRegularAdditionSet extends AggregateRoot implements Serializable, AddSetting{
	...
	/** 労働制 */
	public static int LABOR_SYSTEM_ATR = 0;
	/** 労働時間の加算設定 */
	private AddSettingOfWorkingTime addSetOfWorkingTime;

	public WorkRegularAdditionSet(String companyId, AddSettingOfWorkingTime vacationCalcMethodSet) {
		super();
	 ...
	 * @return 通常勤務の加算設定
	 */
	public static WorkRegularAdditionSet createFromJavaType(
			String companyId,
		...
		WorkRegularAdditionSet myClass = new WorkRegularAdditionSet();
	...
	public static interface Require {
		WorkRegularAdditionSet workRegularAdditionSet(String companyId);
	}
	...
	public WorkRegularAdditionSet createCalculationByActualTime() {
		return new WorkRegularAdditionSet(this.companyId, this.addSetOfWorkingTime.createCalculationByActualTime());
	}
	...
	public WorkRegularAdditionSet getWorkTimeDeductFlexTime() {
		return new WorkRegularAdditionSet(this.companyId, this.addSetOfWorkingTime.getWorkTimeDeductFlexTime());
	}
	...
	public WorkRegularAdditionSet createNewDeductLateEarly() {
		return new WorkRegularAdditionSet(this.companyId, this.addSetOfWorkingTime.createNewDeductLateEarly());
	}
}
