...
@Getter
// 雇用別変形労働労働時間.
public class EmpDeforLaborWorkingHour extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public EmpDeforLaborWorkingHour(EmpDeforLaborWorkingHour memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(EmpDeforLaborWorkingHourSetMemento memento) {
