...
public class FlexTimeOfMonthly implements SerializableWithOptional{
	...
	private void calcFlexMultiForConvenience(
		...
		// 法定労働時間を取得する（フレックス用）
		MonthlyFlexStatutoryLaborTime statLaborTime = getFlexStatutoryLaborTime(
	 ...
	 * @return 所定労働時間（代休控除後）
	 */
	private AttendanceTimeMonth getPrescribedTime(
			RequireM4 require,
			CacheCarrier cacheCarrier,
			String companyId,
			String employeeId,
	 ...
	 * @return 月の法定労働時間
	 */
	public static MonthlyFlexStatutoryLaborTime getFlexStatutoryLaborTime(
			RequireM7 require,
			CacheCarrier cacheCarrier,
			MonAggrCompanySettings companySets,
			MonAggrEmployeeSettings employeeSets,
	...
	public static interface RequireM7 extends MonthlyStatutoryLaborDivisionService.Require,
	 ...
	 * @return 代休控除時間
	 */
	private static CompLeaveDeductTime calcCompLeaveDeductTime(
			RequireM7 require,
			MonAggrCompanySettings companySets,
			MonAggrEmployeeSettings employeeSets,
			SettingRequiredByFlex settingsByFlex,
	 ...
	 * @return 代休控除時間
	 */
	private static CompLeaveDeductTime calcCompLeaveDeductTimeEachDay(
			RequireM7 require,
			MonAggrCompanySettings companySets,
			SettingRequiredByFlex settingsByFlex,
			String employeeId,
	...
	private void flexExcessPrinciple(
			...
			AttendanceTimeMonth compensatoryLeaveAfterDudection,
			String companyId,
			String employeeId,
			YearMonth yearMonth,
			DatePeriod datePeriod,
...
//					companyId, yearMonth.nextMonth());
	...
	// 法定内として扱う時間を求める
	public static interface RequireM2 extends MonthlyStatutoryWorkingHours.RequireM1, RequireM3, RequireM7 {}
