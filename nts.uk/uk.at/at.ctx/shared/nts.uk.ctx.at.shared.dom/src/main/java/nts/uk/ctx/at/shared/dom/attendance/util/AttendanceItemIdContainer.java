...
public class AttendanceItemIdContainer implements ItemConst {
	...
	static {
		...
		DAY_ITEM_ID_CONTAINER.putAll(getDailyKey());
		
		MONTHLY_ITEM_ID_CONTAINER.putAll(getMonthlyKey());
	}
	
	private static Map<Integer, String> getDailyKey(){
...
//		temp.put(461, getText(DAILY_ATTENDACE_LEAVE_NAME, COUNT));
		...
		temp.put(565, join(excess, LATE_NIGHT, TIME, BEFOR_APPLICATION));
		...
		temp.put(464, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_SUPPORT)));
		temp.put(468, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_SUPPORT)));
		temp.put(477, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_UNION)));
		temp.put(480, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_UNION)));
		temp.put(484, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_CHARGE)));
		temp.put(487, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_CHARGE)));
		temp.put(491, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_OFFICAL)));
		temp.put(495, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_OFFICAL)));
		...
		temp.put(499, join(totalLabol, GO_OUT, DEDUCTION, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_OFFICAL)));
	...
	private static Map<Integer, String> getMonthlyKey() {
		Map<Integer, String> temp = new HashMap<>();
		...
		temp.put(5,    "月別実績の勤怠時間.月の計算.実働時間.週割増合計時間");
		temp.put(6,    "月別実績の勤怠時間.月の計算.実働時間.月割増合計時間");
		temp.put(7,    "月別実績の勤怠時間.月の計算.実働時間.変形労働時間.変形労働不足時間");
		temp.put(8,    "月別実績の勤怠時間.月の計算.実働時間.変形労働時間.変形期間繰越時間");
		temp.put(9,    "月別実績の勤怠時間.月の計算.実働時間.変形労働時間.複数月変形途中時間");
		temp.put(10,   "月別実績の勤怠時間.月の計算.実働時間.変形労働時間.変形法定内残業時間.時間");
		temp.put(11,   "月別実績の勤怠時間.月の計算.実働時間.変形労働時間.変形法定内残業時間.計算時間");
		...
		temp.put(110, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_1));
		temp.put(111, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_2));
		temp.put(112, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_3));
		temp.put(113, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_4));
		temp.put(114, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_5));
		temp.put(115, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_6));
		temp.put(116, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_7));
		temp.put(117, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_8));
		temp.put(118, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, TIME + NUMBER_9));
		temp.put(119, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, joinNS(TIME, NUMBER_1, NUMBER_0)));
		temp.put(121, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_1));
		temp.put(122, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_2));
		temp.put(123, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_3));
		temp.put(124, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_4));
		temp.put(125, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_5));
		temp.put(126, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_6));
		temp.put(127, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_7));
		temp.put(128, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_8));
		temp.put(129, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, CALC + NUMBER_9));
		temp.put(130, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, OVERTIME, AGGREGATE, HOLIDAY_WORK, joinNS(CALC, NUMBER_1, NUMBER_0)));
		...
		temp.put(387, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, TIME, PREMIUM, joinNS(PREMIUM, TIME, NUMBER_1, NUMBER_0)));
		...
		temp.put(461, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, CLOCK, LOGON, TOTAL + DAYS));
		temp.put(462, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, CLOCK, LOGON, TOTAL + CLOCK));
		temp.put(463, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, CLOCK, LOGON, AVERAGE + CLOCK));
		temp.put(464, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, CLOCK, LOGOFF, TOTAL + DAYS));
		temp.put(465, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, CLOCK, LOGOFF, TOTAL + CLOCK));
		temp.put(466, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, CLOCK, LOGOFF, AVERAGE + CLOCK));
		temp.put(467, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGON, TOTAL + DAYS));
		temp.put(468, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGON, TOTAL + CLOCK));
		temp.put(469, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGON, AVERAGE + CLOCK));
		temp.put(470, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGOFF, TOTAL + DAYS));
		temp.put(471, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGOFF, TOTAL + CLOCK));
		temp.put(472, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGOFF, AVERAGE + CLOCK));
...
//		temp.put(796, "年休月別残数データ.年休.残数.年休残時間");
		...
		temp.put(835, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, RETENTION, GRANT + INFO));
		...
		/**　TODO: chua map 👇👇👇👇👇👇👇👇👇　*/
		temp.put(840, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数1	特別休暇コード＝1");
		temp.put(841, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後1	特別休暇コード＝1");
		temp.put(842, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間1	特別休暇コード＝1");
		temp.put(843, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後1	特別休暇コード＝1");
		temp.put(844, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数1	特別休暇コード＝1");
		temp.put(845, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数1	特別休暇コード＝1");
		temp.put(846, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後1	特別休暇コード＝1");
		temp.put(847, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間1	特別休暇コード＝1");
		temp.put(848, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後1	特別休暇コード＝1");
		temp.put(849, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数1	特別休暇コード＝1");
		temp.put(850, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間1	特別休暇コード＝1");
		temp.put(851, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数1	特別休暇コード＝1");
		temp.put(852, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数1	特別休暇コード＝1");
		temp.put(853, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後1	特別休暇コード＝1");
		temp.put(854, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間1	特別休暇コード＝1");
		temp.put(855, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後1	特別休暇コード＝1");
		temp.put(856, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数1	特別休暇コード＝1");
		temp.put(857, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数1	特別休暇コード＝1");
		temp.put(858, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後1	特別休暇コード＝1");
		temp.put(859, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間1	特別休暇コード＝1");
		temp.put(860, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後1	特別休暇コード＝1");
		temp.put(861, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数2	特別休暇コード＝2");
		temp.put(862, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後2	特別休暇コード＝2");
		temp.put(863, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間2	特別休暇コード＝2");
		temp.put(864, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後2	特別休暇コード＝2");
		temp.put(865, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数2	特別休暇コード＝2");
		temp.put(866, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数2	特別休暇コード＝2");
		temp.put(867, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後2	特別休暇コード＝2");
		temp.put(868, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間2	特別休暇コード＝2");
		temp.put(869, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後2	特別休暇コード＝2");
		temp.put(870, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数2	特別休暇コード＝2");
		temp.put(871, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間2	特別休暇コード＝2");
		temp.put(872, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数2	特別休暇コード＝2");
		temp.put(873, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数2	特別休暇コード＝2");
		temp.put(874, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後2	特別休暇コード＝2");
		temp.put(875, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間2	特別休暇コード＝2");
		temp.put(876, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後2	特別休暇コード＝2");
		temp.put(877, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数2	特別休暇コード＝2");
		temp.put(878, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数2	特別休暇コード＝2");
		temp.put(879, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後2	特別休暇コード＝2");
		temp.put(880, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間2	特別休暇コード＝2");
		temp.put(881, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後2	特別休暇コード＝2");
		temp.put(882, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数3	特別休暇コード＝3");
		temp.put(883, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後3	特別休暇コード＝3");
		temp.put(884, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間3	特別休暇コード＝3");
		temp.put(885, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後3	特別休暇コード＝3");
		temp.put(886, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数3	特別休暇コード＝3");
		temp.put(887, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数3	特別休暇コード＝3");
		temp.put(888, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後3	特別休暇コード＝3");
		temp.put(889, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間3	特別休暇コード＝3");
		temp.put(890, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後3	特別休暇コード＝3");
		temp.put(891, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数3	特別休暇コード＝3");
		temp.put(892, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間3	特別休暇コード＝3");
		temp.put(893, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数3	特別休暇コード＝3");
		temp.put(894, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数3	特別休暇コード＝3");
		temp.put(895, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後3	特別休暇コード＝3");
		temp.put(896, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間3	特別休暇コード＝3");
		temp.put(897, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後3	特別休暇コード＝3");
		temp.put(898, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数3	特別休暇コード＝3");
		temp.put(899, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数3	特別休暇コード＝3");
		temp.put(900, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後3	特別休暇コード＝3");
		temp.put(901, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間3	特別休暇コード＝3");
		temp.put(902, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後3	特別休暇コード＝3");
		temp.put(903, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数4	特別休暇コード＝4");
		temp.put(904, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後4	特別休暇コード＝4");
		temp.put(905, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間4	特別休暇コード＝4");
		temp.put(906, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後4	特別休暇コード＝4");
		temp.put(907, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数4	特別休暇コード＝4");
		temp.put(908, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数4	特別休暇コード＝4");
		temp.put(909, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後4	特別休暇コード＝4");
		temp.put(910, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間4	特別休暇コード＝4");
		temp.put(911, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後4	特別休暇コード＝4");
		temp.put(912, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数4	特別休暇コード＝4");
		temp.put(913, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間4	特別休暇コード＝4");
		temp.put(914, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数4	特別休暇コード＝4");
		temp.put(915, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数4	特別休暇コード＝4");
		temp.put(916, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後4	特別休暇コード＝4");
		temp.put(917, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間4	特別休暇コード＝4");
		temp.put(918, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後4	特別休暇コード＝4");
		temp.put(919, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数4	特別休暇コード＝4");
		temp.put(920, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数4	特別休暇コード＝4");
		temp.put(921, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後4	特別休暇コード＝4");
		temp.put(922, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間4	特別休暇コード＝4");
		temp.put(923, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後4	特別休暇コード＝4");
		temp.put(924, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数5	特別休暇コード＝5");
		temp.put(925, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後5	特別休暇コード＝5");
		temp.put(926, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間5	特別休暇コード＝5");
		temp.put(927, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後5	特別休暇コード＝5");
		temp.put(928, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数5	特別休暇コード＝5");
		temp.put(929, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数5	特別休暇コード＝5");
		temp.put(930, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後5	特別休暇コード＝5");
		temp.put(931, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間5	特別休暇コード＝5");
		temp.put(932, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後5	特別休暇コード＝5");
		temp.put(933, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数5	特別休暇コード＝5");
		temp.put(934, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間5	特別休暇コード＝5");
		temp.put(935, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数5	特別休暇コード＝5");
		temp.put(936, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数5	特別休暇コード＝5");
		temp.put(937, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後5	特別休暇コード＝5");
		temp.put(938, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間5	特別休暇コード＝5");
		temp.put(939, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後5	特別休暇コード＝5");
		temp.put(940, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数5	特別休暇コード＝5");
		temp.put(941, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数5	特別休暇コード＝5");
		temp.put(942, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後5	特別休暇コード＝5");
		temp.put(943, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間5	特別休暇コード＝5");
		temp.put(944, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後5	特別休暇コード＝5");
		temp.put(945, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数6	特別休暇コード＝6");
		temp.put(946, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後6	特別休暇コード＝6");
		temp.put(947, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間6	特別休暇コード＝6");
		temp.put(948, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後6	特別休暇コード＝6");
		temp.put(949, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数6	特別休暇コード＝6");
		temp.put(950, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数6	特別休暇コード＝6");
		temp.put(951, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後6	特別休暇コード＝6");
		temp.put(952, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間6	特別休暇コード＝6");
		temp.put(953, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後6	特別休暇コード＝6");
		temp.put(954, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数6	特別休暇コード＝6");
		temp.put(955, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間6	特別休暇コード＝6");
		temp.put(956, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数6	特別休暇コード＝6");
		temp.put(957, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数6	特別休暇コード＝6");
		temp.put(958, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後6	特別休暇コード＝6");
		temp.put(959, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間6	特別休暇コード＝6");
		temp.put(960, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後6	特別休暇コード＝6");
		temp.put(961, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数6	特別休暇コード＝6");
		temp.put(962, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数6	特別休暇コード＝6");
		temp.put(963, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後6	特別休暇コード＝6");
		temp.put(964, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間6	特別休暇コード＝6");
		temp.put(965, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後6	特別休暇コード＝6");
		temp.put(966, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数7	特別休暇コード＝7");
		temp.put(967, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後7	特別休暇コード＝7");
		temp.put(968, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間7	特別休暇コード＝7");
		temp.put(969, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後7	特別休暇コード＝7");
		temp.put(970, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数7	特別休暇コード＝7");
		temp.put(971, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数7	特別休暇コード＝7");
		temp.put(972, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後7	特別休暇コード＝7");
		temp.put(973, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間7	特別休暇コード＝7");
		temp.put(974, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後7	特別休暇コード＝7");
		temp.put(975, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数7	特別休暇コード＝7");
		temp.put(976, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間7	特別休暇コード＝7");
		temp.put(977, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数7	特別休暇コード＝7");
		temp.put(978, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数7	特別休暇コード＝7");
		temp.put(979, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後7	特別休暇コード＝7");
		temp.put(980, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間7	特別休暇コード＝7");
		temp.put(981, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後7	特別休暇コード＝7");
		temp.put(982, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数7	特別休暇コード＝7");
		temp.put(983, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数7	特別休暇コード＝7");
		temp.put(984, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後7	特別休暇コード＝7");
		temp.put(985, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間7	特別休暇コード＝7");
		temp.put(986, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後7	特別休暇コード＝7");
		temp.put(987, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数8	特別休暇コード＝8");
		temp.put(988, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後8	特別休暇コード＝8");
		temp.put(989, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間8	特別休暇コード＝8");
		temp.put(990, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後8	特別休暇コード＝8");
		temp.put(991, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数8	特別休暇コード＝8");
		temp.put(992, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数8	特別休暇コード＝8");
		temp.put(993, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後8	特別休暇コード＝8");
		temp.put(994, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間8	特別休暇コード＝8");
		temp.put(995, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後8	特別休暇コード＝8");
		temp.put(996, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数8	特別休暇コード＝8");
		temp.put(997, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間8	特別休暇コード＝8");
		temp.put(998, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数8	特別休暇コード＝8");
		temp.put(999, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数8	特別休暇コード＝8");
		temp.put(1000, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後8	特別休暇コード＝8");
		temp.put(1001, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間8	特別休暇コード＝8");
		temp.put(1002, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後8	特別休暇コード＝8");
		temp.put(1003, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数8	特別休暇コード＝8");
		temp.put(1004, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数8	特別休暇コード＝8");
		temp.put(1005, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後8	特別休暇コード＝8");
		temp.put(1006, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間8	特別休暇コード＝8");
		temp.put(1007, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後8	特別休暇コード＝8");
		temp.put(1008, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数9	特別休暇コード＝9");
		temp.put(1009, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後9	特別休暇コード＝9");
		temp.put(1010, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間9	特別休暇コード＝9");
		temp.put(1011, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後9	特別休暇コード＝9");
		temp.put(1012, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数9	特別休暇コード＝9");
		temp.put(1013, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数9	特別休暇コード＝9");
		temp.put(1014, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後9	特別休暇コード＝9");
		temp.put(1015, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間9	特別休暇コード＝9");
		temp.put(1016, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後9	特別休暇コード＝9");
		temp.put(1017, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数9	特別休暇コード＝9");
		temp.put(1018, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間9	特別休暇コード＝9");
		temp.put(1019, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数9	特別休暇コード＝9");
		temp.put(1020, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数9	特別休暇コード＝9");
		temp.put(1021, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後9	特別休暇コード＝9");
		temp.put(1022, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間9	特別休暇コード＝9");
		temp.put(1023, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後9	特別休暇コード＝9");
		temp.put(1024, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数9	特別休暇コード＝9");
		temp.put(1025, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数9	特別休暇コード＝9");
		temp.put(1026, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後9	特別休暇コード＝9");
		temp.put(1027, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間9	特別休暇コード＝9");
		temp.put(1028, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後9	特別休暇コード＝9");
		temp.put(1029, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数10	特別休暇コード＝10");
		temp.put(1030, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後10	特別休暇コード＝10");
		temp.put(1031, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間10	特別休暇コード＝10");
		temp.put(1032, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後10	特別休暇コード＝10");
		temp.put(1033, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数10	特別休暇コード＝10");
		temp.put(1034, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数10	特別休暇コード＝10");
		temp.put(1035, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後10	特別休暇コード＝10");
		temp.put(1036, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間10	特別休暇コード＝10");
		temp.put(1037, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後10	特別休暇コード＝10");
		temp.put(1038, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数10	特別休暇コード＝10");
		temp.put(1039, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間10	特別休暇コード＝10");
		temp.put(1040, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数10	特別休暇コード＝10");
		temp.put(1041, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数10	特別休暇コード＝10");
		temp.put(1042, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後10	特別休暇コード＝10");
		temp.put(1043, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間10	特別休暇コード＝10");
		temp.put(1044, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後10	特別休暇コード＝10");
		temp.put(1045, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数10	特別休暇コード＝10");
		temp.put(1046, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数10	特別休暇コード＝10");
		temp.put(1047, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後10	特別休暇コード＝10");
		temp.put(1048, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間10	特別休暇コード＝10");
		temp.put(1049, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後10	特別休暇コード＝10");
		temp.put(1050, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数11	特別休暇コード＝11");
		temp.put(1051, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後11	特別休暇コード＝11");
		temp.put(1052, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間11	特別休暇コード＝11");
		temp.put(1053, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後11	特別休暇コード＝11");
		temp.put(1054, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数11	特別休暇コード＝11");
		temp.put(1055, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数11	特別休暇コード＝11");
		temp.put(1056, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後11	特別休暇コード＝11");
		temp.put(1057, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間11	特別休暇コード＝11");
		temp.put(1058, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後11	特別休暇コード＝11");
		temp.put(1059, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数11	特別休暇コード＝11");
		temp.put(1060, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間11	特別休暇コード＝11");
		temp.put(1061, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数11	特別休暇コード＝11");
		temp.put(1062, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数11	特別休暇コード＝11");
		temp.put(1063, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後11	特別休暇コード＝11");
		temp.put(1064, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間11	特別休暇コード＝11");
		temp.put(1065, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後11	特別休暇コード＝11");
		temp.put(1066, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数11	特別休暇コード＝11");
		temp.put(1067, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数11	特別休暇コード＝11");
		temp.put(1068, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後11	特別休暇コード＝11");
		temp.put(1069, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間11	特別休暇コード＝11");
		temp.put(1070, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後11	特別休暇コード＝11");
		temp.put(1071, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数12	特別休暇コード＝12");
		temp.put(1072, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後12	特別休暇コード＝12");
		temp.put(1073, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間12	特別休暇コード＝12");
		temp.put(1074, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後12	特別休暇コード＝12");
		temp.put(1075, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数12	特別休暇コード＝12");
		temp.put(1076, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数12	特別休暇コード＝12");
		temp.put(1077, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後12	特別休暇コード＝12");
		temp.put(1078, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間12	特別休暇コード＝12");
		temp.put(1079, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後12	特別休暇コード＝12");
		temp.put(1080, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数12	特別休暇コード＝12");
		temp.put(1081, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間12	特別休暇コード＝12");
		temp.put(1082, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数12	特別休暇コード＝12");
		temp.put(1083, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数12	特別休暇コード＝12");
		temp.put(1084, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後12	特別休暇コード＝12");
		temp.put(1085, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間12	特別休暇コード＝12");
		temp.put(1086, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後12	特別休暇コード＝12");
		temp.put(1087, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数12	特別休暇コード＝12");
		temp.put(1088, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数12	特別休暇コード＝12");
		temp.put(1089, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後12	特別休暇コード＝12");
		temp.put(1090, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間12	特別休暇コード＝12");
		temp.put(1091, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後12	特別休暇コード＝12");
		temp.put(1092, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数13	特別休暇コード＝13");
		temp.put(1093, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後13	特別休暇コード＝13");
		temp.put(1094, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間13	特別休暇コード＝13");
		temp.put(1095, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後13	特別休暇コード＝13");
		temp.put(1096, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数13	特別休暇コード＝13");
		temp.put(1097, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数13	特別休暇コード＝13");
		temp.put(1098, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後13	特別休暇コード＝13");
		temp.put(1099, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間13	特別休暇コード＝13");
		temp.put(1100, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後13	特別休暇コード＝13");
		temp.put(1101, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数13	特別休暇コード＝13");
		temp.put(1102, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間13	特別休暇コード＝13");
		temp.put(1103, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数13	特別休暇コード＝13");
		temp.put(1104, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数13	特別休暇コード＝13");
		temp.put(1105, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後13	特別休暇コード＝13");
		temp.put(1106, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間13	特別休暇コード＝13");
		temp.put(1107, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後13	特別休暇コード＝13");
		temp.put(1108, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数13	特別休暇コード＝13");
		temp.put(1109, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数13	特別休暇コード＝13");
		temp.put(1110, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後13	特別休暇コード＝13");
		temp.put(1111, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間13	特別休暇コード＝13");
		temp.put(1112, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後13	特別休暇コード＝13");
		temp.put(1113, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数14	特別休暇コード＝14");
		temp.put(1114, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後14	特別休暇コード＝14");
		temp.put(1115, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間14	特別休暇コード＝14");
		temp.put(1116, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後14	特別休暇コード＝14");
		temp.put(1117, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数14	特別休暇コード＝14");
		temp.put(1118, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数14	特別休暇コード＝14");
		temp.put(1119, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後14	特別休暇コード＝14");
		temp.put(1120, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間14	特別休暇コード＝14");
		temp.put(1121, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後14	特別休暇コード＝14");
		temp.put(1122, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数14	特別休暇コード＝14");
		temp.put(1123, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間14	特別休暇コード＝14");
		temp.put(1124, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数14	特別休暇コード＝14");
		temp.put(1125, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数14	特別休暇コード＝14");
		temp.put(1126, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後14	特別休暇コード＝14");
		temp.put(1127, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間14	特別休暇コード＝14");
		temp.put(1128, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後14	特別休暇コード＝14");
		temp.put(1129, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数14	特別休暇コード＝14");
		temp.put(1130, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数14	特別休暇コード＝14");
		temp.put(1131, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後14	特別休暇コード＝14");
		temp.put(1132, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間14	特別休暇コード＝14");
		temp.put(1133, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後14	特別休暇コード＝14");
		temp.put(1134, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数15	特別休暇コード＝15");
		temp.put(1135, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後15	特別休暇コード＝15");
		temp.put(1136, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間15	特別休暇コード＝15");
		temp.put(1137, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後15	特別休暇コード＝15");
		temp.put(1138, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数15	特別休暇コード＝15");
		temp.put(1139, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数15	特別休暇コード＝15");
		temp.put(1140, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後15	特別休暇コード＝15");
		temp.put(1141, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間15	特別休暇コード＝15");
		temp.put(1142, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後15	特別休暇コード＝15");
		temp.put(1143, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数15	特別休暇コード＝15");
		temp.put(1144, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間15	特別休暇コード＝15");
		temp.put(1145, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数15	特別休暇コード＝15");
		temp.put(1146, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数15	特別休暇コード＝15");
		temp.put(1147, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後15	特別休暇コード＝15");
		temp.put(1148, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間15	特別休暇コード＝15");
		temp.put(1149, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後15	特別休暇コード＝15");
		temp.put(1150, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数15	特別休暇コード＝15");
		temp.put(1151, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数15	特別休暇コード＝15");
		temp.put(1152, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後15	特別休暇コード＝15");
		temp.put(1153, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間15	特別休暇コード＝15");
		temp.put(1154, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後15	特別休暇コード＝15");
		temp.put(1155, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数16	特別休暇コード＝16");
		temp.put(1156, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後16	特別休暇コード＝16");
		temp.put(1157, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間16	特別休暇コード＝16");
		temp.put(1158, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後16	特別休暇コード＝16");
		temp.put(1159, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数16	特別休暇コード＝16");
		temp.put(1160, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数16	特別休暇コード＝16");
		temp.put(1161, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後16	特別休暇コード＝16");
		temp.put(1162, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間16	特別休暇コード＝16");
		temp.put(1163, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後16	特別休暇コード＝16");
		temp.put(1164, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数16	特別休暇コード＝16");
		temp.put(1165, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間16	特別休暇コード＝16");
		temp.put(1166, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数16	特別休暇コード＝16");
		temp.put(1167, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数16	特別休暇コード＝16");
		temp.put(1168, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後16	特別休暇コード＝16");
		temp.put(1169, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間16	特別休暇コード＝16");
		temp.put(1170, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後16	特別休暇コード＝16");
		temp.put(1171, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数16	特別休暇コード＝16");
		temp.put(1172, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数16	特別休暇コード＝16");
		temp.put(1173, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後16	特別休暇コード＝16");
		temp.put(1174, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間16	特別休暇コード＝16");
		temp.put(1175, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後16	特別休暇コード＝16");
		temp.put(1176, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数17	特別休暇コード＝17");
		temp.put(1177, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後17	特別休暇コード＝17");
		temp.put(1178, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間17	特別休暇コード＝17");
		temp.put(1179, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後17	特別休暇コード＝17");
		temp.put(1180, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数17	特別休暇コード＝17");
		temp.put(1181, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数17	特別休暇コード＝17");
		temp.put(1182, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後17	特別休暇コード＝17");
		temp.put(1183, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間17	特別休暇コード＝17");
		temp.put(1184, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後17	特別休暇コード＝17");
		temp.put(1185, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数17	特別休暇コード＝17");
		temp.put(1186, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間17	特別休暇コード＝17");
		temp.put(1187, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数17	特別休暇コード＝17");
		temp.put(1188, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数17	特別休暇コード＝17");
		temp.put(1189, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後17	特別休暇コード＝17");
		temp.put(1190, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間17	特別休暇コード＝17");
		temp.put(1191, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後17	特別休暇コード＝17");
		temp.put(1192, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数17	特別休暇コード＝17");
		temp.put(1193, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数17	特別休暇コード＝17");
		temp.put(1194, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後17	特別休暇コード＝17");
		temp.put(1195, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間17	特別休暇コード＝17");
		temp.put(1196, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後17	特別休暇コード＝17");
		temp.put(1197, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数18	特別休暇コード＝18");
		temp.put(1198, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後18	特別休暇コード＝18");
		temp.put(1199, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間18	特別休暇コード＝18");
		temp.put(1200, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後18	特別休暇コード＝18");
		temp.put(1201, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数18	特別休暇コード＝18");
		temp.put(1202, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数18	特別休暇コード＝18");
		temp.put(1203, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後18	特別休暇コード＝18");
		temp.put(1204, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間18	特別休暇コード＝18");
		temp.put(1205, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後18	特別休暇コード＝18");
		temp.put(1206, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数18	特別休暇コード＝18");
		temp.put(1207, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間18	特別休暇コード＝18");
		temp.put(1208, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数18	特別休暇コード＝18");
		temp.put(1209, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数18	特別休暇コード＝18");
		temp.put(1210, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後18	特別休暇コード＝18");
		temp.put(1211, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間18	特別休暇コード＝18");
		temp.put(1212, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後18	特別休暇コード＝18");
		temp.put(1213, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数18	特別休暇コード＝18");
		temp.put(1214, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数18	特別休暇コード＝18");
		temp.put(1215, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後18	特別休暇コード＝18");
		temp.put(1216, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間18	特別休暇コード＝18");
		temp.put(1217, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後18	特別休暇コード＝18");
		temp.put(1218, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数19	特別休暇コード＝19");
		temp.put(1219, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後19	特別休暇コード＝19");
		temp.put(1220, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間19	特別休暇コード＝19");
		temp.put(1221, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後19	特別休暇コード＝19");
		temp.put(1222, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数19	特別休暇コード＝19");
		temp.put(1223, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数19	特別休暇コード＝19");
		temp.put(1224, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後19	特別休暇コード＝19");
		temp.put(1225, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間19	特別休暇コード＝19");
		temp.put(1226, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後19	特別休暇コード＝19");
		temp.put(1227, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数19	特別休暇コード＝19");
		temp.put(1228, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間19	特別休暇コード＝19");
		temp.put(1229, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数19	特別休暇コード＝19");
		temp.put(1230, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数19	特別休暇コード＝19");
		temp.put(1231, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後19	特別休暇コード＝19");
		temp.put(1232, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間19	特別休暇コード＝19");
		temp.put(1233, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後19	特別休暇コード＝19");
		temp.put(1234, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数19	特別休暇コード＝19");
		temp.put(1235, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数19	特別休暇コード＝19");
		temp.put(1236, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後19	特別休暇コード＝19");
		temp.put(1237, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間19	特別休暇コード＝19");
		temp.put(1238, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後19	特別休暇コード＝19");
		temp.put(1239, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数20	特別休暇コード＝20");
		temp.put(1240, "特別休暇月別残数データ.特別休暇.使用数.使用日数	特別休暇使用日数付与後20	特別休暇コード＝20");
		temp.put(1241, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間20	特別休暇コード＝20");
		temp.put(1242, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用時間付与後20	特別休暇コード＝20");
		temp.put(1243, "特別休暇月別残数データ.特別休暇.使用数.使用時間	時間特別休暇使用回数20	特別休暇コード＝20");
		temp.put(1244, "特別休暇月別残数データ.特別休暇.残数	特別休暇残日数20	特別休暇コード＝20");
		temp.put(1245, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残日数付与後20	特別休暇コード＝20");
		temp.put(1246, "特別休暇月別残数データ.特別休暇.残数	特別休暇残時間20	特別休暇コード＝20");
		temp.put(1247, "特別休暇月別残数データ.特別休暇.残数付与後	特別休暇残時間付与後20	特別休暇コード＝20");
		temp.put(1248, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化日数20	特別休暇コード＝20");
		temp.put(1249, "特別休暇月別残数データ.特別休暇.未消化数	特別休暇残未消化時間20	特別休暇コード＝20");
		temp.put(1250, "特別休暇月別残数データ.特別休暇付与情報	特別休暇付与日数20	特別休暇コード＝20");
		temp.put(1251, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数20	特別休暇コード＝20");
		temp.put(1252, "特別休暇月別残数データ.実特別休暇.使用数.使用日数	実特別休暇使用日数付与後20	特別休暇コード＝20");
		temp.put(1253, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間20	特別休暇コード＝20");
		temp.put(1254, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用時間付与後20	特別休暇コード＝20");
		temp.put(1255, "特別休暇月別残数データ.実特別休暇.使用数.使用時間	実時間特別休暇使用回数20	特別休暇コード＝20");
		temp.put(1256, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残日数20	特別休暇コード＝20");
		temp.put(1257, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残日数付与後20	特別休暇コード＝20");
		temp.put(1258, "特別休暇月別残数データ.実特別休暇.残数	実特別休暇残時間20	特別休暇コード＝20");
		temp.put(1259, "特別休暇月別残数データ.実特別休暇.残数付与後	実特別休暇残時間付与後20	特別休暇コード＝20");
		
		temp.put(1260, "代休月別残数データ.発生数	代休発生日数");
		temp.put(1261, "代休月別残数データ.発生数	代休発生時間");
		temp.put(1262, "代休月別残数データ.使用数	代休使用日数");
		temp.put(1263, "代休月別残数データ.使用数	代休使用時間");
		temp.put(1264, "代休月別残数データ.残数	代休残日数");
		temp.put(1265, "代休月別残数データ.残数	代休残時間");
		temp.put(1266, "代休月別残数データ.繰越数	代休繰越日数");
		temp.put(1267, "代休月別残数データ.繰越数	代休繰越時間");
		temp.put(1268, "代休月別残数データ.未消化数	代休未消化日数");
		temp.put(1269, "代休月別残数データ.未消化数	代休未消化時間");
		
		temp.put(1270, "振休月別残数データ	振休発生数");
		temp.put(1271, "振休月別残数データ	振休使用数");
		temp.put(1272, "振休月別残数データ	振休残数");
		temp.put(1273, "振休月別残数データ	振休未消化日数");
		temp.put(1274, "振休月別残数データ	振休繰越数");
