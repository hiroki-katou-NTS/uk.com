...
//		temp.put(461, getText(DAILY_ATTENDACE_LEAVE_NAME, COUNT));
	...
	private static void getMonthlyKey(Map<Integer, String> temp) {
		...
		temp.put(165, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_1));
		temp.put(166, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_2));
		temp.put(167, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_3));
		temp.put(168, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_4));
		temp.put(169, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_5));
		temp.put(170, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_6));
		temp.put(171, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_7));
		temp.put(172, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_8));
		temp.put(173, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, LEGAL + NUMBER_9));
		temp.put(174, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGGREGATE, HOLIDAY_WORK, AGGREGATE, joinNS(LEGAL, NUMBER_1, NUMBER_0)));
	...
	private static void getMonthlyKey2(Map<Integer, String> temp) {
		...
		temp.put(887, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, REMAIN, DAYS + NUMBER_3));
