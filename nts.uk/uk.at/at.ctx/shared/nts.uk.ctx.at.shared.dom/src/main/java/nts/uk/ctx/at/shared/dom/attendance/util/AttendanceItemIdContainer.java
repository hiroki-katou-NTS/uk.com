...
//		temp.put(461, getText(DAILY_ATTENDACE_LEAVE_NAME, COUNT));
		...
		temp.put(160, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1)));
		temp.put(161, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1)));
		temp.put(166, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_2)));
		temp.put(167, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_2)));
		temp.put(172, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_3)));
		temp.put(173, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_3)));
		temp.put(178, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_4)));
		temp.put(179, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_4)));
		temp.put(184, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_5)));
		temp.put(185, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_5)));
		temp.put(190, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_6)));
		temp.put(191, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_6)));
		temp.put(196, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_7)));
		temp.put(197, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_7)));
		temp.put(202, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_8)));
		temp.put(203, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_8)));
		temp.put(208, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_9)));
		temp.put(209, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_9)));
		temp.put(214, join(breakTime, AFTER_CORRECTED, joinNS(START, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1, NUMBER_0)));
		temp.put(215, join(breakTime, AFTER_CORRECTED, joinNS(END, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1, NUMBER_0)));
		...
		temp.put(469, join(totalLabol, GO_OUT, CALC, EXCESS_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_SUPPORT)));
		temp.put(478, join(totalLabol, GO_OUT, CALC, EXCESS_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_UNION)));
		temp.put(481, join(totalLabol, GO_OUT, CALC, EXCESS_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_UNION)));
		temp.put(485, join(totalLabol, GO_OUT, CALC, EXCESS_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_CHARGE)));
		temp.put(488, join(totalLabol, GO_OUT, CALC, EXCESS_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_CHARGE)));
		temp.put(492, join(totalLabol, GO_OUT, CALC, EXCESS_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_OFFICAL)));
		temp.put(496, join(totalLabol, GO_OUT, CALC, EXCESS_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_OFFICAL)));
		temp.put(464, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_SUPPORT)));
		temp.put(468, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_SUPPORT)));
		temp.put(477, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_UNION)));
		temp.put(480, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_UNION)));
		temp.put(484, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_CHARGE)));
		temp.put(487, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_CHARGE)));
		temp.put(491, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_OFFICAL)));
		temp.put(495, join(totalLabol, GO_OUT, CALC, WITHIN_STATUTORY, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_OFFICAL)));
		...
		temp.put(472, join(totalLabol, GO_OUT, DEDUCTION, WITHIN_STATUTORY, joinNS(TIME, DEFAULT_ENUM_SEPERATOR, E_SUPPORT)));
	...
	private static void getMonthlyKey(Map<Integer, String> temp) {
		...
		temp.put(467, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGON, DAYS));
		temp.put(468, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGON, TOTAL));
		temp.put(469, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGON, AVERAGE));
		temp.put(470, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGOFF, DAYS));
		temp.put(471, join(MONTHLY_ATTENDANCE_TIME_NAME, VERTICAL_TOTAL, CLOCK, PC, DIVERGENCE, LOGOFF, TOTAL));
		...
		temp.put(795, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, REMAIN, TIME));
//		temp.put(796, "年休月別残数データ.年休.残数.年休残時間");
