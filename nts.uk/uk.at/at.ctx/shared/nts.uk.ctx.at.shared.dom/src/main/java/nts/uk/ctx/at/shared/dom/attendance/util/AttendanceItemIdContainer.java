...
//		temp.put(797, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, joinNS(REMAIN, GRANT, AFTER), TIME));
		...
		temp.put(801, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, USAGE + NUMBER, GRANT + AFTER, DAYS));
...
//		temp.put(829, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, joinNS(REAL, UPPER_LIMIT, REMAIN), GRANT + AFTER));
		...
		temp.put(1427, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, REMAIN, TOTAL, TIME, TIME));
		temp.put(1428, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, REMAIN, GRANT + AFTER, TIME, TIME));
		...
		temp.put(1432, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, REMAIN, TOTAL, TIME, TIME));
		temp.put(1433, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, REMAIN, GRANT + AFTER, TIME, TIME));
		...
		temp.put(1438, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, HALF_DAY + ANNUNAL_LEAVE, USAGE, COUNT));
		temp.put(1439, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, HALF_DAY + ANNUNAL_LEAVE, USAGE, GRANT + AFTER));
		...
		temp.put(1861, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, USAGE + NUMBER, GRANT + BEFORE, DAYS, DAYS));
		temp.put(1862, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, REMAIN, BEFORE, DAYS));
		temp.put(1863, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, USAGE + NUMBER, GRANT + BEFORE, DAYS, DAYS));
		temp.put(1864, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, REMAIN, BEFORE, DAYS));
		temp.put(1865, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, USAGE + NUMBER, GRANT + BEFORE, TIME, TIME));
		temp.put(1866, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, USAGE + NUMBER, USAGE + DAYS));
		temp.put(1867, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, ANNUNAL_LEAVE, REMAIN, TIME));
		temp.put(1868, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, USAGE + NUMBER, GRANT + BEFORE, TIME, TIME));
		temp.put(1869, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, USAGE + NUMBER, USAGE + DAYS));
		temp.put(1870, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, REAL + ANNUNAL_LEAVE, REMAIN, TIME));
...
//		temp.put(839, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, REAL + RETENTION, GRANT + AFTER, DAYS));
		temp.put(1871, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, RETENTION, USAGE, GRANT + BEFORE));
		temp.put(1872, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, RETENTION, REMAIN, BEFORE));
		temp.put(1873, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, REAL + RETENTION, USAGE, GRANT + BEFORE));
		temp.put(1874, join(MONTHLY_RESERVE_LEAVING_REMAIN_NAME, REAL + RETENTION, REMAIN, BEFORE));
