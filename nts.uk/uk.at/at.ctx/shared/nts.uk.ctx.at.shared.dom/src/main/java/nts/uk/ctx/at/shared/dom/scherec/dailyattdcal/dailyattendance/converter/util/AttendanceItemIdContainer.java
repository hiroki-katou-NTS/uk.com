...
//		temp.put(1240, join(ANY_PERIOD_ATTENDANCE_TIME_NAME, HOLIDAY, SPECIAL_HOLIDAY, USAGE, joinNS(DAYS, NUMBER_1, NUMBER_0)));
...
//		temp.put(1355, join(ANY_PERIOD_ATTENDANCE_TIME_NAME, CALC, IRREGULAR, IRREGULAR + LEGAL + OVERTIME));
	...
	public static Stream<ItemValue> getIdMapStream(Collection<Integer> values, AttendanceItemType type) {
		...
		if (type == AttendanceItemType.MONTHLY_ITEM) {
            ...
            System.out.println("GOT CORRECT CONTAINER!");
