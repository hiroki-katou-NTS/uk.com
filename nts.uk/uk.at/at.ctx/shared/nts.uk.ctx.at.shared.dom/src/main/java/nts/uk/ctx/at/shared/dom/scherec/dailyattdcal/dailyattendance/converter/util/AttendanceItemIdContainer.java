...
//		temp.put(461, getText(DAILY_ATTENDACE_LEAVE_NAME, COUNT));
		...
		temp.put(156, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1)));
		temp.put(162, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_2)));
		temp.put(168, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_3)));
		temp.put(174, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_4)));
		temp.put(180, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_5)));
		temp.put(186, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_6)));
		temp.put(192, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_7)));
		temp.put(198, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_8)));
		temp.put(204, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_9)));
		temp.put(210, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1, NUMBER_0)));
		temp.put(158, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1)));
		temp.put(164, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_2)));
		temp.put(170, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_3)));
		temp.put(176, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_4)));
		temp.put(182, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_5)));
		temp.put(188, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_6)));
		temp.put(194, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_7)));
		temp.put(200, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_8)));
		temp.put(206, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_9)));
		temp.put(212, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(PLACE, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1, NUMBER_0)));
		temp.put(157, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1)));
		temp.put(163, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_2)));
		temp.put(169, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_3)));
		temp.put(175, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_4)));
		temp.put(181, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_5)));
		temp.put(187, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_6)));
		temp.put(193, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_7)));
		temp.put(199, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_8)));
		temp.put(205, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_9)));
		temp.put(211, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1, NUMBER_0)));
		temp.put(159, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1)));
		temp.put(165, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_2)));
		temp.put(171, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_3)));
		temp.put(177, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_4)));
		temp.put(183, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_5)));
		temp.put(189, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_6)));
		temp.put(195, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_7)));
		temp.put(201, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_8)));
		temp.put(207, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_9)));
		temp.put(213, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_WORK_REF, NUMBER_1, NUMBER_0)));
		temp.put(7, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_1)));
		temp.put(9, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_2)));
		temp.put(11, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_3)));
		temp.put(13, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_4)));
		temp.put(15, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_5)));
		temp.put(17, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_6)));
		temp.put(19, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_7)));
		temp.put(21, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_8)));
		temp.put(23, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_9)));
		temp.put(25, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, START, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_1, NUMBER_0)));
		temp.put(8, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_1)));
		temp.put(10, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_2)));
		temp.put(12, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_3)));
		temp.put(14, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_4)));
		temp.put(16, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_5)));
		temp.put(18, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_6)));
		temp.put(20, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_7)));
		temp.put(22, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_8)));
		temp.put(24, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_9)));
		temp.put(26, join(DAILY_BREAK_TIME_NAME, FAKED, TIME_ZONE, END, joinNS(CLOCK, DEFAULT_ENUM_SEPERATOR, E_SCHEDULE_REF, NUMBER_1, NUMBER_0)));
...
//		temp.put(757, "日別実績の遅刻時間．インターバル免除時間.免除時間");
	...
	private static void getMonthlyKey2(Map<Integer, String> temp) {
		...
		temp.put(1350, join(MONTHLY_ATTENDANCE_TIME_NAME, CALC, AGREEMENT + UPPER_LIMIT, AGREEMENT));
