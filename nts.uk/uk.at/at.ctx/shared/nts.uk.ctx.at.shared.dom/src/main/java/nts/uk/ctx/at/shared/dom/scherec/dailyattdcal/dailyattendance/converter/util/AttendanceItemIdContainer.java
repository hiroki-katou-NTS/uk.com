...
//		temp.put(829, join(MONTHLY_ANNUAL_LEAVING_REMAIN_NAME, joinNS(REAL, UPPER_LIMIT, REMAIN), GRANT + AFTER));
	...
	private static void getMonthlyKeySpecialHoliday(Map<Integer, String> temp) {
		...
		for(int i = 0; i< 20; i++) {
			temp.put(840+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, USAGE, TOTAL, DAYS , DAYS + (i+1)));
			temp.put(841+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, USAGE, GRANT+AFTER, DAYS , DAYS + (i+1)));
			temp.put(845+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, REMAIN, TOTAL, DAYS + (i+1)));
			temp.put(846+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, REMAIN, GRANT+AFTER, DAYS + (i+1)));
			temp.put(849+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME,  NOT_DIGESTION, DAYS + (i+1)));
			temp.put(851+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME,  GRANT + DAYS + (i+1)));
			temp.put(852+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, REAL + SPECIAL_HOLIDAY, USAGE, TOTAL, DAYS , DAYS + (i+1)));
			temp.put(853+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, REAL + SPECIAL_HOLIDAY, USAGE, GRANT+AFTER, DAYS , DAYS + (i+1)));
			temp.put(857+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, REAL + SPECIAL_HOLIDAY, REMAIN, TOTAL, DAYS + (i+1)));
			temp.put(858+ i*21, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, REAL + SPECIAL_HOLIDAY, REMAIN, GRANT+AFTER, DAYS + (i+1)));
		}
	
		for(int i = 0; i< 20; i++) {
			temp.put(1446+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, USAGE, TOTAL, TIME , TIME + (i+1)));
			temp.put(1447+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, USAGE, GRANT+AFTER, TIME , TIME + (i+1)));
			temp.put(1448+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, USAGE, COUNT + (i+1)));
			temp.put(1449+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, REMAIN, TOTAL, TIME , TIME + (i+1)));
			temp.put(1450+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, REMAIN, GRANT+AFTER, TIME , TIME + (i+1)));
			temp.put(1451+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME,  NOT_DIGESTION, TIME + (i+1)));
			temp.put(1452+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, REAL + SPECIAL_HOLIDAY, USAGE, TOTAL, TIME , TIME + (i+1)));
			temp.put(1453+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, REAL + SPECIAL_HOLIDAY, USAGE, GRANT+AFTER, TIME , TIME + (i+1)));
			temp.put(1454+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, REAL + SPECIAL_HOLIDAY, USAGE, COUNT + (i+1)));
			temp.put(1455+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, REMAIN, TOTAL, TIME , TIME + (i+1)));
			temp.put(1456+ i*11, join(MONTHLY_SPECIAL_HOLIDAY_REMAIN_NAME, SPECIAL_HOLIDAY, REMAIN, GRANT+AFTER, TIME , TIME + (i+1)));
