...
public class AttendanceItemIdContainer implements ItemConst {
	...
	private static void getDailyKey(Map<Integer, String> temp){
		...
		for (int i = 0; i < 20; i++) {
			String NUMBER = i+1 + "";
			temp.put(921 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, WORKPLACE_BYSUPPORT, WORKPLACEID + NUMBER ));
			temp.put(922 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, WORKPLACE_BYSUPPORT, WORKLOCATIONCD + NUMBER ));
			temp.put(923 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, REMARK + NUMBER ));
			temp.put(924 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, WORKGROUP, WORKCODE1 + NUMBER));
			temp.put(925 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, WORKGROUP, WORKCODE2 + NUMBER));
			temp.put(926 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, WORKGROUP, WORKCODE3 + NUMBER));
			temp.put(927 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, WORKGROUP, WORKCODE4 + NUMBER));
			temp.put(928 + 10*i , join(DAILY_SUPPORT_TIMESHEET_NAME, WORK_CONTENT, WORKGROUP, WORKCODE5 + NUMBER));
