...
import nts.uk.ctx.at.shared.dom.worktime.algorithm.getcommonset.GetCommonSetImpl.Require;
...
public interface GetCommonSet {
	...
	Optional<WorkTimezoneCommonSet> getRequire(Require require, String companyId, String workTimeCode);
	/**
	 * 全ての共通設定の取得
	 * @param companyId 会社ID
