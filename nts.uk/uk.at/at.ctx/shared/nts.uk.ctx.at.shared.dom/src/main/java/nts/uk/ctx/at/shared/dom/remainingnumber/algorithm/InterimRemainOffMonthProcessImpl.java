...
public class InterimRemainOffMonthProcessImpl implements InterimRemainOffMonthProcess{
	...
	public Map<GeneralDate, DailyInterimRemainMngData> monthInterimRemainData(CacheCarrier cacheCarrier, String cid, String sid, DatePeriod dateData) {
		...
		List<RecordRemainCreateInfor> lstRecordData = recordDataService.lstRecordRemainData(cacheCarrier, cid, sid, dateData);
		...
		Map<GeneralDate, DailyInterimRemainMngData> mapDataOutput = InterimRemainOffPeriodCreateData
				.createInterimRemainDataMng(requireService.createRequire(), cacheCarrier, inputPara, comHolidaySetting);
