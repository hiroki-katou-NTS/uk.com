...
public class DefoAggregateMethodOfMonthly {
	...
	public AttendanceTimeMonth calc(Require require, CacheCarrier cacheCarrier, String sid, YearMonth targetYm, 
			GeneralDate baseDate, String cid, String employmentCode, DatePeriod period) {
		...
		/** 在職しない日数を確認する */
		if(period.datesBetween().size() == workingDays) return  monthlyTime;
	...
	public static interface Require extends MonthlyStatutoryWorkingHours.RequireM4, GetPeriodExcluseEntryRetireTime.Require {
