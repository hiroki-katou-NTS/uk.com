...
public enum RoundingTimeUnit {
	...
	/** The six. */
	SIX(0, "Enum_RoundingTimeUnit_six", "6"),
	
	/** The ten. */
	TEN(0, "Enum_RoundingTimeUnit_ten", "10"),
	
	/** The fifteen. */
	FIFTEEN(0, "Enum_RoundingTimeUnit_fifteen", "15"),
	
	/** The twenty. */
	TWENTY(0, "Enum_RoundingTimeUnit_twenty", "20"),
	
	/** The thirty. */
	THIRTY(0, "Enum_RoundingTimeUnit_thirty", "30"),
	
	/** The sixty. */
	SIXTY(0, "Enum_FontRearSection_sixty", "60");
