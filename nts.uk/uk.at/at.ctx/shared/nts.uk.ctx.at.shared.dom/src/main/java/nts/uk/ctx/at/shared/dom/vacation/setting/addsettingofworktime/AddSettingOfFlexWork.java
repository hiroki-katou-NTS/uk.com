 ...
 *
 */
public class AddSettingOfFlexWork  extends AggregateRoot implements AddSetting {
	 ...
	 * Constructor 
	 */
	public AddSettingOfFlexWork(CompanyId companyId, HolidayCalcMethodSet holidayCalcMethodSet) {
		super();
