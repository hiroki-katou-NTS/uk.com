...
@Getter
// 社員別変形労働労働時間
public class ShainSpeDeforLaborHour extends AggregateRoot implements StatutoryWorkTimeSet {
	 ...
	 *            the memento
	 */
	public ShainSpeDeforLaborHour(ShainSpeDeforLaborHour memento) {
	 ...
	 *            the memento
	 */
	public void saveToMemento(ShainSpeDeforLaborHourSetMemento memento) {
