...
public class InterimRemainOffMonthProcessImpl implements InterimRemainOffMonthProcess {
	...
	/** 年休の比較 */
	/*
	 * private void compareAnnualHoliday(Require require, CacheCarrier cacheCarrier,
	 * String cid, String empId, DatePeriod period, List<TmpAnnualHolidayMng>
	 * dailyAnnualHol, IntegrationOfMonthly monthly) {
	 */		
		/** 期間中の次回年休付与を取得 */
