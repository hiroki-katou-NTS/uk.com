...
public class JpaShiftMasterImpl extends JpaRepository implements ShiftMasterRepository {
	...
	private static final String SELECT_ALL_DTO = " SELECT " 
			+ " new nts.uk.ctx.at.shared.dom.workrule.shiftmaster.dto.ShiftMasterDto(c.kshmtShiftMaterPK.companyId, c.name, c.kshmtShiftMaterPK.shiftMaterCode, c.color, c.remarks, c.workTypeCd, wt.abbreviationName, c.workTimeCd, wts.abname ) "
