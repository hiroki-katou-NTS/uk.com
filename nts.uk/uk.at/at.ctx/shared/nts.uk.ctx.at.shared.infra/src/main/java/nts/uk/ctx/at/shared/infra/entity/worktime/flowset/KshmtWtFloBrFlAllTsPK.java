...
/**
 * The Class KshmtWtFloBrFlAllTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFloBrFlAllTsPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KshmtWtFloBrFlAllTsPK other = (KshmtWtFloBrFlAllTsPK) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
