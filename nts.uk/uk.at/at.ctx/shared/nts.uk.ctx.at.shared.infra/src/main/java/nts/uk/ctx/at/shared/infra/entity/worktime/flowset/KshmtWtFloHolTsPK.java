...
/**
 * The Class KshmtWtFloHolTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFloHolTsPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFloHolTsPK)) {
			return false;
		}
		KshmtWtFloHolTsPK other = (KshmtWtFloHolTsPK) object;
