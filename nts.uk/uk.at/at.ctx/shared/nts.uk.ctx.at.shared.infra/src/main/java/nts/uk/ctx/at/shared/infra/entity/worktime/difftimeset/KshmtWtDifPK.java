...
/**
 * The Class KshmtWtDifPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtDifPK implements Serializable {
	 ...
	 */
	public KshmtWtDifPK(String cid, String worktimeCd) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtDifPK)) {
			return false;
		}
		KshmtWtDifPK other = (KshmtWtDifPK) object;
