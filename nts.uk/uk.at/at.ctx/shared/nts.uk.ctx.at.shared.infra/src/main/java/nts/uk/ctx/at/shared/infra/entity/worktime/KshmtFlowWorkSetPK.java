...
/**
 * The Class KshmtFlowWorkSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFlowWorkSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFlowWorkSetPK)) {
			return false;
		}
		KshmtFlowWorkSetPK other = (KshmtFlowWorkSetPK) object;
