...
/**
 * The Class KshmtFlexRestSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFlexRestSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFlexRestSetPK)) {
			return false;
		}
		KshmtFlexRestSetPK other = (KshmtFlexRestSetPK) object;
