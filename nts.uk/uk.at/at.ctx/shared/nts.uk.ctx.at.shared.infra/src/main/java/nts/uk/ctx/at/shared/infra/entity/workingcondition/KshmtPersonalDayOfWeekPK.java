...
/**
 * The Class KshmtPersonalDayOfWeekPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtPersonalDayOfWeekPK implements Serializable {
	 ...
	 */
	public KshmtPersonalDayOfWeekPK() {
		super();
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtPersonalDayOfWeekPK)) {
			return false;
		}
		KshmtPersonalDayOfWeekPK other = (KshmtPersonalDayOfWeekPK) object;
