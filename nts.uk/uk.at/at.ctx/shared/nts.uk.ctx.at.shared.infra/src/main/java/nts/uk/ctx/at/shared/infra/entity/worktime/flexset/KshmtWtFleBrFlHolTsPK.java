...
/**
 * The Class KshmtWtFleBrFlHolTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFleBrFlHolTsPK implements Serializable {
	 ...
	 */
	public KshmtWtFleBrFlHolTsPK(String cid, String worktimeCd, int periodNo) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof KshmtWtFleBrFlHolTsPK))
			return false;
		KshmtWtFleBrFlHolTsPK other = (KshmtWtFleBrFlHolTsPK) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
