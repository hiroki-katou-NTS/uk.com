...
public class KshstWkpDeforLarSetPK implements Serializable {
    ...
    public KshstWkpDeforLarSetPK() {
    }

    public KshstWkpDeforLarSetPK(String cid, String wkpId, short year) {
        this.cid = cid;
        this.wkpId = wkpId;
        this.year = year;
    }
    ...
    public String toString() {
        return "entities.KshstWkpDeforLarSetPK[ cid=" + cid + ", wkpId=" + wkpId + ", year=" + year + " ]";
    }
