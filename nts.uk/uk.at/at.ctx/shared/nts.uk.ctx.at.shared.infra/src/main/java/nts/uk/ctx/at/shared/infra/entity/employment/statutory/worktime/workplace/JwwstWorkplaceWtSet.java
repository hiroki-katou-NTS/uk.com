...
@Getter
@Setter
@Table(name = "JWWST_WORKPLACE_WT_SET")
public class JwwstWorkplaceWtSet extends UkJpaEntity implements Serializable {
	...
	@EmbeddedId
	protected JwwstWorkplaceWtSetPK jwwstWorkplaceWtSetPK;
