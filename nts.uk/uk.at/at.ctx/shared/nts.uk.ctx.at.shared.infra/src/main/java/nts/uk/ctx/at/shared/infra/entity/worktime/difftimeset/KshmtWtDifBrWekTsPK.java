...
/**
 * The Class KshmtWtDifBrWekTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtDifBrWekTsPK implements Serializable {
	 ...
	 */
	public KshmtWtDifBrWekTsPK(String cid, String worktimeCd, int amPmAtr, int periodNo) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KshmtWtDifBrWekTsPK other = (KshmtWtDifBrWekTsPK) obj;
