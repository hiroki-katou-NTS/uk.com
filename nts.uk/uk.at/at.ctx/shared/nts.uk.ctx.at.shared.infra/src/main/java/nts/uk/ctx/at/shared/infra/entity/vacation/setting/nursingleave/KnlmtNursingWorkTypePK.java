...
@Getter
@Embeddable
public class KnlmtNursingWorkTypePK implements Serializable {
     ...
     */
    public KnlmtNursingWorkTypePK(String cid, Integer nursingCtr, Integer orderNumber) {
        this.cid = cid;
