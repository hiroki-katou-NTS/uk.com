...
/**
 * The Class KshmtWtFlePK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFlePK implements Serializable {
	 ...
	 */
	public KshmtWtFlePK(String cid, String worktimeCd) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFlePK)) {
			return false;
		}
		KshmtWtFlePK other = (KshmtWtFlePK) object;
