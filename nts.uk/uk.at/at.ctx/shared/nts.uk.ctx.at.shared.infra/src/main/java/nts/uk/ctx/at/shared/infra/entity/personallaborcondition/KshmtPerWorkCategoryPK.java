...
/**
 * The Class KshmtPerWorkCategoryPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtPerWorkCategoryPK implements Serializable {
     ...
     */
    public KshmtPerWorkCategoryPK(String sid, int workCategoryAtr, GeneralDate startYmd,
			GeneralDate endYmd) {
		super();
		this.sid = sid;
	...
	public boolean equals(Object object) {
		// not set
		if (!(object instanceof KshmtPerWorkCategoryPK)) {
			return false;
		}
		KshmtPerWorkCategoryPK other = (KshmtPerWorkCategoryPK) object;
	...
	public String toString() {
		return "entity.KshmtPerWorkCategoryPK[ sid=" + sid + ", workCategoryAtr=" + workCategoryAtr
