...
@AllArgsConstructor
public class KshmtWtComPredTime extends UkJpaEntity implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtComPredTime)) {
			return false;
		}
