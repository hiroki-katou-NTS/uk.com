...
@Getter
@Embeddable
public class KclmtCompensLeaveEmpPK implements Serializable {
     ...
     *            the empcd
     */
    public KclmtCompensLeaveEmpPK(String cid, String empcd) {
        this.cid = cid;
        this.empcd = empcd;
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof KclmtCompensLeaveEmpPK)) {
            return false;
        }
        KclmtCompensLeaveEmpPK other = (KclmtCompensLeaveEmpPK) object;
