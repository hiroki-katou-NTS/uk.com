...
/**
 * The Class KshmtWtFleWorkTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFleWorkTsPK implements Serializable {
	 ...
	 */
	public KshmtWtFleWorkTsPK(String cid, String worktimeCd, int amPmAtr, int timeFrameNo) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFleWorkTsPK)) {
			return false;
		}
		KshmtWtFleWorkTsPK other = (KshmtWtFleWorkTsPK) object;
