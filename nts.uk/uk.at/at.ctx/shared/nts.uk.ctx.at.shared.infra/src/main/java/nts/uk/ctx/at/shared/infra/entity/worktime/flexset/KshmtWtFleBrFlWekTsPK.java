...
/**
 * The Class KshmtWtFleBrFlWekTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFleBrFlWekTsPK implements Serializable {
	 ...
	 */
	public KshmtWtFleBrFlWekTsPK(String cid, String worktimeCd, int amPmAtr, int periodNo) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KshmtWtFleBrFlWekTsPK other = (KshmtWtFleBrFlWekTsPK) obj;
