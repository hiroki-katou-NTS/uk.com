...
/**
 * The Class KshmtWtComHdcomPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtComHdcomPK implements Serializable {
	 ...
	 */
	public KshmtWtComHdcomPK(String cid, String worktimeCd, int workFormAtr, int worktimeSetMethod, int originAtr) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtComHdcomPK)) {
			return false;
		}
		KshmtWtComHdcomPK other = (KshmtWtComHdcomPK) object;
