...
@NoArgsConstructor
@Entity
@Table(name = "KSHST_IRREGULAR_WORK_SET")
public class KshstIrregularWorkSet  extends UkJpaEntity implements Serializable{
	private static final long serialVersionUID = 1L;
	/** 主キー */
	@EmbeddedId
	public KshstIrregularWorkSetPK kshstIrregularWorkSetPK;
	...
	public int calcIntervalTimeWork;
...
//	public KshstHolidayAddtimeSet holidayAddtimeSet;
	...
	protected Object getKey() {
		return kshstIrregularWorkSetPK;
	}
}
