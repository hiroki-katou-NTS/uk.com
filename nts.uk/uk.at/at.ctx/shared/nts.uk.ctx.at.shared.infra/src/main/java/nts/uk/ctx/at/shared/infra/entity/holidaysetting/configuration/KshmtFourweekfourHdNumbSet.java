...
/**
 * The Class KshmtFourweekfourHdNumbSet.
 */
@Getter
@Setter
@Entity
@Table(name = "KSHMT_FOURWEEKFOUR_HD_NUMB_SET")
public class KshmtFourweekfourHdNumbSet extends ContractUkJpaEntity implements Serializable {
     ...
     */
    public KshmtFourweekfourHdNumbSet() {
    	super();
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof KshmtFourweekfourHdNumbSet)) {
            return false;
        }
        KshmtFourweekfourHdNumbSet other = (KshmtFourweekfourHdNumbSet) object;
