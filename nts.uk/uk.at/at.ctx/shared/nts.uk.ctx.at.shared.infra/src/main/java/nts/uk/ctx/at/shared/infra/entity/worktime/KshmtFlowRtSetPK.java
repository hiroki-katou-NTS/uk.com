...
/**
 * The Class KshmtFlowRtSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFlowRtSetPK implements Serializable {
	...
	/**
	 * Instantiates a new kshmt flow rt set PK.
	 */
	public KshmtFlowRtSetPK() {
		super();
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFlowRtSetPK)) {
			return false;
		}
		KshmtFlowRtSetPK other = (KshmtFlowRtSetPK) object;
