...
/**
 * The Class KshmtFlowFixedRtSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFlowFixedRtSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFlowFixedRtSetPK)) {
			return false;
		}
		KshmtFlowFixedRtSetPK other = (KshmtFlowFixedRtSetPK) object;
