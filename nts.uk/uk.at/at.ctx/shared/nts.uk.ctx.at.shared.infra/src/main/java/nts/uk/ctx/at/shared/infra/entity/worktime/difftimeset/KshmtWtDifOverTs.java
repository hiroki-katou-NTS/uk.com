...
/**
 * The Class KshmtWtDifOverTs.
 */
@Getter
@Setter
@Entity
@Table(name = "KSHMT_WT_DIF_OVER_TS")
public class KshmtWtDifOverTs extends UkJpaEntity implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtDifOverTs)) {
			return false;
		}
