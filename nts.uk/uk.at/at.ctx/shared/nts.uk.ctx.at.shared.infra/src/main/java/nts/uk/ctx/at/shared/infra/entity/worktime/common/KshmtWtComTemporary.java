...
/**
 * The Class KshmtWtComTemporary.
 */
@Getter
@Setter
@Entity
@Table(name = "KSHMT_WT_COM_TEMPORARY")
public class KshmtWtComTemporary extends UkJpaEntity implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtComTemporary)) {
			return false;
		}
