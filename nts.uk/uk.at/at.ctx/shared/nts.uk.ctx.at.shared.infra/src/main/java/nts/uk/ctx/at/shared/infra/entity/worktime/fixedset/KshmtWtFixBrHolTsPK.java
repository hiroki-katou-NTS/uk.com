...
/**
 * The Class KshmtWtFixBrHolTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFixBrHolTsPK implements Serializable {
	 ...
	 */
	public KshmtWtFixBrHolTsPK(String cid, String worktimeCd, int periodNo) {
		this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof KshmtWtFixBrHolTsPK))
			return false;
		KshmtWtFixBrHolTsPK other = (KshmtWtFixBrHolTsPK) obj;
		if (cid == null) {
			if (other.cid != null)
				return false;
