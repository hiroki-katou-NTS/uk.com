...
/**
 * The Class KshmtMedicalTimeSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtMedicalTimeSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtMedicalTimeSetPK)) {
			return false;
		}
		KshmtMedicalTimeSetPK other = (KshmtMedicalTimeSetPK) object;
