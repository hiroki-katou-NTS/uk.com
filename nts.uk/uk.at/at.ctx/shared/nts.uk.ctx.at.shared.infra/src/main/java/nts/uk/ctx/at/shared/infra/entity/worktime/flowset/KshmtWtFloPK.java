...
/**
 * The Class KshmtWtFloPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFloPK implements Serializable {
	 ...
	 *            the worktime cd
	 */
	public KshmtWtFloPK(String cid, String worktimeCd) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFloPK)) {
			return false;
		}
		KshmtWtFloPK other = (KshmtWtFloPK) object;
