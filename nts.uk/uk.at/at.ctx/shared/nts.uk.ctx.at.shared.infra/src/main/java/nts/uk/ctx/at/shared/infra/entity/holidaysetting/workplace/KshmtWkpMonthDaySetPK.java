...
/**
 * The Class KshmtWkpMonthDaySetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWkpMonthDaySetPK implements Serializable {
     ...
     */
    public KshmtWkpMonthDaySetPK(String cid, String wkpId, int manageYear, int month) {
        this.cid = cid;
        this.wkpId = wkpId;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof KshmtWkpMonthDaySetPK)) {
            return false;
        }
        KshmtWkpMonthDaySetPK other = (KshmtWkpMonthDaySetPK) object;
