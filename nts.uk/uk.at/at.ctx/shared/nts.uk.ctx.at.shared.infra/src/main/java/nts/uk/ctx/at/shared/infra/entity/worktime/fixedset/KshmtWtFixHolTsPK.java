...
/**
 * The Class KshmtWtFixHolTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFixHolTsPK implements Serializable {
	 ...
	 */
	public KshmtWtFixHolTsPK(String cid, String worktimeCd, int worktimeNo) {
		super();
		this.cid = cid;
	 ...
	 * @param worktimeNo the worktime no
	 */
	public KshmtWtFixHolTsPK(String cid, String worktimeCd, Integer worktimeNo) {
		super();
		this.cid = cid;
		this.worktimeCd = worktimeCd;
		this.worktimeNo = worktimeNo;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFixHolTsPK)) {
			return false;
		}
		KshmtWtFixHolTsPK other = (KshmtWtFixHolTsPK) object;
