...
/**
 * The Class KshmtWtFleHolTs.
 */
@Getter
@Setter
@Entity
@Table(name = "KSHMT_WT_FLE_HOL_TS")
public class KshmtWtFleHolTs extends UkJpaEntity implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFleHolTs)) {
			return false;
		}
