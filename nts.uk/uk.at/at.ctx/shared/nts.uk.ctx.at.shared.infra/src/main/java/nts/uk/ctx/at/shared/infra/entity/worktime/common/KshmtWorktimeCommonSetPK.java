...
/**
 * The Class KshmtWorktimeCommonSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWorktimeCommonSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWorktimeCommonSetPK)) {
			return false;
		}
		KshmtWorktimeCommonSetPK other = (KshmtWorktimeCommonSetPK) object;
