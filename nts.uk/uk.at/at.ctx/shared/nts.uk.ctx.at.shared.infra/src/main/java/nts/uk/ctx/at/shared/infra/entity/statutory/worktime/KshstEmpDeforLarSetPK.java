...
public class KshstEmpDeforLarSetPK implements Serializable {
    ...
    public KshstEmpDeforLarSetPK() {
    }

    public KshstEmpDeforLarSetPK(String cid, String empCd, short year) {
        this.cid = cid;
        this.empCd = empCd;
        this.year = year;
    }
    ...
    public String toString() {
        return "entities.KshstEmpDeforLarSetPK[ cid=" + cid + ", empCd=" + empCd + ", year=" + year + " ]";
    }
