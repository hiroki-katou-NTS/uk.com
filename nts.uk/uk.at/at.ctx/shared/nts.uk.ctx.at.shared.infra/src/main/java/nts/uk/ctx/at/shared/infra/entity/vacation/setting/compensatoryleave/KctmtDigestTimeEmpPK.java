...
@Getter
@Embeddable
public class KctmtDigestTimeEmpPK implements Serializable {
     ...
     *            the empcd
     */
    public KctmtDigestTimeEmpPK(String cid, String empcd) {
        this.cid = cid;
        this.empcd = empcd;
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof KctmtDigestTimeEmpPK)) {
            return false;
        }
        KctmtDigestTimeEmpPK other = (KctmtDigestTimeEmpPK) object;
