...
/**
 * The Class KshmtOutsideAtdPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtOutsideAtdPK implements Serializable {
     ...
     */
    public KshmtOutsideAtdPK(String cid, int brdItemNo, int attendanceItemId) {
        this.cid = cid;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof KshmtOutsideAtdPK)) {
            return false;
        }
        KshmtOutsideAtdPK other = (KshmtOutsideAtdPK) object;
