...
/**
 * The Class KshmtWtFleBrFlWekPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFleBrFlWekPK implements Serializable {
	 ...
	 *            the worktime cd
	 */
	public KshmtWtFleBrFlWekPK(String cid, String worktimeCd) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KshmtWtFleBrFlWekPK other = (KshmtWtFleBrFlWekPK) obj;
