...
public class JpaPersonalDayOfWeekSetMemento implements PersonalDayOfWeekSetMemento {
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.PersonalDayOfWeekSetMemento#setSaturday(java.util.Optional)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.PersonalDayOfWeekSetMemento#setSunday(java.util.Optional)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.PersonalDayOfWeekSetMemento#setMonday(java.util.Optional)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.PersonalDayOfWeekSetMemento#setThursday(java.util.Optional)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.PersonalDayOfWeekSetMemento#setWednesday(java.util.Optional)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.PersonalDayOfWeekSetMemento#setTuesday(java.util.Optional)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.PersonalDayOfWeekSetMemento#setFriday(java.util.Optional)
	 */
	@Override
