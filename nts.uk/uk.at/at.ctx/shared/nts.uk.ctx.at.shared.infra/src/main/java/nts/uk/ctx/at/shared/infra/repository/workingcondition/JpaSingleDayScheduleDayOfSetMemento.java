 ...
 */
public class JpaSingleDayScheduleDayOfSetMemento implements SingleDayScheduleSetMemento{
	 ...
	 */
	public JpaSingleDayScheduleDayOfSetMemento(KshmtPerDayOfWeek entity) {
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.SingleDayScheduleSetMemento#setWorkTypeCode(nts.uk.ctx.at.shared.dom.worktype.WorkTypeCode)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.SingleDayScheduleSetMemento#setWorkingHours(java.util.List)
	 */
	@Override
	public void setWorkingHours(List<TimeZone> workingHours) {
		...
		workingHours.forEach(workingHour -> {
			// times one set use
			if (workingHour.getTimes() == DEFAULT_TIMES_ONE && workingHour.getUseAtr().equals(UseAtr.USE)) {
			...
			// times two set use
			if (workingHour.getTimes() == DEFAULT_TIMES_TWO && workingHour.getUseAtr().equals(UseAtr.USE)) {
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.personallaborcondition.SingleDayScheduleSetMemento#setWorkTimeCode(java.util.Optional)
	 */
	@Override
