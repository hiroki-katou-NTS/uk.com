...
/**
 * The Class KshmtWtFloBrFlPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFloBrFlPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFloBrFlPK)) {
			return false;
		}
		KshmtWtFloBrFlPK other = (KshmtWtFloBrFlPK) object;
