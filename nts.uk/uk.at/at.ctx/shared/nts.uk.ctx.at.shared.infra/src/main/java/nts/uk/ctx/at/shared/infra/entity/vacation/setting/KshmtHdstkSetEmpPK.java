...
/**
 * The Class KshmtHdstkSetEmpPK.
 */
@Setter
@Getter
@Embeddable
public class KshmtHdstkSetEmpPK implements Serializable {
	 ...
	 *            the emp ctr cd
	 */
	public KshmtHdstkSetEmpPK(String cid, String empCtrCd) {
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtHdstkSetEmpPK)) {
			return false;
		}
		KshmtHdstkSetEmpPK other = (KshmtHdstkSetEmpPK) object;
