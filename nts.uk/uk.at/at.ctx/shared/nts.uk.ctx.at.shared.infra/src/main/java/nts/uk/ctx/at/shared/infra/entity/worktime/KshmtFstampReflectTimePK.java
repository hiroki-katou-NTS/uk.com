...
/**
 * The Class KshmtFstampReflectTimePK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFstampReflectTimePK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFstampReflectTimePK)) {
			return false;
		}
		KshmtFstampReflectTimePK other = (KshmtFstampReflectTimePK) object;
