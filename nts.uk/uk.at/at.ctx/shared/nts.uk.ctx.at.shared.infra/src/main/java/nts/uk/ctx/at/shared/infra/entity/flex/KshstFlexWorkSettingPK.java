...
@NoArgsConstructor
@AllArgsConstructor
public class KshstFlexWorkSettingPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof KshstFlexWorkSettingPK)) {
			return false;
		}
		KshstFlexWorkSettingPK castOther = (KshstFlexWorkSettingPK)other;
		return 
