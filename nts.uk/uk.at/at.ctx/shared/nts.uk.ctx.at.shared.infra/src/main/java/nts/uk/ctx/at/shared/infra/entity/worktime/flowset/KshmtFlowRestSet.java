...
/**
 * The Class KshmtFlowRestSet.
 */
@Getter
@Setter
@Entity
@Table(name = "KSHMT_FLOW_REST_SET")
public class KshmtFlowRestSet extends ContractUkJpaEntity implements Serializable {
	...
	@EmbeddedId
	protected KshmtFlowRestSetPK kshmtFlowRestSetPK;
	...
	public int hashCode() {
		int hash = 0;
		hash += (kshmtFlowRestSetPK != null ? kshmtFlowRestSetPK.hashCode() : 0);
		return hash;
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFlowRestSet)) {
			return false;
		}
	...
	protected Object getKey() {
		return this.kshmtFlowRestSetPK;
	}
