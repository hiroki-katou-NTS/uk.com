...
/**
 * The Class KshmtOtTimeZonePK.
 */
@Getter
@Setter
@Embeddable
public class KshmtOtTimeZonePK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtOtTimeZonePK)) {
			return false;
		}
		KshmtOtTimeZonePK other = (KshmtOtTimeZonePK) object;
