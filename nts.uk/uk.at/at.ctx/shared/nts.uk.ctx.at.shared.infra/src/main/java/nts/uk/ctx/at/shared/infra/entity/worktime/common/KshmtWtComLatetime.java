...
/**
 * The Class KshmtWtComLatetime.
 */
@Getter
@Setter
@Entity
@Table(name = "KSHMT_WT_COM_LATETIME")
public class KshmtWtComLatetime extends UkJpaEntity implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtComLatetime)) {
			return false;
		}
