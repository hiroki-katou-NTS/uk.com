...
/**
 * The Class KshmtWtFixPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFixPK implements Serializable {
	 ...
	 *            the worktime cd
	 */
	public KshmtWtFixPK(String cid, String worktimeCd) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFixPK)) {
			return false;
		}
		KshmtWtFixPK other = (KshmtWtFixPK) object;
