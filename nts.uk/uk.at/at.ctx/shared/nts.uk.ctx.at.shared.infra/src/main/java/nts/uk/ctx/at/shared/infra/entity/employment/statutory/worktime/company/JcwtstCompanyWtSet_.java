 ...
 */
@StaticMetamodel(JcwtstCompanyWtSet.class)
public class JcwtstCompanyWtSet_ {

	/** The jcwtst company wt set PK. */
	public static volatile SingularAttribute<JcwtstCompanyWtSet, JcwtstCompanyWtSetPK> jcwtstCompanyWtSetPK;

	/** The month. */
	public static volatile SingularAttribute<JcwtstCompanyWtSet, Integer> month;
