...
/**
 * The Class KshmtWtDifStmpRefTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtDifStmpRefTsPK implements Serializable {
	 ...
	 *            the atr
	 */
	public KshmtWtDifStmpRefTsPK(String cid, String worktimeCd, int workNo, int atr) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KshmtWtDifStmpRefTsPK other = (KshmtWtDifStmpRefTsPK) obj;
		if (atr != other.atr)
			return false;
		if (cid == null) {
			if (other.cid != null)
