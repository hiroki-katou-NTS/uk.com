...
@AllArgsConstructor
@NoArgsConstructor
public class KshstTempWkUseManagePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof KshstTempWkUseManagePK)) {
			return false;
		}
		KshstTempWkUseManagePK castOther = (KshstTempWkUseManagePK)other;
		return 
