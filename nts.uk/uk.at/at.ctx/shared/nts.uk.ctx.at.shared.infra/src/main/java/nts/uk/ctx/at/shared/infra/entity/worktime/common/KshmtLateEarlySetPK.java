...
/**
 * The Class KshmtLateEarlySetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtLateEarlySetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtLateEarlySetPK)) {
			return false;
		}
		KshmtLateEarlySetPK other = (KshmtLateEarlySetPK) object;
