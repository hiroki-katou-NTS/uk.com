...
/**
 * The Class KshmtFlexOdRtSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFlexOdRtSetPK implements Serializable {
	 ...
	 */
	public KshmtFlexOdRtSetPK(String cid, String worktimeCd) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFlexOdRtSetPK)) {
			return false;
		}
		KshmtFlexOdRtSetPK other = (KshmtFlexOdRtSetPK) object;
