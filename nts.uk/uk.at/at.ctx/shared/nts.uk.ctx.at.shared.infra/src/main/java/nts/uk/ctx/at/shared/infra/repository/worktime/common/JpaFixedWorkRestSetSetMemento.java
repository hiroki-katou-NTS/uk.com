 ...
 */
public class JpaFixedWorkRestSetSetMemento<T extends UkJpaEntity> implements FixedWorkRestSetSetMemento {
	 ...
	 * #setCommonRestSet(nts.uk.ctx.at.shared.dom.worktime.common.CommonRestSetting)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see nts.uk.ctx.at.shared.dom.worktime.common.FixedWorkRestSetSetMemento
	 * #setCalculateMethod(nts.uk.ctx.at.shared.dom.worktime.common.FixedRestCalculateMethod)
	 */
	@Override
