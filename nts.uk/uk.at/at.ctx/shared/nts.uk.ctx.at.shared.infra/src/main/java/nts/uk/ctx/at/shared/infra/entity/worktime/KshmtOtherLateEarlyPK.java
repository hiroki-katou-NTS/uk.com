...
/**
 * The Class KshmtOtherLateEarlyPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtOtherLateEarlyPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtOtherLateEarlyPK)) {
			return false;
		}
		KshmtOtherLateEarlyPK other = (KshmtOtherLateEarlyPK) object;
