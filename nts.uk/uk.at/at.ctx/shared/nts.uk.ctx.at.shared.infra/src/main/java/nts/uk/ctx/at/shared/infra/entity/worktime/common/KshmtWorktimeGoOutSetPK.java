...
/**
 * The Class KshmtWorktimeGoOutSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWorktimeGoOutSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWorktimeGoOutSetPK)) {
			return false;
		}
		KshmtWorktimeGoOutSetPK other = (KshmtWorktimeGoOutSetPK) object;
