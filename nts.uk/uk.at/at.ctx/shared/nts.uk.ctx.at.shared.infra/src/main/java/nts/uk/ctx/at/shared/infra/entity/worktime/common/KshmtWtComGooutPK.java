...
/**
 * The Class KshmtWtComGooutPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtComGooutPK implements Serializable {
	 ...
	 */
	public KshmtWtComGooutPK(String cid, String worktimeCd, int workFormAtr, int worktimeSetMethod) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtComGooutPK)) {
			return false;
		}
		KshmtWtComGooutPK other = (KshmtWtComGooutPK) object;
