...
public class BshmtWorktimeHistPK implements Serializable {
	 ...
	 *            the hist id
	 */
	public BshmtWorktimeHistPK(String sid, String histId) {
		this.sid = sid;
		this.histId = histId;
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof BshmtWorktimeHistPK)) {
			return false;
		}
		BshmtWorktimeHistPK other = (BshmtWorktimeHistPK) object;
