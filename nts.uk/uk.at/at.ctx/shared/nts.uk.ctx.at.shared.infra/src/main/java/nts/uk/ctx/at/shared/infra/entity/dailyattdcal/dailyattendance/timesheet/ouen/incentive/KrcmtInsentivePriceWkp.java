...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "KRCMT_INSENTIVE_PRICE_WKP")
public class KrcmtInsentivePriceWkp extends ContractUkJpaEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	public KrcmtInsentivePriceWkpPK pk;
