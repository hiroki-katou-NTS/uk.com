...
/**
 * The Class KshmtFlowTimeZonePK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFlowTimeZonePK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFlowTimeZonePK)) {
			return false;
		}
		KshmtFlowTimeZonePK other = (KshmtFlowTimeZonePK) object;
