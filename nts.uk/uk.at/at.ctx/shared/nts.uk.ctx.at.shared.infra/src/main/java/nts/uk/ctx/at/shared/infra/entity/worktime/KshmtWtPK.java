...
@Setter
@Embeddable
public class KshmtWtPK implements Serializable {
	 ...
	 */
	public KshmtWtPK(String cid, String worktimeCd) {
		super();
		this.cid = cid;
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtPK)) {
			return false;
		}
		KshmtWtPK other = (KshmtWtPK) object;
