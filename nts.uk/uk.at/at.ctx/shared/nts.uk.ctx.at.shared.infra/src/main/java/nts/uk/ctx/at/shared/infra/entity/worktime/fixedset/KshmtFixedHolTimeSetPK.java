...
/**
 * The Class KshmtFixedHolTimeSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtFixedHolTimeSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtFixedHolTimeSetPK)) {
			return false;
		}
		KshmtFixedHolTimeSetPK other = (KshmtFixedHolTimeSetPK) object;
