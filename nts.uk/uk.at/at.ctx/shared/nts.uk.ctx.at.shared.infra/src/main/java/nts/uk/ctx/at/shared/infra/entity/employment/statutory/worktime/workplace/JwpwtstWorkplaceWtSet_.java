 ...
 */
@StaticMetamodel(JwpwtstWorkplaceWtSet.class)
public class JwpwtstWorkplaceWtSet_ {

	/** The jwpwtst workplace wt set PK. */
	public static volatile SingularAttribute<JwpwtstWorkplaceWtSet, JwpwtstWorkplaceWtSetPK> jwpwtstWorkplaceWtSetPK;

	/** The month. */
	public static volatile SingularAttribute<JwpwtstWorkplaceWtSet, Integer> month;
