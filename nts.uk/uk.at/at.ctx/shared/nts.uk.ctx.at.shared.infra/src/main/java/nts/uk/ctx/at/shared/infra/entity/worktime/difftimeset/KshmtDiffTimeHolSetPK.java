...
/**
 * The Class KshmtDiffTimeHolSetPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtDiffTimeHolSetPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtDiffTimeHolSetPK)) {
			return false;
		}
		KshmtDiffTimeHolSetPK other = (KshmtDiffTimeHolSetPK) object;
