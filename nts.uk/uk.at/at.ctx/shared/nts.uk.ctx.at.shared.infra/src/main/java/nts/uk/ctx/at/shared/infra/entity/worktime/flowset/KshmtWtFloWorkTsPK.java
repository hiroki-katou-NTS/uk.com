...
/**
 * The Class KshmtWtFloWorkTsPK.
 */
@Getter
@Setter
@Embeddable
public class KshmtWtFloWorkTsPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof KshmtWtFloWorkTsPK)) {
			return false;
		}
		KshmtWtFloWorkTsPK other = (KshmtWtFloWorkTsPK) object;
