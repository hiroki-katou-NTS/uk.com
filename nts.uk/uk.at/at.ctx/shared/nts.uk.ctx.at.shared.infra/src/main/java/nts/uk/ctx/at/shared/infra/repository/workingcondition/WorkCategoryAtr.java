...
public enum WorkCategoryAtr {
	...
	/** The holiday time. */
	// 休日時
	HOLIDAY_TIME(2, "Enum_WorkCategoryAtr_holidayTime", "休日時"),

	/** The inlaw break time. */
	// 法内休出時
	INLAW_BREAK_TIME(3, "Enum_WorkCategoryAtr_inLawBreakTime", "法内休出時"),
	
	/** The outside law break time. */
	// 法外休出時
	OUTSIDE_LAW_BREAK_TIME(4, "Enum_WorkCategoryAtr_outsideLawBreakTime", "法外休出時"),
	
	/** The holiday attendance time. */
	// 祝日出勤時
	HOLIDAY_ATTENDANCE_TIME(5, "Enum_WorkCategoryAtr_holidayAttendanceTime", "祝日出勤時"),

	/** The public holiday work. */
	// 公休出勤時
	PUBLIC_HOLIDAY_WORK(6, "Enum_WorkCategoryAtr_publicHolidayWork", "公休出勤時");
