...
@Setter
@Embeddable
public class KshstWorkdayoffFramePK implements Serializable {
     ...
     */
    public KshstWorkdayoffFramePK(String cid, short wdoFrNo) {
        this.cid = cid;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof KshstWorkdayoffFramePK)) {
            return false;
        }
        KshstWorkdayoffFramePK other = (KshstWorkdayoffFramePK) object;
