...
@NoArgsConstructor
@Data
public class AppHolidayWorkInsertCmd {
	...
	public AppHolidayWorkInsertCmd(WorkInformationCommand workInformation, ApplicationTimeCommand applicationTime, boolean backHomeAtr, boolean goWorkAtr, 
