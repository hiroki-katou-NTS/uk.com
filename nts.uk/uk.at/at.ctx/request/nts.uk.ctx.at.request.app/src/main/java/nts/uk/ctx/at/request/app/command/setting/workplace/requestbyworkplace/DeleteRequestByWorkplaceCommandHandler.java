...
@Stateless
public class DeleteRequestByWorkplaceCommandHandler extends CommandHandler<RequestByWorkplaceCommand> {
    @Inject
    ...
    protected void handle(CommandHandlerContext<RequestByWorkplaceCommand> commandHandlerContext) {
        ...
        requestByWorkplaceRepo.delete(companyId, command.getWorkplaceId());
    }
}
