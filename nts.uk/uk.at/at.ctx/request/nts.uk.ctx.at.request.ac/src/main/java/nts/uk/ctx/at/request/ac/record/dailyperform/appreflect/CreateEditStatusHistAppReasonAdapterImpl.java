...
public class CreateEditStatusHistAppReasonAdapterImpl implements CreateEditStatusHistAppReasonAdapter {
	...
	public void process(String employeeId, GeneralDate date, String appId, ScheduleRecordClassifi classification,
			Map<Integer, String> mapValue, GeneralDateTime reflectTime, String execId, ReflectedState state) {
		pub.process(employeeId, date, appId, classification, mapValue, reflectTime, execId,
				EnumAdaptor.valueOf(state.value, RCReflectedStateExport.class));
	}
