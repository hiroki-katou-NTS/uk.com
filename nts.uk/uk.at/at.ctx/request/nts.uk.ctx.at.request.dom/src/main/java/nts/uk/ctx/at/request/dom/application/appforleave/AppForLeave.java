...
import nts.uk.ctx.at.request.dom.application.appforleave.appforspecleave.AppForSpecLeave;
import nts.uk.ctx.at.request.dom.application.appforleave.apptimedigest.AppTimeDigest;
import nts.uk.ctx.at.request.dom.application.holidayshipment.subdigestion.SubDigestion;
import nts.uk.ctx.at.request.dom.application.holidayshipment.subtargetdigestion.SubTargetDigestion;
...
@NoArgsConstructor
@Builder
public class AppForLeave extends AggregateRoot{
	/**
	 * application
	 */
