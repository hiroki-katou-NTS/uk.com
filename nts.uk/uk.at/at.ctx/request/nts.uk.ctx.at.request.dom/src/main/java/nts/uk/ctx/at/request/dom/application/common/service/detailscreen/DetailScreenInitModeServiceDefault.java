...
import nts.uk.ctx.at.request.dom.application.common.service.detailscreen.dto.OutputMode;
...
@Stateless
public class DetailScreenInitModeServiceDefault implements DetailScreenInitModeService {
	/** 14-3.詳細画面の初期モード */
	@Inject
