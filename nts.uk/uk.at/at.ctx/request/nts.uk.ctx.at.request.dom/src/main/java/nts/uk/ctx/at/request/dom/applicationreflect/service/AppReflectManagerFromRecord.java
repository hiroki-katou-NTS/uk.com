...
public interface AppReflectManagerFromRecord {
	 ...
	 */
	boolean applicationRellect(String workId, WorkReflectAtr workAtr, DatePeriod workDate, AsyncCommandHandlerContext asyncContext);	
	/**
	 * 社員の申請を反映
	 * @param workId
	 * @param sid
	...
	boolean reflectAppOfEmployee(String workId, String sid, DatePeriod datePeriod, RequestSetting requesSetting,
			SetInforReflAprResultImport refAppResult);
	/**
	 * 申請の取得
	 * @param sid 社員ID
	 * @param datePeriod 期間
