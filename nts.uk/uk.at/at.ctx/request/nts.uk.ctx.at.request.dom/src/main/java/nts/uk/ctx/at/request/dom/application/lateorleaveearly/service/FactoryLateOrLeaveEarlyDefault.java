...
public class FactoryLateOrLeaveEarlyDefault implements FactoryLateOrLeaveEarly {
	...
	@Override
	public LateOrLeaveEarly buildLateOrLeaveEarly(String appID, GeneralDate applicationDate, int prePostAtr, String appReasonID, String applicationReason,
		...
		return new LateOrLeaveEarly(AppContexts.user().companyId(), appID, prePostAtr, GeneralDate.today(),
				AppContexts.user().personId(), "", applicationDate, appReasonID, applicationReason, 9,
