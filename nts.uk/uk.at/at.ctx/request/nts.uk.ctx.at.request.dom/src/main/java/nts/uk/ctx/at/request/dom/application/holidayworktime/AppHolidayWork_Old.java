...
@NoArgsConstructor
@Builder
public class AppHolidayWork_Old extends AggregateRoot{
	...
	public AppHolidayWork_Old(String companyID,
						String appID,
						String workTypeCode, 
						String workTimeCode, 
	...
	public static AppHolidayWork_Old createSimpleFromJavaType(String companyID,
														String appID, 
														String workTypeCode, 
														String workTimeCode, 
														Integer workClockStart1,
		...
		return new AppHolidayWork_Old(companyID,
				appID,
				workTypeCode,
				workTimeCode,
				workClockStart1,
