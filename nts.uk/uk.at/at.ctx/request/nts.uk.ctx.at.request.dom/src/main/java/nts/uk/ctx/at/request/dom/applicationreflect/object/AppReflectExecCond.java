...
public class AppReflectExecCond implements DomainAggregate {
	...
	// 事前申請を勤務予定に反映する
	private final PreApplicationWorkScheReflectAttr preAppSchedule;
	...
	public AppReflectExecCond(String companyId, PreApplicationWorkScheReflectAttr preAppSchedule, NotUseAtr scheduleConfirm,
