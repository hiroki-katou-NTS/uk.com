...
@NoArgsConstructor
@Builder
public class AppOverTime_Old extends AggregateRoot{
	...
	public AppOverTime_Old(String companyID,
						String appID,
						int overTimeAtr,
						String workTypeCode, 
						String siftCode, 
	...
	public static AppOverTime_Old createSimpleFromJavaType(String companyID,
														String appID, 
														int overTimeAtr,
														String workTypeCode, 
														String siftCode, 
														...
														Integer flexExessTime,
														Integer overTimeShiftNight ){
		return new AppOverTime_Old(companyID,
								appID,
								overTimeAtr,
								workTypeCode,
								siftCode,
