...
public class AppWorkHolidayReceptionDataExport extends ApplicationReceptionDataExport {
	...
	public AppWorkHolidayReceptionDataExport(AppWorkHolidayBuilder builder) {
	...
	public static class AppWorkHolidayBuilder extends ApplicationReceptionDataExport {
		...
		public AppWorkHolidayReceptionDataExport build() {
			return new AppWorkHolidayReceptionDataExport(this);
		}
	}
}
