...
public class AppOverTimeReceptionDataExport extends ApplicationReceptionDataExport {
	...
	public AppOverTimeReceptionDataExport(AppOverTimBuilder builder) {
	...
	public static class AppOverTimBuilder extends ApplicationReceptionDataExport {
		...
		public AppOverTimeReceptionDataExport build() {
			return new AppOverTimeReceptionDataExport(this);
		}
	}
