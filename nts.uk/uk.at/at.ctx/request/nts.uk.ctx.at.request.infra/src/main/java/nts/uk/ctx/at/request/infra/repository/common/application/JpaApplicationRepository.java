package nts.uk.ctx.at.request.infra.repository.common.application;
...
public class JpaApplicationRepository extends JpaRepository implements ApplicationRepository  {
	...
	private final String SELECT_BY_APPDATE = SELECT_FROM_APPLICATION
			+ " AND c.applicationDate = :applicationDate";
	private final String SELECT_BY_APPTYPE = SELECT_FROM_APPLICATION
	...
	private Application toDomain(KafdtApplication entity) {
		return Application.createFromJavaType(
				...
				entity.applicationReason, 
				entity.applicationType, 
				entity.applicantSID, 
				entity.reflectPlanScheReason, 
				entity.reflectPlanTime, 
				entity.reflectPlanState, 
				entity.reflectPlanEnforce, 
				entity.reflectPerScheReason, 
				entity.reflectPerTime, 
				entity.reflectPerState, 
	...
	public List<Application> getAllApplication(String companyID) {
		return this.queryProxy()
				.query(SELECT_FROM_APPLICATION,KafdtApplication.class)
	...
	public Optional<Application> getAppById(String companyID, String applicationID) {
		return this.queryProxy()
				.query(SELECT_BY_CODE,KafdtApplication.class)
				.setParameter("companyID", companyID)
	...
	public List<Application> getAllAppByDate(String companyID, BigDecimal applicationDate) {
		return this.queryProxy()
				.query(SELECT_BY_APPDATE,KafdtApplication.class)
				.setParameter("companyID", companyID)
	...
	public List<Application> getAllAppByAppType(String companyID, int applicationType) {
		return this.queryProxy()
				.query(SELECT_BY_APPTYPE,KafdtApplication.class)
				.setParameter("companyID", companyID)
