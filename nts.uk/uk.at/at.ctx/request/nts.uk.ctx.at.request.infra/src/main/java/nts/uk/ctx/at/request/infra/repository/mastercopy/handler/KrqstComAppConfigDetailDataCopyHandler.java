...
@NoArgsConstructor
@AllArgsConstructor
public class KrqstComAppConfigDetailDataCopyHandler implements DataCopyHandler {
	...
	/** The insert query. */
	private String INSERT_QUERY = "INSERT INTO KRQST_COM_APP_CF_DETAIL(CID, APP_TYPE, MEMO, USE_ATR, PREREQUISITE_FORPAUSE_FLG, OT_APP_SETTING_FLG, HOLIDAY_TIME_APP_CAL_FLG, "
	...
	private String SELECT_BY_CID_QUERY = "SELECT CID, APP_TYPE, MEMO, USE_ATR, PREREQUISITE_FORPAUSE_FLG, OT_APP_SETTING_FLG, HOLIDAY_TIME_APP_CAL_FLG, "
			+ "LATE_OR_LEAVE_APP_CANCEL_FLG, LATE_OR_LEAVE_APP_SETTING_FLG, BREAK_INPUTFIELD_DIS_FLG, BREAK_TIME_DISPLAY_FLG, ATWORK_TIME_BEGIN_DIS_FLG, GOOUT_TIME_BEGIN_DIS_FLG, TIME_CAL_USE_ATR, "
	...
	private String DELETE_BY_CID_QUERY = "DELETE FROM KRQST_COM_APP_CF_DETAIL WHERE CID = ?";
