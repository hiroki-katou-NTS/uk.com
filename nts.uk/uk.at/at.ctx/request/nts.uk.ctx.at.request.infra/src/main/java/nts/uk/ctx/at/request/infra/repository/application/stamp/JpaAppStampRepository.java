...
import nts.uk.ctx.at.request.dom.applicationapproval.application.stamp.AppStampAtr;
import nts.uk.ctx.at.request.dom.applicationapproval.application.stamp.AppStampCancel;
import nts.uk.ctx.at.request.dom.applicationapproval.application.stamp.AppStampCombinationAtr;
import nts.uk.ctx.at.request.dom.applicationapproval.application.stamp.AppStampGoOutAtr;
...
import nts.uk.ctx.at.request.dom.applicationapproval.application.stamp.AppStampWork;
import nts.uk.ctx.at.request.dom.applicationapproval.application.stamp.StampRequestMode;
...
public class JpaAppStampRepository extends JpaRepository implements AppStampRepository {
	...
	private AppStamp convertToDomainAppStamp(KrqdtAppStamp krqdtAppStamp){
		...
		AppStamp appStamp = new AppStamp(
				...
				new AppReason(krqdtAppStamp.kafdtApplication.appReasonId+": "+krqdtAppStamp.kafdtApplication.applicationReason), 
