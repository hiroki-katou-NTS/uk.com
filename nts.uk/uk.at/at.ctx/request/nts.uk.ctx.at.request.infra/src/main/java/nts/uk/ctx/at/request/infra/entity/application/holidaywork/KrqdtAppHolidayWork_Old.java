 ...
 */
@Entity
@Table(name = "KRQDT_APP_HOLIDAY_WORK_BAK")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
public class KrqdtAppHolidayWork_Old extends UkJpaEntity implements Serializable {
	...
	public KrqdtAppHolidayWork_Old fromDomainValue(AppHolidayWork_Old appHolidayWork){
	...
	public AppHolidayWork_Old toDomain(){
		AppHolidayWork_Old appHolidayWork = new AppHolidayWork_Old(
