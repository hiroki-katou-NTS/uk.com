...
public class KrqdtAppOvertimeDetail_Old extends UkJpaEntity implements Serializable {
	 ...
	 */
	@EmbeddedId
	public KrqdtAppOvertimeDetailPk_Old appOvertimeDetailPk;
	...
	public static KrqdtAppOvertimeDetail_Old toEntity(Optional<AppOvertimeDetail> domainOtp) {
		if (!domainOtp.isPresent()) {
			return null;
		}
		AppOvertimeDetail domain = domainOtp.get();
		return new KrqdtAppOvertimeDetail_Old(new KrqdtAppOvertimeDetailPk_Old(domain.getCid(), domain.getAppId()),
	...
	public KrqdtAppOvertimeDetail_Old(KrqdtAppOvertimeDetailPk_Old appOvertimeDetailPk, Integer yearMonth, Integer appTimeAgree,
