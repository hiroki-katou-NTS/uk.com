...
public class StampList {
	...
	private static final int heightDefault = 49; //chiều cao mặc định của một dòng dữ liệu 
	private static final int heightAddRow = 33; //chiều cao khi thêm một dòng dữ liệu 
