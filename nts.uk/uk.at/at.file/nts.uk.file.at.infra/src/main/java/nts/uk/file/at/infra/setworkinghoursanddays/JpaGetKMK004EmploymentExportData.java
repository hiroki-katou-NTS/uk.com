...
public class JpaGetKMK004EmploymentExportData extends JpaRepository implements GetKMK004EmploymentExportRepository {
	...
	private static final String GET_EMPLOYMENT = "SELECT "
											...
											+" LEFT JOIN KSHST_EMP_TRANS_LAB_TIME ON KSHST_EMP_TRANS_LAB_TIME.CID = BSYMT_EMPLOYMENT.CID  " 
											+"            AND BSYMT_EMPLOYMENT.CODE = BSYMT_EMPLOYMENT.CODE  		" 
											+" LEFT JOIN KSHST_FLX_GET_PRWK_TIME ON BSYMT_EMPLOYMENT.CID = KSHST_FLX_GET_PRWK_TIME.CID  "
