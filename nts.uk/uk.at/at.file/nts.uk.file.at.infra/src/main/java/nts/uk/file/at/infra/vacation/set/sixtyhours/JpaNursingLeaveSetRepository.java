    ...
    private List<MasterData> buildMasterListData(NtsResultSet.NtsResultRecord rs) {
        ...
        if (checkIsManager) {
            ...
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    ...
                    , /*A25_2*/new DataEachBox(rs.getString("STR_MD") +/*A25_15*/I18NText.getText("KMF001_246"), ColumnTextAlign.RIGHT)
            ));
            // Row 3
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    ...
                    , new DataEachBox(/*A25_3*/rs.getString("STR_MD") +/*A25_16*/I18NText.getText("KMF001_233"), ColumnTextAlign.RIGHT)
            ));
            // Row 4
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    ...
                    , new DataEachBox(/*25_4*/rs.getString("NUM_LEAVE_DAY") +/*A25_16*/I18NText.getText("KMF001_233"), ColumnTextAlign.RIGHT)
            ));
            // Row 5
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    ...
                    , new DataEachBox(/*25_5*/ rs.getString("NUM_PERSON") +/*A25_16*/I18NText.getText("KMF001_233"), ColumnTextAlign.RIGHT)
            ));
            // Row 6
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    ...
                    , new DataEachBox(/*25_6*/ rs.getString("SPE_HOLIDAY"), ColumnTextAlign.LEFT)
            ));
            // Row 7
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    ...
                    , new DataEachBox(/*25_7*/ rs.getString("WORK_ABS").equals("0") ? "管理する" : "管理しない", ColumnTextAlign.LEFT))
            );
        } else {
            // Row 2 validated by 16
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
        ...
        datas.add(buildARow(new DataEachBox(/*24_14*/I18NText.getText("KMF001_242"), ColumnTextAlign.LEFT)
                ...
                , new DataEachBox(null, ColumnTextAlign.LEFT)
                , new DataEachBox(null, ColumnTextAlign.LEFT)
                , new DataEachBox( /*A25_8*/rs.getString("NURSING_TYPE_LV2").equals("0") ? "会社一律" : "年休付与テーブルを参照", ColumnTextAlign.LEFT
                )));
        if (checkIsManagerLv2) {
            ...
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    ...
                    , new DataEachBox(/*25_9*/ rs.getString("STR_MD_LV2") +/*25_15*/I18NText.getText("KMF001_186"), ColumnTextAlign.RIGHT)
            ));
            // Row 10
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
            ...
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(/*24_22*/I18NText.getText("KMF001_192"), ColumnTextAlign.LEFT)
                    , new DataEachBox(/*24_23*/ I18NText.getText("KMF001_192"), ColumnTextAlign.LEFT)
                    , new DataEachBox(/*25_13*/ rs.getString("NAME_SF"), ColumnTextAlign.LEFT)
            ));
            // Row 14
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(null, ColumnTextAlign.LEFT)
                    , new DataEachBox(/*24_24*/I18NText.getText("KMF001_232"), ColumnTextAlign.LEFT)
                    , new DataEachBox( /*25_14*/ rs.getString("ABSENCE_FRAME_NO"), ColumnTextAlign.LEFT
                    )));
        } else {
            // Row 9
            datas.add(buildARow(new DataEachBox(null, ColumnTextAlign.LEFT)
