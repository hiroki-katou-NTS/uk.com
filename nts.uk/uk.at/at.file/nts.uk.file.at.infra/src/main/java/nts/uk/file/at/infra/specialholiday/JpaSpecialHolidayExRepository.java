...
public class JpaSpecialHolidayExRepository extends JpaRepository implements SpecialHolidayExRepository {
	...
	StringBuilder specialHDData = new StringBuilder()
		...
		.append("		CASE WHEN TABLE_RESULT.ROW_NUMBER = 1 THEN ")
		.append("			CASE TABLE_RESULT.MAKE_INVITATION_ATR WHEN false THEN '-' WHEN true THEN '○' END")
		.append("		ELSE NULL")
		.append("		END MAKE_INVITATION_ATR,")
		.append("		CASE WHEN TABLE_RESULT.ROW_NUMBER = 1 THEN ")
		.append("			CASE TABLE_RESULT.INCLUDE_HOLIDAYS_ATR WHEN false THEN '-' WHEN true THEN '○' END")
		.append("		ELSE NULL")
		...
		.append("			CASE TABLE_RESULT.THREE_PARENT_OR_LESS WHEN false THEN '-' WHEN true THEN '○' END")
		.append("		ELSE NULL")
		...
		.append("		CASE WHEN (TABLE_RESULT.MAX_NUMBER_DAYS_TYPE = 2) THEN ")
		.append("			CASE WHEN (TABLE_RESULT.MORNING_HOUR IS NULL OR TABLE_RESULT.MAKE_INVITATION_ATR = false) THEN NULL ELSE CONCAT(TABLE_RESULT.MORNING_HOUR,'日') END")
		.append("		ELSE NULL")
