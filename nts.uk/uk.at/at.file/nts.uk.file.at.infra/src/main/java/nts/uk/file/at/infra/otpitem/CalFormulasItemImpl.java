...
//	      exportSQL.append("          ,RESULT_FINAL.ITEM_NOTE");
	      ...
	      exportSQL.append("             WHEN 4 THEN CONCAT(CASE cis1.OPERATOR  WHEN 0 THEN '+ ' WHEN 1 THEN '- ' WHEN 2 THEN '* ' WHEN 3 THEN '/ ' END,(REPLACE(dai.ATTENDANCE_ITEM_NAME, '{0}', (SELECT name5.PREMIUM_NAME FROM KSRMT_PREMIUM_ITEM name5 WHERE cis1.CID = name5.CID AND  name5.PREMIUM_NO = B.FRAME_NO))))");
	      ...
	      exportSQL.append("             WHEN 4 THEN CONCAT(CASE cis2.OPERATOR  WHEN 0 THEN '+ ' WHEN 1 THEN '- ' WHEN 2 THEN '* ' WHEN 3 THEN '/ ' END,(REPLACE(mai.M_ATD_ITEM_NAME, '{0}', (SELECT name5.PREMIUM_NAME FROM KSRMT_PREMIUM_ITEM name5 WHERE cis2.CID = name5.CID AND  name5.PREMIUM_NO = B1.FRAME_NO ))))");
