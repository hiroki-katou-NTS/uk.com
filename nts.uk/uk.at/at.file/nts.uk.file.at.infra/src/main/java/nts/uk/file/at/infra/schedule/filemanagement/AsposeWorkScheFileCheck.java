...
public class AsposeWorkScheFileCheck implements CheckFileService {
    ...
    private final String[] dateFormats = {"yyyy/MM/dd", "yyyy-MM-dd'T'HH:mm:ss", "yyyy年M月d日", "yyyy年MM月dd日", "M/d"};
...
//        
//        return true;
        return dateStr.compareTo(getLastDayOfMonth(dateStr, format)) < 1;
    }
