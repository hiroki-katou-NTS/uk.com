...
public class jpaSetWorkingHoursAndDays extends JpaRepository implements SetWorkingHoursAndDaysExRepository {
	...
	private static final String GET_EMPLOYMENT = "SELECT "
											+" ROW_NUMBER() OVER(PARTITION BY KSHST_EMP_NORMAL_SET.EMP_CD ORDER BY IIF(BSYMT_EMPLOYMENT.NAME IS NOT NULL,0,1), KSHST_EMP_NORMAL_SET.EMP_CD ASC, KSHST_EMP_NORMAL_SET.[YEAR]) AS ROW_NUMBER_CODE, "
	...
	private static final String GET_WORKPLACE;
	  static {
	     ...
	     exportSQL.append("             ROW_NUMBER() OVER(PARTITION BY BSYMT_WKP_INFO.WKP_CD ORDER BY IIF(BSYMT_WKP_INFO.HIERARCHY_CD IS NOT NULL,0,1),BSYMT_WKP_INFO.HIERARCHY_CD  ASC, KSHST_WKP_NORMAL_SET.[YEAR] ASC) AS rk2,  ");
	     exportSQL.append("             BSYMT_WKP_INFO.WKP_CD AS WKPCD,   ");
	     ...
	     exportSQL.append("              LEFT JOIN BSYMT_WKP_INFO ON KSHST_WKP_NORMAL_SET.CID = BSYMT_WKP_INFO.CID   ");
	     exportSQL.append("               AND KSHST_WKP_NORMAL_SET.WKP_ID = BSYMT_WKP_INFO.WKP_ID   ");
	     ...
	     exportSQL.append("             ORDER BY TBL.HIERARCHY_CD, TBL.[YEAR] ASC");
