...
public class jpaSetWorkingHoursAndDays extends JpaRepository implements SetWorkingHoursAndDaysExRepository {
	...
	private static final String GET_WORKPLACE = "SELECT * FROM ("
						 +  "SELECT ROW_NUMBER() OVER(PARTITION BY BSYMT_WORKPLACE_INFO.WKPCD, KSHST_WKP_NORMAL_SET.[YEAR] ORDER BY BSYMT_WORKPLACE_HIST.END_DATE DESC) AS rk, BSYMT_WKP_CONFIG_INFO.HIERARCHY_CD, "
