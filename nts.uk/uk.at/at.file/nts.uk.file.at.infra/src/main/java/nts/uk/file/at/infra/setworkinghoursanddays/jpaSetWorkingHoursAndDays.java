...
public class jpaSetWorkingHoursAndDays extends JpaRepository implements SetWorkingHoursAndDaysExRepository {
	...
	private static final String GET_WORKPLACE = "SELECT * FROM ("
						 ...
						 +  "ROW_NUMBER() OVER(PARTITION BY KSHST_WKP_NORMAL_SET.[YEAR] ORDER BY IIF(BSYMT_WKP_CONFIG_INFO.HIERARCHY_CD IS NOT NULL AND BSYMT_WORKPLACE_HIST.END_DATE = CONVERT(DATETIME, '9999-12-31 00:00:00', 120),0,1),BSYMT_WKP_CONFIG_INFO.HIERARCHY_CD  ASC, BSYMT_WORKPLACE_HIST.END_DATE DESC) AS rk2, "
