...
public class JpaWorkTimeReportRepository extends JpaRepository implements WorkTimeReportRepository {
	...
	static {
		...
		sqlFlow.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLOW_RT_SET2.AFTER_PASSAGE_TIME IS NOT NULL AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlow.append(" 			CASE WHEN TEMP.ROW_ID = 1 AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlow.append(" 				 WHEN TEMP.ROW_ID = 1 AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlow.append(" 				 ELSE NULL");
		sqlFlow.append(" 			END");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlow.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLOW_RT_SET2.AFTER_REST_TIME IS NOT NULL AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlow.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isTrue AND FLOW_RT_SET1.AFTER_PASSAGE_TIME IS NOT NULL, ");
		...
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 7 THEN ");
		sqlFlow.append(" 			CASE WHEN TEMP.ROW_ID = 1 AND FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlow.append(" 				 WHEN TEMP.ROW_ID = 1 AND FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlow.append(" 				 ELSE NULL");
		sqlFlow.append(" 			END");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlow.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isTrue AND FLOW_RT_SET1.AFTER_REST_TIME IS NOT NULL, ");
		...
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET1.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND FLEX_HA_RT_SET1.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 				 WHEN TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET1.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET1.AFTER_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND FLEX_HA_RT_SET1.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET2.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 				WHEN TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlex.append(" 				WHEN TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlex.append(" 				ELSE NULL");
		sqlFlex.append(" 			END");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET2.AFTER_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET3.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 7 THEN ");
		sqlFlex.append(" 			CASE WHEN FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue OR WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isFalse THEN NULL");
		sqlFlex.append(" 				 WHEN TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlex.append(" 				 WHEN TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlex.append(" 				 ELSE NULL");
		sqlFlex.append(" 			END");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_HA_RT_SET3.AFTER_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_OD_RT_SET.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_OD_RT_SET.FIX_REST_TIME = ?isFalse AND FLEX_OD_RT_SET.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 				 WHEN TEMP.ROW_ID = 1 AND FLEX_OD_RT_SET.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlex.append(" 				 WHEN TEMP.ROW_ID = 1 AND FLEX_OD_RT_SET.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlex.append(" 				 ELSE NULL");
		sqlFlex.append(" 			END");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(TEMP.ROW_ID = 1 AND FLEX_OD_RT_SET.AFTER_REST_TIME IS NOT NULL AND FLEX_OD_RT_SET.FIX_REST_TIME = ?isFalse AND FLEX_OD_RT_SET.USE_REST_AFTER_SET = ?isTrue, ");
