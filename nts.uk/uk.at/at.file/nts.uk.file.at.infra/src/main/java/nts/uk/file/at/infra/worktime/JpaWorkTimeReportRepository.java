...
public class JpaWorkTimeReportRepository extends JpaRepository implements WorkTimeReportRepository {
	...
	static {
		...
		sqlNormal.append(" 	END,");
		// R1_66 半日勤務
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue, ?isUseHalfDayText, ?isNotUseHalfDayText)");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue, ?isUseHalfDayText, ?isNotUseHalfDayText)");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_68 備考
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND PRED_TIME_SET.RANGE_TIME_DAY IS NOT NULL, ");
		sqlNormal.append(" 		CAST(PRED_TIME_SET.RANGE_TIME_DAY AS INTEGER)/60, NULL),");
		// R1_72 所定設定.1日の範囲時間.夜勤シフト
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND PRED_TIME_SET.NIGHT_SHIFT_ATR = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?isNightShiftText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND PRED_TIME_SET.NIGHT_SHIFT_ATR = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		...
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND PRED_TIME_SET.IS_INCLUDE_OT = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN ?isIncludeOtText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND PRED_TIME_SET.IS_INCLUDE_OT = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN ?isNotIncludeOtText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_4 所定設定.就業時刻2回目
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue THEN ?isUseSecondWorkingDayText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND WORK_TIME_SHEET_SET2.USE_ATR = ?isFalse THEN ?isNotUseSecondWorkingDayText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_76 所定設定.就業時刻2回目.始業時刻
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 		AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue AND WORK_TIME_SHEET_SET2.START_TIME IS NOT NULL,");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 		AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue AND WORK_TIME_SHEET_SET2.END_TIME IS NOT NULL,");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND PRED_TIME_SET.WORK_ADD_ONE_DAY IS NOT NULL,");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND PRED_TIME_SET.WORK_ADD_MORNING IS NOT NULL,");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND PRED_TIME_SET.WORK_ADD_AFTERNOON IS NOT NULL,");
		...
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND FIXED_WORK_TIME_SET2.TIME_STR IS NOT NULL, CONCAT(CAST(FIXED_WORK_TIME_SET2.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_WORK_TIME_SET2.TIME_STR AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND DT_WORK_TIME_SET2.TIME_STR IS NOT NULL, CONCAT(CAST(DT_WORK_TIME_SET2.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_WORK_TIME_SET2.TIME_STR AS INTEGER)%60,'0#')), NULL)),");
		// R1_91 勤務時間帯.午前勤務用.終了時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND FIXED_WORK_TIME_SET2.TIME_END IS NOT NULL, CONCAT(CAST(FIXED_WORK_TIME_SET2.TIME_END AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_WORK_TIME_SET2.TIME_END AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND DT_WORK_TIME_SET2.TIME_END IS NOT NULL, CONCAT(CAST(DT_WORK_TIME_SET2.TIME_END AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_WORK_TIME_SET2.TIME_END AS INTEGER)%60,'0#')), NULL)),");
		// R1_92 勤務時間帯.午前勤務用.丸め
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		CASE WHEN FIXED_WORK_SET.USE_HALF_DAY = ?isFalse OR WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		...
		sqlNormal.append(" 			 ELSE NULL");
		sqlNormal.append(" 		END,");
		sqlNormal.append(" 		CASE WHEN DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isFalse OR WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		...
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND FIXED_WORK_TIME_SET3.TIME_STR IS NOT NULL, CONCAT(CAST(FIXED_WORK_TIME_SET3.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_WORK_TIME_SET3.TIME_STR AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND DT_WORK_TIME_SET3.TIME_STR IS NOT NULL, CONCAT(CAST(DT_WORK_TIME_SET3.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_WORK_TIME_SET3.TIME_STR AS INTEGER)%60,'0#')), NULL)),");
		// R1_95 勤務時間帯.午後勤務用.終了時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND FIXED_WORK_TIME_SET3.TIME_END IS NOT NULL, CONCAT(CAST(FIXED_WORK_TIME_SET3.TIME_END AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_WORK_TIME_SET3.TIME_END AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND DT_WORK_TIME_SET3.TIME_END IS NOT NULL, CONCAT(CAST(DT_WORK_TIME_SET3.TIME_END AS INTEGER)/60, ':',");
		...
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_OT_TIME_SET1.UPD_START_TIME = ?isTrue");
		sqlNormal.append(" 			THEN ?isUpdStartTimeText");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_OT_TIME_SET1.UPD_START_TIME = ?isFalse");
		...
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_WORK_SET.LEGAL_OT_SET = ?isLegalOtSet ");
		sqlNormal.append(" 			AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN FIXED_OT_TIME_SET1.PAYOFF_ORDER");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DIFF_TIME_WORK_SET.OT_SET = ?isLegalOtSet ");
		...
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND FIXED_OT_TIME_SET2.TIME_STR IS NOT NULL, CONCAT(CAST(FIXED_OT_TIME_SET2.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_OT_TIME_SET2.TIME_STR AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND DT_OT_TIME_SET2.TIME_STR IS NOT NULL, CONCAT(CAST(DT_OT_TIME_SET2.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_OT_TIME_SET2.TIME_STR AS INTEGER)%60,'0#')), NULL)),");
		// R1_108 残業時間帯.午前勤務用.終了時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND FIXED_OT_TIME_SET2.TIME_END IS NOT NULL, CONCAT(CAST(FIXED_OT_TIME_SET2.TIME_END AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_OT_TIME_SET2.TIME_END AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND DT_OT_TIME_SET2.TIME_END IS NOT NULL, CONCAT(CAST(DT_OT_TIME_SET2.TIME_END AS INTEGER)/60, ':',");
		...
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue ");
		sqlNormal.append(" 			AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_OT_TIME_SET2.UPD_START_TIME = ?isTrue");
		sqlNormal.append(" 			THEN ?isUpdStartTimeText");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue ");
		sqlNormal.append(" 			AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_OT_TIME_SET2.UPD_START_TIME = ?isFalse");
		sqlNormal.append(" 			THEN ?isNotUpdStartTimeText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		...
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_WORK_SET.LEGAL_OT_SET = ?isLegalOtSet AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			AND FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN FIXED_OT_TIME_SET2.PAYOFF_ORDER");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DIFF_TIME_WORK_SET.OT_SET = ?isLegalOtSet AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN DT_OT_TIME_SET2.PAYOFF_ORDER");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_115 残業時間帯.午後勤務用.開始時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FIXED_OT_TIME_SET3.TIME_STR IS NOT NULL, CONCAT(CAST(FIXED_OT_TIME_SET3.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_OT_TIME_SET3.TIME_STR AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_OT_TIME_SET3.TIME_STR IS NOT NULL, CONCAT(CAST(DT_OT_TIME_SET3.TIME_STR AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_OT_TIME_SET3.TIME_STR AS INTEGER)%60,'0#')), NULL)),");
		// R1_116 残業時間帯.午後勤務用.終了時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FIXED_OT_TIME_SET3.TIME_END IS NOT NULL, CONCAT(CAST(FIXED_OT_TIME_SET3.TIME_END AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_OT_TIME_SET3.TIME_END AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_OT_TIME_SET3.TIME_END IS NOT NULL, CONCAT(CAST(DT_OT_TIME_SET3.TIME_END AS INTEGER)/60, ':',");
		...
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue ");
		sqlNormal.append(" 			AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_OT_TIME_SET3.UPD_START_TIME = ?isTrue");
		sqlNormal.append(" 			THEN ?isUpdStartTimeText");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue ");
		sqlNormal.append(" 			AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_OT_TIME_SET3.UPD_START_TIME = ?isFalse");
		sqlNormal.append(" 			THEN ?isNotUpdStartTimeText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		...
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_WORK_SET.LEGAL_OT_SET = ?isLegalOtSet AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			AND FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN FIXED_OT_TIME_SET3.PAYOFF_ORDER");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DIFF_TIME_WORK_SET.OT_SET = ?isLegalOtSet AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN DT_OT_TIME_SET3.PAYOFF_ORDER");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_123 打刻時間帯.優先設定.出勤
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND PIORITY_SET1.PIORITY_ATR = ?beforePiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?beforePiorityText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND PIORITY_SET1.PIORITY_ATR = ?afterPiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?afterPiorityText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_124 打刻時間帯.優先設定.退勤
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND PIORITY_SET2.PIORITY_ATR = ?beforePiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?beforePiorityText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND PIORITY_SET2.PIORITY_ATR = ?afterPiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?afterPiorityText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		...
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_STAMP_REFLECT1.START_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_STAMP_REFLECT1.END_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue AND FIXED_STAMP_REFLECT3.START_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue AND FIXED_STAMP_REFLECT3.END_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_STAMP_REFLECT2.START_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_STAMP_REFLECT2.END_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue AND FIXED_STAMP_REFLECT4.START_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode ");
		sqlNormal.append(" 			AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue AND FIXED_STAMP_REFLECT4.END_TIME IS NOT NULL");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1,");
		sqlNormal.append(" 		CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 			 WHEN ROUNDING_SET3.ROUNDING_TIME_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 		CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 			 WHEN ROUNDING_SET4.ROUNDING_TIME_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HALF_REST_TIME1.UPD_START_TIME = ?isTrue");
		sqlNormal.append(" 			THEN ?isUpdStartTimeText");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HALF_REST_TIME1.UPD_START_TIME = ?isFalse");
		sqlNormal.append(" 			THEN ?isNotUpdStartTimeText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_147 休憩時間帯.午前勤務用.開始時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FIXED_HALF_REST_SET2.START_TIME IS NOT NULL, CONCAT(CAST(FIXED_HALF_REST_SET2.START_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_HALF_REST_SET2.START_TIME AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_HALF_REST_TIME2.START_TIME IS NOT NULL, CONCAT(CAST(DT_HALF_REST_TIME2.START_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_HALF_REST_TIME2.START_TIME AS INTEGER)%60,'0#')), NULL)),");
		// R1_148 休憩時間帯.午前勤務用.終了時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FIXED_HALF_REST_SET2.END_TIME IS NOT NULL, CONCAT(CAST(FIXED_HALF_REST_SET2.END_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_HALF_REST_SET2.END_TIME AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_HALF_REST_TIME2.END_TIME IS NOT NULL, CONCAT(CAST(DT_HALF_REST_TIME2.END_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_HALF_REST_TIME2.END_TIME AS INTEGER)%60,'0#')), NULL)),");
		// R1_241 休憩時間帯.午前勤務用.固定
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HALF_REST_TIME2.UPD_START_TIME = ?isTrue AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?isUpdStartTimeText");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HALF_REST_TIME2.UPD_START_TIME = ?isFalse AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?isNotUpdStartTimeText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_149 休憩時間帯.開始時間.開始時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FIXED_HALF_REST_SET3.START_TIME IS NOT NULL, CONCAT(CAST(FIXED_HALF_REST_SET3.START_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_HALF_REST_SET3.START_TIME AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_HALF_REST_TIME3.START_TIME IS NOT NULL, CONCAT(CAST(DT_HALF_REST_TIME3.START_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_HALF_REST_TIME3.START_TIME AS INTEGER)%60,'0#')), NULL)),");
		// R1_150 休憩時間帯.開始時間.終了時間
		sqlNormal.append(" 	IIF(WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork,");
		sqlNormal.append(" 		IIF(FIXED_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FIXED_HALF_REST_SET3.END_TIME IS NOT NULL, CONCAT(CAST(FIXED_HALF_REST_SET3.END_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(FIXED_HALF_REST_SET3.END_TIME AS INTEGER)%60,'0#')), NULL),");
		sqlNormal.append(" 		IIF(DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND DT_HALF_REST_TIME3.END_TIME IS NOT NULL, CONCAT(CAST(DT_HALF_REST_TIME3.END_TIME AS INTEGER)/60, ':',");
		sqlNormal.append(" 			FORMAT(CAST(DT_HALF_REST_TIME3.END_TIME AS INTEGER)%60,'0#')), NULL)),");
		// R1_242 休憩時間帯.開始時間.固定
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HALF_REST_TIME3.UPD_START_TIME = ?isTrue AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?isUpdStartTimeText");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HALF_REST_TIME3.UPD_START_TIME = ?isFalse AND DIFF_TIME_WORK_SET.USE_HALF_DAY = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlNormal.append(" 			THEN ?isNotUpdStartTimeText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_151 休憩時間帯.休憩計算設定.実績での休憩計算方法
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_WORK_SET.CALC_METHOD = ?calculateMethodMasterRef");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SET.WORKTIME_SET_METHOD = ?fixedWork AND FIXED_WORK_SET.LEV_REST_CALC_TYPE = ?calcMethodAppropAll");
		...
		// R1_243 休出休憩.固定
		sqlNormal.append(" 	CASE WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HOL_REST_TIME.UPD_START_TIME = ?isTrue");
		sqlNormal.append(" 			THEN ?isUpdStartTimeText");
		sqlNormal.append(" 		 WHEN WORK_TIME_SET.WORKTIME_SET_METHOD = ?difftimeWork AND DT_HOL_REST_TIME.UPD_START_TIME = ?isFalse");
		sqlNormal.append(" 			THEN ?isNotUpdStartTimeText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_162 外出.外出丸め設定.同じ枠内での丸め設定
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_GO_OUT_SET.ROUNDING_SAME_FRAME = ?isTrue THEN ?roudingAfterTotalText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_GO_OUT_SET.ROUNDING_CROSS_FRAME = ?isTrue THEN ?roudingAfterTotalText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT1.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT3.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN SPECIAL_ROUND_OUT2.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND LATE_EARLY_SET.IS_DEDUCTE_FROM_TIME = ?isTrue THEN ?isDeducteFromTimeText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.EXTRACT_LATE_EARLY_TIME = ?isTrue THEN ?isExtractLateEarlyTimeText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.EXTRACT_LATE_EARLY_TIME = ?isTrue THEN ?isExtractLateEarlyTimeText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND OTHER_LATE_EARLY1.GRACE_TIME IS NOT NULL, ");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.INCLUDE_WORKTIME = ?isTrue THEN ?isIncludeWorktimeText");
		...
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND OTHER_LATE_EARLY2.GRACE_TIME IS NOT NULL, ");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.INCLUDE_WORKTIME = ?isTrue THEN ?isIncludeWorktimeText");
		...
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND BONUS_PAY_SET.BONUS_PAY_SET_CD IS NULL AND WORKTIME_COMMON_SET.RAISING_SALARY_SET IS NOT NULL THEN ?masterUnregistered");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_47 代休.休日出勤
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		...
		sqlNormal.append(" 	END,");
		// R1_208 代休.休日出勤.時間区分
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SUBSTITUTION_SET2.USE_ATR = ?isFalse THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET2.TRANFER_ATR = ?specifiedTimeSubHol THEN ?specifiedTimeSubHolText");
		...
		sqlNormal.append(" 		AND (WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR (SUBSTITUTION_SET2.USE_ATR = ?isTrue AND SUBSTITUTION_SET2.TRANFER_ATR = ?specifiedTimeSubHol)), ");
		...
		// R1_211 代休.休日出勤.一定時間
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET2.USE_ATR = ?isTrue ");
		sqlNormal.append(" 		AND SUBSTITUTION_SET2.TRANFER_ATR = ?certainTimeExcSubHol AND SUBSTITUTION_SET2.CERTAIN_TIME IS NOT NULL, ");
		...
		// R1_48 代休.残業
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.USE_ATR = ?isTrue THEN ?isUseSubstitutionText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.USE_ATR = ?isFalse THEN ?isNotUseSubstitutionText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_212 代休.残業.時間区分
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SUBSTITUTION_SET1.USE_ATR = ?isFalse THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol THEN ?specifiedTimeSubHolText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.TRANFER_ATR = ?certainTimeExcSubHol THEN ?certainTimeExcSubHolText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_213 代休.残業.１日
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlNormal.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol AND SUBSTITUTION_SET1.ONE_DAY_TIME IS NOT NULL, ");
		...
		// R1_214 代休.残業.半日
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlNormal.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol AND SUBSTITUTION_SET1.HALF_DAY_TIME IS NOT NULL, ");
		...
		// R1_215 代休.残業.一定時間
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlNormal.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?certainTimeExcSubHol AND SUBSTITUTION_SET1.CERTAIN_TIME IS NOT NULL, ");
		...
		// R1_219 臨時.臨時端数
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND TEMP_WORKTIME_SET.ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.CHILD_CARE_WORK_USE = ?isTrue THEN ?childCareWorkUseText");
		...
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.NUR_TIMEZONE_WORK_USE = ?isTrue THEN ?nurTimezoneWorkUseText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.NUR_TIMEZONE_WORK_USE = ?isFalse THEN ?nurTimezoneWorkNotUseText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_222 医療.日勤申し送り時間
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET1.APP_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		// R1_223 医療.夜勤申し送り時間
		sqlNormal.append(" 	IIF(TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.APP_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		// R1_225 医療.日勤勤務時間.端数
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET1.ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		// R1_227 医療.夜勤勤務時間.端数
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.ROUNDING = ?roundingDown THEN ?roundingDownText");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.ROUNDING = ?roundingUp THEN ?roundingUpText");
		sqlNormal.append(" 		 ELSE NULL");
		sqlNormal.append(" 	END,");
		// R1_228 ０時跨ぎ.0時跨ぎ計算
		sqlNormal.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlNormal.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.OVER_DAY_CALC_SET = ?isTrue THEN ?isUseText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND PRED_TIME_SET.RANGE_TIME_DAY IS NOT NULL, ");
		sqlFlow.append(" 		CAST(PRED_TIME_SET.RANGE_TIME_DAY AS INTEGER)/60, NULL),");
		// R2_64 所定設定.1日の範囲時間.夜勤シフト
		sqlFlow.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND PRED_TIME_SET.NIGHT_SHIFT_ATR = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlFlow.append(" 			THEN ?isNightShiftText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND PRED_TIME_SET.NIGHT_SHIFT_ATR = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		...
		// R2_4 所定設定.就業時刻2回目
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue THEN ?isUseSecondWorkingDayText");
		...
		sqlFlow.append(" 		AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND WORK_TIME_SHEET_SET2.USE_ATR = ?isTrue, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND PRED_TIME_SET.WORK_ADD_ONE_DAY IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND PRED_TIME_SET.WORK_ADD_MORNING IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND PRED_TIME_SET.WORK_ADD_AFTERNOON IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND STAMP_REFLECT1.STR_CLOCK IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND STAMP_REFLECT1.END_CLOCK IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND STAMP_REFLECT2.STR_CLOCK IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND STAMP_REFLECT2.END_CLOCK IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 		CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 			 WHEN ROUNDING_SET3.ROUNDING_TIME_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 		CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 			 WHEN ROUNDING_SET4.ROUNDING_TIME_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 			THEN IIF(FLOW_FLOW_RT_SET2.PASSAGE_TIME IS NOT NULL AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlow.append(" 			THEN IIF(FLOW_RT_SET2.AFTER_PASSAGE_TIME IS NOT NULL AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlow.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlow.append(" 			THEN IIF(FLOW_FLOW_RT_SET2.REST_TIME IS NOT NULL AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlow.append(" 			CASE WHEN FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlow.append(" 				 WHEN FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlow.append(" 				 ELSE NULL");
		sqlFlow.append(" 			END");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlow.append(" 			THEN IIF(FLOW_RT_SET2.AFTER_REST_TIME IS NOT NULL AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL ");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLOW_REST_SET.COMMON_CALCULATE_METHOD = ?calcMethodAppropAll");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL ");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLOW_REST_SET.USE_PLURAL_WORK_REST_TIME = ?isTrue THEN ?isUsePluralWorkRestTimeText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR FLOW_RT_SET2.FIX_REST_TIME = ?isFalse THEN NULL ");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLOW_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferMaster THEN ?restCalcMethodReferMasterText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLOW_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferSchedule THEN ?restCalcMethodReferScheduleText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLOW_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodWithoutRefer THEN ?restCalcMethodWithoutReferText");
		sqlFlow.append(" 		 ELSE NULL");
		sqlFlow.append(" 	END,");
		// R2_121 休憩時間帯.固定休憩設定（休憩時間の固定する）.予定と実績の勤務が一致しな場合はマスタを参照する
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLOW_RT_SET2.FIX_REST_TIME = ?isTrue AND FLOW_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferSchedule, ");
		sqlFlow.append(" 		IIF(FLOW_REST_SET.IS_CALC_FROM_SCHEDULE = ?isTrue, ?isCalcFromSchedule, ?isNotCalcFromSchedule), NULL),");
		// R2_122 休憩時間帯.固定休憩設定（休憩時間の固定する）.休憩時刻が無い場合はマスタから休憩時刻を参照する
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLOW_RT_SET2.FIX_REST_TIME = ?isTrue AND FLOW_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferSchedule, ");
		sqlFlow.append(" 		IIF(FLOW_REST_SET.IS_REFER_REST_TIME = ?isTrue, ?isReferRestTime, ?isNotReferRestTime), NULL),");
		// R2_123 休憩時間帯.固定休憩設定（休憩時間の固定する）.私用外出を休憩として扱う
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLOW_RT_SET2.FIX_REST_TIME = ?isTrue AND FLOW_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodWithoutRefer, ");
		sqlFlow.append(" 		IIF(FLOW_REST_SET.USER_PRIVATE_GO_OUT_REST = ?isTrue, ?userPrivateGoOutRest, ?notUserPrivateGoOutRest), NULL),");
		// R2_124 休憩時間帯.固定休憩設定（休憩時間の固定する）.組合外出を休憩として扱う
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLOW_RT_SET2.FIX_REST_TIME = ?isTrue AND FLOW_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodWithoutRefer, ");
		sqlFlow.append(" 		IIF(FLOW_REST_SET.USER_ASSO_GO_OUT_REST = ?isTrue, ?userAssoGoOutRest, ?notUserAssoGoOutRest), NULL),");
		// R2_125 休憩時間帯.流動休憩設定（休憩時間の固定しない）.実績での休憩計算方法
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse, ");
		sqlFlow.append(" 		IIF(FLOW_REST_SET.FIXED_CALCULATE_METHOD = ?flowRestCalcMethodReferMaster, ?restCalcMethodReferMasterText, ?flowRestCalcMethodMasterAndStampText), NULL),");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse, ");
		sqlFlow.append(" 		IIF(FLOW_REST_SET.USE_STAMP_CALC_METHOD = ?useRestTimeToCalc, ?useRestTimeToCalcText, ?useGoOutTimeToCalcText), NULL),");
		// R2_128 休憩時間帯.流動休憩設定（休憩時間の固定しない）.優先設定
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLOW_RT_SET2.FIX_REST_TIME = ?isFalse, ");
		sqlFlow.append(" 		IIF(FLOW_REST_SET.TIME_MANAGER_SET_ATR = ?isClockManage, ?isClockManageText, ?notClockManageText), NULL),");
		// R2_129 休出時間帯.経過時間
		...
		sqlFlow.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlow.append(" 			THEN IIF(FLOW_FLOW_RT_SET1.PASSAGE_TIME IS NOT NULL AND FLOW_RT_SET1.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlow.append(" 			THEN IIF(FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isTrue AND FLOW_RT_SET1.AFTER_PASSAGE_TIME IS NOT NULL, ");
		...
		sqlFlow.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlow.append(" 			THEN IIF(FLOW_FLOW_RT_SET1.REST_TIME IS NOT NULL AND FLOW_RT_SET1.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 7 THEN ");
		sqlFlow.append(" 			CASE WHEN FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlow.append(" 				 WHEN FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlow.append(" 				 ELSE NULL");
		sqlFlow.append(" 			END");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlow.append(" 			THEN IIF(FLOW_RT_SET1.FIX_REST_TIME = ?isFalse AND FLOW_RT_SET1.USE_REST_AFTER_SET = ?isTrue AND FLOW_RT_SET1.AFTER_REST_TIME IS NOT NULL, ");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_GO_OUT_SET.ROUNDING_SAME_FRAME = ?isTrue THEN ?roudingAfterTotalText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_GO_OUT_SET.ROUNDING_CROSS_FRAME = ?isTrue THEN ?roudingAfterTotalText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT1.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT3.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN SPECIAL_ROUND_OUT2.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.EXTRACT_LATE_EARLY_TIME = ?isTrue THEN ?isExtractLateEarlyTimeText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.EXTRACT_LATE_EARLY_TIME = ?isTrue THEN ?isExtractLateEarlyTimeText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.GRACE_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.INCLUDE_WORKTIME = ?isTrue THEN ?isIncludeWorktimeText");
		...
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.GRACE_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.INCLUDE_WORKTIME = ?isTrue THEN ?isIncludeWorktimeText");
		...
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND BONUS_PAY_SET.BONUS_PAY_SET_CD IS NULL AND WORKTIME_COMMON_SET.RAISING_SALARY_SET IS NOT NULL THEN ?masterUnregistered");
		sqlFlow.append(" 		 ELSE NULL");
		sqlFlow.append(" 	END,");
		// R2_41 代休.休日出勤
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		...
		sqlFlow.append(" 	END,");
		// R2_189 代休.休日出勤.時間区分
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SUBSTITUTION_SET2.USE_ATR = ?isFalse THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET2.TRANFER_ATR = ?specifiedTimeSubHol THEN ?specifiedTimeSubHolText");
		...
		sqlFlow.append(" 		AND (WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR (SUBSTITUTION_SET2.USE_ATR = ?isTrue AND SUBSTITUTION_SET2.TRANFER_ATR = ?specifiedTimeSubHol)), ");
		...
		// R2_192 代休.休日出勤.一定時間
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET2.USE_ATR = ?isTrue ");
		sqlFlow.append(" 		AND SUBSTITUTION_SET2.TRANFER_ATR = ?certainTimeExcSubHol AND SUBSTITUTION_SET2.CERTAIN_TIME IS NOT NULL, ");
		...
		// R2_42 代休.残業
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.USE_ATR = ?isTrue THEN ?isUseSubstitutionText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.USE_ATR = ?isFalse THEN ?isNotUseSubstitutionText");
		sqlFlow.append(" 		 ELSE NULL");
		sqlFlow.append(" 	END,");
		// R2_194 代休.残業.時間区分
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SUBSTITUTION_SET1.USE_ATR = ?isFalse THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol THEN ?specifiedTimeSubHolText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.TRANFER_ATR = ?certainTimeExcSubHol THEN ?certainTimeExcSubHolText");
		sqlFlow.append(" 		 ELSE NULL");
		sqlFlow.append(" 	END,");
		// R2_195 代休.残業.１日
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlFlow.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol AND SUBSTITUTION_SET1.ONE_DAY_TIME IS NOT NULL, ");
		...
		// R2_196 代休.残業.半日
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlFlow.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol AND SUBSTITUTION_SET1.HALF_DAY_TIME IS NOT NULL, ");
		...
		// R2_197 代休.残業.一定時間
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlFlow.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?certainTimeExcSubHol AND SUBSTITUTION_SET1.CERTAIN_TIME IS NOT NULL, ");
		...
		// R2_201 臨時.臨時端数
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND TEMP_WORKTIME_SET.ROUNDING = ?roundingDown THEN ?roundingDownText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND TEMP_WORKTIME_SET.ROUNDING = ?roundingUp THEN ?roundingUpText");
		sqlFlow.append(" 		 ELSE NULL");
		sqlFlow.append(" 	END,");
		// R2_202 育児.育児時間帯に勤務した場合の扱い
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.CHILD_CARE_WORK_USE = ?isTrue THEN ?childCareWorkUseText");
		...
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.NUR_TIMEZONE_WORK_USE = ?isTrue THEN ?nurTimezoneWorkUseText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.NUR_TIMEZONE_WORK_USE = ?isFalse THEN ?nurTimezoneWorkNotUseText");
		sqlFlow.append(" 		 ELSE NULL");
		sqlFlow.append(" 	END,");
		// R2_204 医療.日勤申し送り時間
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET1.APP_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		// R2_205 医療.夜勤申し送り時間
		sqlFlow.append(" 	IIF(TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.APP_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		// R2_207 医療.日勤勤務時間.端数
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET1.ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		// R2_209 医療.夜勤勤務時間.端数
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.ROUNDING = ?roundingDown THEN ?roundingDownText");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.ROUNDING = ?roundingUp THEN ?roundingUpText");
		sqlFlow.append(" 		 ELSE NULL");
		sqlFlow.append(" 	END,");
		// R2_210 ０時跨ぎ.0時跨ぎ計算
		sqlFlow.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlow.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.OVER_DAY_CALC_SET = ?isTrue THEN ?isUseText");
		...
		sqlFlex.append(" 	END,");
		// R3_67 モード
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode THEN ?detailModeText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?simpleMode THEN ?simpleModeText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_68 半日勤務
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlFlex.append(" 			THEN ?isUseHalfDayText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		...
		sqlFlex.append(" 	END,");
		// R3_4 所定設定.コアタイム時間帯
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND FLEX_WORK_SET.CORETIME_USE_ATR = ?useCoretime THEN ?useCoretimeText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLEX_WORK_SET.CORETIME_USE_ATR = ?notUseCoretime THEN ?notUseCoretimeText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_77 所定設定.コアタイム時間帯.始業時刻
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND FLEX_WORK_SET.CORE_TIME_STR IS NOT NULL AND FLEX_WORK_SET.CORETIME_USE_ATR = ?useCoretime, ");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND FLEX_WORK_SET.CORE_TIME_END IS NOT NULL AND FLEX_WORK_SET.CORETIME_USE_ATR = ?useCoretime, ");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND FLEX_WORK_SET.LEAST_WORK_TIME IS NOT NULL AND FLEX_WORK_SET.CORETIME_USE_ATR = ?notUseCoretime, ");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND PRED_TIME_SET.WORK_ADD_ONE_DAY IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND PRED_TIME_SET.WORK_ADD_MORNING IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND PRED_TIME_SET.WORK_ADD_AFTERNOON IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlex.append(" 	IIF(FLEX_WORK_TIME_SET2.TIME_STR IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_WORK_TIME_SET2.TIME_END IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_WORK_TIME_SET3.TIME_STR IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_WORK_TIME_SET3.TIME_END IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_OT_TIME_SET2.TIME_END IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_OT_TIME_SET3.TIME_STR IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_OT_TIME_SET3.TIME_END IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND PIORITY_SET1.PIORITY_ATR = ?beforePiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlFlex.append(" 			THEN ?beforePiorityText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND PIORITY_SET1.PIORITY_ATR = ?afterPiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlFlex.append(" 			THEN ?afterPiorityText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_119 打刻時間帯.優先設定.退勤
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID = 1 AND PIORITY_SET2.PIORITY_ATR = ?beforePiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlFlex.append(" 			THEN ?beforePiorityText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND PIORITY_SET2.PIORITY_ATR = ?afterPiority AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode");
		sqlFlex.append(" 			THEN ?afterPiorityText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND FLEX_STAMP_REFLECT2.START_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND FLEX_STAMP_REFLECT2.END_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1,");
		sqlFlex.append(" 		CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 			 WHEN ROUNDING_SET3.ROUNDING_TIME_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 		CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 			 WHEN ROUNDING_SET4.ROUNDING_TIME_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	IIF(FLEX_HA_FIX_REST2.STR_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_HA_FIX_REST2.END_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_HA_FIX_REST3.STR_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 	IIF(FLEX_HA_FIX_REST3.END_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 			THEN IIF(FLEX_HA_REST_SET1.FLOW_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlex.append(" 			THEN IIF(FLEX_HA_RT_SET1.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND FLEX_HA_RT_SET1.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_REST_SET1.FLOW_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlex.append(" 				 WHEN FLEX_HA_RT_SET1.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlex.append(" 				 WHEN FLEX_HA_RT_SET1.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlex.append(" 				ELSE NULL");
		sqlFlex.append(" 			END");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_RT_SET1.AFTER_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND FLEX_HA_RT_SET1.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_REST_SET2.FLOW_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_RT_SET2.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_REST_SET2.FLOW_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 7 THEN ");
		sqlFlex.append(" 			CASE WHEN FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue OR WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isFalse THEN NULL");
		sqlFlex.append(" 				WHEN FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlex.append(" 				WHEN FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlex.append(" 				ELSE NULL");
		sqlFlex.append(" 			END");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_RT_SET2.AFTER_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET2.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_REST_SET3.FLOW_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_RT_SET3.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_REST_SET3.FLOW_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 7 THEN ");
		sqlFlex.append(" 			CASE WHEN FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue OR WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isFalse THEN NULL");
		sqlFlex.append(" 				 WHEN FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isTrue THEN ?isUseRestAfterSetText");
		sqlFlex.append(" 				 WHEN FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlex.append(" 				 ELSE NULL");
		sqlFlex.append(" 			END");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(FLEX_HA_RT_SET3.AFTER_REST_TIME IS NOT NULL AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_WORK_SET.USE_HALFDAY_SHIFT = ?isTrue AND FLEX_HA_RT_SET3.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLEX_REST_SET.COMMON_CALCULATE_METHOD = ?calcMethodAppropAll");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse THEN NULL ");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLEX_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferMaster THEN ?restCalcMethodReferMasterText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLEX_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferSchedule THEN ?restCalcMethodReferScheduleText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND FLEX_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodWithoutRefer THEN ?restCalcMethodWithoutReferText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_161 休憩時間帯.固定休憩設定（休憩時間の固定する）.予定と実績の勤務が一致しな場合はマスタを参照する
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND FLEX_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferSchedule, ");
		sqlFlex.append(" 		IIF(FLEX_REST_SET.IS_CALC_FROM_SCHEDULE = ?isTrue, ?isCalcFromSchedule, ?isNotCalcFromSchedule), NULL),");
		// R3_162 休憩時間帯.固定休憩設定（休憩時間の固定する）.休憩時刻が無い場合はマスタから休憩時刻を参照する
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND FLEX_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodReferSchedule, ");
		sqlFlex.append(" 		IIF(FLEX_REST_SET.IS_REFER_REST_TIME = ?isTrue, ?isReferRestTime, ?isNotReferRestTime), NULL),");
		// R3_163 休憩時間帯.固定休憩設定（休憩時間の固定する）.私用外出を休憩として扱う
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND FLEX_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodWithoutRefer, ");
		sqlFlex.append(" 		IIF(FLEX_REST_SET.USER_PRIVATE_GO_OUT_REST = ?isTrue, ?userPrivateGoOutRest, ?notUserPrivateGoOutRest), NULL),");
		// R3_164 休憩時間帯.固定休憩設定（休憩時間の固定する）.組合外出を休憩として扱う
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isTrue AND FLEX_REST_SET.FIXED_REST_CALC_METHOD = ?restCalcMethodWithoutRefer, ");
		sqlFlex.append(" 		IIF(FLEX_REST_SET.USER_ASSO_GO_OUT_REST = ?isTrue, ?userAssoGoOutRest, ?notUserAssoGoOutRest), NULL),");
		// R3_165 休憩時間帯.流動休憩設定（休憩時間の固定しない）.実績での休憩計算方法
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse, ");
		sqlFlex.append(" 		IIF(FLEX_REST_SET.CALCULATE_METHOD = ?flowRestCalcMethodReferMaster, ?restCalcMethodReferMasterText, ?flowRestCalcMethodMasterAndStampText), NULL),");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse, ");
		sqlFlex.append(" 		IIF(FLEX_REST_SET.USE_STAMP_CALC_METHOD = ?useRestTimeToCalc, ?useRestTimeToCalcText, ?useGoOutTimeToCalcText), NULL),");
		// R3_168 休憩時間帯.流動休憩設定（休憩時間の固定しない）.優先設定
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND FLEX_HA_RT_SET1.FIX_REST_TIME = ?isFalse, ");
		sqlFlex.append(" 		IIF(FLEX_REST_SET.TIME_MANAGER_SET_ATR = ?isClockManage, ?isClockManageText, ?notClockManageText), NULL),");
		// R3_169 休出時間帯.開始時間
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlex.append(" 			THEN IIF(FLEX_OD_REST_SET.FLOW_PASSAGE_TIME IS NOT NULL AND FLEX_OD_RT_SET.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '経過時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(FLEX_OD_RT_SET.AFTER_PASSAGE_TIME IS NOT NULL AND FLEX_OD_RT_SET.FIX_REST_TIME = ?isFalse AND FLEX_OD_RT_SET.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN TEMP.ROW_ID < 6   ");
		sqlFlex.append(" 			THEN IIF(FLEX_OD_REST_SET.FLOW_REST_TIME IS NOT NULL AND FLEX_OD_RT_SET.FIX_REST_TIME = ?isFalse, ");
		...
		sqlFlex.append(" 				 WHEN FLEX_OD_RT_SET.USE_REST_AFTER_SET = ?isFalse THEN ?isNotUseRestAfterSetText");
		sqlFlex.append(" 				 ELSE NULL");
		sqlFlex.append(" 			END");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 8 THEN '休憩時間'");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 9 ");
		sqlFlex.append(" 			THEN IIF(FLEX_OD_RT_SET.AFTER_REST_TIME IS NOT NULL AND FLEX_OD_RT_SET.FIX_REST_TIME = ?isFalse AND FLEX_OD_RT_SET.USE_REST_AFTER_SET = ?isTrue, ");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_GO_OUT_SET.ROUNDING_SAME_FRAME = ?isTrue THEN ?roudingAfterTotalText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_GO_OUT_SET.ROUNDING_CROSS_FRAME = ?isTrue THEN ?roudingAfterTotalText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PERSONAL_DEDUCT_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT1.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT1.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT1.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT3.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT3.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT3.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD = ?reverseTimezoneRounding THEN ?reverseTimezoneRoundingText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1, ");
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN SPECIAL_ROUND_OUT2.PUB_ROUNDING_UNIT = ?roundingTime1Min THEN ?roundingTime1MinText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SPECIAL_ROUND_OUT2.PUB_ROUNDING_METHOD != ?isSetRounding THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SPECIAL_ROUND_OUT2.PUB_ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND LATE_EARLY_SET.IS_DEDUCTE_FROM_TIME = ?isTrue THEN ?isDeducteFromTimeText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.EXTRACT_LATE_EARLY_TIME = ?isTrue THEN ?isExtractLateEarlyTimeText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.EXTRACT_LATE_EARLY_TIME = ?isTrue THEN ?isExtractLateEarlyTimeText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.GRACE_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY1.INCLUDE_WORKTIME = ?isTrue THEN ?isIncludeWorktimeText");
		...
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.GRACE_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND OTHER_LATE_EARLY2.INCLUDE_WORKTIME = ?isTrue THEN ?isIncludeWorktimeText");
		...
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND BONUS_PAY_SET.BONUS_PAY_SET_CD IS NULL AND WORKTIME_COMMON_SET.RAISING_SALARY_SET IS NOT NULL THEN ?masterUnregistered");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_230 代休.休日出勤
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		...
		sqlFlex.append(" 	END,");
		// R3_231 代休.休日出勤.時間区分
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SUBSTITUTION_SET2.USE_ATR = ?isFalse THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET2.TRANFER_ATR = ?specifiedTimeSubHol THEN ?specifiedTimeSubHolText");
		...
		sqlFlex.append(" 		AND (WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR (SUBSTITUTION_SET2.USE_ATR = ?isTrue AND SUBSTITUTION_SET2.TRANFER_ATR = ?specifiedTimeSubHol)), ");
		...
		// R3_234 代休.休日出勤.一定時間
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET2.USE_ATR = ?isTrue ");
		sqlFlex.append(" 		AND SUBSTITUTION_SET2.TRANFER_ATR = ?certainTimeExcSubHol AND SUBSTITUTION_SET2.CERTAIN_TIME IS NOT NULL, ");
		...
		// R3_235 代休.残業
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.USE_ATR = ?isTrue THEN ?isUseSubstitutionText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.USE_ATR = ?isFalse THEN ?isNotUseSubstitutionText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_236 代休.残業.一定時間
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode OR SUBSTITUTION_SET1.USE_ATR = ?isFalse THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol THEN ?specifiedTimeSubHolText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND SUBSTITUTION_SET1.TRANFER_ATR = ?certainTimeExcSubHol THEN ?certainTimeExcSubHolText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_237 代休.残業.１日
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlFlex.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol AND SUBSTITUTION_SET1.ONE_DAY_TIME IS NOT NULL, ");
		...
		// R3_238 代休.残業.半日
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlFlex.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?specifiedTimeSubHol AND SUBSTITUTION_SET1.HALF_DAY_TIME IS NOT NULL, ");
		...
		// R3_239 代休.残業.一定時間
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode AND SUBSTITUTION_SET1.USE_ATR = ?isTrue ");
		sqlFlex.append(" 		AND SUBSTITUTION_SET1.TRANFER_ATR = ?certainTimeExcSubHol AND SUBSTITUTION_SET1.CERTAIN_TIME IS NOT NULL, ");
		...
		// R3_243 臨時.臨時端数
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND TEMP_WORKTIME_SET.ROUNDING = ?roundingDown THEN ?roundingDownText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND TEMP_WORKTIME_SET.ROUNDING = ?roundingUp THEN ?roundingUpText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_244 育児.育児時間帯に勤務した場合の扱い
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.CHILD_CARE_WORK_USE = ?isTrue THEN ?childCareWorkUseText");
		...
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.NUR_TIMEZONE_WORK_USE = ?isTrue THEN ?nurTimezoneWorkUseText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.NUR_TIMEZONE_WORK_USE = ?isFalse THEN ?nurTimezoneWorkNotUseText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_246 医療.日勤申し送り時間
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET1.APP_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		// R3_247 医療.夜勤申し送り時間
		sqlFlex.append(" 	IIF(TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.APP_TIME IS NOT NULL AND WORKTIME_DISP_MODE.DISP_MODE = ?detailMode, ");
		...
		// R3_249 医療.日勤勤務時間.端数
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET1.ROUNDING = ?roundingDown THEN ?roundingDownText");
		...
		// R3_251 医療.夜勤勤務時間.端数
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.ROUNDING = ?roundingDown THEN ?roundingDownText");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND MEDICAL_TIME_SET2.ROUNDING = ?roundingUp THEN ?roundingUpText");
		sqlFlex.append(" 		 ELSE NULL");
		sqlFlex.append(" 	END,");
		// R3_252 ０時跨ぎ.0時跨ぎ計算
		sqlFlex.append(" 	CASE WHEN WORKTIME_DISP_MODE.DISP_MODE != ?detailMode THEN NULL");
		sqlFlex.append(" 		 WHEN TEMP.ROW_ID = 1 AND WORKTIME_COMMON_SET.OVER_DAY_CALC_SET = ?isTrue THEN ?isUseText");
