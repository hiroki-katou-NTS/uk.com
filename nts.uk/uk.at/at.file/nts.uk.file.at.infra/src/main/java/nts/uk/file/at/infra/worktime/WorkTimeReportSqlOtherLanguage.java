...
public class WorkTimeReportSqlOtherLanguage {
	...
	static {
		...
		sqlNormal.append(" 		FROM KSHMT_WT WORK_TIME_SET");
		sqlNormal.append(
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_COM_DISP_MODE WORKTIME_DISP_MODE");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM WORKTIME_COMMON_SET");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX FIXED_WORK_SET");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_EXCEEDED_PRED_OT_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_OT_IN_LAW_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_OT_NOT_IN_LAW_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF DIFF_TIME_WORK_SET");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_EXCEEDED_PRED_OT_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_OT_IN_LAW_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_OT_NOT_IN_LAW_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_COM_PRED_TIME PRED_TIME_SET");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_PRED_TS WORK_TIME_SHEET_SET1");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_PRED_TS WORK_TIME_SHEET_SET2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_WORK_TS FIXED_WORK_TIME_SET1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_WORK_TS FIXED_WORK_TIME_SET2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_WORK_TS FIXED_WORK_TIME_SET3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_WORK_TS DT_WORK_TIME_SET1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_WORK_TS DT_WORK_TIME_SET2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_WORK_TS DT_WORK_TIME_SET3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_OVER_TS FIXED_OT_TIME_SET1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_OT_FRAME1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_LEGAL_OT_FRAME1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_OVER_TS FIXED_OT_TIME_SET2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_OT_FRAME2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_LEGAL_OT_FRAME2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_OVER_TS FIXED_OT_TIME_SET3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_OT_FRAME3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME FIXED_LEGAL_OT_FRAME3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_OVER_TS DT_OT_TIME_SET1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_OT_FRAME1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_LEGAL_OT_FRAME1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_OVER_TS DT_OT_TIME_SET2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_OT_FRAME2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_LEGAL_OT_FRAME2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_OVER_TS DT_OT_TIME_SET3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_OT_FRAME3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_OVER_FRAME DT_LEGAL_OT_FRAME3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_STMP_REF_TS FIXED_STAMP_REFLECT1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_STMP_REF_TS FIXED_STAMP_REFLECT2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_STMP_REF_TS FIXED_STAMP_REFLECT3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_STMP_REF_TS FIXED_STAMP_REFLECT4");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_STMP_REF_TS DT_STAMP_REFLECT1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_STMP_REF_TS DT_STAMP_REFLECT2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_STMP_REF_TS DT_STAMP_REFLECT3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_STMP_REF_TS DT_STAMP_REFLECT4");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_BR_WEK_TS FIXED_HALF_REST_SET1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_BR_WEK_TS FIXED_HALF_REST_SET2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_BR_WEK_TS FIXED_HALF_REST_SET3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_BR_WEK_TS DT_HALF_REST_TIME1");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_BR_WEK_TS DT_HALF_REST_TIME2");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_BR_WEK_TS DT_HALF_REST_TIME3");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_HOL_TS FIXED_HOL_TIME_SET");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME FIXED_HOL_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME FIXED_OUT_HOL_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME FIXED_PUB_HOL_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_HOL_TS DIFF_TIME_HOL_SET");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME DT_HOL_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME DT_OUT_HOL_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME DT_PUB_HOL_FRAME");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_FIX_BR_HOL_TS FIXED_HOL_REST_SET");
		...
		sqlNormal.append(" 	LEFT JOIN KSHMT_WT_DIF_BR_HOL_TS DT_HOL_REST_TIME");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_GOOUT WORKTIME_GO_OUT_SET");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT1");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT2");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT3");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_LATETIME OTHER_LATE_EARLY1");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_LATETIME OTHER_LATE_EARLY2");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_LATETIME_MNG LATE_EARLY_SET");
		...
		sqlNormal.append(" 	LEFT JOIN KRCMT_BONUS_PAY_SET BONUS_PAY_SET");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_HDCOM SUBSTITUTION_SET1");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_HDCOM SUBSTITUTION_SET2");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_TEMPORARY TEMP_WORKTIME_SET");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_MEDICAL MEDICAL_TIME_SET1");
		...
		sqlNormal.append(" 	JOIN KSHMT_WT_COM_MEDICAL MEDICAL_TIME_SET2");
		...
		sqlFlow.append(
				" 	(SELECT CID, WORKTIME_CD, NAME, ABNAME, SYMBOL, ABOLITION_ATR, DAILY_WORK_ATR, WORKTIME_SET_METHOD, NOTE, MEMO");
		sqlFlow.append(" 		FROM KSHMT_WT WORK_TIME_SET");
		sqlFlow.append(
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_COM_DISP_MODE WORKTIME_DISP_MODE");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM WORKTIME_COMMON_SET");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO FLOW_WORK_SET");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_COM_PRED_TIME PRED_TIME_SET");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_PRED_TS WORK_TIME_SHEET_SET1");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_PRED_TS WORK_TIME_SHEET_SET2");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_WORK_TS FLOW_TIME_ZONE");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_OVER_TS OT_TIME_ZONE");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_STMP_REF_TS STAMP_REFLECT1");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_STMP_REF_TS STAMP_REFLECT2");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_STMP_REF2_TS FSTAMP_REFLECT_TIME");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_BR_FL FLOW_RT_SET1");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_BR_FL FLOW_RT_SET2");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_BR_FI_ALL_TS FLOW_FIXED_RT_SET1");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_BR_FI_ALL_TS FLOW_FIXED_RT_SET2");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_BR_FL_ALL_TS FLOW_FLOW_RT_SET1");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_BR_FL_ALL_TS FLOW_FLOW_RT_SET2");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_BR_FL_ALL FLOW_REST_SET");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_WT_FLO_HOL_TS FWORK_HOLIDAY_TIME");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME INLEGAL_BREAK_REST_TIME_FRAME");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME OUT_LEGALB_REAK_REST_TIME_FRAME");
		...
		sqlFlow.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME OUT_LEGAL_PUBHOL_REST_TIME_FRAME");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_GOOUT WORKTIME_GO_OUT_SET");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT1");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT2");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT3");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_LATETIME OTHER_LATE_EARLY1");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_LATETIME OTHER_LATE_EARLY2");
		...
		sqlFlow.append(" 	LEFT JOIN KRCMT_BONUS_PAY_SET BONUS_PAY_SET");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_HDCOM SUBSTITUTION_SET1");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_HDCOM SUBSTITUTION_SET2");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_TEMPORARY TEMP_WORKTIME_SET");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_MEDICAL MEDICAL_TIME_SET1");
		...
		sqlFlow.append(" 	JOIN KSHMT_WT_COM_MEDICAL MEDICAL_TIME_SET2");
		...
		sqlFlex.append(
				" 	(SELECT CID, WORKTIME_CD, NAME, ABNAME, SYMBOL, ABOLITION_ATR, DAILY_WORK_ATR, WORKTIME_SET_METHOD, NOTE, MEMO");
		sqlFlex.append(" 		FROM KSHMT_WT WORK_TIME_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_COM_DISP_MODE WORKTIME_DISP_MODE");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM WORKTIME_COMMON_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE FLEX_WORK_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_COM_PRED_TIME PRED_TIME_SET");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_PRED_TS WORK_TIME_SHEET_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_WEK FLEX_HA_RT_SET1");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_WEK FLEX_HA_RT_SET2");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_WEK FLEX_HA_RT_SET3");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_WORK_TS FLEX_WORK_TIME_SET1");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_WORK_TS FLEX_WORK_TIME_SET2");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_WORK_TS FLEX_WORK_TIME_SET3");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_OVER_TS FLEX_OT_TIME_SET1");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_OVER_FRAME FLEX_OT_FRAME1");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_OVER_TS FLEX_OT_TIME_SET2");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_OVER_FRAME FLEX_OT_FRAME2");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_OVER_TS FLEX_OT_TIME_SET3");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_OVER_FRAME FLEX_OT_FRAME3");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_STMP_REF_TS FLEX_STAMP_REFLECT1");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_STMP_REF_TS FLEX_STAMP_REFLECT2");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_STMP_REF_TS FLEX_STAMP_REFLECT3");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_STMP_REF_TS FLEX_STAMP_REFLECT4");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FI_WEK_TS FLEX_HA_FIX_REST1");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FI_WEK_TS FLEX_HA_FIX_REST2");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FI_WEK_TS FLEX_HA_FIX_REST3");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_WEK_TS FLEX_HA_REST_SET1");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_WEK_TS FLEX_HA_REST_SET2");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_WEK_TS FLEX_HA_REST_SET3");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL FLEX_REST_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_HOL FLEX_OD_RT_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_HOL_TS FLEX_HOL_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME FLEX_HOL_FRAME");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME FLEX_OUT_HOL_FRAME");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_HD_WORK_FRAME FLEX_PUB_HOL_FRAME");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FI_HOL_TS FLEX_OD_FIX_REST");
		...
		sqlFlex.append(" 	LEFT JOIN KSHMT_WT_FLE_BR_FL_HOL_TS FLEX_OD_REST_SET");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_GOOUT WORKTIME_GO_OUT_SET");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT1");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT2");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_GOOUT_ROUND SPECIAL_ROUND_OUT3");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_LATETIME OTHER_LATE_EARLY1");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_LATETIME OTHER_LATE_EARLY2");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_LATETIME_MNG LATE_EARLY_SET");
		...
		sqlFlex.append(" 	LEFT JOIN KRCMT_BONUS_PAY_SET BONUS_PAY_SET");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_HDCOM SUBSTITUTION_SET1");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_HDCOM SUBSTITUTION_SET2");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_TEMPORARY TEMP_WORKTIME_SET");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_MEDICAL MEDICAL_TIME_SET1");
		...
		sqlFlex.append(" 	JOIN KSHMT_WT_COM_MEDICAL MEDICAL_TIME_SET2");
