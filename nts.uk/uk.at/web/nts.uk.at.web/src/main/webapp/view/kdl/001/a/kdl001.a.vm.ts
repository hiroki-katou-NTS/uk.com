module nts.uk.at.view.kdl001.a {
    export module viewmodel {
        export class ScreenModel {
            ...
            selectAbleCodeList: KnockoutObservableArray<WorkTimeSet>;
            ...
            constructor() {
                var self = this;
                self.multiSelectMode = ko.observable(false);
                self.searchOption = ko.observable(1);
                self.startTimeOption = ko.observable(1);
                self.startTime = ko.observable(100);
                self.endTimeOption = ko.observable(1);
                self.endTime = ko.observable(3600);  
                self.selectAbleCodeList = ko.observableArray([
                    ...
                    new WorkTimeSet('0021','n', 't', 'thu2', 'thu2', 'thu2'),
                    new WorkTimeSet('0022','o', 'thu2', 'thu2', 'thu2', 'thu2'),
                    new WorkTimeSet('0023','p', 'thu2', 'thu2', 'thu2', 'thu2'),
                    new WorkTimeSet('0024','q', 'thu2', 'thu2', 'thu2', 'thu2'),
                    new WorkTimeSet('0025','r', 'thu2', 'thu2', 'thu2', 'thu2'),
                    new WorkTimeSet('0026','s', 'thu2', 'thu2', 'thu2', 'thu2'),
                    new WorkTimeSet('0027','t', 'thu2', 'thu2', 'thu2', 'thu2'),
                ]);
