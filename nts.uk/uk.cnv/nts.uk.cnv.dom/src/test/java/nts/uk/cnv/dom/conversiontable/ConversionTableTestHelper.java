		...
		return new ConversionTable(
				...
				Arrays.asList(
					new OneColumnConversion(
						"CID", 
						Arrays.asList(new CodeToIdPattern(
							info,
							new Join(
					...
					new OneColumnConversion(
							"CCD", 
							Arrays.asList(new ParentJoinPattern(
									info,
					...
					new OneColumnConversion(
							"CONTRACT_CD", 
							Arrays.asList(new FixedValuePattern(info, true, Constants.ContractCodeParamName))
					),
					new OneColumnConversion(
							"NAME", 
							Arrays.asList(new NotChangePattern(
									info,
									new Join(new TableName(info.getSourceDatabaseName(), info.getSourceSchema(), "kyotukaisya_m", Constants.BaseTableAlias),
										JoinAtr.Main,
										null),
