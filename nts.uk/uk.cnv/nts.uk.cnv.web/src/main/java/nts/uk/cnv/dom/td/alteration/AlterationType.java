...
import nts.uk.cnv.dom.td.alteration.content.ChangeColumnContaint;
...
import nts.uk.cnv.dom.td.alteration.content.ChangeDefaultValue;
...
public enum AlterationType {
	...
	private BiFunction<Optional<TableDesign>, Optional<TableDesign>, AlterationContent> content;
	private BiFunction<Optional<TableDesign>, Optional<TableDesign>, Boolean> applicable;

	private AlterationType(BiFunction<Optional<TableDesign>, Optional<TableDesign>, AlterationContent> content,
			BiFunction<Optional<TableDesign>, Optional<TableDesign>, Boolean> applicable) {
		this.content = content;
		this.applicable = applicable;
	}

	public AlterationContent createContent(Optional<TableDesign> base, Optional<TableDesign> altered) {
